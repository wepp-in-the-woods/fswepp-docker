...
$DEPfile  = 'working/' . $output['file'] . '.prodgrd.txt';
...
#        $gap=0;
	...
	imagefilledrectangle($img,$marginl,$marginb,$img_width-1-$marginl,$img_height-1-$marginb,$background_color);
...
#        $z_hex = sprintf "%lx", $z;
#        $color='#00'.$z_hex.'00';
          $dep_color=imagecolorallocate($img,0,$z,0);
