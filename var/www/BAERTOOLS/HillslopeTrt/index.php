<HTML xmlns="https://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <!-- #BeginTemplate "/Templates/home_deh.dwt" --><HEAD>
...
<!-- #EndEditable -->
  ...
  <META content="Rocky Mountain Research Station, Forest Service,&#10; Post-fire Treatment Effectiveness for Hillslope Stabilization" name=Keywords>
<!-- #EndEditable -->
...
<?php
   $page = $_REQUEST['page'];
// echo "page: $page";
   if (!isset($_REQUEST['page'])) $page = 'index';	// https://www.programmersheaven.com/mb/phpstuff/355987/355987/check-that-_post-variable-exists/
  ...
  <TBODY>
   <TR>
    <TD id=glob-nav-left width=229 colSpan=2>
     <A id=top name=top></A>
     <A class=hidden tabIndex=1 href="https://forest.moscowfsl.wsu.edu/TreatmentEffectiveness/#content">[Jump to the main content of this page]</A>
     <BR>
...
//
    ...
    $footer="footer_n.htm";
    if ($page == "index") {$footer="footer_1.htm";};
    $file=file($footer);
    foreach ($file as $line_num => $line) {
      echo $line;
    }
