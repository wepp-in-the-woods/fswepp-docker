...
<HEAD>
  <!DOCTYPE HTML
    PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "https://www.w3c.org/TR/1999/REC-html401-19991224/loose.dtd">
  <!-- #BeginTemplate "/Templates/home_deh.dwt" -->

  <HEAD>
    <!-- #BeginEditable "doctitle" -->
    <TITLE>RMRS - Post Fire Treatment Efectiveness</TITLE>
    <!-- #EndEditable -->
    <!-- DW6 -->
    ...
    <META content="USFS Version 3.02AB, 05 February 2003" name=version>
    <!-- LEAVE THIS ALONE ABOVE --><!-- EDITABLE META TAGS - IDEALLY THE DESCRIPTION AND KEYWORDS SHOULD ADDRESS THE CONTENT OF EACH INDIVIDUAL PAGE. --><!-- #BeginEditable "metatags" -->
    ...
    <META content="USDA Forest Service - Rocky Mountain Research Station, Moscow Forestry Sciences Laboratory"
      name=Description>
    <META
      content="Rocky Mountain Research Station, Forest Service,&#10; Post-fire Treatment Effectiveness for Hillslope Stabilization"
      name=Keywords>
    <!-- #EndEditable -->
    ...
    <style type="text/css" media="screen">
      @import url(/local_resources/styles/screen.css);
...
<body>
  ...
  if (!isset($_REQUEST['page']))
    $page = 'index';	// https://www.programmersheaven.com/mb/phpstuff/355987/355987/check-that-_post-variable-exists/
// if ($page) {} else {$page = 'index'};
// if ($page = '') {$page = "index"};
// echo "page: $page";
  ?>

  <TABLE cellSpacing=0 cellPadding=0 width="100%"
    summary="Layout table: Main table. The first row contains a USDAFS link and a service wide drop-down navigation.  The second row and third rows contains the Station name and search engine.  Below this are two cells.  The left cell contains the site navigation.  The right cell contains the content of the page."
    border=0>
    ...
    <TBODY>
      <TR>
        <TD id=glob-nav-left width=229 colSpan=2>
          <A id=top name=top></A>
          <A class=hidden tabIndex=1 href="https://forest.moscowfsl.wsu.edu/TreatmentEffectiveness/#content">[Jump to
            the main content of this page]</A>
          <BR>
          <A tabIndex=2 href="https://www.fs.fed.us/">
            <IMG height=29 alt="USDA Forest Service" src="/local_resources/images/logos/usda-fs-text.gif" width=143
              border=0></A>
        </TD>
    ...
    STATION NAME (RIGHT CELL) -->
      <TR id=header-tr>
        ...
        <TD id=header-center width=40>
          <IMG height=40 alt="" src="/local_resources/images/slices/trees-right.gif" width=40>
        </TD>
        <TD id=header-right>
          <H3> <!-- IMG height=40 alt="" src="/local_resources/images/rmrs/rmrs_index_top.gif" width=75 align=right -->
            <SPAN class=style1>Post-fire Treatment Effectiveness for Hillslope Stabilization</SPAN>
          </H3>
        </TD>
      </TR>
      ...
      <!-- TAB INDEX: 5-6 -->
      <!-- ROW CONTAINS:	 	SEARCH ENGINE	 	1/4 ARCH IMAGE -->
      <TR>
        <TD id=search-table-left-cell width=189><IMG height=14 alt=""
            src="/local_resources/images/slices/search-head.gif" width=189>
          <FORM id=search_form title="[Form]: Google search of Moscow FSL site." action=https://www.google.com/search
            method=get>
            <DIV><INPUT type=hidden value=forest.moscowfsl.wsu.edu name=as_sitesearch>
              ...
              <INPUT id=search_field
                ...
                onclick="value=''" tabIndex=5 size=12 value="(enter query)" name=as_q>&nbsp; <INPUT class=button
                tabIndex=6 type=submit value=Search>
            </DIV>
          </FORM>
        </TD>
        <TD id=search-table-right-cell width="100%" colSpan=2><IMG height=31 alt=""
            src="/local_resources/images/slices/arch-basic.gif" width=322>
        </TD>
      </TR>
      ...
      <TR>
        ...
        <TD id=main-table-left-cell vAlign=top width=189>
          ...
          <TABLE id=prim-nav-table cellSpacing=0 cellPadding=0 width="100%"
            summary="Layout table: Main Navigation.  The column on the left contains image bullets.  The column on the right contains links."
            border=0>
            <!-- RMRS HOME LINK -->
            <TBODY>
              <TR bgColor=#ded794>
                <TD width=21><IMG height=16 alt="" src="/local_resources/images/bullets/active-link.gif" width=21></TD>
                <TD width=168><A class=main-nav-current tabIndex=8 href="https://forest.moscowfsl.wsu.edu/">Moscow FSL
                    Home Page</A></TD>
              </TR>
              <!-- AT THE LAB -->
              <!-- ABOUT US LINK -->
              ...
              <TR class=p-link-not-active-tr>
                <TD><IMG height=16 alt="" src="/local_resources/images/bullets/not-active-link.gif" width=21></TD>
                <TD><A class=main-nav-not-current tabIndex=14 href="/library/">Engineering Publications</A></TD>
              </TR>
              <TR class=p-link-not-active-tr>
                <TD><IMG height=16 alt="" src="/local_resources/images/bullets/not-active-link.gif" width=21></TD>
                <TD><A class=main-nav-not-current tabIndex=15 href="/BAERTOOLS/">BAER Tools</A></TD>
              </TR>
          ...
          <DIV id=top-space>
            ...
            <TABLE id=sec-nav-table cellSpacing=0 cellPadding=0 width="100%"
              summary="Layout table: Secondary Navigation. The column on the left contains bullet images.  The column on the right contains links."
              border=0>
              <TBODY>
                <TR>
                  <TD colSpan=2 height=20><IMG height=10 alt="" src="/local_resources/images/bullets/local-link.gif"
                      width=21></TD>
                  <TD height=20><A class=main-nav-current href="https://www.fs.fed.us/rm/">Rocky Mountain Research
                      Station</A></TD>
                </TR>
                <TR>
                  <TD colSpan=2 height=20><IMG height=10 alt="" src="/local_resources/images/bullets/local-link.gif"
                      width=21></TD>
                  <TD height=20><A class=main-nav-current href="https://www.fs.fed.us/research/">Forest Service
                      Research</A></TD>
                </TR>
                <TR>
            ...
            <?php
            //           **** navigation ****	//
            $pagenav = $page . "_nav.htm";
            //    $pagenav="navigation.htm";
            $file = file($pagenav);
            echo "<font size=-1>\n";
            ...
            <TBODY>
              ...
              <TR>
                <TD class=ten-px-pad-cen colSpan=2>
                  ...
                  <MAP id=logos name=logos><AREA title="USDA Link" shape=RECT alt="USDA Link" coords=0,1,66,48
                      href="https://www.usda.gov/">
                    <AREA title="Forest Service Link" shape=RECT alt="Forest Service Link" coords=69,2,135,57
  ...
  <!-- IMAGE MAPS -->
  <MAP id=logos>
    <AREA shape=RECT alt="USDA logo which links to the department's national site." coords=-13,-5,65,45
      href="https://www.usda.gov/">
    <AREA shape=RECT alt="Forest Service logo which links to the agency's national site." coords=68,1,120,48
      href="https://www.fs.fed.us/">
  </MAP>
</BODY>
<!-- #EndTemplate -->
