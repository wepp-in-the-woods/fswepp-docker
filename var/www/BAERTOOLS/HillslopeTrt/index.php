...
<?php
   $page = $_REQUEST['page'];
// echo "page: $page";
   if (!isset($_REQUEST['page'])) $page = 'index';	// http://www.programmersheaven.com/mb/phpstuff/355987/355987/check-that-_post-variable-exists/
  ...
  <TBODY>
   <TR>
    <TD id=glob-nav-left width=229 colSpan=2>
     <A id=top name=top></A>
     <A class=hidden tabIndex=1 href="http://forest.moscowfsl.wsu.edu/TreatmentEffectiveness/#content">[Jump to the main content of this page]</A>
     <BR>
