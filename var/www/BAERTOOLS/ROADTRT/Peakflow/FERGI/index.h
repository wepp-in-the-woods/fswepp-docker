<HTML xmlns="https://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - FERGI</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p><font size="+1">Fire Enhanced Runoff and Gully Initiation (FERGI) Model</font></p>
      <p>&nbsp;</p>
      <p>The <a href="supplement.html#Details" target="_blank">FERGI model</a> 
        is used by a relatively small number of BAER team members in Region 4 
        (<a href="../supplement.html#Peakflow" target="_blank">2%</a>)
        (<a href="#Foltz2008">Foltz and others, 2008</a>).</p>
      <p>&nbsp;</p>
      <p>To use the FERGI model, you need to visit the
       <font size="+1">
        <b><a href="https://fergi.boise.rmrs.fs.fed.us/fergi/" target="_blank">FERGI model website (FS only)</a></b>
       </font>.
      </p>
      <p>&nbsp;</p>
      <p><b>Input Requirement</b></p>
      <ul type="disc">
        <li>Location of <a href="supplement.html#WeatherStations" target="_blank">three nearest weather stations</a>;</li>
        <li><a href="supplement.html#Depth" target="_blank">Depth to water repellent layer</a>;</li>
        <li>Fractional water repellency;</li>
        <li>Saturated hydraulic conductivity;</li>
        <li>Slope;</li>
        <li><a href="supplement.html#Hillslope" target="_blank">Hillslope length</a>;</li>
        <li>D<sub>50</sub> of soil surface;</li>
        <li><a href="supplement.html#Storage" target="_blank">Storage capacity of barriers</a>; and,</li>
        <li><a href="supplement.html#Trenched" target="_blank">Fraction of area trenched</a>.</li>
      </ul>
      <p>&nbsp;</p>
      <p><b>Steps</b></p>
      <ol>
        <li>Visit the FERGI website
        ...
        <li>Select each of the three weather stations.</li>
        <li>Type in soil and hillslope parameters.</li>
      </ol>
      <p>&nbsp;</p>
      <p><b>Advantages</b></p>
      <ul>
        <li>Estimates
         <a href="supplement.html#RainfallRO" target="_blank">rainfall excess, post-fire runoff, and gully length</a>. </li>
        <li>Provides an estimate of <a href="supplement.html#LogBarrier" target="_blank">the effectiveness of contour felled logs/log barriers</a>.</li>
        <li>On-line accessible.</li>
        <li>Process-based, and applicable to the western U.S.</li>
      </ul>
      <p>&nbsp;</p>
      <p><b>Disadvantages</b></p>
      <ul>
        <li><a href="supplement.html#NotPrefire" target="_blank">Does not provide 
          pre-fire rainfall excess, runoff amount, and gully initiation positions</a>.</li>
        <li>Does not estimate erosion.</li>
        <li>Does not consider post-fire debris flow/torrent.</li>
        <li>Available only for Forest Service intranet.</li>
        <li>Requires detailed soil parameter information.</li>
        <li><a href="supplement.html#WatershedShape" target="_blank">Does not consider watershed shapes</a>.</li>
        <li><a href="supplement.html#24Hour" target="_blank">Considers only 24-hour storm duration</a>.</li>
        <li>Uses only metric units.</li>
      </ul>
      <p>&nbsp;</p>
      ...
      <p>REFERENCES</p>
      <blockquote> 
        <p><a name="Istanbulluoglu2002"></a>Istanbulluoglu, Erkan; Tarboton, David 
          G.; Pack, Robert T.; Luce, Charles. 2002. A probablistic approach for 
          channel initiation. Water Resources Research. 38(12): 1325.</p>
        <p><a name="Istanbulluoglu2003"></a>Istanbulluoglu, Erkan; Tarboton, David 
          G.; Pack, Robert T.; Luce, Charles. 2003. A sediment transport model 
          for incision of gullies on steep topography. Water Resources Research. 
          39(4): 1103.</p>
        <p><a name="Istanbulluoglu2004"></a>Istanbulluoglu, Erkan; Tarboton, David 
          G.; Pack, Robert T.; Luce, Charles. 2004. Modeling of the interactions 
          between forest vegetation, disturbances, and sediment yields. Journal 
          of Geophysical Research. 109: F01009.</p>
        <p><a name="Luce2001"></a>Luce, Charles H. (2001 September 5--copyright 
          date). FERGI: Fire Enhanced Runoff and Gully Initiation model [Homepage 
          of FERGI], [Online]. Available:
          <a href="https://fergi.boise.rmrs.fs.fed.us/fergi/" target="_blank">https://fergi.boise.rmrs.fs.fed.us/fergi/</a> 
          [2008, January 2]. </p>
        <p><a name="Luce2005"></a>Luce, Charles H.; Tarboton, David G.; Istanbulluoglu, 
          Erkan; Pack, Robert T. 2005. Reply to comment by Jonathan J. Rhodes 
          on &quot;Modeling of the interactions between forest vegetation, disturbances, 
          and sediment yields&quot;. Journal of Geophysical Research. 110: F01013.</p>
        <p><a name="Luce2005a"></a>Luce, Charles. 2005. Land use and land cover 
          effects on runoff processes: fire. Encyclopedia of Hydrological Sciences. 
          13: 1831-1837.</p>
        <p><a name="Rajagopalan1999"></a>Rajagopalan, B.; Lall, U. 1999. A k-nearest-neighbor 
          simulator for daily precipitation and other weather variables. Water 
          Resources Research. 35(10): 3089-3101 </p>
        <p><a name="Rhodes2005"></a>Rhodes, Jonathan J. 2005. Comment on &quot;Modeling 
          of the interactions between forest vegetation, disturbances, and sediment 
          yields&quot; by Erkan Istanbulluoglu and others. Journal of Geophysical 
          Research. 110: F01012.</p>
        <p><a name="Shakesby2000"></a>Shakesby, R. A.; Doerr, S. H.; Walsh, R. 
          P. D. 2000. The erosional impact of soil hydrophobicity: current problems 
          and future research directions. Journal of Hydrology. 231-232: 178-191.</p>
