<HTML xmlns="https://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - FERGI Supplement</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p><b>Details of FERGI Model</b></p>
      <p>The FERGI model was developed by the USDA Rocky Mountain Research Station, 
        Boise Aquatic Sciences Lab (<a href="#Luce2001">Luce, 2001</a>), based 
        on several scientific research papers
        (<a href="#Rajagopalan1999">Rajagopalan and Lall, 1999</a>;
        <a href="#Shakesby2000">Shakesby and others, 2000</a>; 
        <a href="#Istanbulluoglu2002">Istanbulluoglu and others, 2002</a>;
        <a href="#Istanbulluoglu2003">Istanbulluoglu and others, 2003</a>;
        <a href="#Istanbulluoglu2004">Istanbulluoglu and others, 2004</a>;
        <a href="#Rhodes2005">Rhodes, 2005</a>;
        <a href="#Luce2005">Luce and others, 2005</a>;
        <a href="#Luce2005a">Luce, 2005</a>).
        The FERGI model is physically-based mathematical description of hillslope hydrologic 
        and geomorphic response to a set of weather events, and the model is applicable 
        to any part of the western U.S. FERGI estimates the probability of post-fire 
        rainfall excess (mm), runoff generation amount (m<sup>3</sup>/s/m), and 
        gully initiation positions (m) on hillslopes with and without mitigations, 
        using contour felled logs/log barriers. </p>
      <p>&nbsp;</p>
      <p><a name="WeatherStations"></a><b>Weather Stations</b></p>
      <p>Users can choose three nearest weather stations, which are wind, rainfall 
        intensity, and
        <a href="https://www.weather.gov/om/coop/what-is-coop.html" target="_blank">COOP (Cooperative Weather Program; NOAA, 2006)</a>
        stations.</p>
      <p>&nbsp;</p>
      <p><a name="Depth"></a><b>Depth to Water Repellent Layer (mm)</b></p>
      <p> The proportion of the area that is underlain by water repellent soils after a fire.</p>
      <p>&nbsp;</p>
      <p><a name="Hillslope"></a><b>Hillslope Length (m)</b></p>
      <p>Average length of hillslope before flow begins to accumulate into channels.</p>
      <p>&nbsp;</p>
      <p><a name="Storage"></a><b>Storage Capacity of Barriers (mm)</b></p>
      <p>The amount of precipitation that can be stored by the barriers, i.e., 
        the volume of water storage behind barriers divided by the total area 
        over which the measured barriers are applied.</p>
      <p>&nbsp;</p>
      <p><a name="Trenched"></a><b>Fraction of Area Trenched (between 0 and 1)</b></p>
      <p>The total length of scalping times the width of scalped area divided by the total area of the site.</p>
      <p>&nbsp;</p>
      <p><b><a name="RainfallRO"></a>Rainfall Excess, Post-Fire Runoff, and Gully Length</b></p>
      <p> The model results are based on a rectangular strip with unit width.</p>
      <p>&nbsp;</p>
      <p><b><a name="LogBarrier"></a>Effectiveness of Contour Felled Logs/Log Barriers </b></p>
      <p>The model provides the effectiveness as a function of storm return periods.</p>
      <p>&nbsp;</p>
      <p><a name="NotPrefire"></a><b>Does Not Provide Pre-Fire Results</b></p>
      <p>No pre-fire results are available; therefore, users cannot compare pre- and post-fire changes.</p>
      <p>&nbsp;</p>
      <p><a name="WatershedShape"></a><b>Watershed Shapes</b></p>
      <p>FERGI assumes a rectangular hillslope.</p>
      <p>&nbsp;</p>
      <p><a name="24Hour"></a><b>24-hour Storm Duration</b></p>
      <p>FERGI considers only 24-hour storm duration; therefore, it is not applicable 
        to the regions where the damaging storm duration is much shorter, such as 15 or 30 minutes.</p>
      <p>&nbsp;</p>
      <p>REFERENCES</p>
      <blockquote> 
        <p><a name="Istanbulluoglu2002"></a>
          Istanbulluoglu, Erkan; Tarboton, David G.; Pack, Robert T.; Luce, Charles. 2002.
          A probablistic approach for channel initiation. Water Resources Research. 38(12): 1325.</p>
        <p><a name="Istanbulluoglu2003"></a>
          Istanbulluoglu, Erkan; Tarboton, David G.; Pack, Robert T.; Luce, Charles. 2003.
          A sediment transport model for incision of gullies on steep topography.
          Water Resources Research. 39(4): 1103.</p>
        <p><a name="Istanbulluoglu2004"></a>Istanbulluoglu, Erkan; Tarboton, David G.; Pack, Robert T.; Luce, Charles. 2004.
          Modeling of the interactions between forest vegetation, disturbances, and sediment yields.
          Journal of Geophysical Research. 109: F01009.</p>
        <p><a name="Luce2001"></a>Luce, Charles H. (2001 September 5--copyright date).
          FERGI: Fire Enhanced Runoff and Gully Initiation model [Homepage of FERGI], [Online].
          Available:
          <a href="https://fergi.boise.rmrs.fs.fed.us/fergi/" target="_blank">https://fergi.boise.rmrs.fs.fed.us/fergi/</a> 
          [2008 January 2].</p>
        <p><a name="Luce2005"></a>
          Luce, Charles H.; Tarboton, David G.; Istanbulluoglu, Erkan; Pack, Robert T. 2005.
          Reply to comment by Jonathan J. Rhodes on &quot;Modeling of the interactions between forest vegetation, disturbances, 
          and sediment yields&quot;. Journal of Geophysical Research. 110: F01013. 
        </p>
        <p><a name="Luce2005a"></a>
          Luce, Charles. 2005.
          Land use and land cover effects on runoff processes: fire.
          Encyclopedia of Hydrological Sciences. 13: 1831-1837.</p>
        <p><a name="Rajagopalan1999"></a>
          Rajagopalan, B.; Lall, U. 1999.
          A k-nearest-neighbor simulator for daily precipitation and other weather variables.
          Water Resources Research. 35(10): 3089-3101.</p>
        <p><a name="Rhodes2005"></a>
          Rhodes, Jonathan J. 2005.
          Comment on &quot;Modeling of the interactions between forest vegetation, disturbances, and sediment 
          yields&quot; by Erkan Istanbulluoglu and others.
          Journal of Geophysical Research. 110: F01012.</p>
        <p><a name="Shakesby2000"></a>
          Shakesby, R. A.; Doerr, S. H.; Walsh, R. P. D. 2000.
          The erosional impact of soil hydrophobicity: current problems and future research directions.
          Journal of Hydrology. 231-232: 178-191.</p>
      </blockquote>
