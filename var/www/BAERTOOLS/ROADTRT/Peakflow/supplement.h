<HTML xmlns="http://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Tools - Peak Flow Supplement</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p><b>Post-fire Peakflow Estimation Methods used by BAER Specialists</b>
      ...
      <table width="600" border="0" cellspacing="0" cellpadding="0" height="277">
       ...
       <tr> 
        <td width="180"><div align="center">Method</div></td>
       ...
       <tr> 
        <td width="180">USGS Regression</td>
        <td width="60"><div align="center">43</div></td>
        <td width="60"><div align="center">38</div></td>
        <td width="60"><div align="center">--</div></td>
        <td width="60"><div align="center">25</div></td>
        <td width="60"><div align="center">60</div></td>
        <td width="60"><div align="center">50</div></td>
        <td width="60"><div align="center">75</div></td>
       </tr>
       <tr bgcolor="#CCCCCC">
        <td width="180">Curve Number</td>
        <td width="60">             <div align="center">28</div>          </td>
        <td width="60">             <div align="center">38</div>          </td>
        <td width="60">             <div align="center">100</div>          </td>
        <td width="60">             <div align="center">9</div>          </td>
        <td width="60">             <div align="center">7</div>          </td>
        <td width="60">             <div align="center">38</div>          </td>
          <td width="60">             <div align="center">25</div>          </td>
        </tr>
        <tr> 
          <td width="180">Rule of Thumb by Greg Kuyumjian</td>
          <td width="60">             <div align="center">7</div>          </td>
          <td width="60">             <div align="center">--</div>          </td>
          <td width="60">             <div align="center">--</div>          </td>
        ...
        <tr> 
          <td width="180">Consult w/ hydrologist</td>
          <td width="60">             <div align="center">7</div>          </td>
