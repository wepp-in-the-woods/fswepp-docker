    ...
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <blockquote>
        ...
        <p><a name="Key2006"></a>Key, Carl H.; Benson, Nathan C. 2006. Landscape 
          ...
          <a href="http://frames.nbii.gov/portal/server.pt?space=CommunityPage&cached=true&parentname=SiteMap&parentid=17&in_hi_userid=2&control=SetCommunity&CommunityID=286&PageID=0">FIREMON: 
        ...
        <p><a name="Moody2001"></a>Moody, John A.; Martin, Deborah A. 2001. <a href="http://pubs.er.usgs.gov/usgspubs/wri/wri014122">Hydrologic 
