<HTML xmlns="http://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - Rule of Thumb by Kuyumjian</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p><font size="+1">Rule of Thumb by Kuyumjian</font></p>
      <p>&nbsp;</p>
      <p>The <a href="supplement.html#Details" target="_blank">rule of thumb by Greg Kuyumjian</a>
        has been used by Region 3 BAER team members, which is about
        <a href="../supplement.html#Peakflow" target="_blank">7%</a> of 
        BAER interviewees (<a href="#Foltz2008">Foltz and others, 2008</a>).</p>
      <p>&nbsp;</p>
      <p>You will need to know the following
       <font size="+1"><b><a href="supplement.html#RuleThumb" target="_blank">Rule of Thumb by Kuyumjian</a></b></font>.
      </p>
      <p>&nbsp;</p>
      <p><b>Input Requirement</b></p>
      <ul type="disc">
        <li>Area of high and moderate soil burn severity; and,</li>
        <li>Anticipated precipitation amount from damaging storm.</li>
      </ul>
      <p>&nbsp;</p>
      <p><b>Steps</b></p>
      <ol start="1" type="1">
        <li>Determine design/damaging storm, including storm intensity, duration, and recurrence interval.</li>
        <li>Estimate post-fire peak flow (Qp) using the
            <a href="supplement.html#RuleThumb" target="_blank">Rule of Thumb by Kuyumjian</a>.</li>
      </ol>
      <p>&nbsp;</p>
      <p><b>Advantages</b></p>
      <ul>
        <li>Applicable for estimating post-fire peak flow.</li>
        <li>A simple and quick approximation.</li>
        <li>Does not need to determine parameter values.</li>
        <li>Considers bulking factor for post-fire debris flow/torrent.</li>
      </ul>
      <p>&nbsp;</p>
      <p><b>Disadvantages</b></p>
      <ul>
        <li>Does not estimate erosion.</li>
        <li>Only for short-duration (one hour or less) high intensity (greater than 0.5 inch) storms.</li>
        <li>Not applicable for estimating peak flow from snowmelt or rain-on-snow or frozen ground.</li>
        <li>Currently evaluated only for Region 3.</li>
      ...
      <blockquote> 
       <p>
        <a href="Example/" target="_blank">Rendija Canyon after the 2000 Cerro Grande Fire, New Mexico</a>
       </p>
      </blockquote>
      <p>&nbsp;</p>
      <p>REFERENCES</p>
