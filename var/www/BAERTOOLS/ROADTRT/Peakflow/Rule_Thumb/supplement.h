<HTML xmlns="https://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - Rule of Thumb by Kuyumjian Supplement</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p><b>Details of Rule of Thumb by Kuyumjian</b></p>
      <p>Experienced BAER team members often use their own rule of thumb, which 
        was developed based on their experience and post-fire monitoring/observation, 
        and works well within certain regions. An experienced BAER hydrologist 
        (personal communication, Kuyumjian, 2007) suggested using the following 
        rule of thumb, which requires a minimal amount of input information.</p>
      <p>&nbsp;</p>
      <p><a name="RuleThumb"></a><b>Rule of Thumb</b></p>
      <p>&nbsp;</p>
      <table width="600" border="0" cellspacing="0" cellpadding="0">
       <tr> 
        <td width="40">&nbsp;</td>
        <td colspan="4"><span class="style2 style2"><em><font size="+1"><em>Q<sub>p</sub> 
          = 300 x A<sub>s</sub>x I x 1.25</em></font></em></span></td>
       </tr>
       <tr> 
        <td width="40">&nbsp;</td>
        <td width="40">&nbsp;</td>
       ...
       <tr> 
        ...
        <td width="30"><i>Q<sub>p</sub></i></td>
        <td width="20">=</td>
        <td width="470">peak flow in cfs;</td>
       </tr>
       <tr> 
        <td width="80" colspan="2">&nbsp;</td>
        <td width="30"><em>I</em> </td>
        <td width="20">=</td>
        <td width="470">precipitation intensity in inch/hour;</td>
       </tr>
       <tr> 
        <td width="80" colspan="2">&nbsp;</td>
        <td width="30"><i>A<sub>s</sub></i> </td>
        <td width="20">=</td>
        <td width="470">size of high burn severity area in mile<sup>2</sup>; and,</td>
       </tr>
       <tr> 
        <td width="80" colspan="2">&nbsp;</td>
        <td width="30"><em>1.25</em></td>
        <td width="20">=</td>
        <td width="470"><em>bulking factor.</em></td>
       </tr>
      </table>
      <p>&nbsp;</p>
      <p>REFERENCES</p>
