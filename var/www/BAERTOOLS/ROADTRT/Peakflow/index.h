...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p>&nbsp;</p>
      <p>There is a general consensus that post-fire streamflow increases, often 
        with orders of magnitude larger than pre-fire events, especially for watersheds 
        of high and moderate burn severity. Burned watersheds can yield runoff 
        quickly, producing flash floods. The largest post-fire peak flow often 
        occurs in smaller watersheds. Increased post-fire flow may transport debris 
        and sediment that was produced from burned upland catchment basin, which 
        is often called bulking. Road treatments should be prescribed and implemented 
        if existing drainage structures can not handle the post-fire runoff increase. 
      </p>
      <p>&nbsp;</p>
      <p>BAER specialists have been using the following methods to estimate post-fire 
        runoff. </p>
      <ol>
        <li><a href="USGS">USGS regression</a>, </li>
        <li><a href="CN">Curve Number</a>, </li>
        <li><a href="Rule_Thumb">Rule of Thumb</a>, </li>
        <li><a href="TR55">TR-55</a>,</li>
        <li><a href="ERMiT">ERMiT</a>, </li>
        <li><a href="FERGI">FERGI</a>, and </li>
        <li><a href="WATBAL">WATBAL</a>.</li>
      </ol>
      <p>&nbsp;</p>
      <p>Disclaimers: USDA Forest Service, Moscow Forestry Sciences Laboratory 
        is not responsible for results of post-fire runoff estimation methods, 
        but provides information on how to use these methods. The choice of the 
        method is the user's, and he/she is solely responsible for the estimation 
        results.</p>
      <blockquote> 
        <p>&nbsp;</p>
        <p>&nbsp;</p>
