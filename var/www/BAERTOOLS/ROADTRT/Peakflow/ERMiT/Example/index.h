<HTML xmlns="https://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - ERMiT Example</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p><font 
      size=+1>Example Results for WEPP: the 2006 Red Eagle Fire, Montana</font></p>
      <p>The WEPP model was run to estimate 20 years of the pre- and post-fire 
        runoff and erosion potential for Red Eagle Fire in 2006
        (<a href="#Sirucek2006">Sirucek and others, 2006</a>).
        The results show more runoff events with greater risks of flood and erosion.
        The WEPP model predicted dramatic increases of rainfall and snowmelt runoff events
        from 2 and 0 for pre-fire conditions to 79 and 14 for post-fire conditions.</p>
      <p>&nbsp;</p>
      <table width="600" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="120">             <div align="center">Condition</div>          </td>
          <td width="120">             <div align="center">Runoff</div>          </td>
          <td width="120">             <div align="center">Soil erosion</div>          </td>
          <td width="120">             <div align="center">Number of</div>          </td>
          <td width="120">             <div align="center">Number of</div>          </td>
        </tr>
        <tr> 
          <td width="120">             <div align="center"></div>          </td>
          <td width="120">             <div align="center">(inch)</div>          </td>
          <td width="120">             <div align="center">(tons/ac)</div>          </td>
          <td width="120">             <div align="center">rainfall events</div>          </td>
          <td width="120">             <div align="center">snowmelt events</div>          </td>
        </tr>
        <tr> 
          <td colspan="5">             <hr noshade>          </td>
        </tr>
        <tr> 
          <td width="120">             <div align="center">Pre-fire </div>          </td>
          <td width="120">             <div align="center">0.18</div>          </td>
          <td width="120">             <div align="center">0.04</div>          </td>
          <td width="120">             <div align="center">2</div>          </td>
          <td width="120">             <div align="center">0</div>          </td>
        </tr>
        <tr> 
          <td width="120">             <div align="center">Post-fire</div>          </td>
          <td width="120">             <div align="center">3.08</div>          </td>
          <td width="120">             <div align="center">127</div>          </td>
          <td width="120">             <div align="center">79</div>          </td>
          <td width="120">             <div align="center">14</div>          </td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>REFERENCES</p>
      <blockquote> 
        <p><a name="Sirucek2006"></a>
          ...
          Red Eagle Fire, watershed resource assessment, hydrology and soils. 24&nbsp;p.</p>
      </blockquote>
