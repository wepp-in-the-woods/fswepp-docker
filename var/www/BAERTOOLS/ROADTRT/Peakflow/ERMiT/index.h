<HTML xmlns="https://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - ERMiT</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p>
       <font size=+1>Erosion Risk Management Tool (ERMiT)</font>
      </p>
      <p>&nbsp;</p>
      <p>The <a href="supplement.html#Details" target="_blank">ERMiT</a>
        (<a href="#Robichaud2006">Robichaud and others, 2006</a> and
         <a href="#Robichaud2007">2007</a>),
         <a href="https://forest.moscowfsl.wsu.edu/fswepp/" target="_blank">an FS WEPP Interface</a>,
        has been used by the BAER team members (<a href="../supplement.html#Peakflow" target="_blank">5%</a>), 
        primarily from Region 4 (<a href="#Foltz2008">Foltz and others, 2008</a>).</p>
      <p>&nbsp;</p>
      <p>To use ERMiT, you need to visit the
       <font size="+1">
        <b><a href="https://forest.moscowfsl.wsu.edu/fswepp" target="_blank">FS WEPP website</a></b>
       </font>.
      </p>
      <p>&nbsp;</p>
      ...
      <ul type="disc">
       <li>Climate;</li>
       <li>Soil texture, chosen among clay loam, silt loam, sandy loam, and loam;</li>
       <li>Rock content;</li>
       <li>Vegetation type, chosen among forest, range, and chaparral;</li>
       <li><a href="supplement.html#PreFireDescription" target="_blank">Range/chaparral pre-fire community description</a>;</li>
        <li><a href="supplement.html#HillslopeGradient" target="_blank">Hillslope 
          gradient</a>; </li>
        <li>Hillslope horizontal length; and,</li>
        <li>Soil burn severity, chosen among high, moderate, and low.</li>
      </ul>
      <p>&nbsp;</p>
      <p><b>Steps</b></p>
      <ol>
        <li>Visit the FS WEPP web site
         (<a href="https://forest.moscowfsl.wsu.edu/fswepp/" target="_blank">https://forest.moscowfsl.wsu.edu/fswepp/</a>).</li>
        <li>Select ERMiT.</li>
        <li>Choose and type input information.</li>
        <li>Run ERMiT.</li>
      </ol>
      <p>&nbsp;</p>
      <p><b>Advantages</b></p>
      <ul type="disc">
        <li>Applicable for estimating post-fire erosion up to 5 years after the fire.</li>
        <li>Identifies the <a href="supplement.html#DamagingStorm" target="_blank">damaging storm</a>.</li>
        <li>Provides <a href="supplement.html#Outputs" target="_blank">various
            outputs</a>, such as the exceedance probability.</li>
        <li>Suitable for evaluating the effectiveness of
            <a href="supplement.html#HillslopeTreatments" target="_blank">various hillslope treatments</a>.</li>
        <li>User-friendly, easy to use, and on-line accessible.</li>
        <li>Process-based.</li>
        <li>Uses both English and metric units.</li>
      </ul>
      <p>&nbsp;</p>
      <p><b>Disadvantages</b></p>
      <ul type="disc">
        <li>Does not estimate post-fire peak flow.</li>
        <li>Does not provide pre-fire runoff and erosion information.</li>
        <li>Does not consider post-fire debris flow/torrent. </li>
        <li>Does not consider <a href="supplement.html#WatershedShape" target="_blank">watershed shapes</a>.</li>
      </ul>
      <p>&nbsp;</p>
      <p><b>Example Results</b><br>
      </p>
      <blockquote> 
        <p><a href="Example/" target="_blank">The 2006 Red Eagle Fire, Montana.</a></p>
      </blockquote>
      <p>&nbsp;</p>
      <p>REFERENCES</p>
      <blockquote> 
        ...
        <p><a name="Robichaud2007"></a>
          ...
          <a href="https://forest.moscowfsl.wsu.edu/cgi-bin/engr/library/searchpub.pl?pub=2007c" target="_blank">Erosion 
          Risk Management Tool (ERMiT) user manual (version 2006.01.18). Gen. Tech. Rep. RMRS-GTR-188.</a>
