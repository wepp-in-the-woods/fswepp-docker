<HTML xmlns="https://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - Curve Number Methods Example</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p><font size="+1">Example Results for Curve Number Methods: the 2005 Blackerby 
        Fire in the Nez Perce National Forest, Idaho</font></p>
      <p>The Blackerby Fire on the Nez Perce National Forest near Grangeville, 
        Idaho occurred in August 2005. On 19 May 2006 a 0.79 inch precipitation 
        event with a 30 minute duration occurred over a portion of the burned 
        area. The precipitation event was equivalent to a 25 year-30 minute storm 
        event as determined from
        <a href="https://www.nws.noaa.gov/oh/hdsc/currentpf.htm" target="_blank">NOAA Atlas 2</a>
        (<a href="#Miller1973">Miller and others, 1973</a>).</p>
      <p>&nbsp;</p>
      <table width="600" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="150">&nbsp;</td>
          <td colspan="3"> 
            <div align="center">Precipitation (inches)</div>
          </td>
        </tr>
        <tr>
          <td width="150">&nbsp;</td>
        ...
        <tr>
          <td width="150">             <div align="center">Return interval</div>          </td>
          <td colspan="3">             <div align="center">Rainfall duration</div>          </td>
        </tr>
        <tr> 
          <td width="150">             <div align="center"></div>          </td>
          <td width="150">             <div align="center">30 minute</div>          </td>
          <td width="150">             <div align="center">6 hour</div>          </td>
          <td>             <div align="center">24 hour</div>          </td>
        </tr>
        <tr> 
          <td colspan="4">             <hr noshade align="center">          </td>
        </tr>
        <tr> 
          <td width="150">             <div align="center">2-year</div>          </td>
          <td width="150">             <div align="center">0.32</div>          </td>
          <td width="150">             <div align="center">0.9</div>          </td>
          <td>             <div align="center">1.6</div>          </td>
        </tr>
        <tr bgcolor="#CCCCCC"> 
          <td width="150">             <div align="center">5-year</div>          </td>
          <td width="150">             <div align="center">0.47</div>          </td>
          <td width="150">             <div align="center">1.1</div>          </td>
          <td>             <div align="center">2.0</div>          </td>
        </tr>
        <tr> 
          <td width="150">             <div align="center">10-year</div>          </td>
          <td width="150">             <div align="center">0.63</div>          </td>
          <td width="150">             <div align="center">1.3</div>          </td>
          <td>             <div align="center">2.4</div>          </td>
        </tr>
        <tr bgcolor="#CCCCCC"> 
          <td width="150">             <div align="center">25-year</div>          </td>
          <td width="150">             <div align="center"><b>0.79</b></div>          </td>
          <td width="150">             <div align="center">1.5</div>          </td>
          <td>             <div align="center">2.9</div>          </td>
        </tr>
      </table>
      <p>&nbsp; </p>
      <p>The NRCS CN flood flow model results used in the BAER analysis (using 
        FIRE HYDRO) were for a 25-year return event and based on the assumption 
        of limited soil and vegetation regeneration during the first year after 
        the fire (<a href="#Gerhardt2006">Gerhardt, 2006</a>). The observed flood 
        discharge value was 71 cfs or 56 cfsm (cfs/mile<sup>2</sup>). This observed 
        flood discharge was half that of predicted flow. Additionally, the observed 
        debris flow discharge was 620 cfs or 492 cfsm, indicating that debris 
        flow discharge was nearly an order of magnitude greater than the flood 
        discharge. </p>
      <p>&nbsp;</p>
      <table width="600" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="200">             <div align="center">Storm</div>          </td>
          <td colspan="2">             <div align="center">Estimated peak flow rate using FIRE HYDRO</div></td>
        </tr>
        <tr> 
          <td width="200">             <div align="center">return interval</div>          </td>
          <td width="200">             <div align="center">cfs</div>          </td>
          <td width="200">             <div align="center">cfsm</div>          </td>
        </tr>
        <tr> 
          <td colspan="3">             <hr noshade align="center">          </td>
        </tr>
        <tr> 
          <td width="200">             <div align="center">2-year 24-hour</div>          </td>
          <td width="200">             <div align="center">23</div>          </td>
          <td width="200">             <div align="center">18</div>          </td>
        </tr>
        <tr bgcolor="#CCCCCC"> 
          <td width="200">             <div align="center">5-year 24-hour</div>          </td>
          <td width="200">             <div align="center">50</div>          </td>
          <td width="200">             <div align="center">40</div>          </td>
        </tr>
        <tr> 
          <td width="200">             <div align="center">10-year 24-hour</div>          </td>
          <td width="200">             <div align="center">85</div>          </td>
          <td width="200">             <div align="center">67</div>          </td>
        </tr>
        <tr bgcolor="#CCCCCC"> 
          <td width="200">             <div align="center">25-year 24-hour</div>          </td>
          <td width="200">             <div align="center"><b>138</b></div>          </td>
          <td width="200">             <div align="center"><b>109</b></div>          </td>
        </tr>
        <tr> 
          <td colspan="3">&nbsp;</td>
        </tr>
        <tr> 
          <td width="200">             <div align="center">Storm</div>          </td>
          <td colspan="2">             <div align="center">Observed peak flow rate</div>          </td>
        </tr>
        <tr> 
          <td width="200">             <div align="center">return interval</div>          </td>
          <td width="200">             <div align="center">cfs</div>          </td>
        ...
        <tr> 
          <td width="200">             <div align="center">25-year 30-minute</div>          </td>
          <td width="200">             <div align="center"><b>71</b></div>          </td>
          <td width="200">             <div align="center"><b>56</b></div>          </td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>REFERENCES</p>
      <blockquote> 
        <p><a name="Gerhardt2006"></a>Gerhardt, Nick. 2006. [Unpublished report]. 
          December 18. Characterization of a post-fire debris flow and flood, 
          Blackerby Fire, Idaho. </p>
        <p><a name="Miller1973"></a>Miller, J. F.; Frederick, R. H.; Tracey, R. J. 1973.
          <a href="https://www.nws.noaa.gov/oh/hdsc/PF_documents/Atlas2_Volume5.pdf">NOAA Atlas 2. Precipitation-frequency atlas of the western United States. Volume V--Idaho.</a>
          Silver Spring, MD: NOAA.</p>
        <p>&nbsp;</p>
      </blockquote>
