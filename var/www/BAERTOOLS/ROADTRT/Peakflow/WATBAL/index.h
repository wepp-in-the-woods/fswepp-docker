...
.
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - WATBAL</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <FONT size=+1> <HR> </FONT> 
      <p>
       <font size="+1">Watershed Response Model for Forest Management (WATBAL)</font> 
      </p>
      <p>&nbsp;</p>
      <p><a href="supplement.html#Details" target="_blank">WATBAL</a> has been 
        used by <a href="../supplement.html#Peakflow" target="_blank">2%</a> of 
        the BAER team members in Region 1 (<a href="#Foltz2008">Foltz and others, 
        2008</a>). The WATBAL program is designed to simulate the potential and 
        most likely effects of primary forest management practices (e.g., timber 
        harvest, road development, and fire) on the responses of watershed and 
        water resources systems with regard to stream flow and sediment regimes 
        (<a href="#Jones2005">Jones, 2005</a>).</p>
      <p>&nbsp;</p>
      <p>To use WATBAL, you will need<b><font size="+1"> <a href="supplement.html#Contact" target="_blank">WATBAL 
        Program</a></font></b>.</p>
      <p>&nbsp;</p>
      <p><b>Advantages</b></p>
      <ul type="disc">
        <li>Applicable for estimating <a href="supplement.html#StreamFlow" target="_blank">stream 
          flow</a> and sediment regime effects of forest management practices.</li>
        <li>Believed to be <a href="supplement.html#Accurate" target="_blank">relatively 
          accurate</a>.</li>
      </ul>
      <p>&nbsp;</p>
      <p><b>Disadvantages</b></p>
      <ul type="disc">
        <li><a href="supplement.html#LocationLimit" target="_blank">Only applicable</a> 
          to Central and Northern Rocky Mountains.</li>
        <li>Does not consider post-fire debris flow/torrent. </li>
        <li>Works best in <a href="supplement.html#WatershedLimit" target="_blank">watersheds</a> 
          of 4-40 mile<sup>2</sup>.</li>
        <li><a href="supplement.html#NotFriendly" target="_blank">Not user-friendly</a>.</li>
        <li>Requires an <a href="supplement.html#Understanding">understanding of 
          the program</a>.</li>
      ...
      <blockquote> 
        <p> <a href="Example/" target="_blank">The 2000 Crooked Fire in the Clearwater National Forest, Idaho.</a></p>
      </blockquote>
      <p>&nbsp;</p>
      <p>REFERENCES</p>
      <blockquote> 
