...
.
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - WATBAL Supplement</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p><b>Details of WATBAL</b></p>
      <p>The WATBAL program originated from the Northern Region's Water Yield 
        Guidelines, also known as R1/R4 Guidelines (<a href="#Haupt1976">Haupt and others, 1976</a>)
        to establish water yields in response to cumulative 
        watershed development and vegetation manipulation and recovery over time. 
        The WATBAL program was written in FORTRAN, and has been evolved using 
        up-to-date methodologies, research findings, and locally derived water/sediment 
        data. The WATBAL program is currently designed to simulate the potential 
        and most likely effects of primary forest management practices (e.g., 
        timber harvest, road development, and fire) on the responses of watershed 
        and water resource systems with regard to stream flow and sediment regimes 
        (<a href="#Jones2005">Jones, 2005</a>). There are three functional elements 
        in the program:</p>
      <ul type="disc">
        <li>A water yield model that utilizes response functions correlated to 
          land characteristics and forest practices. These functions were from 
          the Hydrologic Simulation Model of the Colorado Subalpine Forest
          (<a href="#Leaf1973">Leaf and Brink, 1973</a>), and calibrated for the northern Rocky Mountains;</li>
        <li>A sediment yield procedure based on surface erosion that incorporates 
          the concepts and methodologies for the Idaho Batholith physiographic 
          regions and associated lands (<a href="#Cline1981">Cline and others, 1981</a>); and</li>
        <li>A sediment yield procedure based on mass erosional processes developed 
          on the Clearwater National Forest (<a href="#Jones2005">Jones, 2005</a>).</li>
      </ul>
      <p>&nbsp;</p>
      <p><a name="Contact"></a><b>Contact Information for WATBAL</b></p>
      <table width="400" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td colspan="3"> 
            <p>To acquire WATBAL program and users guide, please contact</p>
          </td>
        </tr>
        <tr> 
          <td width="20">&nbsp;</td>
        ...
        <tr> 
          <td width="20">&nbsp;</td>
          <td colspan="2"><b>Meg Foltz</b></td>
        </tr>
        <tr> 
          <td width="20">&nbsp;</td>
          <td width="60">Address</td>
          <td width="320">1700 Highway 6</td>
        </tr>
        <tr> 
          <td width="20">&nbsp;</td>
          <td width="60">&nbsp;</td>
          <td width="320">Potlatch, ID 83855</td>
        </tr>
        <tr> 
          <td width="20">&nbsp;</td>
          <td width="60">Phone</td>
          <td width="320">(208) 875-1717</td>
        </tr>
        <tr> 
          <td width="20">&nbsp;</td>
          <td width="60">Fax</td>
          <td width="320">(208) 875-1133</td>
        </tr>
        <tr> 
          <td width="20">&nbsp;</td>
          <td width="60">E-mail</td>
          <td width="320">mfoltz@fs.fed.us</td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p><a name="StreamFlow"></a><b>Stream Flow</b></p>
      <p>This includes annual and peak runoff, and time to peak.</p>
      <p>&nbsp;</p>
      <p><a name="Accurate"></a><b>Relatively Accurate</b></p>
      <p>The Clearwater National Forest keeps monitoring watersheds. Based on 
        the monitoring data, the model is continuously calibrated, validated, 
        and calibrated again; therefore, it is believed to be relatively accurate.</p>
      <p>&nbsp;</p>
      <p><b><a name="LocationLimit"></a>Geographic/Geologic Limit</b></p>
      <p>WATBAL is applicable only to Central and Northern Rocky Mountains for 
        water yield (annual and peak runoff); the Idaho Batholith physiographic 
        region for sediment yield from surface erosion; and Clearwater National 
        Forest in the southern Idaho Batholith for sediment yield from landslides.</p>
      <p>&nbsp;</p>
      <p><b><a name="WatershedLimit"></a>Watershed Limit</b></p>
      <p>It tends to overpredict sediment in watersheds smaller than 4 mile<sup>2</sup>; 
        and under predict, greater than 40 mile<sup>2</sup> (<a href="#Jones2005">Jones, 2005</a>).</p>
      <p>&nbsp;</p>
      <p><b><a name="NotFriendly"></a>Not User-Friendly</b></p>
      <p>The program is not user-friendly, and often adding input data requires 
        understanding of the program and the natural processes. </p>
      <p>&nbsp;</p>
      <p><b><a name="Understanding"></a>Understanding of the Program</b></p>
      <p>Program output data should be interpreted and used with an understanding 
        of the program and the natural processes. Interpretations should be left 
        to an experienced and trained professional.</p>
      <p>&nbsp;</p>
      <p>REFERENCES</p>
      <blockquote> 
        <p><a name="Cline1981"></a>Cline, R.; Cole, G; Megahan, W; Patten, R.; 
          Potyondy, J. 1981. Guide for predicting sediment yields from forested 
          watersheds (the R1/R4 sediment guidelines). Missoula, MT: U.S. Department 
          of Agriculture, Forest Service, Northern and Intermountain Regions. 
        </p>
        <p><a name="Haupt1976"></a>Haupt, H. F.; [and others]. 1976. Hydrologic 
          effects of vegetation manipulation. In: Forest hydrology. Missoula, 
          MT: U.S. Department of Agriculture, Forest Service, Northern Region: 
          part&nbsp;2.</p>
        <p><a name="Jones2005"></a>Jones, Richard. 2005. Watershed response model 
          for forest management: WATBAL technical users guide, revised. Orofino, 
          ID: U.S. Department of Agriculture, Forest Service, Northern Region, 
          Clearwater National Forest. 36&nbsp;p.</p>
        <p><a name="Leaf1973"></a>Leaf, C. F.; Brink, G. E. 1973. Hydrologic simulation 
          model of the Colorado subalpine forest. Research Paper RM-107. Fort 
          Collins, CO: U.S. Department of Agriculture, Forest Service, Rocky Mountain 
          Forest and Range Experiment Station. 22&nbsp;p. </p>
      </blockquote>
