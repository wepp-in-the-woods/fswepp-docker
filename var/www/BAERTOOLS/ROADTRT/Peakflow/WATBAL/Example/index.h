<HTML xmlns="https://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - WATBAL Example</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
     ...
     <p><font size="+1">
      Example Results for Watershed Response Model for Forest Management (WATBAL):
      the 2000 Crooked Fire in the Clearwater National Forest, Idaho</font></p>
      <p>The Crooked Fire occurred on the Clearwater National Forest in July 28, 2000.
        WATBAL was used to estimate post-fire sediment and peak flow increases. 
        The pre- and post-fire WATBAL comparison is shown below. All values are 
        percent increase over baseline condition (<a href="#Jones2000">Jones, 2000</a>).</p>
      <p>&nbsp;</p>
      <table width="600" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="132">             <div align="center">Watershed</div>          </td>
          <td colspan="4">             <div align="center">Pre-fire</div>          </td>
          <td colspan="4">             <div align="center">Post-fire</div>          </td>
        </tr>
        <tr> 
          <td width="132">&nbsp;</td>
          <td width="60">             <div align="center">Sediment</div>          </td>
          <td width="58">             <div align="center">Q<sub>aa</sub><sup>1</sup></div>          </td>
          <td width="58">             <div align="center">Q<sub>pk</sub><sup>2</sup></div>          </td>
          <td width="58">             <div align="center">T<sub>pk</sub><sup>3</sup></div>          </td>
          <td width="60">             <div align="center">Sediment</div>          </td>
          <td width="58">             <div align="center">Q<sub>aa</sub></div>          </td>
          <td width="58">             <div align="center">Q<sub>pk</sub></div>          </td>
          <td width="58">             <div align="center">T<sub>pk</sub></div>          </td>
        </tr>
        <tr> 
          <td width="132">&nbsp;</td>
        ...
        <tr> 
          <td width="132">Haskell</td>          <td width="60">             <div align="right"><sup>4</sup>48</div>          </td>
          <td width="58">             <div align="right">8</div>          </td>
          <td width="58">             <div align="right">8</div>          </td>
          <td width="58">             <div align="right">9</div>          </td>
          <td width="60">             <div align="right">104</div>          </td>
          <td width="58">             <div align="right">15</div>          </td>
          <td width="58">             <div align="right">16</div>          </td>
          <td width="58">             <div align="right">17</div>          </td>
        </tr>
        <tr bgcolor="#CCCCCC"> 
          <td width="132">Rock</td>
          <td width="60">             <div align="right">31</div>          </td>
          <td width="58">             <div align="right">5</div>          </td>
          <td width="58">             <div align="right">5</div>          </td>
          <td width="58">             <div align="right">5</div>          </td>
          <td width="60">             <div align="right">295</div>          </td>
          <td width="58">             <div align="right">18</div>          </td>
          <td width="58">             <div align="right">20</div>          </td>
          <td width="58">             <div align="right">19</div>          </td>
        </tr>
        <tr> 
          <td width="132">Pack</td>
          <td width="60">             <div align="right">9</div>          </td>
          <td width="58">             <div align="right">9</div>          </td>
          <td width="58">             <div align="right">9</div>          </td>
          <td width="58">             <div align="right">10</div>          </td>
          <td width="60">             <div align="right">9</div>          </td>
          <td width="58">             <div align="right">9</div>          </td>
          <td width="58">             <div align="right">9</div>          </td>
          <td width="58">             <div align="right">10</div>          </td>
        ...
        <tr bgcolor="#CCCCCC"> 
          <td width="132">Lower Crooked</td>
          <td width="60">             <div align="right">14</div>          </td>
          <td width="58">             <div align="right">5</div>          </td>
          <td width="58">             <div align="right">5</div>          </td>
          <td width="58">             <div align="right">6</div>          </td>
          <td width="60">             <div align="right">109</div>          </td>
          <td width="58">             <div align="right">15</div>          </td>
          <td width="58">             <div align="right">16</div>          </td>
          <td width="58">             <div align="right">17</div>          </td>
        </tr>
        <tr> 
          <td width="132">Crooked (at mouth)</td>
          <td width="60">             <div align="right">7</div>          </td>
          <td width="58">             <div align="right">2</div>          </td>
          <td width="58">             <div align="right">2</div>          </td>
          <td width="58">             <div align="right">3</div>          </td>
          <td width="60">             <div align="right">22</div>          </td>
          <td width="58">             <div align="right">3</div>          </td>
          <td width="58">             <div align="right">3</div>          </td>
          <td width="58">             <div align="right">4</div>          </td>
        </tr>
      </table>
      <p> <br>
      </p>
      ...
      <table width="600" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="590">Average annual runoff</td>
        </tr>
        <tr> 
          <td width="10"><sup>2</sup></td>
          <td width="590">Peak flow</td>
        </tr>
        <tr> 
          <td width="10"><sup>3</sup></td>
          <td width="590">Time to peak</td>
        </tr>
        <tr> 
          <td width="10"><sup>4</sup></td>
          <td width="590">Haskell watershed in pre-fire condition produces 48% more sediment than baseline condition.</td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <p>REFERENCES</p>
      <blockquote> 
        <p><a name="Jones2000"></a>
          Jones, Richard. 2000. BAER report, Crooked Fire, Clearwater National Forest, Idaho.
          Orofino, ID: U.S. Department of Agriculture, Forest Service, Northern Region, Clearwater National Forest.
          15&nbsp;p.</p>
      </blockquote>
