<HTML xmlns="https://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - TR-55 Supplement</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <!-- ***************************************************************************************** -->
       ...
       <a href="./">TR-55</a> -&gt; Supplement
      <FONT size=+1>
       <HR>
      </FONT> 
      <p><b>Details of TR-55</b><br>
      </p>
      <p>The TR-55 was released as a simplified procedure to calculate the storm 
        runoff volume, peakflow rate, hydrograph, and storage volume for storm 
        water management structures in small watersheds in urban areas, assuming 
        the NRCS Type II rainfall distribution for all calculations
        (<a href="#SCS1975">USDA SCS, 1975</a>).
        Later a major revision was made to improve the model by 
        adding three more rainfall distributions (Type I, IA, and III), programming 
        the computations, and estimating time of concentration using split separate 
        flow phases (<a href="#SCS1986">USDA SCS, 1986</a>). The current version 
        of the TR-55 computer model is WinTR-55, which was revised and completely 
        rewritten. It uses the TR-20 model (<a href="#NRCS2005a">USDA NRCS, 2005a</a>), 
        another NRCS storm event surface water hydrologic model applied at a watershed 
        scale, as the driving engine for all the hydrograph procedures
        (<a href="#NRCS2005b">USDA NRCS, 2005b</a>),</p>
      <p>WinTR-55 is a single-event rainfall-runoff hydrologic model for small 
        watersheds with multiple sub-areas that are homogeneous. It generates 
        hydrographs from urban and agricultural areas; and the generated hydrographs 
        are routed downstream through channels or reservoirs.</p>
      <p>&nbsp;</p>
      <p><a name="Storm"></a><b>Storm Data</b></p>
      <ul>
       <li>NRCS storm data can be used.</li>
       <li>Rainfall return period (year)</li>
       <li>24-hour rainfall amount (inch)</li>
       <li>Rainfall distribution type</li>
      </ul>
      <p>&nbsp;</p>
      <p><a name="Tc"></a><b>Time of Concentration (Tc) Details</b></p>
      <ul>
        <li>Length (ft)</li>
        <li>Slope (ft/ft)</li>
        <li>Surface (Manning's n)</li>
        <li>Velocity (ft/s) for sheet, shallow concentrated, and channel flow types</li>
      </ul>
      <p>&nbsp;</p>
      <p><a name="24Hour"></a><b>24-hour Storm Duration</b></p>
      <p>TR-55 uses only 24-hour storm duration; therefore, it is not applicable 
        to the regions where the damaging storm duration is much shorter, such 
        as 15 or 30 minutes.</p>
      <p>&nbsp;</p>
      ...
      <p>REFERENCES</p>
      <blockquote> 
        <p><a name="NRCS2005a"></a>U.S. Department of Agriculture, Natural Resources 
          Conservation Service. (2005a, January 1--last update).
          Hydraulics and Hydrology: Tools and Models--WinTR-20 [Homepage of WinTR-20], [Online]. 
          Available:
          <a href="https://www.wsi.nrcs.usda.gov/products/W2Q/H&H/Tools_Models/WinTR20.html" target="_blank">https://www.wsi.nrcs.usda.gov/products/W2Q/H&amp;H/Tools_Models/WinTR20.html</a> 
          [2008 October 24]. </p>
        <p><a name="NRCS2005b"></a>U.S. Department of Agriculture, Natural Resources 
          Conservation Service. (2005b, January 1--last update). Hydraulics and 
          Hydrology: Tools and Models--WinTR-55 [Homepage of WinTR-55], [Online]. 
          Available:
          <a href="https://www.wsi.nrcs.usda.gov/products/W2Q/H&H/Tools_Models/WinTR55.html" target="_blank">https://www.wsi.nrcs.usda.gov/products/W2Q/H&amp;H/Tools_Models/WinTR55.html</a> 
          [2008 February 7]. </p>
        <p><a name="SCS1975"></a>U.S. Department of Agriculture, Soil Conservation 
          Service. 1975. Urban hydrology for small watersheds. Technical Release 
          55. Chester, PA: U.S. Department of Agriculture, Soil Conservation Service. 91&nbsp;p.</p>
        <p><a name="SCS1986"></a>U.S. Department of Agriculture, Soil Conservation 
          Service. 1986. Urban hydrology for small watersheds. Technical Release&nbsp;55.
          Chester, PA: U.S. Department of Agriculture, Soil Conservation Service. 156&nbsp;p.</p>
        <p>&nbsp;</p>
      </blockquote>
