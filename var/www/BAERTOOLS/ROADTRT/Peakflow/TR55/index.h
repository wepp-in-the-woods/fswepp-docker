<HTML xmlns="https://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - TR-55</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p><font size="+1">TR-55</font></p>
      <p>&nbsp;</p>
      Seven of BAER team members (<a href="../supplement.html#lPeakflow" target="_blank">7%</a>) 
      used <a href="supplement.html#Details" target="_blank">TR-55</a> to calculate 
      post-fire runoff increase (<a href="#Foltz2008">Foltz and others, 2008</a>). 
      The TR-55 requires the runoff curve number (CN) as an input parameter; therefore, 
      it can be considered as a <a href="../CN/" target="_blank">Curve Number method</a>.
      The current version of the TR-55 computer model is WinTR-55. 
      <p>&nbsp;</p>
      <p>To use TR-55, you will need
       <b>
        <font size="+1">
         <a href="https://www.wsi.nrcs.usda.gov/products/W2Q/H&H/Tools_Models/WinTR55.html" target="_blank">WinTR-55</a>
        </font>
       </b>.
      </p>
      <p>&nbsp;</p>
      ...
      <ul type="disc">
       ...
       <li>Dimensionless unit hydrograph;</li>
       <li><a href="supplement.html#Storm" target="_blank">Storm data</a>;</li>
       <li>Rainfall distribution;</li>
       <li>Area (acre);</li>
       <li>Runoff curve number (CN); and,</li>
       <li><a href="supplement.html#Tc" target="_blank">Time of concentration (Tc) details</a>.</li>
      </ul>
      <p>&nbsp;</p>
      <p><b>Steps</b></p>
      <ol>
       <li>Run TR-55 for pre-fire watershed conditions.</li>
       <li>Determine the CNs for burned areas within the watershed.</li>
       <li>Run TR-55 for post-fire watershed conditions.</li>
      </ol>
      <p>&nbsp;</p>
      <p><b>Advantages</b></p>
      <ul>
       <li>Applicable for estimating peak flow.</li>
       <li>Estimates time to peak.</li>
       <li>Applicable to larger watersheds(&lt; 25 mile<sup>2</sup>).</li>
      ...
      <ul>
       ...
       <li><a href="supplement.html#24Hour" target="_blank">Only considers 24-hour storm duration</a>.</li>
      ...
      <blockquote> 
       <p><a href="Example/" target="_blank">The 2002 Bullock Fire in the Coronado National Forest, Arizona</a></p>
      </blockquote>
      <p>&nbsp;</p>
      <p>REFERENCES</p>
      <blockquote> 
        <p><a name="Foltz2008"></a>Foltz, Randy B.; Robichaud, Peter R.; Rhee, Hakjun. 2008.
