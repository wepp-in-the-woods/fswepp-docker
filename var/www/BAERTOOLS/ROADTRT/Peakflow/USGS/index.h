<HTML xmlns="https://www.w3.org/1999/xhtml">
 ...
 <HEAD>
  ...
  <TITLE>RMRS - BAER Road Treatment Tools - USGS Regression Methods</TITLE>
<!-- #EndEditable -->
  <!-- DW6 -->
...
<!-- MAIN CONTENT CELL WITH CONTENT ANCHOR START -->
    <TD id=main-table-right-cell align=left bgColor=#ffffff colSpan=2> 
      ...
      <p><font size="+1">USGS Regression Methods</font></p>
      <p>&nbsp;</p>
      <p>The <a href="supplement.html#Details" target="_blank">USGS regression method</a>
        is the most commonly used post-fire runoff estimation method 
        by BAER team members (<a href="../supplement.html#Peakflow" target="_blank">43%</a>) 
        (Foltz and others, 2008), and has been developed by the Department of 
        Interior U.S. Geological Survey (USGS) to estimate magnitude and frequency 
        of floods.</p>
      <p>&nbsp;</p>
      <p>To use the USGS regression methods, you will need
       <font size="+1"><b>
        <a href="https://water.usgs.gov/osw/streamstats/index.html" target="_blank">StreamStats</a>
       </b></font>
       or
       <font size="+1"><b>
        <a href="supplement.html#USGSPub" target="_blank">USGS publications</a>.
       </b></font>
      </p>
      <p>&nbsp;</p>
      <p><b>Input Requirement</b></p>
      <ul type="disc">
        <li>USGS regression equations for the area of interests (burned sites);</li>
        <li>Gaged data from the watershed of interests (if any);</li>
        <li><a href="supplement.html#BasinCharacts" target="_blank">Basin characteristics</a>;</li>
        <li>Design storm intensity, duration, and recurrence interval;</li>
        <li>Size of high soil burn severity areas; and, </li>
        <li>Water repellency and surface runoff increase.</li>
      </ul>
      <p>&nbsp;</p>
      <p><b><a name="Steps"></a>Steps</b></p>
      <ol start="1" type="1">
        <li>Find the USGS regression equations for the area of interests;</li>
        <li>Collect the basin characteristics of burned areas; </li>
        <li>Collect <a href="supplement.html#BurnedAreaInfo" target="_blank">information</a> about the burned area; </li>
        <li>Determine <a href="supplement.html#StormInfo" target="_blank">design/damaging storm</a>; </li>
        <li>Estimate pre-fire runoff;</li>
        <li>Determine <a href="supplement.html#RunoffIncrease" target="_blank">the 
          percent runoff increase</a> for high and moderate soil burn severity area; </li>
        <li>Determine <a href="supplement.html#Modifier" target="_blank">modifier</a>;</li>
        <li>Estimate post-fire runoff by multiplying the modifier and pre-fire 
          runoff (or use <a href="supplement.html#Alternatives">alternatives</a>). 
          <p>&nbsp;</p>
        </li>
      </ol>
      <p><b>Advantages</b></p>
      <ul>
        <li>Applicable for estimating both pre-fire and post-fire peak flow.</li>
        <li>Estimate peak flow, regardless of the storm duration and intensity.</li>
        <li>Appropriate for larger watersheds (&gt; 5 mile<sup>2</sup>).</li>
        <li>Does not usually require detailed watershed information.</li>
        <li>More accurate if gaged data is used from the watershed of interests.</li>
        <li>Applicable to longer duration events, and snowmelt runoff events.</li>
      </ul>
      <p>&nbsp;</p>
      ...
      <ul>
        ...
        <li>The user has to find the adequate USGS regression equations for the 
          watershed in the pre-fire condition.</li>
        <li>The user has to find the adequate USGS regression equations for the 
          watershed in the post-fire condition (if any).</li>
        <li>The user has to determine the <a href="supplement.html#Modifier">modifier</a>.</li>
      ...
      <!-- ol start="1" type="1" -->
        <blockquote> 
          <p><a href="Example/" target="_blank">The 2000 Skalkaho/Valley 
            Complex Fires in the Bitterroot National Forest, Montana</a></p>
        </blockquote>
      <!-- /ol -->
      <p>&nbsp;</p>
      <p>REFERENCES</p>
