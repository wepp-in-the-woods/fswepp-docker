...
<meta name="description" content="Deception Creek Experimental Forest: Heartland of the Ponderosa Pine forest type" />
<meta name="keywords" contest="experimental forest, experimental forests, Deception Creek Experimental Forest, Deception Creek, Coeur d'Alene, western white pine " />
<title>Deception Creek Experimental Forest</title>
<?php
     ...
     <div id="section02">
      <div class="contentbox01">
       <h1><span class="umbrella-title">Experimental Forests</span> <br />
           Deception Creek Experimental Forest</h1>
       <ul class="breadcrumb-nav">
	<li><a href="<?php echo ("".$home_URL.""); ?>/">Moscow Home</a> &gt; </li>
	<li><strong>Deception Creek Experimental Forest</strong></li>
       </ul>
