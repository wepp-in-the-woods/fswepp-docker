...
<div id="section01">
	<div class="contentbox01">
		<ul class="fslinks">
			<li><a href="http://www.fs.fed.us/rmrs/" title="Rocky Mountain Research Station"><img src="<?php echo ("/".$shared_directory.""); ?>/logo_rmrs_tan_bkgd.gif" width="160" height="118" alt="Rocky Mountain Research Station" /></a></li>
			<li><a href="http://www.usda.gov" title="United States Department of Agriculture"><img src="<?php echo ("/".$shared_directory.""); ?>/logo_usda.gif" width="69" height="47" alt="United States Department of Agriculture" /></a><a href="http://www.fs.fed.us/"><img src="<?php echo ("/".$shared_directory.""); ?>/logo_fs_tan_bkgd.gif" width="45" height="46" alt="United States Forest Service" /></a></li>
			<li><a href="http://www.usa.gov"><img src="<?php echo ("/".$shared_directory.""); ?>/logo_usagov_tan_bkgd.gif" width="121" height="36" alt="USA.gov" /></a></li>
		</ul>
           ...
           <div class="contentbox01">
            <h1>Moscow Forestry Sciences Laboratory</h1>
             <div class="simple-main-content-nav">
              <h2><a href="/climate/">Climate Data &amp; Estimates, Climate Change and Plant Climate Relationships</a></h2>
              <h2><a href="/lidar/">LiDAR &ndash; Multiscale Curvature Classification</a></h2>
              <h2 class="nohref">Long-Term Soil Productivity and Related Work</h2>
	       <ul>
		<li><a href="/smp/">Long-Term Soil Productivity (LTSP)</a></li>
	        <li><a href="/smp/solo/"><acronym title="Soil quality monitoring and Long term ecosystem sustainability">SoLo</acronym>: Soil Monitoring and Productivity Library</a></li>
	       </ul>
         ...
         <h2><a href="people">Moscow Lab Personnel</a></h2>
					...
					<ul>
						<li><a href="/ef/pref/index.php">Priest River Experimental Forest</a></li>
						<li><a href="/ef/dcef.php">Deception Creek Experimental Forest</a></li>
						<li><a href="/ef/bbef.php">Boise Basin Experimental Forest</a></li>
					</ul>
