...
#  <option value="2">  Aldo Leopold</option>                     7
#  <option value="3">  Boise FSL</option>                       26
#  <option value="4">  Bozeman</option>                          8
#  <option value="5">  Flagstaff FSL</option>                   19 + 7
#  <option value="6">  Fort Collins</option>                    70
#  <option value="7">  Logan</option>                            5
#  <option value="8">  Missoula FiSL</option>                   53
#  <option value="9">  Missoula FoSL</option>                   33
#  <option value="10"> Moscow FSL</option>                      24
#  <option value="11"> FIA Ogden</option>                       43
#  <option value="12"> Provo</option>                            8
#  <option value="13"> Rapid City</option>                       4
#  <option value="13"> Reno</option>                       	 3
...
# $loc = array('Albuquerque','Aldo Leopold','Boise','Bozeman','FIA Data Collection','Flagstaff','Fort Collins','Logan','Missoula FiSL','Missoula FoSL','Moscow FSL','Ogden','Provo','Rapid City');
  $loc = array('Albuquerque','Aldo Leopold','Boise','Bozeman','Flagstaff','Fort Collins','Logan','Missoula FiSL','Missoula FoSL','Moscow FSL','Ogden','Provo','Rapid City','Reno');  # 2018
...
# $emp = array(9,8,24,11,22,84,5,68,36,24,45,10,5);  # 2017
# $emp = array(8,1,25,11,19,76,5,60,45,25,44,10,5,2); # 2018
# $emp = array(8,8,25,11,19,76,5,60,45,25,44,10,5,2); # 2018
  $emp = array(8,7,26,8,26,70,5,53,33,24,43,8,4,3); # 2019
