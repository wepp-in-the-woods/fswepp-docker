...
echo "
   ...
   <table border=0>
    <tr bgcolor=lightgreen>
     <th><font size=-1>Location</th><th><font size=-1>Players / <br>employees</th><th><font size=-1>Percent<br>participation</th><th><font size=-1>%</th><th><font color=gold size=-1>High</font> <font size=-1 color=green>Total</font> Points</th><th><font size=-2>Individual High | Location Total<br>Points</font></th>
    </tr>
";
...
//   open file, read pontsw and pointso
    ...
    echo
"    <tr>
      <th align=left bgcolor=lightgreen><font size=-1><a href=\"location.php?loc=$i\">$location</a></th>
      <td align=right><font size=-1>$players / $employees</td>
      <td align=right><font size=-1>$percent</td>
