...
#  <option value="2">  Aldo Leopold</option>                     1
#  <option value="3">  Boise FSL</option>                       25
#  <option value="4">  Bozeman</option>                         11
#  <option value="5">  Flagstaff FSL</option>                   19
#  <option value="6">  Fort Collins</option>                    76
#  <option value="7">  Logan</option>                            5
#  <option value="8">  Missoula FiSL</option>                   60
#  <option value="9">  Missoula FoSL</option>                   45
#  <option value="10"> Moscow FSL</option>                      25
#  <option value="11"> FIA Ogden</option>                       44
#  <option value="12"> Provo</option>                           10
#  <option value="13"> Rapid City</option>                       5
#  <option value="13"> Reno</option>                       	 2
