<html>
 ...
 <font face="trebuchet, tahoma, arial, sans serif">
   <table border=0 width=100%><tr bgcolor=darkgreen><th><h3><font color=white><a href=".">Get Your Green On: Summit Mt. Sustainability</a></font></h3></th></tr></table>
<br>
...
die;
    ...
    if ($handle) {
     ...
     fwrite($handle, "r,$opr1,$opr2,$opr3,$opr4,$opr5,$opr6,$opr7,$opr8,$opr9,\n");
