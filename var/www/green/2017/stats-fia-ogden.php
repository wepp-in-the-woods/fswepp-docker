...
#  <option value="4"   >Bozeman</option>			 6
#  <option value="5"   >FIA Data Collection Team</option>	 0
#  <option value="6"   >Flagstaff FSL</option>			21
#  <option value="7"   >Fort Collins</option>			85
#  <option value="8"   >Logan</option>				 8
#  <option value="9"   >Missoula FiSL</option>			57
#  <option value="10"  >Missoula FoSL</option>			40
#  <option value="11"  >Moscow FSL</option>			32
#  <option value="12"  >FIA Ogden</option>			68
...
# $emp = array(8,8,23,5,50,23,86,8,54,36,34,44,8,5);
  $emp = array(8,8,26,6,0,21,85,8,57,40,32,68,10,3);   # FIA consolidated in Ogden
