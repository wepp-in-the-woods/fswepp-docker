...
echo "
   ...
   <table border=0 cellpadding=1 cellspacing=1>
    <tr bgcolor=lightgreen>
     <th><font size=-1>Location</th><th colspan=2><font size=-1>Percent<br>participation</th><th><font color=gold size=-1>Indiv. High</font> <font size=-1 color=green>Total</font><font size=-1> Points</th><th><font size=-2>Individual High | Location Total<br>Points</font></th><th><font size=-1>Average<br>points<br>earned</th>
    </tr>
";
...
<?php echo "  <b>Total players: $allplayers<br>
    Large lab maximum average points: $highlargelabloc ($highlargelabrate points)<br>
    Small lab maximum average points: $highsmalllabloc ($highsmalllabrate points)</b>"; ?>
 </body>
</html>
