...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wr.log
   $file = '../cgi-bin/fswepp/working/_2016/wr.log';
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wrb.log
   $file = '../cgi-bin/fswepp/working/_2016/wrb.log';
...
<?php
         $dits = 0;
         for ($i = 1; $i <= 53; $i++) {
            $dits += filesize("../cgi-bin/fswepp/working/_2016/wr/$i");
         }
...
<?php
  // wc ../cgi-bin/fswepp/working/_2016/we.log
   $file = '../cgi-bin/fswepp/working/_2016/we.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/web.log
   $file = '../cgi-bin/fswepp/working/_2016/web.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2016/wd2.log
   $file = '../cgi-bin/fswepp/working/_2016/wd2.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/dwb.log
   $file = '../cgi-bin/fswepp/working/_2016/dwb.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
// wc ../cgi-bin/fswepp/working/_2015/wt.log
   $file = '../cgi-bin/fswepp/working/_2016/wt.log';
...
//   wc ../cgi-bin/fswepp/working/_2015/wb.log
   $file = '../cgi-bin/fswepp/working/_2016/wb.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wf.log
   $file = '../cgi-bin/fswepp/working/_2016/wf.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<img title="USDA National Institute of Food and Agriculture">
                                                      <img src="https://cals-wepponlinegis.ag.uidaho.edu/gl/images/ArmyCorpLogo.jpg" width=100 height=75" border=0 title="Army Corp of Engineers">
