...
?>
   <table bgcolor="lightgreen">
    <tr>
     <td>
      <form name="mylatlon" action="closest_israel.php">
       <center>
...
//    $z = array_multisort($dist, $file, $stat);
    ...
    if ($i < $howmany) { $howmany = $i; }

    if (array_multisort($dist, $stat, $lati, $long)) {

      echo "    Closest $howmany of $i stations to latitude $my_latitude<sup>o</sup>, longitude $my_longitude<sup>o</sup>: <br><br>\n";
      echo "   <table border=1 cellpadding=5>\n";
      echo "    <tr><th valign=top>Distance<br>($units2)</th><th valign=top>Lat Long</th><th valign=top>Station</th></tr>\n";
      for ($j = 0; $j < $howmany; $j++) {
