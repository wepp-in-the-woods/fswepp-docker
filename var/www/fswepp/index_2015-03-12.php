...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wr.log
   $file = '../cgi-bin/fswepp/working/_2015/wr.log';
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wrb.log
   $file = '../cgi-bin/fswepp/working/_2015/wrb.log';
...
<?php
         $dits = 0;
         for ($i = 1; $i <= 53; $i++) {
            $dits += filesize("../cgi-bin/fswepp/working/_2015/wr/$i");
         }
...
<!-- ===================  ERMiT  ====================== -->
     ...
     <tr align=top>
      ...
      <td align="center" bgcolor="lightgrey">
       ...
       <font size=-2>
<?php
  // wc ../cgi-bin/fswepp/working/_2015/we.log
   $file = '../cgi-bin/fswepp/working/_2015/we.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/web.log
   $file = '../cgi-bin/fswepp/working/_2015/web.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<!-- ===================  Disturbed WEPP ====================== -->
     ...
     <TR align=top>
      ...
      <td align="center" bgcolor="lightgrey">
       ...
       <font size=-2>
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wd2.log
   $file = '../cgi-bin/fswepp/working/_2015/wd2.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/dwb.log
   $file = '../cgi-bin/fswepp/working/_2015/dwb.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
// wc ../cgi-bin/fswepp/working/_2015/wt.log
   $file = '../cgi-bin/fswepp/working/_2015/wt.log';
...
//   wc ../cgi-bin/fswepp/working/_2015/wb.log
   $file = '../cgi-bin/fswepp/working/_2015/wb.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wf.log
   $file = '../cgi-bin/fswepp/working/_2015/wf.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<!-- ===================  Great Lakes on the Web  ================= -->
     ...
     <tr align=top>
      <td align=center bgcolor="lightgrey">
       <a href="http://cals-wepponlinegis.ag.uidaho.edu/gl/" target="_doit">
        <img src="images/WEPP_GIS.png"
      ...
      <td align="center" bgcolor="lightgrey">
       <div id="help">
        <a href="http://cals-wepponlinegis.ag.uidaho.edu/gl/" target="new"
...
<!-- ================================================================================= -->
<!-- ROW SEVEN --> <!-- WASP and Other WEPP resources-->
<!-- ===================  Peak Flow Calculator  ====================== -->

     <TR align=top>
      <td align=center bgcolor="lightgrey">
       <a href="javascript:submitit('WASP')">
       <img src="images/wasp_logo.png" height=45 width=45 border=2
           alt="Run WASP"
           onMouseOver="window.status='Run WASP';return true"
           onMouseOut="window.status='Forest Service WEPP Interfaces'; return true"></a>
      </td>
      <td align="center" bgcolor="lightgrey">
       <div id="help">
        <a href="javascript:submitit('WASP')"
             onMouseOver="window.status='Run WASP';return true"
             onMouseOut="window.status='FS WEPP'; return true">Water And Sediment Predictor
         <span>
          WASP (Water And Sediment Predictor) &ndash; under development &ndash; will provide a water balance report.
 	 </span>
        </a>
       </div>
<font size=-2>Under development</font>
      </td>
       ...
       <div id="help">
        <a href="WEPPlinks.html" target="new"
         ...
         <span>
           ...
           <!-- Additional WEPP resources: ARS's WEPP on the Web, WEPP for Windows, GeoWEPP, WEPP manuals, etc., on remote sites ["WEPPlinks.html]  -->
        </a>
       </div>
      </td>
      <td align=center bgcolor="lightgrey">
...
<a href="http://www.fs.fed.us">                       <img src="/images/usfs.gif" alt="USDA Forest Service" height=37 width=73 alt="USFS logo" border=0 title="U.S. Forst Service"></a>
<a href="http://www.fs.fed.us/rmrs">                  <img src="images/rmrs_small.gif" width="75" alt="RMRS logo" border=0 title="U.S. Forest Service Rocky Mountain Research Station"></a>
<a href="http://www.fs.fed.us/eng/techdev/sdtdc.htm"> <img src="/images/sdtd_l50.gif" height=50 width=87 alt="San Dimas logo" border=0 title="U.S. Forest Service San Dimas Technology and Development Center"></a>
<a href="http://www.firescience.gov">                 <img src="/images/jfsp_l75.gif" width=75 height=102 alt="JFSP logo" border=0 title="U.S. Department of Interior Joint Fire Science Program"></a>
<img title="USDA National Institute of Food and Agriculture">
                                                      <img src="http://cals-wepponlinegis.ag.uidaho.edu/gl/images/ArmyCorpLogo.jpg" width=100 height=75" border=0 title="Army Corp of Engineers">
<a href="http://www.ars.usda.gov/mwa/lafayette/nserl"><img src="/images/ars_60.gif" with=60 height=45 alt="ARS logo" border=0 title="WEPP is an interagency model lead by the Agricultural Research Service's National Soil Erosion Research Laboratory"></a>
   </center>
  </font>
 </BODY>
</HTML>
