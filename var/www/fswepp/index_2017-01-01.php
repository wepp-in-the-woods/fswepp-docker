...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wr.log
   $file = '../cgi-bin/fswepp/working/_2017/wr.log';
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wrb.log
   $file = '../cgi-bin/fswepp/working/_2017/wrb.log';
...
<?php
         $dits = 0;
         for ($i = 1; $i <= 53; $i++) {
            $dits += filesize("../cgi-bin/fswepp/working/_2017/wr/$i");
         }
...
<?php
  // wc ../cgi-bin/fswepp/working/_2016/we.log
   $file = '../cgi-bin/fswepp/working/_2017/we.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/web.log
   $file = '../cgi-bin/fswepp/working/_2017/web.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2016/wd2.log
   $file = '../cgi-bin/fswepp/working/_2017/wd2.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/dwb.log
   $file = '../cgi-bin/fswepp/working/_2017/dwb.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
// wc ../cgi-bin/fswepp/working/_2015/wt.log
   $file = '../cgi-bin/fswepp/working/_2017/wt.log';
...
//   wc ../cgi-bin/fswepp/working/_2015/wb.log
   $file = '../cgi-bin/fswepp/working/_2017/wb.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wf.log
   $file = '../cgi-bin/fswepp/working/_2017/wf.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<!-- ===================  Great Lakes on the Web  ================= -->
     ...
     <tr align=top>
      <td align=center bgcolor="lightgrey">
       <a href="https://cals-wepponlinegis.ag.uidaho.edu/gl/" target="_doit">
      ...
      <td align="center" bgcolor="lightgrey">
       <div id="help">
        <a href="https://cals-wepponlinegis.ag.uidaho.edu/gl/" target="new"
...
<a href="http://nifa.usda.gov">                        <img src="http://think.stedwards.edu/sustainability/sites/think.stedwards.edu.sustainability/files/USDA%20NIFA%20Logo.jpg" title="USDA National Institute of Food and Agriculture" width=100></a>
