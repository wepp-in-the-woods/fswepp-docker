...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wr.log
   $file = '../cgi-bin/fswepp/working/_2019/wr.log';
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wrb.log
   $file = '../cgi-bin/fswepp/working/_2019/wrb.log';
...
<?php
         $dits = 0;
         for ($i = 1; $i <= 53; $i++) {
            $dits += filesize("../cgi-bin/fswepp/working/_2019/wr/$i");
         }
...
<?php
  // wc ../cgi-bin/fswepp/working/_2016/we.log
   $file = '../cgi-bin/fswepp/working/_2019/we.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/web.log
   $file = '../cgi-bin/fswepp/working/_2019/web.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2016/wd2.log
   $file = '../cgi-bin/fswepp/working/_2019/wd2.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/dwb.log
   $file = '../cgi-bin/fswepp/working/_2019/dwb.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
<?php
  // wc ../cgi-bin/fswepp/working/_2015/wf.log
   $file = '../cgi-bin/fswepp/working/_2019/wf.log';
   echo intval(exec('wc -l '.escapeshellarg($file).' 2>/dev/null'));
?> runs YTD
       </font>
      </td>
...
// wc ../cgi-bin/fswepp/working/_2015/wt.log
   $file = '../cgi-bin/fswepp/working/_2019/wt.log';
...
<!-- ================= WEPPcloud                                           =================== -->
     ...
     <tr align=top>
      <td align=center bgcolor="white">
       <a href="https://wepp1.nkn.uidaho.edu/weppcloud/" target="new">
        <img src="images/WEPPcloudLogo.png"
          alt="WEPPcloud"
          height=50 width=50 border=2
      ...
      <td align="center" bgcolor="lightgrey">
       <div id="help">
        <a href="https://wepp1.nkn.uidaho.edu/weppcloud/" target="new"
         ...
         <span>
             WEPPcloud -- A WEPP-based computer simulation tool that estimates hillslope soil erosion, small watershed runoff, and sediment yields from anywhere in the continental U.S.
             Especially useful for post-wildfire assessments, fuel treatment planning, and prescribed fire analysis.
         </span>
        </a>
       </div>
      </td>
...
<!-- ===================  WEPPcloud Postfire Erosion Prediction (PEP)  ====================== -->
      ...
      <td align="center" bgcolor="lightgrey">
       <div id="help">
        <a href="https://wepp1.nkn.uidaho.edu/weppcloud#pep"
         ...
         <span>
           WEPP Postfire Erosion Prediction (PEP) -- a computer simulation tool that estimates soil erosion following an actual or simulated wildfire from soil burn severity maps
         </span>
           <!--  -->
        </a>
       </div>
      ...
      <td align=center bgcolor="lightgrey">
       <a href="https://wepp1.nkn.uidaho.edu/weppcloud/">
        <img src="images/WEPPcloudPEPLogo.png" width=50 height=50 border=2
          alt="WEPPcloudPEP"
          height=50 width=50 border=2
          onMouseOver="window.status='WEPP Cloud';return true"
          onMouseOut="window.status='Forest Service WEPP Interfaces'; return true"></a>
      </td>
     </tr>

<!-- ============================================================== -->
<!-- ROW SEVEN        =============???? and Peak Flow ============= -->
<!-- ============================================================== -->
    <tr bgcolor=white>
     <td></td><td></td>
...
<!-- ===================  Peak Flow Calculator  ====================== -->
      ...
      <td align=center bgcolor="lightgrey">
       <a href="ermit/peakflow/" target="new"><img src="ermit/peakflow/peakflow.jpg" width=50 height=42 border=2></a>
      </td>
     </tr>
...
<!-- END ROWS -->
   ...
   <table width=100% border=0>
    ...
    <table>
     <tr>
      <td><a href="https://www.fs.fed.us">                       <img src="/images/usfs.gif" alt="USDA Forest Service" height=37 width=73 alt="USFS logo" border=0 title="U.S. Forst Service"></a>
