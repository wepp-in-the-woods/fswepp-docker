...
<br /><br />
	...
	<p class="figure">
		<em class="bld"><a name="fig3"></a>Figure 3</em>&#8212;Random selection of half the original sample for model development and the remaining half for model validation. <a href="graphics/verbyla_fig3a_lg.gif">[view larger image of graph below - 12K]</a>
		<br />
		<br />
		...
		<br /><br /><a href="graphics/verbyla_fig3b_lg.gif">[view larger image of graph below - 12K]</a>
		<br /><br />
