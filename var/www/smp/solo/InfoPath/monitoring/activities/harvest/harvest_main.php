...
?>
		<meta name="description" content="Timber Harvest" />
		<meta name="keywords" content="timber harvest" />
<?php
require("http://forest.moscowfsl.wsu.edu/smp/solo/shared/header3.php");
?>
			<h5 class="subnav"><a href="../../../../index.html">SOLO HOME</a> &gt; <a href="../../index.php">MONITORING</a> &gt; <a href="../../activities.php">ACTIVITIES</a> &gt; HARVEST</h5>
			<h2 class="topheading">MONITORING ACTIVITIES: HARVEST</h2>
			<p>Historically, timber harvest has been one of the largest uses of National Forest land. Depending on the method used, the effects can vary widely. As a result, some management practices can be termed &quot;sustainable&quot; while others cannot.</p>
