...
?>
			...
			<p>Two quantitative procedures are involved in soil quality monitoring. The first is <a href="#measurement"><strong>measurement</strong></a>, or assessment of those parameters which indicate the level of acceptability of soil quality at a site. The second is <strong><a href="#application">application</a></strong> of a method or methods from a menu of methods which either will maintain or improve the soil quality at a site. Each is situationally specific.</p>
			...
			<h2><a name="application" id="application"></a>Application of Method(s)</h2>
