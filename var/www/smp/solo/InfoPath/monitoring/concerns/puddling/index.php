...
?>
    <title>Monitoring Activities: Puddling</title>
<?php
include($_SERVER["DOCUMENT_ROOT"]."/smp/solo/shared/stylesheet.php");
include($_SERVER["DOCUMENT_ROOT"]."/smp/solo/shared/header2.php");
?>
		<meta name="description" content="Monitoring Concerns: Puddling" />
		<meta name="keywords" content="soil monitoring concerns puddling" />
<?php
include($_SERVER["DOCUMENT_ROOT"]."/smp/solo/shared/header3.php");
?>
			<h5 class="subnav"><a href="../../../../index.php">SOLO HOME</a> &gt; <a href="../../index.php">MONITORING</a> &gt; <a href="../../concerns.php">CONCERNS</a> &gt; PUDDLING</h5>
			<h2 class="topheading">MONITORING ACTIVITIES: PUDDLING</h2>
			<ul class="navlist">
