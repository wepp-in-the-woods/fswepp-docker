...
?>
			<h5 class="subnav"><a href="../../index.php">SOLO HOME</a> &gt; <a href="index.php">MONITORING</a> &gt; GUIDELINES</h5>
			<h1 class="topheading">GUIDELINES FOR SOIL QUALITY MONITORING</h1>
			<p>Guidelines do not represent the minimum disturbance that will reduce inherent productivity, but indicate the maximum tolerable disturbance; i.e., disturbance that will result in a detectable loss of productivity. Nonetheless, management goals should strive to create as little disturbance as possible, not just to keep from exceeding guidelines.</p>
