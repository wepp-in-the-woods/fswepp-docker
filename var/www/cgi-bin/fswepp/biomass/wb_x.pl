...
#  wb.pl -- BIOSE workhorse
#  Modified by HR from fume2.pl 2013.03.01

## BEGIN HISTORY ##############################
# WEPP BIOSE Results history
...
#     $weppdiro = "https://" . $wepphost . "/Scripts/fswepp/wd/weppdiro.pl";#elena
     $fume = "https://" . $wepphost . "/cgi-bin/fswepp/wb/wb.pl";#elena
#     print "<p> weppdiro $fume <br>";#elena

   if (lc($action) =~ /custom/) {
#     $weppdiro = "https://" . $wepphost . "/Scripts/fswepp/wd/weppdiro.pl";
     $fume = "https://" . $wepphost . "/cgi-bin/fswepp/wb/wb.pl";		# 2004.09.21 DEH
...
#       exec "perl c:\\Inetpub\\Scripts\\fswepp\\rc\\rockclim.pl -server -i$me -u$units $fume"
   ...
   if (lc($action) ne 'run wepp biomass' && lc($achtung) =~ /describe climate/) {	# 2004.11.19 DEH
     $weppdiro = "https://" . $wepphost . "/Scripts/fswepp/wd/weppdiro.pl";
     $fume = "https://" . $wepphost . "/cgi-bin/fswepp/wb/wb.pl";
     if ($platform eq "pc") {
    ...
    <table width=100% border=0>
     <tr>
      ...
      <td>
       ...
       <img src="/fswepp/images/epage.gif" align="right" alt="BIOMASS documentation" border=0></a>
      </td>
     </tr>
    </table>
';
...
<!-- ============== -->
  <form method='post' action='/cgi-bin/fswepp/wb/wb.pl'>
...
#   $thinning_cycle=20;		# harvesting cycle (years)
...
#  $undiraw=@out_asypa[0]*640;
   ...
   $undisturbe=$out_asypa[0]*640;
   $thinning  = sprintf '%.1f',($out_asypa[1]*640)/$thinning_cycle;
...
print "
    ...
    When soil texture is clay loam, silt loam, or loam, the road will be pulverized and its traffic will be high access level.
    The pulverized road is dusty when it is dry, and turns to slurry when it is wet.
...
<img src="https://',$wepphost,'/fswepp/images/epaemail.gif" align="right" border=0>
 ...
 (for review only) Interface by David Hall, Elena Velasquez, and Hakjun Rhee
...
#     print  RUNLOG "$soil_type{$soil}\t";	# Soil texture
      ...
      print  RUNLOG "$thinning_cycle\t";	# Harvesting cycle
