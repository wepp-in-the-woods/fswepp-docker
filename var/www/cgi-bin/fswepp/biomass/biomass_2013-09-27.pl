...
## WEPP biomass Input Screen version history
   ...
   $version='2013.09.27';       # Mdification of 2013.03.01 WEPP BIOMASS input screen
   ...
   <table width=100% border=0>
    <tr>
     ...
     <td align=center>
       ...
       <hr>
    <td>
       <A HREF="/fswepp/docs/biomass/WEPPbiomass.pdf" target="docs">
