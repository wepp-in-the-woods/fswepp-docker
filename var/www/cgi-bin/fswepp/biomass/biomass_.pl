...
## WEPP biomass Input Screen version history
   ...
   $version='2013.03.12';       # Mdification of 2013.03.01 WEPP BIOMASS input screen
...
<html>
 <head>
  ...
  <META NAME="Contributors" CONTENT="USDA Forest Service, Rocky Mountain Research Station, Moscow, ID: model developed by Bill Elliot and Pete Robichaud; interface programming by David Hall, Elena Velasquez, and Hakjun Rhee">
     ...
     <th bgcolor="lightblue" title="Number of years between thinnings">
      <font face="tahoma, arial, helvetica, sans serif">
       ...
       <input type="text" size=8 value="20" name="thinning_cycle"
        ...
        title="Thinning cycle: ',$fmc_min,' to ',$fmc_max,'">
      </font>
     </th>
    </tr>
   </table>
     ...
     <tr>
      <td valign="top">
       <font face="tahoma, arial, helvetica, sans serif" size=1>
        ...
        (for review only) by
        David Hall, Elena Velasquez, and Hakjun Rhee<br>
...
print "  <font face='tahoma, arial, helvetica, sans serif' size=1>
   ...
   <b>$runs</b> WEPP BIOMASS runs since Jan 01, 2013
  </font>
 </body>
</html>
";
