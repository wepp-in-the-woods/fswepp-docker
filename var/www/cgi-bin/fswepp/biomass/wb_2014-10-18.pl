...
print "
    ...
    When soil texture is clay loam, silt loam, or loam, the road will be <a href=\"JavaScript:popuppulvroad()\">pulverized</a> and its traffic will be high access level.
    The <a href=\"JavaScrpt:popuppulvroad()\">pulverized road</a> is dusty when it is dry, and turns to slurry when it is wet.
