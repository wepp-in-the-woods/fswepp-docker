...
#    $units		'm' or 'ft'
#    $comefrom          wepp:road or disturbed wepp or other path
#    $state             for retreat
#    form:
#      platitude        PRISM location latitude
#      plongitude       PRISM location longitude
...
#  2012.03.14   DEH Adjust precip std dev in proportion to change in mean; reformat
#  2009.07.24   DEH Lat/Long tracking modification
...
# DEH 03/05/2001
   ...
   $climate_name = substr($line,1,32);
     ...
     $line=<PAR>;	# S DEV P  0.12  0.12  0.11  0.13  0.13  0.18  0.22  0.13  0.13  0.11  0.14  0.13
       @sd_p_if = split ' ',$line; $sd_p_base = 3;
...
print "
   ...
   var opsd1 = parseFloat($sd_p_if[3])
   var opsd2 = parseFloat($sd_p_if[4])
   var opsd3 = parseFloat($sd_p_if[5])
   var opsd4 = parseFloat($sd_p_if[6])
   var opsd5 = parseFloat($sd_p_if[7])
   var opsd6 = parseFloat($sd_p_if[8])
   var opsd7 = parseFloat($sd_p_if[9])
   var opsd8 = parseFloat($sd_p_if[10])
   var opsd9 = parseFloat($sd_p_if[11])
   var opsd10 = parseFloat($sd_p_if[12])
   var opsd11 = parseFloat($sd_p_if[13])
   var opsd12 = parseFloat($sd_p_if[14])
...
//   sum_nw()
   ...
   function pcpct() {
    ...
    sum_pc()								// ZZZZZZZZZZZZZZZZZZZZZZZZZZZ
    document.mods.pcsd1.value = precision(opsd1 * ratio,2)
    document.mods.pcsd2.value = precision(opsd2 * ratio,2)
    document.mods.pcsd3.value = precision(opsd3 * ratio,2)
    document.mods.pcsd4.value = precision(opsd4 * ratio,2)
    document.mods.pcsd5.value = precision(opsd5 * ratio,2)
    document.mods.pcsd6.value = precision(opsd6 * ratio,2)
    document.mods.pcsd7.value = precision(opsd7 * ratio,2)
    document.mods.pcsd8.value = precision(opsd8 * ratio,2)
    document.mods.pcsd9.value = precision(opsd9 * ratio,2)
    document.mods.pcsd10.value = precision(opsd10 * ratio,2)
    document.mods.pcsd11.value = precision(opsd11 * ratio,2)
    document.mods.pcsd12.value = precision(opsd12 * ratio,2)
   }
...
function fix_nw() {
// alert ('fix_nw: '+document.mods.nw1.value)
...
// var i=2;
 ...
 var orig_mean_pcp; var orig_sd_pcp;
// orig_mean_pcp=EVAL('opc'+ '2')           						 // zzzzzzzzzzzzzzzzzzzz
 if (i==1)  {orig_mean_pcp=opc1};  if (i==2)  {orig_mean_pcp=opc2};  if (i==3)  {orig_mean_pcp=opc3};
 if (i==4)  {orig_mean_pcp=opc4};  if (i==5)  {orig_mean_pcp=opc5};  if (i==6)  {orig_mean_pcp=opc6};
 if (i==7)  {orig_mean_pcp=opc7};  if (i==8)  {orig_mean_pcp=opc8};  if (i==9)  {orig_mean_pcp=opc9};
 if (i==10) {orig_mean_pcp=opc10}; if (i==11) {orig_mean_pcp=opc11}; if (i==12) {orig_mean_pcp=opc12};
 new_mean_pcp=obj.value
// orig_sd_pcp=EVAL('opsd'+'2')
 if (i==1)  {orig_sd_pcp=opsd1};  if (i==2)  {orig_sd_pcp=opsd2};  if (i==3)  {orig_sd_pcp=opsd3};
 if (i==4)  {orig_sd_pcp=opsd4};  if (i==5)  {orig_sd_pcp=opsd5};  if (i==6)  {orig_sd_pcp=opsd6};
 if (i==7)  {orig_sd_pcp=opsd7};  if (i==8)  {orig_sd_pcp=opsd8};  if (i==9)  {orig_sd_pcp=opsd9};
 if (i==10) {orig_sd_pcp=opsd10}; if (i==11) {orig_sd_pcp=opsd11}; if (i==12) {orig_sd_pcp=opsd12};
 alert ('original mean P: '+orig_mean_pcp)
 alert ('new mean P: '+new_mean_pcp)
 alert ('original SD P: '+orig_sd_pcp)
 if (orig_mean_pcp>0.001) {
   ratio=(new_mean_pcp-orig_mean_pcp)/(orig_mean_pcp)
   alert ('ratio: '+ratio)
   new_sd=orig_sd_pcp*(1+ratio)
   alert ('new SD P: '+new_sd)
   n=precision(new_sd,2)
   if (i==1)  {document.mods.pcsd1.value = n};    if (i==2)  {document.mods.pcsd2.value = n};
   if (i==3)  {document.mods.pcsd3.value = n};    if (i==4)  {document.mods.pcsd4.value = n};
   if (i==5)  {document.mods.pcsd5.value = n};    if (i==6)  {document.mods.pcsd6.value = n};
   if (i==7)  {document.mods.pcsd7.value = n};    if (i==8)  {document.mods.pcsd8.value = n};
   if (i==9)  {document.mods.pcsd9.value = n};    if (i==10) {document.mods.pcsd10.value = n};
   if (i==11) {document.mods.pcsd11.value = n};   if (i==12) {document.mods.pcsd12.value = n};
   alert (n)
 }
}
...
function lapsetemp() {
  if (document.mods.lapse.checked) {
    ...
    if ($units eq "m") { 
      print "
     var lelev = parseFloat(document.mods.melev.value)
...
function TransferName() {
     document.mods.newname.value=document.prism.newname.value;
}

function TransferElev() {
   if (units=='m')  {document.mods.melev.value=document.prism.pelev.value}
   if (units=='ft') {document.mods.ftelev.value=document.prism.pelev.value}
   lapsetemp()
}

function transfer_prism_pcp() {
  var x=window.confirm('Transfer PRISM pricipitation values?')
  if (x) {
    document.mods.pc1.value = document.mods.pcpr1.value; adjust_pcp_sd(1)
    document.mods.pc2.value = document.mods.pcpr2.value; adjust_pcp_sd(2)
    document.mods.pc3.value = document.mods.pcpr3.value; adjust_pcp_sd(3)
    document.mods.pc4.value = document.mods.pcpr4.value; adjust_pcp_sd(4)
    document.mods.pc5.value = document.mods.pcpr5.value; adjust_pcp_sd(5)
    document.mods.pc6.value = document.mods.pcpr6.value; adjust_pcp_sd(6)
    document.mods.pc7.value = document.mods.pcpr7.value; adjust_pcp_sd(7)
    document.mods.pc8.value = document.mods.pcpr8.value; adjust_pcp_sd(8)
    document.mods.pc9.value = document.mods.pcpr9.value; adjust_pcp_sd(9)
    document.mods.pc10.value = document.mods.pcpr10.value; adjust_pcp_sd(10)
    document.mods.pc11.value = document.mods.pcpr11.value; adjust_pcp_sd(11)
    document.mods.pc12.value = document.mods.pcpr12.value; adjust_pcp_sd(12)
  }
}

function adjust_pcp_sd (i) {

   var orig_mean_pcp; var orig_sd_pcp;

   orig_mean_pcp = eval('opc'+i)
   new_mean_pcp = eval('document.mods.pc'+i+'.value')
// alert (orig_mean_pcp);
// alert (new_mean_pcp);

   orig_sd_pcp=eval('opsd'+i)
...
//   alert ('new SD P: '+new_sd)
     ...
     n=precision(new_sd,2)
     if (i==1) document.mods.pcsd1.value = n;     if (i==7) document.mods.pcsd7.value = n;
     if (i==2) document.mods.pcsd2.value = n;     if (i==8) document.mods.pcsd8.value = n;
     if (i==3) document.mods.pcsd3.value = n;     if (i==9) document.mods.pcsd9.value = n;
     if (i==4) document.mods.pcsd4.value = n;     if (i==10) document.mods.pcsd10.value = n;
     if (i==5) document.mods.pcsd5.value = n;     if (i==11) document.mods.pcsd11.value = n;
     if (i==6) document.mods.pcsd6.value = n;     if (i==12) document.mods.pcsd12.value = n;
   }
}
   // -->
  </SCRIPT>
...
#     print '<b>';
##    printf "%.2f", abs($lat);		# 2009.07.22 DEH
#     print "Latitude: ";		# 2009.07.22 DEH
#     printf "%.2f", $lat;
#     print '<sup>o</sup>';
...
#    printf "%.2f", abs($lon);		# 2009.07.22 DEH
#     print " longitude: ";		# 2009.07.22 DEH
#     printf "%.2f", $lon;
#     print '<sup>o</sup>';
...
#     print $longhemisphere;
     ...
     print '
    <center>
     <form name="prism" action="/cgi-bin/fswepp/prism/prisllhiform.pl" method=post>
      <H3>Rock:Clime custom climate
       <a href="/fswepp/docs/modpardoc.html" target="docs">
        <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
       </a>
      </H3>
';
     print '
...
#    <input type=hidden name=longitude value=',abs($lon),'>
     ...
     <table border=2>
      <tr>
       ...
       <th bgcolor=lightblue>Latitude</th>
       <th bgcolor=lightblue>Longitude</th>
       <th bgcolor=lightblue>Elevation</th>
       <th bgcolor=lightblue></th>
      </tr>
      <tr>
       <th bgcolor=lightblue align=right>Custom climate</th>
       <th bgcolor=orange><input type=text name=newname size=30 maxlength=30 value="';

     $climate_name =~ s/^\s*(.*?)\s*$/$1/;           # trim whitespace 2001/04/11 DEH

     print $climate_name,'" onChange=TransferName()></th>
       <td bgcolor=orange><input type=text name=platitude size=7 value=';                       # 2009.07.22 DEH
     printf "%.2f", $plat;
     print ' onChange="updateLL()"> <b><sup>o</sup>N</b></td>
       <td bgcolor=orange><input type=text name=plongitude size=7 value=';                        # 2009.07.22 DEH
     printf "%.2f", $plon;
     print ' onChange="updateLL()"> <b><sup>o</sup>E</b></td>
       <td bgcolor=orange>';
     if ($units eq 'm') {
       print '<input type=text name=pelev size=7 onChange="TransferElev()" value=';
       printf " %4d",$pelev;
       print '> <b>m</b>';
     }
     else {
     ...
     print '
      ...
      <tr>
       <th align=right bgcolor=lightblue>Based on</th>
       <td>',$climate_name,'</td>
       <td>',$latf,' <b><sup>o</sup>N<b></td>
       <td>',$lonf,' <b><sup>o</sup>E</b></td>
       <td>',$elevf,'</td>
       <td>
        <font size=-2>
         <a href="Javascript:latlong_calc(\'',$units,'\')">lat-long&nbsp;calc</a><br>
         <a href="Javascript:dms2dec_calc(\'',$units,'\')">degrees&nbsp;calc</a>
        </font>
       </td>
      </tr>
     </table>
...
';
     if ($units eq 'm') {
       print "\n      ";
       print '<input type=hidden name=melev size=7 onChange="lapsetemp()" value=';
       printf " %4d",$pelev;
       print '>';
     }
     else {
       print "\n      ";
       print '<input type=hidden name=ftelev size=7 onChange="lapsetemp()" value=';
       printf " %4d",$pelev;
       print '>';
     }
     print '
      <input type=hidden name="newname" value="',$climate_name,'">
      <input type="hidden" name="units" value="',$units,'">
      <input type="hidden" name="climateFile" value="',$climateFile,'">
      <input type="hidden" name="latitude" value="';
#     printf "%.2f", abs($plat);  print '">		# 2009.07.24 DEH
     printf "%.2f", $plat;  print '">
    <input type="hidden" name="longitude"  value="';
#     printf "%.2f", abs($plon);  print '">		# 2009.07.24 DEH
     printf "%.2f", $plon;  print '">
      <input type="hidden" name="comefrom" value="',$comefrom,'">
...
#        }
     if ($units eq 'm') {
      print '
        <th bgcolor=85D2f2>Month</th>
        <th bgcolor=85D2f2 colspan=2>Maximum<br>Temperature<br>Mean<br>(<sup>o</sup>C)</th>
        <th bgcolor=85D2f2 colspan=2>Minimum<br>Temperature<br>Mean<br>(<sup>o</sup>C)</th>
        <th bgcolor=85D2c2 colspan=3>Precipitation<br>Mean<br>(mm)</th>
        <th bgcolor=gold colspan=2>Precipitation<br>Std. Dev.<br><br>
         <a href="/fswepp/docs/precip_sd_doc.html" target="docs">
          <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
         </a>
        </th>
        <th bgcolor=85D2D2 colspan=2>Wet Days<br><br><br>(days)
         <a href="/fswepp/docs/precip_sd_doc.html" target="docs">
          <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
         </a>
        </th>
        <th bgcolor=gold>Prob. wet<br>given wet<br><br>P(W:W)
         <a href="/fswepp/docs/pww_doc.html" target="docs">
          <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
         </a>
        </th>
        <th bgcolor=gold>Prob. dry<br>given wet<br><br>P(W:D)
         <a href="/fswepp/docs/pwd_doc.html" target="docs">
          <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
         </a>
        </th>
       </tr>
';
       ...
       print '
        <th bgcolor=85D2f2>Month</th>
        <th bgcolor=85D2f2 colspan=2>Maximum<br>Temperature<br>Mean<br>(<sup>o</sup>F)</th>
        <th bgcolor=85D2f2 colspan=2>Minimum<br>Temperature<br>Mean<br>(<sup>o</sup>F)</th>
        <th bgcolor=85D2c2 colspan=3>Precipitation<br>Mean<br>(in)</th>
        <th bgcolor=gold colspan=2>Precipitation<br>Std. Dev.<br><br>
         <a href="/fswepp/docs/precip_sd_doc.html" target="docs">
          <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
         </a>
        </th>
        <th bgcolor=85D2d2 colspan=2>Wet days<br><br>(days)<br>
         <a href="/fswepp/docs/wet_days_doc.html" target="docs">
          <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
         </a>
        </th>
        <th bgcolor=gold>Prob<br>P(W:W)<br><br>
         <a href="/fswepp/docs/pww_doc.html" target="docs">
          <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
         </a>
        </th>
        <th bgcolor=gold>Prob<br>P(W:D)<br><br>
         <a href="/fswepp/docs/pwd_doc.html" target="docs">
          <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
         </a>
        </th>
...
';
      ...
      <tr>
       <th></th>
       <th><font size=-1>base</th><th bgcolor=orange><font size=-1>new</th>
       <th><font size=-1>base</th><th bgcolor=orange><font size=-1>new</th>
       <th><font size=-1>base</th><th bgcolor=orange><font size=-1>new</th><th><a href="javascript:transfer_prism_pcp()">&lt;</a>&nbsp;<font size=-1>PRISM</th>
       <th><font size=-1>base</th><th><font size=-1>new</th>
       <th><font size=-1>base</th><th bgcolor=orange><font size=-1>new</th>
       <th></th><th></th>
      </tr>
';
for $i (0..11) {print '
      <tr>
       <th bgcolor=85D2f2>',$month_name[$i],'</th>
       <td align=right> ',$tmax[$i],'</td>
       <td align=right bgcolor=orange><input type=text name="tx',$i+1,'" size=8 value="',$tmax[$i],'" onChange="mod_tmp(document.mods.tx',$i+1,')"></td>
       <td align=right> ',$tmin[$i],'</td>
       <td align=right bgcolor=orange><input type=text name="tn',$i+1,'" size=8 value="',$tmin[$i],'" onChange="mod_tmp(document.mods.tn',$i+1,')"></td>
       <td align=right> ',$mean_p[$i],'</td>
       <td align=right bgcolor=orange><input type=text name="pc',$i+1,'" size=8 value="',$ppcp[$i],'" onChange="mod_pc(document.mods.pc',$i+1,',',$i+1,')"></td>
       <td align=right><input type=text name="pcpr',$i+1,'" size=8 value="',$ppcp[$i],'" disabled></td>
       <td align=right> ',$sd_p_if[$i+3],'</td>
       <td align=right><input type=text name="pcsd',$i+1,'" size=8 value="',@sd_p_if[$i+$sd_p_base],'" disabled></td>
       <td align=right> ',$num_wet[$i],'</td>
       <td align=right bgcolor=orange><input type=text name="nw',$i+1,'" size=8 value="',$num_wet[$i],'" onChange="mod_nw(',$i+1,')"></td>
       <td align=right><input type=text name="pww',$i+1,'" size=8 value="',$pww[$i],' "disabled></td>
       <td align=right><input type=text name="pwd',$i+1,'" size=8 value="',$pwd[$i],' "disabled></td>
      </tr>
'
}
     print '
      <tr>
       <th bgcolor=85D2f2>Annual</td>
       <td align=right><br></td>
       <td align=right><br></td>
       <td align=right><br></td>
       <td align=right><br></td>
       <td align=right> ',$annual_precip,'</td>
       <td align=right bgcolor=orange><input type=text name="pc" size=8 value="',$ppcp,'" onChange="distribute_pcp()"></td>
       <td align=right><br></td>
       <td align=right><br></td>
       <td align=right><br></td>
       <td align=right> ',$annual_wet_days,'</td>
       <td align=right bgcolor=orange><input type=text name="nw" size=8 value="',$annual_wet_days,'" onChange="distribute_wet()"></td>
       <td align=right><br></td>
       <td align=right><br></td>
      </tr>
      <tr>
       <th colspan=2 align=right><font size=-2>Change column &nbsp;&gt;&nbsp;&gt;</fonot></th>
       <th align=right bgcolor=orange>+/-<input type=text size=4 name="txd" value="0" onChange="txdeg()"><sup>o</sup></th>
       <th></th>
       <th align=right bgcolor=orange>+/-<input type=text size=4 name="tnd" value="0" onChange="tndeg()"><sup>o</sup></th>
       <th></th>
       <th align=right bgcolor=orange>+/-<input type=text size=4 name="pcp" value="0" onChange="pcpct()">%</th>
       <th><img src="/fswepp/images/go.gif"></th>
       <th></th>
       <th></th>
       <th></th>
       <th align=right bgcolor=orange>+/-<input type=text size=4 name="nwp" value="0" onChange="nwpct()">%</th>
       <th colspan=2 align=left><font size=-2>&lt;&nbsp;&lt;&nbsp;0 to reset to base</font></th>
      </tr>
     </table>

     <br>
      <input type=checkbox name=lapse onClick="lapsetemp()"><font size=-1> Adjust temperature for elevation by lapse rate</font>
      <input type=submit value="Use these values"> <input type="submit" value="Retreat">
     <br>
...
#print "State: $state   CL: $CL  Units: $units  Comefrom: $comefrom";
  ...
  if ($state eq "personal") {
    if ($action eq "-server") {
         print '
   <form name="modback" method="post" action="../rc/rockclim.pl">
   ...
   <form name="modback" method="post" action="../rc/showpersonal.pl">
    ...
    print '
   <form name="modback" method="post" action="../rc/showclimates.pl">
    <INPUT name=units type=hidden value="',$units,'">
    <INPUT name=comefrom type=hidden value="',$comefrom,'">
    <INPUT name=state type=hidden value="',$state,'">
    <INPUT name=action type=hidden value="',$action,'">
