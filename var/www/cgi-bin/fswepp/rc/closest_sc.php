...
?>
   <table bgcolor="lightgreen">
    <tr>
     <td>
      <form name="mylatlon" action="closest_sc.php">
       <center>
...
';
      for ($j = 0; $j < $howmany; $j++) {
        ...
        if ($j == 0) echo '      <OPTION VALUE="'.$CL.'" selected>'.$stat[$j]." ($distance $units2)</option>\n";
        if ($j > 0)  echo '      <OPTION VALUE="'.$CL.'">'.$stat[$j]." ($distance $units2)</option>\n";
      }
