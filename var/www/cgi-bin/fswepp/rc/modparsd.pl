...
#     print $longhemisphere;
   ...
   <td width=45%>
    <center>
     ...
     <H3>Customized climate parameters
      <a href="/fswepp/docs/modpardoc.html" target="docs"><img src="/fswepp/images/quest.gif" width="14" height="12" border="0"></a>
      <input type=text name=newname size=30 MAXLENGTH=30 value="';
$climate_name =~ s/^\s*(.*?)\s*$/$1/;		# trim whitespace 2001/04/11 DEH
print $climate_name;
print '" onChange=TransferName()></H3>
     <b>Latitude: <input type=text name=platitude size=7 value=';			# 2009.07.22 DEH
#    printf "%.2f", abs($plat);     print ' onChange="updateLL()"> <sup>o</sup>';	# 2009.07.22 DEH
     printf "%.2f", $plat;     print ' onChange="updateLL()"> <b><sup>o</sup>';		# 2009.07.22 DEH
#     print $lathemisphere;								# 2009.07.22 DEH
     print '
     longitude: <input type=text name=plongitude size=7 value=';			# 2009.07.22 DEH
#    printf "%.2f", abs($plon);     print ' onChange="updateLL()"> <sup>o</sup>';	# 2009.07.22 DEH
     printf "%.2f", $plon;     print ' onChange="updateLL()"> <b><sup>o</sup>';		# 2009.07.22 DEH
#    printf "%.2f", $plon;     print ' onChange="updateLL()"> <b><sup>o</sup>';
#    print $longhemisphere;								# 2009.07.22 DEH
     print '</b>
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
print '
 ...
 <br>
   ...
   <input type=text name="newname" value="',$climate_name,'">
</tr>
</table>
<p>
    <input type="text" name="units" value="',$units,'">
    <input type="text" name="climateFile" value="',$climateFile,'">
...
#     printf "%.2f", abs($plon);  print '">		# 2009.07.24 DEH
    ...
    <input type="text" name="comefrom" value="',$comefrom,'">
    <input type="text" name="lathemisphere" value="',$lathemisphere,'">
    <input type="text" name="longhemisphere" value="',$longhemisphere,'">
...
<tr>';
     if ($units eq 'm') {
      print '
        ...
        <th bgcolor=85D2f2 colspan=2>Mean<br>Maximum<br>Temperature<br>(<sup>o</sup>C)</th>
        <th bgcolor=85D2f2 colspan=2>Mean<br>Minimum<br>Temperature<br>(<sup>o</sup>C)</th>
        <th bgcolor=85D2c2 colspan=2>';
        if ($prism eq "") {
            print 'Mean';
        }
        else {
      ...
      print '<br>Precipitation<br><br>(mm)</th>
        <th bgcolor=gold>Standard<br>Deviation<br>Precipitation</th>
        <th bgcolor=85D2D2 colspan=2>Wet Days<br><br><br>(days)</th>
...
';
       ...
       print '
        <th bgcolor=85D2f2>Month</th>
        <th bgcolor=85D2f2 colspan=2>Mean<br>Maximum<br>Temperature<br>(<sup>o</sup>F)</th>
        <th bgcolor=85D2f2 colspan=2>Mean<br>Minimum<br>Temperature<br>(<sup>o</sup>F)</th>
        <th bgcolor=85D2c2 colspan=2>';
        if ($prism eq "") {
            print 'Mean';
        }
      ...
      print '<br>Precipitation<br>(in)</th>
        <th bgcolor=gold>SD<br>Precip</th>
        <th bgcolor=85D2d2 colspan=2 >Number<br>of wet days</th>
        <th bgcolor=gold>P(W:W)</th>
        <th bgcolor=gold>P(W:D)</th>
      </tr>
';
      }
for $i (0..11) {print '
   <tr>
    ...
    <td align=right><input type=text name="tx',$i+1,'" size=8 value="',$tmax[$i],'" onChange="mod_tmp(document.mods.tx',$i+1,')"></td>
    <td align=right> ',$tmin[$i],'</td>
    <td align=right><input type=text name="tn',$i+1,'" size=8 value="',$tmin[$i],'" onChange="mod_tmp(document.mods.tn',$i+1,')"></td>
    <td align=right> ',$mean_p[$i],'</td>
    <td align=right><input type=text name="pc',$i+1,'" size=8 value="',$ppcp[$i],'" onChange="mod_pc(document.mods.pc',$i+1,',',$i+1,')"></td>
    <td align=right> ',$sd_p_if[$i+3],'<input type=text name="pcsd',$i+1,'" size=8 value="',@sd_p_if[$i+$sd_p_base],'" disabled></td>                                <!-- zzzzzzzzzzzzzzzzzz -->
    <td align=right> ',$num_wet[$i],'</td>
    <td align=right><input type=text name="nw',$i+1,'" size=8 value="',$num_wet[$i],'" onChange="mod_nw(',$i+1,')"></td>
...
'
   ...
   <tr>
    ...
    <td align=right><br></td>
    <td align=right><br></td>
    <td align=right><input type=text name="pc" size=8 value="',$ppcp,'" onChange="distribute_pcp()"></td>
    <td align=right><br></td>
    <td align=right><input type=text name="nw" size=8 value="',$annual_wet_days,'" onChange="distribute_wet()"></td>
   </tr>
   <tr>
    <th colspan=5 align=right>Change entire column (enter 0 to reset) &nbsp;&gt;&nbsp;&gt;</th>
    <th align=right>+/-<input type=text size=4 name="txd" value="0" onChange="txdeg()"><sup>o</sup></th>
    <th align=right>+/-<input type=text size=4 name="tnd" value="0" onChange="tndeg()"><sup>o</sup></th>
    <th align=right>+/-',$prism,'<input type=text size=4 name="pcp" value="0" onChange="pcpct()">%</th>
    <th align=right></th>
    <th align=right>+/-<input type=text size=4 name="nwp" value="0" onChange="nwpct()">%</th>
   </tr>
  </table>
 </form>
