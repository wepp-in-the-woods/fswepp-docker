...
# 2010.05.25 DEH chomp $old_sttion_no (would print blank line 2 for SNOTEL stations)
...
# 05/16/2000 DEH changed letter a..e to v..z
...
#print "I came from: $comefrom\n";
    ...
    else {if ($platform eq 'pc') {exec "perl ../rc/rockclim.pl -server -u$units $comefrom"}
