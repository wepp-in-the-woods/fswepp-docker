...
print '
   ...
   <table border=0>
    <tr>
     <td align=center valign=top bgcolor=lightgreen>
...
print <<'theEnd';
      ...
      <br><br>
      <input type="submit" value="Show Climates"> 
theEnd
print '
     ...
     <td valign=top align=center bgcolor=lightgreen>
      <h3>...find the closest stations</h3>
      <p>
       <form ACTION="/cgi-bin/fswepp/rc/closest.php" method="post">
        <table border=0>
         <tr><td>Latitude</td>  <td><input type="text" name="latitude" size=8>  (pos: N)</td></tr>
         <tr><td>Longitude</td> <td><input type="text" name="longitude" size=8> (pos: E)</td></tr>
         <tr><td></td><td><input type="hidden" name="units" value="',$units,'"></td>  </tr>
         <tr height=70><td></td><td valign=bottom><input type="submit" value="Find closest"></td></tr>
        </table>
       </form>
      </p>
     </td>
    ...
    <tr>
     <td>
      <font face="Arial, Geneva, Helvetica" size=-2>
       Rock:Clime (rockclim_ll.pl) version ', $version,'<br>
