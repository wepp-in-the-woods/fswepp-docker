...
#  $climlog = 'working/_2014/lastclimate.txt';
#  $climlog = 'working/_2015/lastclimate.txt';
   $climlog = 'working/_2017/lastclimate.txt';
   if (-e $climlog) {
     $days_old = -M $climlog;
...
if ($time eq ' minutes' && $long_ago < 1) {$bgcolor='#FAAFBE'};
 ...
 <body>
  <font face='trebuchet, tahoma, arial, sans serif' size=2>
   <table border=1 width = 320 bgcolor='$bgcolor'>
    <tr>
     <td align=center>
      Last FS WEPP run<br>
