...
print <<'theEnd';
  ...
  <B>Years to simulate:</B> <input type="text" size="3" name="years" value="30"
        ...
        onBlur="blankStatus()"> (this may take several minutes)
<!--<b><input type="checkbox" name="Full" value=1
onFocus="showExtendedHelp()" onBlur="blankStatus()">
   Extended output</b>-->
<BR>
  <font color=red size=-1>Note: now running WEPP 2010.100.
   If you need continuity: WEPP:Road 2000 [ <a href="/cgi-bin/fswepp/wr/wepproadv2000?units=m">metric</a> 
                                            <a href="/cgi-bin/fswepp/wr/weppraodv2000">| English</a> ]</font>
  <br>
