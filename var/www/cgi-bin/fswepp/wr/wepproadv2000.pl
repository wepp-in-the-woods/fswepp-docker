...
print "  <br clear=all>\n";
print '  <FORM name="wepproad" method=post onSubmit="return validate()" ACTION="http://',$wepphost,'/cgi-bin/fswepp/wr/wr.pl">';
print "\n";
...
print <<'theEnd';
  ...
  <B>Years to simulate:</B> <input type="text" size="3" name="years" value="30"
        ...
        onBlur="blankStatus()"> (this may take several minutes)<br>
...
print '  <input type="hidden" name="climate_name">
...
print '  </FORM>
  ...
  <hr>
   <font size=1>
    WEPP:Road, a component of FS WEPP, predicts erosion from insloped or outsloped forest roads.
    <br><br>
    <b>Citation:</b><br>
    Elliot, William J.; Foltz, Randy B.; Hall, David E. 2000. <b>WEPP:Road</b> Ver. ',$version, '.
   ...
   <tr>
    <td>
     <font face="Arial, Geneva, Helvetica" size=-2>
      ...
      <b>$runs</b> WEPP:Road runs since Jan 1, 2011
   <!--
         8,101 runs in 2009
         8,563 runs in 2008
         9,033 runs in 2007
