...
#  2011.04.12 DEH CRLF of results file also broke sediment delivery parse -- fixed (needed a "chomp" for $syp)
#  2011.04.12 DEH Fixed another break in 2011, CRLF effect of results file broke Javascript of display of files
#  2011.03.29 DEH Oops, I broke it Friday with the 2000/2010 option. Fixed.
#  2011.03.25 DEH Select WEPP2000 or WEPP2010 added (altho calling screen not modified to specify)
#  2009.10.13 DEH Change display of vegetation file to allow full file display (had been truncated for brevity)
#  2009.02.23 DEH Add WEPP version option
#! 2008.06.04 DEH Record Lat/Long to wr.log
#  2006.09.18 DEH Reformat INPUT report, change 'extended' to 'WEPP results', paint results table, move calculated %rock
#                 Remove 'you must be connected to the Internet, shall I try?' message on comment link
#  2006.09.14 DEH Report user climate parameters
#  2006.02.23 DEH Print $unique in output and in title of each file listing popup; unlink $newSoilFile
#! 2005.07.14 DEH Write climate name to working/lastclimate.txt
#  26 Jan 2004 DEH reduce Ki to 25% for low- and no-traffic
#  24 Dec 2003 DEH move wrdev to wr and change internal pointers
#  19 Dec 2003 DEH print ill-timed error messages at appropriate moment
#  18 Nov 2003 DEH remove "mailto:" links (link to personnel pages)
#  14 Nov 2003 DEH logstuff.pl to logstuffwr.pl
#                  wrd to wrdev *
#                  fixed more type styles
...
#
#  usage: wepproad.pl (called from web HTML form)
#  parameters:
...
# ======================  CUSTOM CLIMATE  ======================
   ...
   if (lc($action) =~ /custom/) {
     $wepproad = "http://" . $wepphost . "/cgi-bin/fswepp/wr/wepproad.pl";
     if ($platform eq "pc") {
...
# ======================  DESCRIBE SOIL  ======================
   ...
   if ($achtung =~ /Describe Soil/) {
     ...
     if    ($slope eq 'inveg')    {$tauC = '10'}  # tauC is critical shear (N/M^2)
...
#sda     if    ($platform eq "pc")    {$soilPath = 'data\\'}
#sda     else                         {$soilPath = 'data/'}
   if ($platform eq "pc") {
...
#   $unique='wepp' . time . '-' . $$;
     ...
     print "<HTML>\n";
     print "<HEAD>\n";
     print "<TITLE>WEPP:Road -- Soil Parameters</TITLE>\n";
     print "</HEAD>\n";
     print '<BODY background="http://',$wepphost,
          '/fswepp/images/note.gif" link="#1603F3" vlink="#160A8C">
     <font face="Arial, Geneva, Helvetica">
';
     print "<center><h1>WEPP:Road Soil Parameters</h1></center>\n";
     print "<blockquote>\n";
#    &printdate;
...
popupwindow.document.writeln('  <title>WEPP:Road Results Screen version history</title>')
popupwindow.document.writeln(' </head>')
...
popupwindow.document.writeln('    <h1>WEPP:Road Results Version History</h1>')
...
popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th bgcolor="85d2d2" valign="top">2009.10.13</th>')
popupwindow.document.writeln('     <td>Change vegetation file link to allow full file display (had been truncated for brevity).</td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th bgcolor="85d2d2" valign="top">2009.02.23</th>')
popupwindow.document.writeln('     <td>Check user request for WEPP version.</td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th bgcolor="85d2d2" valign="top">2004.01.26</th>')
popupwindow.document.writeln('     <td>Reduce baseline interrill erodibility (k<sub>i</sub>) for low- and no-traffic conditions.</td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th bgcolor="85d2d2" valign="top">2003.12.19</th>')
popupwindow.document.writeln('     <td>Print almost proper error page for users who skate by the input checks.<br>')
popupwindow.document.writeln('         (History popup inactive on error report page)</td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th bgcolor="85d2d2" valign="top">2003.11.14</th>')
popupwindow.document.writeln('     <td>Adjust critical shear values for some soil files<br>')
popupwindow.document.writeln('         Report traffic level and rock content inputs<br>')
popupwindow.document.writeln('         Report derived rock content for road, fill, and buffer<br>')
popupwindow.document.writeln('         Add link to display WEPP slope input file<br>')
popupwindow.document.writeln('         Add link to display WEPP soil input file<br>')
popupwindow.document.writeln('         Add link to display part of WEPP vegetation (management) input file<br>')
popupwindow.document.writeln('         Add link to display WEPP weather station (climate) parameter file<br>')
popupwindow.document.writeln('         Add link to display WEPP extended output file<br>')
popupwindow.document.writeln('         Add link to display WEPP response file<br>')
popupwindow.document.writeln('         Change results version history to pop-up window<br>')
popupwindow.document.writeln('         Clean up type faces</td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th bgcolor="85d2d2">2002.11.14</th>')
popupwindow.document.writeln('     <td>proxy/NAT workaround (HTTP_X_FORWARDED_FOR)</td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th valign=top bgcolor=85d2d2>2000.10.13')
popupwindow.document.writeln('     <td>Display WEPP error file if unsuccessful run.<br>')
popupwindow.document.writeln('         Adjust alignment for snowmelt table<br>')
popupwindow.document.writeln('         Make unit-conversion consistent with other server (change signif. digits for precipitation and runoff)</td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th valign=top bgcolor=85d2d2>2000.08.21</th>')
popupwindow.document.writeln('     <td>Add pavement capability<br>')
popupwindow.document.writeln('         Correct "outrut" and "outunrut" file names</td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th valign=top bgcolor=85d2d2>2000.05.05</th>')
...
print '
 ...
 <BODY background="http://',$wepphost,
          '/fswepp/images/note.gif" link="green" vlink="#160A8C">
   <font face="Arial, Geneva, Helvetica">
   <blockquote>
   <CENTER>
   <font face="Arial, Geneva, Helvetica">
   ...
   <td align=center>
    ...
    <td>
       <a href="http://',$wepphost,'/fswepp/docs/wroadimg.html#wrout" target="_docs">
...
#    | <a href="javascript:void(showvegfile())">vegetation</a>
   ...
   ';                                                                      
     print '<font color="red">', $error_message, "</font><br>\n";  # DEH 12/19/2003
     print '   </CENTER>';
   }
...
<a href="javascript:popuphistory()">',
     ...
     by 
     <a HREF="http://forest.moscowfsl.wsu.edu/people/engr/dehall.html" target="o">Hall</A> and
     Anderson;
     Project leader 
     <a HREF="http://forest.moscowfsl.wsu.edu/people/engr/welliot.html" target="o">Bill Elliot</a><BR>
...
#    $thisdayoff=$thisday+3;				# [Jan 1] -1: Sunday; 0: Monday # +3: 2009
     $thisdayoff=$thisday+4;				# [Jan 1] -1: Sunday; 0: Monday # +3: 2009
     $thisweek = 1+ int $thisdayoff/7;
     $ditlogfile = '>>../working/wr/' . $thisweek;	# modify this
...
#        $srof = sprintf "%.0f", $sro;
         ...
         print "<table cellspacing=8 bgcolor='#ccffff'>
   <tr>
...
";
         ...
         print '
     <font face="Arial, Geneva, Helvetica">
   <form name="wrlog" method="post" action="http://',$wepphost,'/cgi-bin/fswepp/wr/logstuffwr.pl">
