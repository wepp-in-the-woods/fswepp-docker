...
#  2009.02.12 DEH Change WEPP call to wepp08 (for WEPP Model Version 2008.907  (September 2008))
#                 Potential: check for radio button 2000 or 2008 WEPP
...
#      $sterFile = 'working' . $unique . ".ste";
       if ($platform eq "pc") {
         @args = ("..\\wepp08 <$responseFile >$stoutFile"); 
       }
       else {
         @args = ("nice -20 ../wepp08 <$responseFile >$stoutFile 2>$sterFile");
       }
       system @args;
...
<a href="javascript:popuphistory()">',
     ...
     <a HREF="http://forest.moscowfsl.wsu.edu/people/engr/danderson.html" target="o">Anderson</A>;
     Project leader 
