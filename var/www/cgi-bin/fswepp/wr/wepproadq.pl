...
//      alert('show_help')
para = 'The biggest changes from WEPP version 2000 to 2010 are in the winter routines,'
para = para +' where generally winter runoff rates are higher, depending on climate, and in'
para = para +' the lateral flow in the forest buffer, which will have a tendency to increase'
para = para +' lateral flow on steeper slopes, decreasing surface runoff.'
para = para +' The net effect of these two major changes varies with climate and topography.'
...
popupwindow.document.writeln('  <title>WEPP:Road Input Screen version history</title>')
popupwindow.document.writeln(' </head>')
...
popupwindow.document.writeln('   <h3>WEPP:Road Input Screen Version History</h3>')
...
popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th valign="top" bgcolor="85d2d2">2005.08.15</th>')
popupwindow.document.writeln('     <td>Add metadata to generated HTML page</td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th valign="top" bgcolor="85d2d2">2003.11.14</th>')
popupwindow.document.writeln('     <td>Add rock content field to log file; add traffic level to surface field<br>')
popupwindow.document.writeln('         Remove "extended output" option (now always available)<br>')
popupwindow.document.writeln('         Remove "paved" warning<br>')
popupwindow.document.writeln('         Add "road surface" popup help<br>')
popupwindow.document.writeln('         Add traffic level radio buttons for "low" and "no" traffic<br>')
popupwindow.document.writeln('         Add "rock content" input (was 20% for buffer before)<br>')
popupwindow.document.writeln('         Display user IP for diagnostic purposes (enhanced)<br>')
popupwindow.document.writeln('         Display counter for number of runs<br>')
popupwindow.document.writeln('         Move history report to popup window<br>')
popupwindow.document.writeln('         Clean up type faces')
popupwindow.document.writeln('     </td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th valign="top" bgcolor="85d2d2">2002.11.04</th>')
popupwindow.document.writeln('     <td>Report user IP address</td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th valign=top bgcolor=85d2d2>2001.03.05</th>')
popupwindow.document.writeln('     <td>Adjust climate display for multiple users on browser')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th valign=top bgcolor=85d2d2>2001.01.04</th>')
popupwindow.document.writeln('     <td>If no units specified (bookmarked), use \'ft\'</td>')
popupwindow.document.writeln('    </tr>')

popupwindow.document.writeln('    <tr>')
popupwindow.document.writeln('     <th valign=top bgcolor=85d2d2>2000.09.21</th>')
popupwindow.document.writeln('     <td>Add paved surface button<br>')
popupwindow.document.writeln('         Add capability to read \"public\" ("!") climates</td>')
popupwindow.document.writeln('    </tr>')
...
print '    <TH bgcolor=#85D2D2><a href="JavaScript:popupwidth()">';
...
print '    
   <tr>
    ...
    <TH bgcolor="#85D2D2"><font face="Arial, Geneva, Helvetica">Road</font></th>
   ...
   <TR>
    <TH bgcolor="#85D2D2"><font face="Arial, Geneva, Helvetica">Fill</font></th>
...
print '
  <font color=red size=-2>
   <span class="thhelpoff"
        onmouseover="className=\'thhelpon\'" onClick="JavaScript:show_help(\'\')">For continuity: <a href="/cgi-bin/fswepp/wr/wepproadv2000.pl?units=',$units,'">WEPP:Road 2000</a>
   </span> 
  </font>
  <br>
