...
#  wepproad.pl -- input screen for WEPP:Road
  ...
  $version = '2012.10.26';	# Clean up HTML code
 ...
 <BODY bgcolor="white" link="#555555" vlink="#555555">
  <font face="Arial, Geneva, Helvetica">
   <table width="100%" border=0>
    <tr>
     <td>
      <a href="http://',$wepphost,'/fswepp/"><img src="http://',$wepphost,'/fswepp/images/fsweppic2.jpg"
       width=65 height=65
     ...
     <td>
      <a href="/fswepp/docs/wroadimg.html" target="docs"><img src="http://',$wepphost,'/fswepp/images/ipage.gif"
 ...
 -->
   ...
   <TABLE BORDER="1">
    <tr>
     <th bgcolor="#85D2D2">
      <font face="Arial, Geneva, Helvetica">
       <a href="JavaScript:popupdesign()">Road Design</a>
      </font>
     </th>
...
print '     <th bgcolor=#85D2D2><font face="Arial, Geneva, Helvetica"><a href="JavaScript:popupwidth()">Width</a>';
print "      <br> ($units)</font></th>\n";
print '
    </tr>
    <tr>
     <td rowspan=4>
...
-->
    ...
    <tr><th bgcolor="#85D2D2">Buffer</th>
...
print '
  <font color=red size=-2>
   For continuity: <a href="/cgi-bin/fswepp/wr/wepproadv2000.pl?units=',$units,'">WEPP:Road 2000</a> 
  </font>
  <br>
...
print '<img src="/fswepp/images/epaemail.gif" align="right" border=0></a>
    </td>
   </tr>
  </table>
 </BODY>
