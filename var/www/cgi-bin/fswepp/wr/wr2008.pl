...
#      $sterFile = 'working' . $unique . ".ste";
       if ($platform eq "pc") {
         ...
         if ($weppversion eq '2000') {@args = ("nice -20 ../wepp2000 <$responseFile >$stoutFile 2>$sterFile")};  # DEH 2009.02.23
...
#6029   unlink $responseFile;
#6029   unlink $outputFile;
#6029   unlink $stoutFile;
#6029   unlink $sterFile;
#6029   unlink $slopeFile;
#6029   unlink $newSoilFile;			# 2006.02.23 DEH
