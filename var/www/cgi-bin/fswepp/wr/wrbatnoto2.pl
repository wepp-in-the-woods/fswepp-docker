...
#######################   check continue
     ...
     print "
     <FORM name=\"wrbat\" method=post ACTION=\"/cgi-bin/fswepp/wr/wrbatnoto2.pl\">
...
print"
<br><font size=-2>Following updated every 10 minutes</font><br>
    <iframe src='/cgi-bin/fswepp/wr/wrbatchcheck.pl?ip=$user_ID&count=$count' frameborder=1 width=630 height=88>
    </iframe>
 </body>
</html>
";
