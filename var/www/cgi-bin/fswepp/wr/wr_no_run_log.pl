...
#         if ($weppversion eq '2008') {@args = ("nice -20 ../wepp2008 <$responseFile >$stoutFile 2>$sterFile")};  # DEH 2009.02.23
#         if ($weppversion eq '2000')
 {@args = ("nice -20 ../wepp2000 <$responseFile >$stoutFile 2>$sterFile")};  # DEH 2009.02.23
...
#       print WRLOG $climate_name,"\n";                 # 2008.06.04 DEH
     ...
     open CLIMLOG, '>../working/lastclimate.txt';	# 2005.07.14 DEH
       flock CLIMLOG,2;
       print CLIMLOG 'WEPP:Road: ', $climate_name;
     close CLIMLOG;
