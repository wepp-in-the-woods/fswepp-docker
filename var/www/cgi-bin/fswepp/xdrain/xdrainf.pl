...
print '
  <HTML>
  <HEAD>
  <TITLE>X-DRAIN Cross-Drain Spacing -- Sediment Yield Program
  </TITLE>
  </HEAD>
  ...
  <table width="100%">
    ...
    <td align=center>
       ...
       <H2>X-Drain<br>Cross-Drain Spacing -- Sediment Yield Program</H2>
       <img src="http://',$wepphost,'/fswepp/images/line.gif" alt="= birds on a wire =">
    <td>
    ...
    <FORM method=post ACTION="http://',$wepphost,'/cgi-bin/fswepp/xdrain/xdrainm.pl">
       ...
       <B><a href="http://',$wepphost,'/fswepp/xdrain/climates.html"';
print <<'theEnd';
...
print '</B>
       ...
       <B><a href="http://',$wepphost,'/fswepp/xdrain/soils.html"',"\n";
print <<'theEnd';
       onMouseOver="status='Click to display soil type details'; return true;"
       onMouseOut="status=''; return true;">Soil Type</A></B>
theEnd
print <<'theEnd';
       </TD>
       <TD align="center" bgcolor="85D2D2">
...
';
    ...
    print '<select name="Climate" size="5">',"\n"; 
