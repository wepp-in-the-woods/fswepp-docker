...
#  2004.06.23  DEH split from old weppdist.pl on "forest"
#			remove veg calibration
...
popupwindow.focus()
  ...
  function checkeverything() {
    if (checkYears(this.form.climyears)) {
      RunningMsg(this.form.actionw,"Running WEPP...");
...
print '<BODY background="/fswepp/ermit/under_dev.gif"
  ...
  <center>
  <!--FORM name="weppdist" method="post" ACTION="https://',$wepphost,'/cgi-bin/fswepp/wdnew/wd.pl" -->
...
print <<'theEnd';
   ...
   <tr>
    <th rowspan=2 bgcolor="lightblue">
     <font face="Arial, Geneva, Helvetica">
      Upper
     </font>
    </th>
   ...
   <tr>
    ...
    <SELECT NAME="LowSlopeType" SIZE="8" ALIGN="top" onChange="pcover2()";>
     <OPTION VALUE="tree20"> Mature forest
...
print "  $remote_host &ndash; $remote_address ($user_really) personality '<b>$me</b>'<br>
  <b>$runs</b> Disturbed WEPP runs since Jan 1, 2004;
  <b>18,950</b> runs in 2003 (<b>12,176</b> in 2002).
 </body>
</html>
";
