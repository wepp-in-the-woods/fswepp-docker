...
$vegetationSize=$parameters{'stemsize'}+0;
$vegetationDensity=$parameters{'density'}+0;
$fireImpactDepth=$parameters{'brndep'}+0;
$staticFrictionAngle=$parameters{'static'}+0;
$kineticFrictionAngle=$parameters{'kinetic'}+0;
$bulkDensity=$parameters{'bulk'}+0;
