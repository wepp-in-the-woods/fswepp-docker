...
#  BIOSE -- Biolmass utilization Impats on Soil Erosion
#
#  based on
#  Fuel Management Erosion (FuME) Analysis input screen
#
#  biose.pl -- input screen for BIOSE
#  Hakjun Rhee and David Hall, USDA FS RMRS Moscow Forestry Siences Lab & ...

## BEGIN HISTORY ###################################
## WEPP BIOSE Input version history

   $version='2013.03.01';	# Modification of 2009.09.17 FuMe
...
<html>
 <head>
  <title>WEPP BIOSE: Biomass Utilization Impacts On Soil Erosion</title>
...
para = para +'</font>'
             ...
             para = '      <h3>FS WEPP FuME topography</h3>'
      ...
      para = para + '    <br>'
      para = para + '    Cross section of a generic FuME hillslope'
      para = para + '   </center>'
    }
      ...
      para = para + '   and the planned period between thinning treatments.'
      para = para + '   <br><br>'
      ...
      para = para + '   <br><br>'
      para = para + '   <b>Thinning cycles</b> vary from 10 to 80 years.'
    }
...
//    document.forms.weppdiro.submit.value="Describe"
  ...
  function explain_soil_texture () {
    ...
    if (newWin != null) {
      ...
      newin.document.writeln('   <a href="https://topsoil.nserl.purdue.edu/nserlweb/weppmain/docs/chap7.pdf" target="pdf"><i>Chapter 7. Soil Component.</i></a> <b>In:</b> Flanagan, D. C. and M. A. Nearing (eds.)')
  ...
  <font face="tahoma, arial, helvetica, sans serif">
   <table width=100% border=0>
    <tr>
     ...
     <td align=center>
       <hr>
       <h3>WEPP <font color="#006009">BIOSE</font><br>
           <font color="#006009">B</font>iomass Utilization
           <font color="#006009">I</font>mpacts
           <font color="#006009">O</font>n
           <font color="#006009">S</font>oil
           <font color="#006009">E</font>rosion</h3>
       <hr>
    <td>
       <A HREF="/fswepp/docs/fume/WEPP_BIOSE.pdf" target="docs">
...
<br>
  ...
  <form name="fume" method="post" ACTION="https://',$wepphost,'/cgi-bin/fswepp/fume/fume2.pl">
     ...
     <td align="center" bgcolor="lightblue">
      ...
      <tr>
       <td align=center>
        ...
        <input type="hidden" name="achtung" value="Run BIOSE">
  ...
  <tr>
   ...
   <table border=1 cellpadding=4>
    ...
    <tr>
     ...
     <th bgcolor="lightblue" title="Number of years between thinnings">
      <font face="tahoma, arial, helvetica, sans serif">
        Thinning
       <br>
...
-->
     ...
     <p>
      <input type="SUBMIT" name="actionw" VALUE="Run BIOSE"
       onClick=\'RunningMsg(this.form.actionw,"Running BIOSE..."); this.form.achtung.value="Run WEPP FuME"\'>
      <br>
     </p>
    </center>
   </form>
