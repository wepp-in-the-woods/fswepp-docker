...
# WEPP FuME Results history
   ...
   $version = '2015.05.27';	# Delete working files at end of run
#  $version = '2014.05.06';	# update Disturbed WEPP soil parameter values
#  $version = '2014.04.09';	# switch to WEPP 2010.100
#  $version = '2013.03.04';	# minor clean-up
...
#  $version = '2006.04.13';	# Modify management Apr 13 2006 high.ys, low.ys, short.ys, shrub.ys, skid.ys, tall.ys, tree20.ys, tree5.ys
...
#     else {$working = 'c:\\Inetpub\\Scripts\\fswepp\\working'} #elena
     ...
     $sterrFile    = "$working\\fume.err";	# 2014
