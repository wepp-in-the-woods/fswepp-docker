...
# $version = '2004.12.09';	# Record run in log; return count
#				  correct heading for sed yield for Disturbed WEPP table (not per y)
# $version = '2004.12.07';	# Change 'low traffic' and 'high traffic' to '...access'
#				  Fix Thinning 'In order to...' value in narrative
#				  Fix percentage calculations (some still off?)
# $version = '2004.11.30';	# Set WEPP output variables to null before runn (so no drift-over)
# $version = '2004.11.23';	# Move 'Content-type' to below calls out to Rock:Clime etc.; change font sizes
# $version = '2004.11.19';	# Add a variety of Disturbedd WEPP runs for other conditions
# $version = '2004.10.01';
    ...
    <table width=100% border=0>
     <tr>
      ...
      <td align=center>
       ...
       <hr>
      <td>
       <A HREF="http://',$wepphost,'/fswepp/docs/fume/Draft_Watershed_Chapter.htm" target="docs">
...
#######################  do DISTURBED WEPP runs #########################
   ...
   print TEMP '
   <br>
   <h4>Details of Inputs and Outputs</h4>
   Refer to the <a href="">documentation</a> for details on the applications for the five
...
';
    ...
    [$buf_length] will generate less sediment.
