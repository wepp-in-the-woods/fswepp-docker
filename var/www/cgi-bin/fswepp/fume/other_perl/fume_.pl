...
#  by David Hall and Elena Velasquez
    ...
    $version = '2004.09.24';	# Beta release for Missoula presentation
...
//    document.forms.weppdiro.submit.value="Describe"
  ...
  function explain_soil_texture () {
    ...
    if (newWin != null) {
      ...
      newin.document.writeln('   <h3>Soil Texture</h3>')
...
print <<'theEnd';
   ...
   <table border="2">
    <tr>
     <th bgcolor="#006009">
      <font face="Arial, Geneva, Helvetica" color="#99ff00">
   ...
   <table border=2 cellpadding=4>
    <tr>
     <td colspan=4 bgcolor="#006009">
      <font face="trebuchet, tahoma, arial" color="#99ff00">
       <b>
        Hillslope horizontal length (ft) <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
       </b>
      </font>
     </td>
    </tr>
   ...
   <table border=1 cellpadding=4>
    <tr>
     <td  colspan=4 bgcolor="#006009">
      <font face="trebuchet, tahoma, arial" color="#99ff00">
       <b>
        Hillslope gradient (%) <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
       </b>
      </font>
     </td>
    </tr>
   ...
   <table border=1 cellpadding=4>
    <tr>
     <td  colspan=4 bgcolor="#006009">
      <font face="trebuchet, tahoma, arial" color="#99ff00">
       <b>
        Disturbance frequency (y) <img src="/fswepp/images/quest.gif" width="14" height="12" border="0">
       </b>
      </font>
     </td>
    </tr>
