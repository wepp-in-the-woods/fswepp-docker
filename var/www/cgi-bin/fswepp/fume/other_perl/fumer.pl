...
# 2004.11.02 DEH add helps; move "road density"
# 2004.09.24 DEH change bounds for input checks
# 2004.09.21 DEH Fix return ($fume) from Custom Climate call
# 		  Add work-around for NAT ($user_really)
...
#                 Remove "cleaned logs and climates" note (finally!)
# 2003.01.01 DEH Remove "mailto:" link (welliot)
#                 Fix close of "Host"
#                 Add "cleaned logs and climates" note
...
//       document.fume.hilll.value=0
  ...
  function popuphistory() {
    ...
    popupwindow.document.writeln('  <title>WEPP FuMe Input version history</title>')
    popupwindow.document.writeln(' </head>')
    ...
    popupwindow.document.writeln('   <h3>WEPP FuMe Input Version History</h3>')
...
//    document.forms.weppdiro.submit.value="Describe"
  ...
  function explain_topo() {
    ...
    if (newWin != null) {
      ...
      newin.document.writeln('  </style>')
      newin.document.writeln(' </HEAD>')
      newin.document.writeln(' <body bgcolor="ivory" onLoad="top.window.focus()" link="white" vlink="white" text="#006009">')
      ...
      newin.document.writeln('   <b>Treated hillslope horizontal length</b> is calculated as the difference between these two entered values.')
  ...
  function explain_road_density() {
    ...
    if (newWin != null) {
      ...
      newin.document.writeln('    </td></tr>')
      newin.document.writeln('   </table>')
      newin.document.writeln('   Road density is the number of miles of road per square mile of territory.')
      newin.document.writeln('<!--tool bar begins--><p>')
      newin.document.writeln('  <table bgcolor="#666666" width="20%" border="0" cellspacing="1" cellpadding="5" align="center">')
      newin.document.writeln('   <tr>')
      newin.document.writeln('    <td align="center" bgcolor="#333333"')
  ...
  function explain_frequency() {
    ...
    if (newWin != null) {
      newin.document.writeln('<HTML>')
      newin.document.writeln(' <HEAD>')
      newin.document.writeln('  <title>FS WEPP FuME disturbance frequency</title>')
      newin.document.writeln('  <style>')
      newin.document.writeln('   BODY')
      newin.document.writeln('   {scrollbar-base-color:666666;scrollbar-face-color:#333333;scrollbar-highlight-color:#333333;scrollbar-shadow-color:666666;scrollbar-dark-shadow-color:ffffcc;scrollbar-arrow-color:ff6600}')
      newin.document.writeln('   .question {color:ffffcc}')
      ...
      newin.document.writeln('  <font face="tahoma, arial, helvetica, sans serif">')
      newin.document.writeln('   <table width=100%>')
      newin.document.writeln('    <tr><td bgcolor="lightgoldenrodyellow" align="center">')
      newin.document.writeln('     <font face="tahoma, arial, helvetica, sans serif">')
      newin.document.writeln('      <h3>FS WEPP FuME disturbance frequency</h3>')
      newin.document.writeln('     </font>')
      newin.document.writeln('    </td></tr>')
      newin.document.writeln('   </table>')
      newin.document.writeln('<!--tool bar begins--><p>')
...
function RunningMsg (obj, text) {
    ...
    if (hill_l < buff_l) {document.forms[0].hillslope_length.value=buff_plus_one}
  ...
  <font face="tahoma, arial, helvetica, sans serif">
   <table width=100% border=0>
    <tr>
     <td>
      <a href="/fswepp/">
       <IMG src="/fswepp/images/fsweppic2.jpg" alt="Erosion Analysis"
     ...
     <td align=center>
       ...
       <h3>WEPP <font color="red">FuME</font><br>
           ...
           <font color="red">E</font>rosion Analysis</h3>
       <hr>
    <td>
       <A HREF="http://',$wepphost,'/fuels/">
       <IMG src="http://',$wepphost,'/fswepp/images/firetool.jpg"
...
print <<'theEnd';
     ...
     <td align="center" bgcolor="lightblue">
      ...
      <tr>
       <td align=center>
        <input type="hidden" size="5" name="climyears" value="5">
   ...
   <table border=1 cellpadding=4>
    <tr>
     <td  colspan=4 bgcolor="#006009">
      <font face="tahoma, arial, helvetica, sans serif" color="#99ff00">
       <b>
        Disturbance frequency (y)
          <a href="javascript:explain_frequency()"
             onMouseOver="window.status='Explain disturbance frequency (new window)';return true"
             onMouseOut="window.status='Forest Service WEPP FuMe';return true">
             <img src="/fswepp/images/quest.gif" width="14" height="12" border="0"></a>
       </b>
      </font>
     ...
     <tr>
      <td>
       <font face="tahoma, arial, helvetica, sans serif" size=1>
        FUME input interface v.
        <a href="javascript:popuphistory()"> ',$version,'</a>
        (for review only) by
        David Hall &amp; lena Velasquez<br>
...
print "
  <b>$runs</b> FUME runs since January 1
 </body>
</html>
";
