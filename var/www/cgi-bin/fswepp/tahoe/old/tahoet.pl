...
para = para +'their site to climate effects.  '
      ...
      if (what == 'gradient') {
para='<h3>Gradient</h3>'
para = para + 'The upper and lower elements are broken into two overland flow elements each, each being half the element\'s specified horizontal length.'
para = para + 'The user specifies the gradient or slope angle of each of the four overland flow elements'
      }
...
print '<BODY bgcolor="white"
  ...
  <table width=100% border=0>
    ...
    <td align=center>
       <hr>
       <h3>Tahoe Basin Model <font color=crimson>(* under construction *)</font></h3>
       <hr>
    <td>
...
### display personal climates, if any
    ...
    print "       </SELECT>
      ...
      <a href=\"/fswepp/rc/closest.php?units=$units\" target=\"_close\"><input type=\"button\" value=\"closest\"></a>
";
#################
#
...
print <<'theEnd';
   ...
   <tr>
    ...
    <SELECT NAME="UpSlopeType" SIZE="13" ALIGN="top" onChange="pcover1()";>
     ...
     <OPTION VALUE="Sod">  Good Grass
     <OPTION VALUE="Bunchgrass"> Poor Grass
