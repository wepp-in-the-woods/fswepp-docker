...
print <<'theEnd';
       ...
       <SELECT NAME="SoilType" SIZE="4"
         ...
         <OPTION VALUE="sand" disabled>sandy loam
         <OPTION VALUE="loam" disabled>loam
       </SELECT>
      <tr><td align=center>
...
print <<'theEnd';
   ...
   <tr>
    ...
    <SELECT NAME="UpSlopeType" SIZE="8" ALIGN="top" onChange="pcover1()";>
     <OPTION VALUE="matureforest" selected> Mature forest
     <OPTION VALUE="youngforest"> Thin or young forest
     <OPTION VALUE="shrub"> Shrubs
     <OPTION VALUE="goodgrass">  Good Grass
     <OPTION VALUE="poorgrass"> Poor Grass
     ...
     <OPTION VALUE="mulchtill"> Mulch and till
   ...
   <tr>
    ...
    <SELECT NAME="LowSlopeType" SIZE="8" ALIGN="top" onChange="pcover2()";>
     <OPTION VALUE="matureforest"> Mature forest
