...
## Tahoe Basin Sediment Model version history
   ...
   $version = '2011.11.30';	# read WEPP water file ato determine lateral flow
...
#   <p><hr><p>
   print "
   <h3>Runoff and erosion for $simyears $yearyears</h3>
   <table border=1><tr><td>
    <table border=0 cellpadding=4 bgcolor='lightyellow'>
     <tr>
      <td bgcolor='#85d2d2'></td>
      <th colspan=2 bgcolor='#85d2d2'><font size=-1>Average<br>annual</font></th>
      <th colspan=2 bgcolor='#85d2d2'><font size=-1>Total for<br>$years2sim $yearyears</font></th>
     </tr>
     <tr>
      <th bgcolor='#85d2d2'><font face='Arial, Geneva, Helvetica'>Precipitation</font></th>
     ...
     <tr>
      <th bgcolor='#85d2d2'><font face='Arial, Geneva, Helvetica'>Runoff from rainfall</font></th>
     ...
     <tr>
      <th bgcolor='#85d2d2'><font face='Arial, Geneva, Helvetica'>Runoff from snowmelt or winter rainstorm</font></th>
     ...
     <tr>
      <th valign=bottom bgcolor='#85d2d2'><font face='Arial, Geneva, Helvetica'>Lateral flow</font></th>
      <td align=right valign=bottom id='lat' onmouseover='markLatCalc(1)' onmouseout='markLatCalc(0)'><font face='Arial, Geneva, Helvetica'>",sprintf('%.1f',$lateral_flow),"</font></td>     <!-- lat -->
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</font></td>
      <td align=right id='sumLat'><font face='Arial, Geneva, Helvetica'>",sprintf("%d",$sumLatqcc),"</font></td>
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</font></td>
     </tr>
     <tr>
      <th valign=bottom bgcolor='#85d2d2'><font face='Arial, Geneva, Helvetica'>Upland erosion rate ($syra kg m<sup>-2</sup>)</font></th>
     ...
     <tr>
      <th valign=bottom bgcolor='#85d2d2'><font face='Arial, Geneva, Helvetica'>Sediment leaving profile ($sypa kg m<sup>-1</sup> width)</font></th>
      <td align=right valign=bottom id='sed'><font face='Arial, Geneva, Helvetica'>$user_asypa</font></td>   <!-- sed  -->
      <td><font face='Arial, Geneva, Helvetica'>$rate</font></td>
     </tr>
     <tr>
      <th valign=bottom bgcolor='#85d2d2'><font face='Arial, Geneva, Helvetica'>SSA enrichment ratio leaving profile</font></th>
...
print '
   <center>
    ...
    <form name="phosphate">
     <input type="hidden" name="rro" id="rro" value=',$user_rro,'>
     <input type="hidden" name="sro" id="sro" value=',$user_sro,'>
     <input type="hidden" name="sed" id="sed" value=',$user_asypa,'>
     ...
     <table border=0 cellpadding=5 bgcolor="lightyellow">
      ...
      <tr>
       ...
       <td><font face="Arial, Geneva, Helvetica">mm</font></td>
       <td align=right id="srConc"><font face="Arial, Geneva, Helvetica"><input type=text size=4 value="1" name="sr_conc" onkeypress="erase_sr_delivery()"></font></td>
       <td><font face="Arial, Geneva, Helvetica">mg/l</font></td>
       <td align=right id="srDel" onmouseover="markSrCalc(1)" onmouseout="markSrCalc(0)"><font face="Arial, Geneva, Helvetica"><span id="sr_delivery">',sprintf("%.2f",$sr_delivery),'</span></font></td>
      ...
      <tr>
       ...
       <td align=right id="lfAmt" onmouseover="markLatFlow(1)" onmouseout="markLatFlow(0)"><font face="Arial, Geneva, Helvetica">',sprintf("%.1f",$lateral_flow),'</font></td>
       <td><font face="Arial, Geneva, Helvetica">mm</font></td>
       <td align=right id="lfConc"><font face="Arial, Geneva, Helvetica"><input type=text size=4 value="1.5" name="lf_conc" onkeypress="erase_lf_delivery()"></font></td>
       <td><font face="Arial, Geneva, Helvetica">mg/l</font></td>
       <td align=right id="lfDel" onmouseover="markLfCalc(1)" onmouseout="markLfCalc(0)"><font face="Arial, Geneva, Helvetica"><span id="lf_delivery">',sprintf("%.2f",$lf_delivery),'</span></font></td>
       <td><font face="Arial, Geneva, Helvetica">kg/ha</font></td>
      </tr>
      <tr>
       <td bgcolor="#85d2d2"><font face="Arial, Geneva, Helvetica"><b>Sediment</b></font></td>
       <td align=right id="sedAmt" onmouseover="markSed(1)" onmouseout="markSed(0)"><font face="Arial, Geneva, Helvetica">',$user_asypa,'</font></td>
       <td><font face="Arial, Geneva, Helvetica">kg/ha</font></td>
       <td align=right id="sedConc"><font face="Arial, Geneva, Helvetica"><input type=text size=4 value="100" name="sed_conc" onkeypress="erase_sed_delivery()"></font></td>
       <td><font face="Arial, Geneva, Helvetica">mg/kg</font></td>
       <td align=right id="sedDel" onmouseover="markSedCalc(1)" onmouseout="markSedCalc(0)"><font face="Arial, Geneva, Helvetica"><span id="sed_delivery">',sprintf("%.2f",$sed_delivery),'</span></font></td>
       <td><font face="Arial, Geneva, Helvetica">kg/ha</font></td>
      </tr>
      <tr>
       <td colspan=3 bgcolor="#85d2d2"><font face="Arial, Geneva, Helvetica"><b>Total</b></font></td>
       <th><font face="Arial, Geneva, Helvetica"><input type=button value="reset ^" onClick="reset_defaults()"></font></th>
       <th><font face="Arial, Geneva, Helvetica"><input type=button value="calculate =>" onClick="calc_delivery()"></font></th>
       <td align=right onmouseover="markDeliveries(1)" onmouseout="markDeliveries(0)"><font face="Arial, Geneva, Helvetica"><span id="total">',sprintf("%.2f",$total_phosphate),'</span></font></td>
       <td><font face="Arial, Geneva, Helvetica">kg/ha</font></td>
      </tr>
      <tr>
