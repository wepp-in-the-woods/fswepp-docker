...
<!--             phosphate table calculations start         -->
   ...
   function calc_sr_delivery() {
     ...
     val=""
//   D = 14.6;    // ****
     rro=parseFloat(phosphate.rro.value)
//rro=document.getElementById("rro").value
     sro=parseFloat(phosphate.sro.value)
...
#   <p><hr><p>
   ...
   <h3>Mean annual averages for $simyears years</h3>
    <table border=0 cellpadding=4 bgcolor=lightyellow>
     ...
     <tr>
      <td align=right valign=bottom id='SSA'><font face='Arial, Geneva, Helvetica'>zzzz$SSA_ratio</td>   <!-- SSA  -->
    ...
    <form name="phosphate">
     ...
     <table border=1 cellpadding=5>
      ...
      <tr>
       ...
       <td align="right" bgcolor="lightgreen" onmouseover="markRunoffs()" onmouseout="unmarkRunoffs()">',$user_rro+$user_sro,'</td>  <!-- **** surface runoff (rain + snow) **** -->
       <td bgcolor="lightgreen">mm</td>
       <td align=right><input type=text size=4 value="1" name="sr_conc" onkeypress="erase_sr_delivery()"></td>
       <td>mg/l</td>
       <td align=right><span id="sr_delivery">', ,'</span></td><td>kg/ha</td>  <!-- calc_sr_delivery -->
      </tr>
      <tr>
       ...
       <td>mg/l </td>
       <td align=right><span id="lf_delivery">', ,'</span></td>  <!-- calc_lf_delivery -->
       <td>kg/ha</td>
      </tr>
      <tr>
       <td bgcolor="lightyellow"><b>Sediment</b></td>
       <td align=right bgcolor="lightgreen" onmouseover="markSed()" onmouseout="unmarkSed()">',$user_asypa,'</td>  <!-- **** sediment leaving profile **** -->
       ...
       <td>mg/kg</td>
       <td align=right><span id="sed_delivery">', ,'</span></td>  <!-- calc_sed_delivery -->
       <td>kg/ha</td>
      </tr>
      <tr>
