...
";
     ...
     <tr>
      ...
      <td align=right rowspan=2 bgcolor='#FAF8CC'><font face='Arial, Geneva, Helvetica'>$user_ofe1_length</font></td>
     ...
     <tr>
      ...
      <td bgcolor='lightyellow'><font face='Arial, Geneva, Helvetica'>$simyears $yearyears</font></td>
     </tr>
    </table>
    <p>
";
...
$sed_delivery=$user_asyra * $sed_conc * $SSA_ratio / 1000;	# metric
...
#   <p><hr><p>
   ...
   <table border=1><tr><td>
    <table border=0 cellpadding=4 bgcolor='lightyellow'>
     ...
     <tr>
      <td align=right valign=bottom id='lat'><font face='Arial, Geneva, Helvetica'>$lateral_flow</font></td>     <!-- lat -->
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</font></td>
      <td valign=bottom><font face='Arial, Geneva, Helvetica'>lateral flow</font></td>
      <td align=right><font face='Arial, Geneva, Helvetica'>",sprintf("%d",$sumLatqcc),"</font></td>
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</font></td>
     </tr>
     <tr>
      ...
      <td valign=bottom><font face='Arial, Geneva, Helvetica'>upland erosion rate ($syra kg m<sup>-2</sup>)</font></td>
     </tr>
     <tr>
      <td align=right valign=bottom id='sed'><font face='Arial, Geneva, Helvetica'>$user_asypa</font></td>   <!-- sed  -->
      <td><font face='Arial, Geneva, Helvetica'>$rate</font></td>
      <td valign=bottom><font face='Arial, Geneva, Helvetica'>sediment leaving profile ($sypa kg m<sup>-1</sup> width)</font></td>
     </tr>
     <tr>
      <td align=right valign=bottom id='SSA'><font face='Arial, Geneva, Helvetica'>$SSA_ratio</font></td>   <!-- SSA  -->
      <td><font face='Arial, Geneva, Helvetica'></font></td>
      <td valign=bottom><font face='Arial, Geneva, Helvetica'>average annual SSA enrichment ratio leaving profile</font></td>
     </tr>
    </table>
   </td></tr></table>
   </center>
...
print '
   <center>
    ...
    <form name="phosphate">
     ...
     <input type="hidden" name="sed" id="sed" value=',$user_asyra,'>
     ...
     <table border=0 cellpadding=5 bgcolor="lightyellow">
      ...
      <tr>
       ...
       <td align="right" bgcolor="lightgreen" onmouseover="markRunoffs()" onmouseout="unmarkRunoffs()"><font face="Arial, Geneva, Helvetica">',$user_rro+$user_sro,'</font></td>
       <td bgcolor="lightgreen"><font face="Arial, Geneva, Helvetica">mm</font></td>
       <td align=right><font face="Arial, Geneva, Helvetica"><input type=text size=4 value="1" name="sr_conc" onkeypress="erase_sr_delivery()"></font></td>
       <td><font face="Arial, Geneva, Helvetica">mg/l</font></td>
       <td align=right><font face="Arial, Geneva, Helvetica"><span id="sr_delivery">',$sr_delivery,'</span></font></td>
      ...
      <tr>
       ...
       <td align=right bgcolor="lightgreen" onmouseover="markLatFlow()" onmouseout="unmarkLatFlow()"><font face="Arial, Geneva, Helvetica">',sprintf("%.1f",$lateral_flow),'</font></td>
       <td bgcolor="lightgreen"><font face="Arial, Geneva, Helvetica">mm</font></td>
       <td align=right><font face="Arial, Geneva, Helvetica"><input type=text size=4 value="1.5" name="lf_conc" onkeypress="erase_lf_delivery()"></font></td>
       <td><font face="Arial, Geneva, Helvetica">mg/l</font></td>
       <td align=right><font face="Arial, Geneva, Helvetica"><span id="lf_delivery">',$lf_delivery,'</span></font></td>
       <td><font face="Arial, Geneva, Helvetica">kg/ha</font></td>
      </tr>
      <tr>
       <td bgcolor="#85d2d2"><font face="Arial, Geneva, Helvetica"><b>Sediment</b></font></td>
       <td align=right bgcolor="lightgreen" onmouseover="markSed()" onmouseout="unmarkSed()"><font face="Arial, Geneva, Helvetica">',$user_asypa,'</font></td>
       <td bgcolor="lightgreen"><font face="Arial, Geneva, Helvetica">kg/ha</font></td>
       <td align=right><font face="Arial, Geneva, Helvetica"><input type=text size=4 value="100" name="sed_conc" onkeypress="erase_sed_delivery()"></font></td>
       <td><font face="Arial, Geneva, Helvetica">mg/kg</font></td>
       <td align=right><font face="Arial, Geneva, Helvetica"><span id="sed_delivery">',$sed_delivery,'</span></font></td>
       <td><font face="Arial, Geneva, Helvetica">kg/ha</font></td>
      </tr>
      <tr>
       ...
       <td align=right><font face="Arial, Geneva, Helvetica"><span id="total">',$total_phosphate,'</span></font></td>
       <td><font face="Arial, Geneva, Helvetica">kg/ha</font></td>
      </tr>
      <tr>
...
print "
   ...
   <h3>Probabilities of occurrence<br>first year following disturbance<br>
    ...
    <table border=0 cellpadding=4 bgcolor='lightyellow'>
     <tr>
      <th align=right><font face='Arial, Geneva, Helvetica'>Probability there is runoff</font></th>
     ...
     <tr>
      <th align=right><font face='Arial, Geneva, Helvetica'>Probability there is erosion</font></th>
      <td>";
     ...
     <tr>
      <th align=right><font face='Arial, Geneva, Helvetica'>Probability there is sediment delivery</font></th>
      <td><font face='Arial, Geneva, Helvetica'>";
