...
para = para +'  The user may visualize the slope profile as a line running up and down the hill, having a representative width which applies to the entire field or a portion of the field.'
para = para +'<br><br>'
...
para = para +'<br><br>'
para = para +'  The user enters four surface slope gradients, labeled A through D in the figure below, to describe the profile&ndash;the top and middle gradient of the upper element, and the middle and toe gradient of the lower element.'
para = para +'<br><br>'
...
para = para +'The <input type="submit" value="Future" disabled> button offers future climate scenario files.'
para = para +'<br><br>'
...
print '<BODY bgcolor="white"
  ...
  <center>
  <form name="weppdist" method="post" ACTION="http://',$wepphost,'/cgi-bin/fswepp/tahoe/wtpfc.pl">
...
<br>
 <table width=90% border=0 bgcolor="pink">
  <tr>
   <td title="click on table headers that turn pink for help">
 ...
 <table border = 5>
  <tr valign=top>
   <td valign=top>    <!-- CLIMATE above SOIL TEXTURE above FINES -->
    ...
    <TABLE border="1">
     <tr align="top">
      <th class="thhelpoff" onmouseover="className='thhelpon'" onmouseout="className='thhelpoff'" onClick="JavaScript:show_help('climate')">
       <b><a href="JavaScript:submitme('Describe Climate')"
          ...
          <a href="JavaScript:show_help('climate')"
             onMouseOver="window.status='Explain climate input';return true"
             onMouseOut="window.status='Forest Service Tahoe Model';return true">
             <img src="/fswepp/images/quest_b.gif" border=0 name="climate_quest" align=right></a>
      </td>
     <tr align=top>
theEnd
print '
...
print <<'theEnd';
     ...
     <tr>
     <tr>
      <th class="thhelpoff" onmouseover="className='thhelpon'" onmouseout="className='thhelpoff'" onClick="JavaScript:show_help('soil_texture')">
...
print <<'theEnd';
  <table border=2 cellpadding=6>
   <tr>
    <th bgcolor=85d2d2>
     <font face="Arial, Geneva, Helvetica">Element</font>
    </th>
    ...
    <th class="thhelpoff" onmouseover="className='thhelpon'" onmouseout="className='thhelpoff'" onClick="JavaScript:show_help('geometry')">
     <font face="Arial, Geneva, Helvetica">Gradient (%)<br>
      <a href="JavaScript:show_help('geometry')"
...
print "
    <th class=\"thhelpoff\" onmouseover=\"className='thhelpon'\" onmouseout=\"className='thhelpoff'\" onClick=\"JavaScript:show_help('geometry')\">
      <font face=\"Arial, Geneva, Helvetica\">Horizontal<br>Length ($units)
       <a href=\"JavaScript:show_help('geometry')\"
          onMouseOver=\"window.status='Explain geometry';return true\"
          onMouseOut=\"window.status='Forest Service Tahoe Model';return true\">
          <img src=\"/fswepp/images/quest_b.gif\" border=0 name=\"length_quest\" align=right></a>
     </font>
    </th>
";
print <<'theEnd';
    <th class="thhelpoff" onmouseover="className='thhelpon'" onmouseout="className='thhelpoff'" onClick="JavaScript:show_help('cover')">
     <font face="Arial, Geneva, Helvetica">Cover (%) <br>
      <a href="JavaScript:show_help('cover')"
         ...
         onMouseOut="window.status='Forest Service Tahoe Model';return true">
         <img src="/fswepp/images/quest_b.gif" border=0 name="cover_quest" align=right></a>
     </font>
    </th>
   ...
   <tr>
    <th rowspan=2 bgcolor="#85d2d2"><font face="Arial, Geneva, Helvetica">Upper</th>
  ...
  <tr>
   ...
   <tr>
    <th class="thhelpoff" onmouseover="className='thhelpon'" onmouseout="className='thhelpoff'" onClick="JavaScript:show_help('phosphorus')">
     <font size=-1>
      Phosphorus<br>Concentration
        <a href="JavaScript:show_help('phosphorus')"
             onMouseOver="window.status='Explain phosphorus inputs';return true"
             onMouseOut="window.status='Forest Service Tahoe Model';return true">
             <img src="/fswepp/images/quest_b.gif" border=0 name="phosphorus_quest" align=right></a>
     </font>
    </th>
    <th bgcolor="#85d2d2">
     <font size=-1>
