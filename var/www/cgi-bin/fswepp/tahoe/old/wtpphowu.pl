...
//   alert (" S: " + S + " SSA: " + SSA + "conc: " + phosphate.sed_conc.value)
  ...
  function markDeliveries($i) {
    if ($i) {
      document.getElementById("srDel").style.background="lightgreen"
      document.getElementById("lfDel").style.background="lightgreen"
      document.getElementById("sedDel").style.background="lightgreen"
    } else {
      document.getElementById("srDel").style.background="white"
      document.getElementById("lfDel").style.background="white"
      document.getElementById("sedDel").style.background="white"
    }
  }
  function markLatCalc($i) {
    if ($i) {
      document.getElementById("len_top").style.background="lightgreen"
      document.getElementById("len_bot").style.background="lightgreen"
      document.getElementById("years").style.background="lightgreen"
      document.getElementById("sumLat").style.background="lightgreen"
    } else {
      document.getElementById("len_top").style.background="white"
      document.getElementById("len_bot").style.background="white"
      document.getElementById("years").style.background="white"
      document.getElementById("sumLat").style.background="white"
    }
  }
  function markSrCalc($i) {
    if ($i) {
   //   document.getElementById("srAmt").style.background="lightgreen"
      document.getElementById("srConc").style.background="lightgreen"
    } else {
   //   document.getElementById("srAmt").style.background="white"
      document.getElementById("srConc").style.background="white"
    }
    markRunoffs($i)
  }
  function markLfCalc($i) {
    if ($i) {
      document.getElementById("lfAmt").style.background="lightgreen"
      document.getElementById("lfConc").style.background="lightgreen"
    } else {
      document.getElementById("lfAmt").style.background="white"
      document.getElementById("lfConc").style.background="white"
    }
  }
  function markSedCalc($i) {
    if ($i) {
      document.getElementById("sedAmt").style.background="lightgreen"
      document.getElementById("sedConc").style.background="lightgreen"
      document.getElementById("ssa_").style.background="lightgreen"
    } else {
      document.getElementById("sedAmt").style.background="white"
      document.getElementById("sedConc").style.background="white"
      document.getElementById("ssa_").style.background="white"
    }
  }
...
# Average lateral flow from toe
     $lateral_flow = ($sumLatqcc * $user_ofe2_length / $user_total_length) / $years2sim;
     $lateral_flow_u = $lateral_flow;
     $lateral_flow_u /= 25.4 if ($units eq "ft");
  ...
  <center>
   <h3>User inputs</h3>
    ...
    <table border=0 cellpadding=5>
     <tr>
      <td colspan=5 bgcolor='#FAF8CC'><font face='Arial, Geneva, Helvetica' size=-1>$description</font></td>
      <td bgcolor='lightyellow' id='years'><font face='Arial, Geneva, Helvetica'>$simyears $yearyears</font></td>
     </tr>
     <tr>
...
# $lf_conc = 1.5;
# $sed_conc = 100;
$sr_delivery=($user_rro+$user_sro) * $sr_conc / 100;		# metric
$lf_delivery=$lateral_flow * $lf_conc / 100;			# metric
$sed_delivery=$user_asypa * $sed_conc * $SSA_ratio / 1000;	# metric
$total_phosphate=$sr_delivery+$lf_delivery+$sed_delivery;
   ...
   <table border=1><tr><td>
    <table border=0 cellpadding=4 bgcolor='lightyellow'>
     <tr>
      ...
      <th colspan=4 bgcolor='#85d2d2'>Phosphate Analysis</th>
     </tr>
     <tr>
     ...
     <tr>
      ...
      <td align=right id='rro'><font face='Arial, Geneva, Helvetica'>$user_rro</font></td>   <!-- rro  -->
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</font></td>
      <td rowspan=2 align=right id='srConc'><font face='Arial, Geneva, Helvetica'>$sr_conc</font></td>
      <td rowspan=2><font face='Arial, Geneva, Helvetica'>mg/l</font></td>
      <td rowspan=2 align=right id='srDel' onmouseover='explain(1);markSrCalc(1)' onmouseout='markSrCalc(0)'>
       <font face='Arial, Geneva, Helvetica'><span id='sr_delivery'>",sprintf("%.2f",$sr_delivery),"</span></font>
      </td>
      <td rowspan=2><font face='Arial, Geneva, Helvetica'>kg/ha</font></td>
     </tr>
     <tr>
      ...
      <td><font face='Arial, Geneva, Helvetica'>events</font></td>
      <td align=right id='sro'><font face='Arial, Geneva, Helvetica'>$user_sro</font></td>   <!-- sro  -->
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</font></td>
     </tr>
     <tr>
      <th align=right valign=bottom bgcolor='#85d2d2'><font face='Arial, Geneva, Helvetica' size=-1>Lateral flow</font></th>
      <td align=right id='sumLat'><font face='Arial, Geneva, Helvetica'>",sprintf("%.2f",$sumLatqcc),"</font></td>
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</font></td>
      <td align=right valign=bottom id='lfAmt' onmouseover='explain(5);markLatCalc(1)' onmouseout='explain(-1);markLatCalc(0)'>
       <font face='Arial, Geneva, Helvetica'>",sprintf('%.2f',$lateral_flow_u),"</font>
      </td>     <!-- lat -->
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</font></td>
      <td align=right id='lfConc'><font face='Arial, Geneva, Helvetica'>$lf_conc</font></td>
      ...
      <td align=right id='lfDel' onmouseover='explain(2);markLfCalc(1)' onmouseout='explain(-1);markLfCalc(0)'>
       <font face='Arial, Geneva, Helvetica'>
        <span id='lf_delivery'>",sprintf("%.2f",$lf_delivery),"</span>
       </font>
      </td>
      <td><font face='Arial, Geneva, Helvetica'>kg/ha</font></td>
     </tr>
     <tr>
     ...
     <tr>
      ...
      <td><font face='Arial, Geneva, Helvetica'>$rate</font></td>
      <td align=right id='sedConc'><font face='Arial, Geneva, Helvetica'>$sed_conc</font></td>
      ...
      <td align=right id='sedDel' onmouseover='explain(3);markSedCalc(1)' onmouseout='explain(-1);markSedCalc(0)'>
       <font face='Arial, Geneva, Helvetica'>
        <span id='sed_delivery'>",sprintf("%.2f",$sed_delivery),"</span>
       </font>
      </td>
      <td><font face='Arial, Geneva, Helvetica'>kg/ha</font></td>
     </tr>
     <tr>
      ...
      <th colspan=2 bgcolor='#85d2d2' valign=bottom><font face='Arial, Geneva, Helvetica' size=-1>Phosphate total</font></th>
      <td align=right onmouseover='explain(4);markDeliveries(1)' onmouseout='explain(-1);markDeliveries(0)'><font face='Arial, Geneva, Helvetica'><span id='total'><hr>",sprintf("%.2f",$total_phosphate),"</span></font></td>
      <td valign=bottom><font face='Arial, Geneva, Helvetica'>kg/ha</font></td>
     </tr>
    </table>
   </td></tr>
   <tr><td><font face='Arial, Geneva, Helvetica' size=-1><span id='helptext'>&nbsp;</span></font></td></tr>
     </table>
    </form>
   </center>
";
