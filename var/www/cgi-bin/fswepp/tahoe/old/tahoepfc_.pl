...
#  $version = '2012.09.07';	# add BurnP
#  $version = '2102.08.28';	# start puulling in future climate options
...
para = para +'    <tr><td><font size=-1>burn pile</font></td>           <td><font size=-1> 20% cover</font></td></tr>'
...
para = para +'    <li>  burn pile &ndash;    20% cover</li>';
...
if (!$fc) { print "
      ...
      <input type=button value='present climates' onclick=\"javascript:click_present()\">\n";
}
#################
#
