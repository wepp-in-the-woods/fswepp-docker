#! /usr/bin/perl
#
# wtfc.pl        Tahoe Basin Future Climate Sediment Model
#
# Tahoe Basin Future Climate Sediment Model workhorse
# Reads user input from tahoe.pl, runs WEPP, parses output files

# Needed update: automatic history popup

# 2012.08.21 DEH -- modift from wt.pl
# 2009.08.24 DEH -- Modify from wd.pl

#  $debug=1;

## BEGIN HISTORY ###################################
## Tahoe Basin Future Climate Sediment Model version history

   $version = '2012.08.21';     # Adjust handling of sod and bunchgrass
...
#     elsif ($slope eq "inbare")   {$conduct = '2'}
     ...
     print "<HTML>\n";
     print " <HEAD>\n";
     print "  <TITLE>Tahoe Basin Future Climate Sediment Model -- Soil Parameters</TITLE>\n";
     print " </HEAD>\n";
    ...
    <blockquote>
     <table width=95% border=0>
      <tr>
       ...
       <td align=center>
        <hr>
        <h3>Tahoe Basin Future Climate Sediment Model Soil Texture Properties</h3>
        <hr>
       </td>
      </tr>
     </table>
...
#    &CreateCligenFile;						# DEH 2012.08.21
     &ExtractCligenFile;
...
########################  start HTML output ###############
   ...
   print '<HTML>
 <HEAD>
  <TITLE>Tahoe Basin Future Climate Sediment Model Results</TITLE>
<!-- new 2004 -->
  <script>
  ...
  <blockquote>
   <table width=100% border=0>
    <tr>
     ...
     <td align=center>
      <hr>
      <h3>Tahoe Basin Future Climate Sediment Model Results (* provisional *)</h3>
      <hr>
     </td>
    </tr>
   </table>
...
#------------------------------
  ...
  # 2010.05.15 #
   ##  unlink $climateFile;    # be sure this is right file .....     # 2/2000   2012.08.21
...
print "
     ...
     <tr>
      ...
      <td colspan=2 bgcolor=\"#FAF8CC\"><font face='Arial, Geneva, Helvetica'>$soil_type{$soil}</td>
      <td colspan=2 bgcolor=\"#85d2d2\"><font face='Arial, Geneva, Helvetica'>Start year</td>
      <td colspan=1 bgcolor=\"#FAF8CC\"><font face='Arial, Geneva, Helvetica'>$startYear</td>
     </tr>
     <tr>
...
# print "CL: $CL<br>\n";
# print "fullCliFile: $fullCliFile<br>\n";
...
<font size=-2>
<b>Citation:</b><br>
Elliot, William J.; Hall, David E. 2012. Tahoe Basin Future Climate Sediment Model. Ver. $version.
...
<br><br>
     Tahoe Basin Future Climate Sediment Model Results v.";
...
print "
     <br>
     Tahoe Basin Future Climate Sediment Model Run ID $unique
    </font>
   </blockquote>
 </body>
</html>
...
#  system "rm working/$unique.*";
   ...
   # unlink <$working/$unique.*>;			# 2012.08.21 TEMP
...
#
Soil file for Tahoe Basin Future Climate Sediment Model run from soilbase.tahoe for $treat1 $soil1 $treat2 $soil2
 2    1
";
...
#print CLOUT "$fullCliFile\n";	   # ../rc/tahoe/fc/../rc/tahoe/fc/FallenLeaf_A2_srad.cli
 ...
 $line = <CLI>; print CLOUT $line; #	   324.7   268.5   255.5   133.6    98.6    32.2     3.2     7.8    25.6    82.0   200.2   332.6
...
# Management Section #
######################
Tahoe Basin Future Climate Sediment Model
