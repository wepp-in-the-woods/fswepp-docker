...
#
#  Tahoe Basin Future Climate Sediment Model input screen
#

#  tahoe.pl -- input screen for Tahoe Basin Future Climate Sediment Model

#  2009.08.24 DEH Modify Disturbed WEPP input screen weppdist.pl for Tahoe Basin Future Climate Sediment Model

## BEGIN HISTORY ###################################
## Tahoe Basin Future Climate Sediment Model version history

   $version = '2012.08.20';	# First Future Climate work
...
<html>
<head>
<title>Tahoe Basin Future Climate Sediment Model</title>
  <META http-equiv="Content-Type" content="text/html; charset=utf-8">
  <META NAME="Name" CONTENT="Tahoe Basin Future Climate Sediment Model">
  <META NAME="Brief Description" CONTENT="Tahoe Basin Future Climate Sediment Model, a component of FS WEPP, predicts sedimentation and erosion from rangeland, forestland, and forest skid trails.
...
para='<h3>Gradient</h3>'
para = para +' The Tahoe Basin Future Climate Sediment Model uses two "overland flow elements" &ndash; an upper and a lower.'
...
para = para +'   The Tahoe Basin Future Climate Sediment Model provides thirteen categories of vegetation or treatment.';
...
print '<BODY bgcolor="white"
  ...
  <table width=100% border=0>
    ...
    <td align=center>
       <hr>
       <h3>Tahoe Basin Future Climate Sediment Model <font color=crimson>(* under construction *)</font></h3>
       <hr>
    <td>
  ...
  <center>
  <FORM name="weppdist" method="post" ACTION="http://',$wepphost,'/cgi-bin/fswepp/tahoe/wtfc.pl">
 ...
 <table border = 7>
  <tr>
   <td bgcolor="85d2d2" colspan=2>
    ...
    &nbsp;&nbsp;
    <b>Years to simulate:</b> 20
    <input type="hidden" name="climyears" value="20">
    &nbsp;&nbsp;&nbsp; <b>Starting year (2001-2080): </b>
...
<!--
<hr>GCM:
<input type = "radio" name="scenario" value="A2"> A2
<input type = "radio" name="scenario" value="B1"> B1
-->
</script>
      </td>
     <tr align=top>
...
theEnd
 ...
 <font size=-1>
  ...
  <font size=-2>
   The Tahoe Basin Future Climate Sediment Model is a version of Disturbed WEPP customized for the Lake Tahoe Basin.
   <br><br>
   <b>Citation:</b><br>
