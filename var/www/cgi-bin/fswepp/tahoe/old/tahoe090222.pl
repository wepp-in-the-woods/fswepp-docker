...
//    window.document.weppdist.climyears.value = max_year[0];
    ...
    default_pcover[9] = 80;	// treatment 3
    default_pcover[8] = 60;	// treatment 2
    default_pcover[7] = 40;	// treatment 1
...
print <<'theEnd';
 <br>  <a href="/fswepp/docs/distweppdoc.html#cover" target="_popup"
         ...
         onMouseOut="window.status='Forest Service Tahoe Basin';return true">
         <img src="/fswepp/images/quest_b.gif" border=0 name="soil_quest"></a></font>
   ...
   <tr>
    ...
    <SELECT NAME="UpSlopeType" SIZE="8" ALIGN="top" onChange="pcover1()";>
     ...
     <OPTION VALUE="trt1">  Treatment 1
     <OPTION VALUE="trt2">  Treatment 2
     <OPTION VALUE="trt3">  Treatment 3
