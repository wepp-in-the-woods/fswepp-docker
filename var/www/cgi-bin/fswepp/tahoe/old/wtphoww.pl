...
$lf_delivery=40 * $lf_conc / 100;				# metric
...
print '
   <center>
    ...
    <form name="phosphate">
     ...
     <input type="hidden" name="lf" value=40>
     ...
     <table border=0 cellpadding=5 bgcolor="lightyellow">
      ...
      <tr>
       ...
       <td align=right bgcolor="lightgreen" onmouseover="markLatFlow()" onmouseout="unmarkLatFlow()"><font face="Arial, Geneva, Helvetica">40</font></td>
       <td bgcolor="lightgreen"><font face="Arial, Geneva, Helvetica">mm</font></td>
