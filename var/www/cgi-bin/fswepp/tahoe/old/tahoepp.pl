...
print '<BODY bgcolor="white"
  ...
  <center>
  <FORM name="weppdist" method="post" ACTION="http://',$wepphost,'/cgi-bin/fswepp/tahoe/wtpphowu.pl">
...
print <<'theEnd';
   ...
   <tr>
    ...
    <td bgcolor="#FAF8CC" colspan=5>
     <font size=-1>
      <b>surface</b>      <input name='sr_conc'  type=text value='1.0' size=3>&nbsp;mg/l;
      <b>lateral flow</b> <input name='lf_conc'  type=text value='1.5' size=3>&nbsp;mg/l;
      <b>sediment</b>     <input name='sed_conc' type=text value='100' size=3>&nbsp;mg/l 
     </font>
    </td>
   </tr>
   <tr>
