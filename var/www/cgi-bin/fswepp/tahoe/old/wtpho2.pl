...
#   <p><hr><p>
   ...
   <h3>Mean annual averages for $simyears years</h3>
    <table border=0 cellpadding=4 bgcolor=lightyellow>
     ...
     <tr>
      <td align=right id='rro'><font face='Arial, Geneva, Helvetica'>$user_rro</td>   <!-- rro  -->
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</td>
     ...
     <tr>
      <td align=right id='sro'><font face='Arial, Geneva, Helvetica'>$user_sro</td>   <!-- sro  -->
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</td>
     ...
     <tr>
      <td align=right valign=bottom id='lat'><font face='Arial, Geneva, Helvetica'>$lateral_flow</td>     <!-- lat -->
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</td>
      <td valign=bottom>lateral flow</td>
     </tr>
     <tr>
     ...
     <tr>
      <td align=right valign=bottom id='sed'><font face='Arial, Geneva, Helvetica'>$user_asypa</td>   <!-- sed  -->
      <td><font face='Arial, Geneva, Helvetica'>$rate</td>
      <td valign=bottom><font face='Arial, Geneva, Helvetica'>sediment leaving profile ($sypa kg m<sup>-1</sup> width)</td>
     </tr>
     <tr>
      <td align=right valign=bottom id='SSA'><font face='Arial, Geneva, Helvetica'>$SSA_ratio</td>   <!-- SSA  -->
      <td><font face='Arial, Geneva, Helvetica'></td>
      <td valign=bottom><font face='Arial, Geneva, Helvetica'>average annual SSA enrichment ratio leaving profile</td>
     </tr>
    </table>
   </center>
";
    ...
    <form name="phosphate">
     ...
     <table border=1 cellpadding=5>
      ...
      <tr>
       ...
       <td align="right" bgcolor="lightgreen" onmouseover="markRunoffs()" onmouseout="unmarkRunoffs()">',$user_rro+$user_sro,'</td>
       <td bgcolor="lightgreen">mm</td>
       <td align=right><input type=text size=4 value="1" name="sr_conc" onkeypress="erase_sr_delivery()"></td>
       <td>mg/l</td>
       <td align=right><span id="sr_delivery">',$sr_delivery,'</span></td>
       <td>kg/ha</td>
      </tr>
      <tr>
       <td bgcolor="lightyellow"><b>Lateral flow</b></td>
       <td align=right bgcolor="lightgreen" onmouseover="markLatFlow()" onmouseout="unmarkLatFlow()">40</td>
       <td bgcolor="lightgreen">mm</td>
       <td align=right><input type=text size=4 value="1.5" name="lf_conc" onkeypress="erase_lf_delivery()"></td>
       <td>mg/l </td>
       <td align=right><span id="lf_delivery">',$lf_delivery,'</span></td>
       <td>kg/ha</td>
      </tr>
      <tr>
       <td bgcolor="lightyellow"><b>Sediment</b></td>
       <td align=right bgcolor="lightgreen" onmouseover="markSed()" onmouseout="unmarkSed()">',$user_asypa,'</td>
       ...
       <td>mg/kg</td>
       <td align=right><span id="sed_delivery">',$sed_delivery,'</span></td>
       <td>kg/ha</td>
      </tr>
      <tr>
       ...
       <td align=right><span id="total">',$total_phosphate,'</span></td>
       <td>kg/ha</td>
      </tr>
      <tr>
       <td colspan=7><font size=-2>
         surface runoff delivery = (surface runoff) * (surface runoff concentration) / 100<br>
         lateral flow delivery = (lateral flow) * (lateral flow concentration) / 100<br>
