...
###
   ...
   if (lc($action) =~ /custom/) {
     $weppdist = "http://" . $wepphost . "/cgi-bin/fswepp/tahoe/tahoe.pl";
     if ($platform eq "pc") {
...
#     elsif ($slope eq "inbare")   {$conduct = '2'}
     ...
     print "<HTML>\n";
     print " <HEAD>\n";
     print "  <TITLE>Tahoe -- Soil Parameters</TITLE>\n";
     print " </HEAD>\n";
  ...
  <table width=95% border=0>
    ...
    <td align=center>
       <hr>
       <h2>Tahoe Soil Texture Properties</h2>
       <hr>
    <td>
...
# make hash of treatments
   ...
   $treatments{trt1}   = 'treatment 1';
   $treatments{trt2}   = 'treatment 2';
   $treatments{trt3}   = 'treatment 3';
   $treatments{lowr}   = 'low traffic road';
   $treatments{highr}  = 'high traffic road';
...
popupwindow.document.writeln('  <title>Tahoe Results version history</title>')
popupwindow.document.writeln(' </head>')
...
popupwindow.document.writeln('   <h3>Tahoe Results Version History</h3>')
   ...
   <table width=100% border=0>
    <tr>
     <td>
      <a href="JavaScript:window.history.go(-1)">
      <IMG src="http://',$wepphost,'/fswepp/images/disturb.gif"
      align="left" alt="Return to Tahoe input screen" border=1></a>
     <td align=center>
      <hr>
      <h2>Tahoe Results</h2>
      <hr>
...
######################
DISTWEPP
Two OFEs to drive the Tahoe interface
...
# make outer_offset hash	2009.08.28 DEH
   ...
   $outer_offset = {};
   $outer_offset{sand} = 5;
   $outer_offset{silt} = 34;
   $outer_offset{clay} = 63;
   $outer_offset{loam} = 92;
...
# make inner_offset hash        2009.08.28 DEH
   ...
   $inner_offset{trt1} = 16;
   $inner_offset{trt2} = 18;
   $inner_offset{trt3} = 20;
   $inner_offset{lowr} = 22;
   $inner_offset{highr} = 24;
