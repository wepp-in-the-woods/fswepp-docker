...
# Average lateral flow from toe
     ...
     $lateral_flow_u /= 25.4 if ($units == "ft");
   ...
   <table border=1><tr><td>
    <table border=0 cellpadding=4 bgcolor='lightyellow'>
     ...
     <tr>
      ...
      <th colspan=2><font face='Arial, Geneva, Helvetica'><input type=button value='v -- reset' onClick='reset_defaults()'></font></th>
      <th colspan=2><font face='Arial, Geneva, Helvetica'><input type=button value='v -- calculate' onClick='calc_delivery()'></font></th>
     </tr>
     <tr>
      ...
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</font></td>
      <td rowspan=2 align=right id='srConc'><font face='Arial, Geneva, Helvetica'><input type=text size=4 value='1' name='sr_conc' onkeypress='erase_sr_delivery()'></font></td>
      <td rowspan=2><font face='Arial, Geneva, Helvetica'>mg/l</font></td>
      <td rowspan=2 align=right id='srDel' onmouseover='explain(1);markSrCalc(1)' onmouseout='markSrCalc(0)'><font face='Arial, Geneva, Helvetica'><span id='sr_delivery'>",sprintf("%.2f",$sr_delivery),"</span></font></td>
     ...
     <tr>
      ...
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</font></td>
      <td align=right valign=bottom id='lfAmt' onmouseover='explain(5);markLatCalc(1)' onmouseout='explain(-1);markLatCalc(0)'><font face='Arial, Geneva, Helvetica'>",sprintf('%.2f',$lateral_flow_u),"</font></td>     <!-- lat -->
      <td><font face='Arial, Geneva, Helvetica'>$pcp_unit</font></td>
      ...
      <td align=right id='lfDel' onmouseover='explain(2);markLfCalc(1)' onmouseout='explain(-1);markLfCalc(0)'><font face='Arial, Geneva, Helvetica'><span id='lf_delivery'>",sprintf("%.2f",$lf_delivery),"</span></font></td>
     ...
     <tr>
      ...
      <td align=right id='sedDel' onmouseover='explain(3);markSedCalc(1)' onmouseout='explain(-1);markSedCalc(0)'><font face='Arial, Geneva, Helvetica'><span id='sed_delivery'>",sprintf("%.2f",$sed_delivery),"</span></font></td>
      <td><font face='Arial, Geneva, Helvetica'>kg/ha</font></td>
     </tr>
     <tr>
      ...
      <th colspan=2 bgcolor='#85d2d2'><font face='Arial, Geneva, Helvetica' size=-1>Phosphate total</font></th>
      <td align=right onmouseover='explain(4);markDeliveries(1)' onmouseout='explain(-1);markDeliveries(0)'><font face='Arial, Geneva, Helvetica'><span id='total'>",sprintf("%.2f",$total_phosphate),"</span></font></td>
      <td><font face='Arial, Geneva, Helvetica'>kg/ha</font></td>
     </tr>
    </table>
   </td></tr>
