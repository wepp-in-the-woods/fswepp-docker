...
#
#  WEPP Water input screen
#

#  wepplat.pl -- input screen for WEPP-Water (Lateral Flow)
...
<html>
<head>
<title>WEPP Water (Lateral Flow)</title>
  <META http-equiv="Content-Type" content="text/html; charset=utf-8">
  <META NAME="Name" CONTENT="Disturbed WEPP">
  <META NAME="Brief Description" CONTENT="Disturbed WEPP, a component of FS WEPP, predicts erosion from rangeland, forestland, and forest skid trails. WEPP Water allows users to easily describe numerous disturbed forest and rangeland erosion conditions. The interface presents the probability of a given level of erosion occurring the year following a disturbance.">
...
popupwindow.document.writeln('  <title>WEPP Water Input Screen version history</title>')
popupwindow.document.writeln(' </head>')
...
popupwindow.document.writeln('   <h3>WEPP Water Input Screen Version History</h3>')
...
print '<BODY bgcolor="white"
  ...
  <center>
  <FORM name="weppdist" method="post" ACTION="https://',$wepphost,'/cgi-bin/fswepp/wd/wd4.pl">
...
print <<'theEnd';
     <TR align="top"><TD align="center" bgcolor="85d2d2">
       <b><a href="JavaScript:submitme('Describe Climate')"
             ...
             onMouseOut="window.status='Forest Service WEPP Water'; return true">
             Climate</a></b>
           [<a href="/fswepp/wd/clisymbols.html" target="_popup"
             onMouseOver="window.status='Explain symbols (new window)';return true"
             onMouseOut="window.status='Forest Service WEPP water';return true">?</a>]
  ...
  <TD align="center" bgcolor="85d2d2">
    <b><a href="JavaScript:submitme('Describe Soil')"
           ...
           onMouseOut="window.status='Forest Service WEPP Water'; return true">Soil Texture</a></b>
       [<a href="/fswepp/docs/weppwaterdoc.html#texture" target="_popup"
           onMouseOver="window.status='Explain soil texture (new window)';return true"
           onMouseOut="window.status='Forest Service WEPP Water'; return true">?</a>]
      </td>
      <td align="center" bgcolor="85d2d2">
       <b><a href="">Soil Restrictive Layer</a></b>
      </td>
      <td align="center" bgcolor="85d2d2">
       <b>Soil Properties</b>
      </td>
...
print <<'theEnd';
       ...
       <td>
        <SELECT NAME="SoilRestiction" SIZE="7"
         onChange="showTexture()"
         onBlur="blankStatus()">
         <OPTION VALUE="clay" selected>decomposed granite
         <OPTION VALUE="loam">user-defined
        </SELECT>
       </td>
       <td>
        <font size=-1>
         <b>Soil Depth</b> (mm)<br>
         <input type="text" size=6 name="soildepth" value="300"><br>
         <b>Anisotropy</b> (units)<br>
         <input type="text" size=6 name="aniso"><br>
         <b>Conductivity</b> (units)<br>
         <input type="text" size=6 name="conduct">
        </font>
       </td>
      </tr>
    </table>
    ...
    <th bgcolor=85d2d2>
     <font face="Arial, Geneva, Helvetica">Treatment
      [<a href="/fswepp/docs/distweppdoc.html#treatment" target="_popup"
         ...
         onMouseOut="window.status='Forest Service WEPP Water';return true">?</a>]
    <th bgcolor=85d2d2>
     <font face="Arial, Geneva, Helvetica">Gradient (%)
...
print <<'theEnd';
      [<a href="/fswepp/docs/distweppdoc.html#cover" target="_popup"
         ...
         onMouseOut="window.status='Forest Service WEPP Water';return true">?</a>]</font>
    <th bgcolor=85d2d2><font face="Arial, Geneva, Helvetica">Rock (%)
...
print "  $remote_host &ndash; $remote_address ($user_really) personality '<b>$me</b>'<br>
  <b>$runs</b>WEPP Water runs since Jan 1, 2007;
  <b>16,760</b> runs in 2006.
  <!-- 19,060 runs in 2005. -->
  <!-- 19,258 runs in 2004. -->
  <!-- 18,950 runs in 2003. -->
  <!-- 12,176 runs in 2002. -->
