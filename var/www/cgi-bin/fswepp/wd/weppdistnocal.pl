...
## Tahoe Basin Sediment Model version history
   ...
   $version = '2011.04.01';	# April Fools Day
...
<html>
<head>
<title>Disturbed WEPP 2.0 (NoCal) Model</title>
  <META http-equiv="Content-Type" content="text/html; charset=utf-8">
  <META NAME="Name" CONTENT="Disturbed WEPP 2.0 (NoCal) Model">
  <META NAME="Brief Description" CONTENT="Disturbed WEPP 2.0 (NoCal) Model, a component of FS WEPP, predicts sedimentation and erosion from rangeland, forestland, and forest skid trails.
...
print '<BODY bgcolor="white"
  ...
  <font face="Arial, Geneva, Helvetica">
   <table width=100% border=0>
    ...
    <td align=center>
       <hr>
       <h3>Disturbed WEPP Model <font color=crimson>(* no calibration *)</font></h3>
       <hr>
    <td>
  ...
  <center>
  <FORM name="weppdist" method="post" ACTION="https://',$wepphost,'/cgi-bin/fswepp/wdnc/wdnocal.pl">
...
print <<'theEnd';
   ...
   <tr>
    ...
    <SELECT NAME="UpSlopeType" SIZE="8" ALIGN="top" onChange="pcover1()";>
     <OPTION VALUE="tree20" selected> Mature forest
     <OPTION VALUE="tree5"> Thin or young forest
...
<font size=-2>
<b>Citation:</b><br>
Elliot, William J.; Hall, David E. 2010. Disturbed WEPP No Cal Model. Ver. ', $version,'.
...
print "  $remote_host &ndash; $remote_address ($user_really) personality '<b>$me</b>'<br>
  <b>$runs</b> Disturbed WEPP Model runs since January 1, 2011
 </body>
</html>
";
