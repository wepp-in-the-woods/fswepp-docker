...
#  $zoop=1;
  $debug=0;
  $weppversion=2000;	# 2014.03.18 DEH
...
#   $rtc=1 if ($parameters{'rtc'} =~ 'on');  			# 2005.10.19 DEH
   ...
   $debug=$parameters{'debug'};					# 2014.03.18 DEH
...
#  $weppversion=2010 if ($weppversion ne '2000' && $weppversion ne '2010');		# DEH 2014.03.18
...
#';
  ...
  <blockquote>
   <pre>
    ...
    WEPP version requested $weppversion
    I am $me
    units = $units
    climate file = $CL
...
";
     ...
     if ($platform eq "pc") {
       ...
       if ($weppversion eq 2010) {@args = ("wine ../wepp2010.100.exe <$responseFile >$stoutFile 2>$sterrFile")}	# DEH 2014.03.18
#      if ($weppversion eq 2008) {@args = ("../wepp2008 <$responseFile >$stoutFile 2>$sterrFile")};  		# DEH 2014.03.18
       if ($weppversion eq 2000) {@args = ("../wepp2000 <$responseFile >$stoutFile 2>$sterrFile")};  		# DEH 2014.03.18
#      {@argws = ("../wepp2000 <$responseFile >$stoutFile 2>$sterrFile")};  # DEH 2009.02.23
