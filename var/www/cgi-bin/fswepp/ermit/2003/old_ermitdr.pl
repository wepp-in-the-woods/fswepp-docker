...
//      newin = window.open('','dry_ravel','width=600,scrollbars=yes,resizable=yes')                                         
      ...
      newin.document.writeln('  <tr><th align="right">Soil texture:</th> <td>' + soiltexture+'</td></tr>')
      newin.document.writeln('  <tr><th align="right">Rock fragment:</th> <td>' + rfg +'%</td></tr>')
      newin.document.writeln('  <tr><th align="right">Top gradient:</th> <td>' + window.document.ermit.top_slope.value + '%</td></tr>')
      newin.document.writeln('  <tr><th align="right">Middle gradient:</th><td>' + window.document.ermit.avg_slope.value + '%</td></tr>')
      newin.document.writeln('  <tr><th align="right">Toe gradient:</th> <td>' + window.document.ermit.toe_slope.value + '%</td></tr>')
      newin.document.writeln('  <tr><th align="right">Fire severity:</th> <td>' + severity + '</td></tr>')
...
function RunningMsg3 (obj, text) {
  ...
  obj.value=text
  document.fswepplogo.src='/images/countdowns/60countdown.gif'
...
//   newin = window.open('','spinner')
   ...
   newin.document.write  ('  <img src=\'/images/countdowns/60countdown')
...
print <<'theEnd1';
       ...
       <TD align="center">
        ...
        <br>
       <a href="/fswepp/docs/ermitdoc.html#rock" target="_popup"
             onMouseOver="window.status='Explain rock fragment (new window)';return true"
             onMouseOut="window.status='Forest Service ERMiT'; return true">
         <b>Rock</a>
     ...
     <tr>
      ...
      <td align="right">
       <b>Top&nbsp;<input type="text" size="5" name="top_slope" value="0"
        ...
        <b>Average&nbsp;<input type="text" size="5" name="avg_slope" value="30"
           onChange="checkRange(avg_slope,'Hillslope average gradient',0,100,20,'%')"
           onFocus="showRange(this.form,'Hillslope average gradient: ',0,100,'%')"
           onBlur="blankStatus()"> %</b>&nbsp;&nbsp;<br>
        <b>Toe&nbsp;<input type="text" size="5" name="toe_slope" value="5"
...
print <<'theEnd';
     ...
     <tr>
      <td colspan="4" align="center" bgcolor="85d2d2">
       <a href="/fswepp/docs/ermitdoc.html#prefirecommunity" target="_popup"
          onMouseOver="window.status='Explain prefire community (new window)';return true"
          onMouseOut="window.status='Forest Service ERMiT'; return true">
        <b>Range/chaparral prefire community description</b></a><br>
