...
theEnd
print '<BODY background="under_dev.gif"
...
print <<'theEnd';
     ...
     <tr>
      ...
      <th bgcolor=85d2d2 valign="top">
       <a href="/fswepp/docs/ermitdoc.html#topography" target="_popup"
             ...
             onMouseOut="window.status='Forest Service ERMiT'; return true">
          Hillslope gradient</a><br>%
      </th>
      <th bgcolor=85d2d2 valign="top">
       <a href="/fswepp/docs/ermitdoc.html#topography" target="_popup"
             onMouseOver="window.status='Explain gradient (new window)';return true"
             onMouseOut="window.status='Forest Service ERMiT'; return true">
          Hillslope horizontal length</a>
      </th>
      <th bgcolor=85d2d2 valign="top">
 ...
 <!--  onfocus="javascript:alert('hoop')"> -->
      ...
      <td>
       &nbsp;&nbsp;<input type="text" size="5" name="top_slope" value="0"> 
        <b>Top</b><br>
       &nbsp;&nbsp;<input type="text" size="5" name="avg_slope" value="30">
        <b>Average</b><br>
       &nbsp;&nbsp;<input type="text" size="5" name="toe_slope" value="5">
        <b>Toe</b>
       </td>
      <td>
       &nbsp;&nbsp;<input type="text" size="5" name="length"  value="100"> m
      </td>
