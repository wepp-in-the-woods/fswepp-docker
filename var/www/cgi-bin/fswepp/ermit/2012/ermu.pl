...
#   remove WGR switch
   ...
   $version='2012.02.28';	# Handle unburned condition
...
#   $zoop = 1 if ($me eq 'q');							# DEH 2006.04.05
   ...
   $severityclass_x = 'unburned' if ($severityclass eq 'u');		#u
   ...
   $count = 10 if ($severityclass eq 'u');	# 2012.02.28 DEH	#u
...
# reads:
  # $s - spatial severity arrangement ("uuu", "lll", "lhl", "hhl" etc.)
...
# $severityclass_x - fire severity class ('unburned','low', 'moderate', 'high')		#u
