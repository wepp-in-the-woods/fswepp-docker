...
## WEPP ERMiT version history
   ...
   $version='2012.02.28';	# Handle unburned baseline condition
...
# 2012.02.28 DEH start adding unburned condition
...
//      newin = window.open('','dry_ravel','width=600,scrollbars=yes,resizable=yes')                                         
      ...
      newin.document.writeln(' <table border=1>')
       ...
       if (window.document.ermit.severity[3].checked) severity = 'unburned'
...
print ' <BODY link="#555555" vlink="#555555" onLoad="StartUp()">
  ...
  <table width=100% border=0>
    ...
    <td align=center>
      ...
      <td>
       <a href="http://',$wepphost,'/fswepp/docs/ermit/" target="docs">
       <img src="http://',$wepphost,'/fswepp/images/epage.gif" title="Read ERMiT documentation online"
  ...
  <FORM name="ermit" method="post" ACTION="http://',$wepphost,'/cgi-bin/fswepp/ermit/ermu.pl">
...
print <<'theEnd';
      <td>
       ...
       <input type="radio" name="severity" value="u" onClick='document.burnsevpic.src="/fswepp/ermit/images/unburn.gif"'> <b>Unburned</b><br>
      </td>
     </tr>
     <tr>
...
<!-- 1,550 runs in 2004 -->
        ...
        <b>',$runs,'</b> ERMiT runs since Jan 01, 2011<br>
        ',$user_ID_really,' Personality "<b>',$me,'</b>"<br>
';
  if ($debug) {print "
...
print '
      ...
      <td valign="top" rowspan=2>
       <a href="http://',$wepphost,'/fswepp/comments.html" title="Send comments to the FS WEPP development team"><img src="/fswepp/images/epaemail.gif" align="right" border=0></a>
      </td>
     </tr>
     <tr>
