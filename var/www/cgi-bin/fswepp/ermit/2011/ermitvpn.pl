...
#  ERMiT input screen
#
#  ermitvpn.pl -- input screen for ERMiT

## BEGIN HISTORY ###################################
## WEPP ERMiT version history

   $version='2011.06.27';	# Allow user-specified IP for climate use -- parameter 'ip'
...
####  VPN
    $guest_IP = $parameters{'ip'};
#    if ($dq1 >= 0 && $dq1 <256 && $dq2 >= 0 && $dq2 <256 && $dq3 >= 0 && $dq3 <256 && $dq4 >= 0 && $dq4 <256) {
#      $guest_IP = $dq1 . "." . $dq2 . "." . $dq3 . "." . $dq4;
#    }
####
...
$user_ID_really = $user_ID;				# DEH 06/27/2011
$guest_ID = $guest_IP;					# DEH 06/27/2011
$guest_ID =~ tr/./_/;					# DEH 06/27/2011
    $user_ID =~ tr/./_/;
$user_ID = $guest_ID if ($guest_IP != '');		# DEH 06/27/2011
...
<!-- 1,550 runs in 2004 -->
        ...
        ',$user_ID_really,' Personality "<b>',$guest_IP,$me,'</b>"<br>
';
  if ($debug) {print "
