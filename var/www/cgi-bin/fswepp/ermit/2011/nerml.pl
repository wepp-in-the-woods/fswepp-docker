#! /usr/bin/perl
#
# nerml.pl -- integrate no-burn run
#
# ermit workhorse
...
#   remove WGR switch
   $version='2011.05.16';	# Add no burn option
...
#   $zoop = 1 if ($me eq 'q');							# DEH 2006.04.05
   ...
   $severityclass_x = 'no'       if ($severityclass eq 'n');
   ...
   $count = 10 if ($severityclass eq 'n');	# 2011.05.16 DEH
...
#     $soilFilefq = $datapath . $soilFile;
  ...
  <table width=95% border=0>
    ...
    <td align=center>
       ...
       <hr>
    <td>
       <A HREF="http://',$wepphost,'/fswepp/docs/ermit/.html">
...
';
     ...
     open SOIL, ">$soilFile";
       $s='hhh';
       $k=4;
       $soilfileitself = &createsoilfilen;		# DEH 20110516 none
...
#     if ($debug) {$printfilename = $manFile; &printfile}
     ...
     open SOL, ">$soilFile";
       $s='hhh';
       $k=4;
       print SOL &createsoilfilen;		# DEH 20110516 none
     close SOL;
...
#      print TEMP @run_off[$indx[$runner]],@max_run[$indx[$runner]],"<br>\n";
#    }
#  }
...
#  for $k (0..0) {   #ZZ#
     for $k (0..4) {			#   for conductivity (k) = (l1..l5; h1..h5)
       open SOL, ">$soilFile";
         $mySoilFile = &createsoilfilen;				# DEH 20110516 none
...
<!== == == ==  ALL NEW TABLE == == == ->
    ...
    <table border=1>
     <tr><th colspan=6 bgcolor="gold">Mitigation Treatment Comparisons</th></tr>
     <tr>
      ...
      <th colspan=5 bgcolor="lightgoldenrodyellow">
       <a href="javascript:showpt()"
             onMouseOver="window.status='Display sediment yield--probability table (new window)'; return true"
             onMouseOut="window.status=''; return true"><img src="/fswepp/images/printer.png" border="0" alt="[display table]"></a>
       &nbsp;&nbsp;&nbsp;
       Event sediment delivery (<script>document.writeln(js_sedunits)</script>)
       &nbsp;&nbsp;&nbsp;
       <a href="javascript:printseds()"
             onMouseOver="window.status='Display sediment delivery paragraphs (new window)'; return true"
             onMouseOut="window.status=''; return true"><img src="/fswepp/images/printer.png" border="0" alt="[display table]"></a>
      </th>
     </tr>
     <tr>
...
<!-- untreated -->
     <tr>
      <th bgcolor="lightgoldenrodyellow" align="right">
       Untreated <a href="javascript:showtable('cp','untreated','Untreated')"
             onMouseOver="window.status='Display untreated sediment yield--probability of exceedance table (new window)'; return true"
             onMouseOut="window.status=''; return true"><img src="/fswepp/images/printer.png" border=0 alt="[?]"></a>&nbsp;
      </th>
...
<!-- seeding -->
     <tr>
      <th bgcolor="lightgoldenrodyellow" align="right">
       Seeding <a href="javascript:showtable('cp_s','seed','Seeding after fire')"
             onMouseOver="window.status='Display seeding sediment yield--probability of exceedance table (new window)'; return true"
             onMouseOut="window.status=''; return true"><img src="/fswepp/images/printer.png" border=0 alt="[?]"></a>&nbsp;
      </th>
     ...
     <tr>
      <th bgcolor="lightgoldenrodyellow" align="right">
       ...
       <a href="javascript:showtable('cp_m47','mulch_47',mulch1a)"
             onMouseOver="window.status='Display mulching sediment yield--probability of exceedance table (new window)'; return true"
             onMouseOut="window.status=''; return true"><img src="/fswepp/images/printer.png" border=0 alt="[?]"></a>&nbsp;
      </th>
...
<!-- mulch 94% -->
     ...
     <tr>
      <td bgcolor="gold" colspan=6>Erosion Barriers: 
       <font size=-1>
         Diameter <input type="text" name="diameter" value ="0" size="5" onChange="javascript:logchange()"> <script>document.write(js_units)</script>&nbsp;
         Spacing <input type="text" name="spacing" value="50" size="5" onChange="javascript:logchange()"> <script>document.write(js_units)</script>&nbsp;
...
<!-- contour-felled logs -->
     <tr>
      <th bgcolor="gold" align="right">
       Logs &amp; Wattles&nbsp;&nbsp;<a href="javascript:logtable()"
             onMouseOver="window.status='Display log & wattle efficiency tables (new window)'; return true"
             onMouseOut="window.status=''; return true"><img src="/fswepp/images/printer.png" border="0" alt="[print table]"></a>&nbsp;
       <br>
       <div align="right">
        <font size=-1>
EOP2
...
<!== == == ==  END NEW TABLE == == == ->
  ...
  <br>
  <font face="trebuchet, tahoma, arial, helvetica, sans serif" size=-2>
       [ <a href="javascript:showpt()"
             onMouseOver="window.status='Display sediment yield--probability table (new window)'; return true"
             onMouseOut="window.status=''; return true">Sediment yield--probability table</a> ]
<br>
       [ <a href="javascript:printseds()"
             onMouseOver="window.status='Display sediment delivery paragraphs (new window)'; return true"
             onMouseOut="window.status=''; return true">Sediment delivery paragraphs</a> ]
<br>Sediment yield--probability of exceedance tables<br>&nbsp;&nbsp;&nbsp;
       [ <a href="javascript:showtable('cp','no_mit','Untreated')"
             onMouseOver="window.status='Display untreated sediment yield--probability of exceedance table (new window)'; return true"
             onMouseOut="window.status=''; return true">untreated</a> |

       <a href="javascript:showtable('cp_s','seed','Seeding after fire')"
             onMouseOver="window.status='Display seeding sediment yield--probability of exceedance table (new window)'; return true"
             onMouseOut="window.status=''; return true">seeding</a> |
mulching 
       <a href="javascript:showtable('cp_m47','mulch_47',mulch1a)"
             onMouseOver="window.status='Display 47% cover mulching sediment yield--probability of exceedance table (new window)'; return true"
             onMouseOut="window.status=''; return true">47% cover</a> |

       <a href="javascript:showtable('cp_m72','mulch_72',mulch2a)"
             onMouseOver="window.status='Display 72% cover mulching sediment yield--probability of exceedance table (new window)'; return true"
             onMouseOut="window.status=''; return true">72% cover</a> |

       <a href="javascript:showtable('cp_m89','mulch_89',mulch3a)"
             onMouseOver="window.status='Display 89% cover mulching sediment yield--probability of exceedance table (new window)'; return true"
             onMouseOut="window.status=''; return true">89% cover</a> |

       <a href="javascript:showtable('cp_m94','mulch_94',mulch4a)"
             onMouseOver="window.status='Display 94% cover mulching sediment yield--probability of exceedance table (new window)'; return true"
             onMouseOut="window.status=''; return true">94% cover</a> ]
<br>
       [ <a href="javascript:logtable()"
             onMouseOver="window.status='Display log & wattle efficiency tables (new window)'; return true"
             onMouseOut="window.status=''; return true">Log & straw wattle efficiency tables</a> ]
<br>
EOP2a
print '
  <hr>
  <font size=-2>
   ...
   <p align="left" class="Reference">
        ...
        2006.
        <b>Erosion Risk Management Tool (ERMiT) Ver. <a href="javascript:popuphistory()">',$version,'</a>.</b>
...
sub lhtoab {	# ######################### lhtoab  2011.05.16

# reads:
  # $s - spatial severity arrangement ("lll", "lhl", "hhl", "nnn" etc.)
...
# returns:
 ...
 if (lc($s) eq "nnn")  			 { $ab = 'aaa'; $nofe = 1 }	### aaa.slp ###
...
# print TEMP "checking $stoutFile for successful run ... ";
       $found = 0;
       while (<weppstout>) {
...
// set minimum values for log spacing and slope (both in denominator of equation)
   var slope_max = 100		// %
   var slope_min = 0.05		// %
   var spacing_min = 1.5		// m was 3
   var spacing_max = 25		// m was 50
   var spacing_def = 5		// m was 10
   var diam_min = 0.05		// m
   var diam_max = 1		// m
   var diam_def = 0.3		// m

   if (js_units == 'ft') {
     spacing_min = 5		// ft was 5
     spacing_max = 82	  	// ft was 165
     spacing_def = 20		// ft was 40
     diam_min = 0.15		// ft
     diam_max = 3.5		// ft
     diam_def = 1		// ft
   }
...
//   coeff_spacing = 544		// spacing in m
     ...
     var eff_4 = eff_3 * 0.45;   //  if (eff_4<0) {eff_4=0}; if (eff_4>100) {eff_4=100} // 2005.11.02
...
//   var sediment_0=logtable.getElementById('sediment0').innerHTML
//   var sediment_1=logtable.getElementById('sediment1').innerHTML
//   var sediment_2=logtable.getElementById('sediment2').innerHTML
//   var sediment_3=logtable.getElementById('sediment3').innerHTML
//   var sediment_4=logtable.getElementById('sediment4').innerHTML
...
//   diameter[1] = 0.091	// m 0.30' (3.6")
    ...
    log_table.document.writeln('    '+js_climate_name+'<br>'+js_soil_texture+'; '+js_rfg+'% rock; '+js_top_slope+'%, '+js_avg_slope+'%,'+js_toe_slope+'% slope; '+js_hillslope_length+' '+ js_units+'; '+js_severityclass_x+' soil burn severity<br>[Run ID '+js_unique+']<br>')
...
//       log_table.document.writeln('     <th bgcolor=#33ccff><font size=3>YEAR '+yr+'</font></th>')
       if (yr==0) log_table.document.writeln('     <th bgcolor=#33ccff><font size=3>1st year</font></th>')
       if (yr==1) log_table.document.writeln('     <th bgcolor=#33ccff><font size=3>2nd year</font></th>')
       if (yr==2) log_table.document.writeln('     <th bgcolor=#33ccff><font size=3>3rd year</font></th>')
       if (yr==3) log_table.document.writeln('     <th bgcolor=#33ccff><font size=3>4th year</font></th>')
       if (yr==4) log_table.document.writeln('     <th bgcolor=#33ccff><font size=3>5th year</font></th>')
       log_table.document.writeln('     <th bgcolor=#33ccff colspan='+diameter.length+'><font size=2>')
...
//       capacity = capacity_m
//       if (js_units == 'ft') {capacity=0.4461*capacity_m} 	// capacity in user units ton/ac or Mg/ha
         max_caught = capacity * eff[yr]/100; 	// if (max_caught>sediment_0) {max_caught=sediment_0}
...
function showpt() {
  ...
  newinpt.document.writeln('   '+js_climate_name+'<br>'+js_soil_texture+'; '+js_rfg+'% rock; '+js_top_slope+'%, '+js_avg_slope+'%,'+js_toe_slope+'% slope; '+js_hillslope_length+' '+ js_units+'; '+js_severityclass_x+' soil burn severity<br>[Run ID '+js_unique+']')
...
#  $rfg = 20;      # percentage of rock fragments (by volume) in the layer (%)
  ...
  if ($string eq 'lll' || $string eq 'hhh' || $string eq 'nnn') { $nofe = 1 }
...
# skip:
  ...
  @n[0] = @ki_n[0] . "\t" . @kr_n[0] . "\t" . $tauc_n . "\t" . @ksat_n[0];
  @n[1] = @ki_n[1] . "\t" . @kr_n[1] . "\t" . $tauc_n . "\t" . @ksat_n[1];
  @n[2] = @ki_n[2] . "\t" . @kr_n[2] . "\t" . $tauc_n . "\t" . @ksat_n[2];
  @n[3] = @ki_n[3] . "\t" . @kr_n[3] . "\t" . $tauc_n . "\t" . @ksat_n[3];
  @n[4] = @ki_n[4] . "\t" . @kr_n[4] . "\t" . $tauc_n . "\t" . @ksat_n[4];
...
sub soil_parametersn {   # 2011.05.16
 ...
 # @ki_n[0..4]          # no   soil burn severity baseline interrill erodibility (ki) (kg s/m^4)
 ...
 # @kr_n[0..4]          # no   soil burn severity baseline rill erodibility (kr) (s/m)
 ...
 # $tauc_n              # no   soil burn severity baseline critical shear (shcrit) (N/m^2)
 ...
 # @ksat_n[0..4]        # no   severity effective hydraulic conductivity of surface soil (avke) (mm/h)
 ...
 # @ksat_h[0..4]        # high severity effective hydraulic conductivity of surface soil (avke) (mm/h)
  ...
  if ($vegtype eq 'forest') {
    if ($SoilType eq 'sand') {
      ...
      $tauc_l=2;
      $tauc_h=2;
      @ki_n[0] =  300000; @kr_n[0] = 0.0000030; @ksat_n[0] = 48;      #
      @ki_n[1] =  500000; @kr_n[1] = 0.00034;   @ksat_n[1] = 46;
      @ki_n[2] =  700000; @kr_n[2] = 0.00037;   @ksat_n[2] = 44;
      @ki_n[3] = 1000000; @kr_n[3] = 0.00040;   @ksat_n[3] = 24;
      @ki_n[4] = 1200000; @kr_n[4] = 0.00045;   @ksat_n[4] = 14;
    ...
    if ($SoilType eq 'silt') {
      ...
      $tauc_l = 3.5;
      $tauc_h = 3.5;
      @ki_n[0] =  250000; @kr_n[0] = 0.0000020; @ksat_n[0] = 33;      #
      @ki_n[1] =  300000; @kr_n[1] = 0.00024;   @ksat_n[1] = 31;
      @ki_n[2] =  400000; @kr_n[2] = 0.00027;   @ksat_n[2] = 29;
      @ki_n[3] =  500000; @kr_n[3] = 0.00030;   @ksat_n[3] = 19;
      @ki_n[4] =  600000; @kr_n[4] = 0.00035;   @ksat_n[4] =  9;
    ...
    if ($SoilType eq 'clay') {
      ...
      $tauc_l = 4;
      $tauc_h = 4;
      @ki_n[0] =  200000; @kr_n[0] = 0.0000010; @ksat_n[0] = 25;      #
      @ki_n[1] =  250000; @kr_n[1] = 0.00014;   @ksat_n[1] = 24;
      @ki_n[2] =  300000; @kr_n[2] = 0.00017;   @ksat_n[2] = 23;
      @ki_n[3] =  400000; @kr_n[3] = 0.00020;   @ksat_n[3] = 14;
      @ki_n[4] =  500000; @kr_n[4] = 0.00025;   @ksat_n[4] =  8;
    ...
    if ($SoilType eq 'loam') {
      ...
      $tauc_l = 3;
      $tauc_h = 3;
      @ki_n[0] =  320000; @kr_n[0] = 0.0000015; @ksat_n[0] = 40;      #
      @ki_n[1] =  370000; @kr_n[1] = 0.00019;   @ksat_n[1] = 38;
      @ki_n[2] =  470000; @kr_n[2] = 0.00022;   @ksat_n[2] = 36;
      @ki_n[3] =  600000; @kr_n[3] = 0.00025;   @ksat_n[3] = 28;
      @ki_n[4] =  800000; @kr_n[4] = 0.00030;   @ksat_n[4] = 18;
...
sub soil_parameters {	# 2006.06.20 adjusted range values to match 'Working Range Soil Tables(Simanton_krs).xlstable' (4/25/2006)
...
sub soil_parameters_old { # range values have been changed
...
#      if ($rtc) {$tauc_l=3; $tauc_h=3}
    ...
    $pgrass = $grass / 100;
    $pbare = $bare / 100;
#   $orgmat = 1 if ($me eq 'o');			########################## OM

    for ($i=0; $i<5; $i++) {
      @ki_l[$i]   = $pshrub * @ki_shrub_l[$i] + $pgrass * @ki_grass_l[$i] + $pbare * @ki_bare_l[$i];
      @ki_h[$i]   = $pshrub * @ki_shrub_h[$i] + $pgrass * @ki_grass_h[$i] + $pbare * @ki_bare_h[$i];
#      @kr_l[$i]   = $pshrub * @kr_l[$i] + $pgrass * @kr_l[$i] + $pbare * @kr_l[$i];	# 2005.10.31 DEH
#      @kr_h[$i]   = $pshrub * @kr_h[$i] + $pgrass * @kr_h[$i] + $pbare * @kr_h[$i];	# 2005.10.31 DEH
      @ksat_l[$i] = $pshrub * @ks_shrub_l[$i] + $pgrass * @ks_grass_l[$i] + $pbare * @ks_bare_l[$i];
      @ksat_h[$i] = $pshrub * @ks_shrub_h[$i] + $pgrass * @ks_grass_h[$i] + $pbare * @ks_bare_h[$i];
    }
#    $, = '  ';
