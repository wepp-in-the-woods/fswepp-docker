...
print ' <BODY link="#555555" vlink="#555555" onLoad="StartUp()">
  ...
  <FORM name="ermit" method="post" ACTION="http://',$wepphost,'/cgi-bin/fswepp/ermit/nerm.pl">
...
print <<'theEnd';
      <td>
       ...
       <input type="radio" name="severity" value="n" onClick='document.burnsevpic.src="/fswepp/ermit/images/noburn.gif"'> <b>None</b><br>
      </td>
     </tr>
     <tr>
