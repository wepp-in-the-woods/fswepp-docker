...
#   echo input parameters
  ...
  print "
    <table border=2>
     ...
     <tr>
      <th bgcolor=85d2d2 valign=\"top\">
       Vegetation<br>type
      </th>
      <th bgcolor=85d2d2 valign=\"top\">
       Hillslope<br>gradient
      </th>
      <th bgcolor=85d2d2 valign=\"top\">
       Hillslope<br>horizontal<br>length
      </th>
      <th bgcolor=85d2d2 valign=\"top\">
       Fire<br>severity<br>class
      </th>
     </tr>
     <tr>
      <td>
      ...
      <td>
       $avg_slope % average<br>
       $toe_slope % toe
      </td>
      <td>
       $hillslope_length $units
      </td>
      <td>
       $severityclass
      </td>
    ...
    if ($vegtype ne 'forest') {print "
     <tr>
      <td colspan=\"4\">
        Prefire community $shrub % shrub $grass % grass 
      </td>
     </tr>
     <tr>
      <td colspan=\"4\">
...
<p>
<a href="javascript:percentages(1)">1</a> --
...
<a href="javascript:percentages(100)">1</a> year
</form>
<p>
<!--<img src="gostone.gif">-->
<br>
