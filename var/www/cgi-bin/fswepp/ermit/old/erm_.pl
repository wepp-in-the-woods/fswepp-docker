...
#### 2003 units
      if ($units eq 'ft') {
         ...
         $max_sed_del_f = sprintf '%9.2f', $max_sed_del / $hillslope_length_m * 4.45;
            # kg per m / m length * 4.45 --> t per ac
      }
      else {
         $run_off_f = @run_off[$indx[0]];
         $max_precip_f = $max_precip;
         $max_sed_del_f = $max_sed_del / $hillslope_length * 10;
...
";
    ...
    ($interrill_det,$avg_det,$max_det,$det_pt,
     ...
     if (@run_off[$indx[$years]] eq '') {
       ...
       $min_sed_del_f = sprintf '%9.2f', $min_sed_del / $hillslope_length_m * 4.45;
     }
     else {
       $run_off_f = @run_off[$indx[$years]];
       $min_precip_f = $min_precip;
       $min_sed_del_f = $min_sed_del / $hillslope_length * 10;
     }
...
<form name="doit">
 <table border="1" bgcolor="ffff99">
  ...
  <tr>
   <td colspan="3">
 <script>
  seds = whatseds (0.1, cp0)
  seds = rounder(seds*js_sedconv,2)
  document.writeln(' There is a ')
  document.writeln(' <input type="text" name="probability0" onChange="javascript:probchange(0)" value="10" size="8">')
  ...
  document.writeln(js_sedunits +' in the year following the fire.<br>')
  seds = rounder(whatseds (0.1, cp1)*js_sedconv,2)
  document.writeln(' <input type="hidden" name="probability1" onChange="javascript:probchange(1)" value="10" size="8">')
  ...
  document.writeln(' <input type="hidden" name="probability2" onChange="javascript:probchange(2)" value="10" size="8">')
  ...
  document.writeln(' <input type="hidden" name="probability3" onChange="javascript:probchange(3)" value="10" size="8">')
  ...
  document.writeln(' <input type="hidden" name="probability4" onChange="javascript:probchange(4)" value="10" size="8">')
...
<form name="seeding">
 ...
 <script>
  ...
  document.writeln(' t ha<sup>-1</sup> in the year following the fire.<br>')
 </script>
   </td>
  </tr>
 </table>
...
<p>
<a href="JavaScript:window.history.go(-1)"><img src="images/rtis.gif" alt="Return to input screen" border="0" align=center></a>
</center>
  <p>
  <hr>
<a href="http://forest.moscowfsl.wsu.edu/fswepp/comments.html"><img src="images/epaemail.gif" align="right" border=0></a>
ERMiT v. 2003.03.06 (for review only). 
...
function sedchange (year) {
  ...
  var default_sed_del = rounder((sed_del_max-sed_del_min)/2,2)
    ...
    prob0 = whatprob (sedval/js_sedconv, eval('cp0'))
    prob1 = whatprob (sedval/js_sedconv, eval('cp1'))
    prob2 = whatprob (sedval/js_sedconv, eval('cp2'))
    prob3 = whatprob (sedval/js_sedconv, eval('cp3'))
    prob4 = whatprob (sedval/js_sedconv, eval('cp4'))
...
function probchange (year) {
  ...
  if (!isNumber (document.doit.probability0.value)) {document.doit.probability0.value = 10}
  if (document.doit.probability0.value < 0.1) {document.doit.probability0.value = .1}
  if (document.doit.probability0.value > 99.9) {document.doit.probability0.value = 99.9}
  var myprob = document.doit.probability0.value / 100
  ...
  seds0 = whatseds (myprob, eval('cp0')) * js_sedconv
  seds1 = whatseds (myprob, eval('cp1')) * js_sedconv
  seds2 = whatseds (myprob, eval('cp2')) * js_sedconv
  seds3 = whatseds (myprob, eval('cp3')) * js_sedconv
  seds4 = whatseds (myprob, eval('cp4')) * js_sedconv
...
//  document.doit.sediment.value = ''
  ...
  if (year == 1) {
   ...
   if (document.doit.probability1.value < 0.1) {document.doit.probability1.value = .1}
  ...
  if (year == 2) {
   ...
   if (document.doit.probability2.value < 0.1) {document.doit.probability2.value = .1}
  ...
  if (year == 3) {
   ...
   if (document.doit.probability3.value < 0.1) {document.doit.probability3.value = .1}
  ...
  if (year == 4) {
   ...
   if (document.doit.probability4.value < 0.1) {document.doit.probability4.value = .1}
...
function showtable () {
  ...
  for (var i=1; i<= sed_del.length; i++) {
   ...
   newin.document.writeln(' <td><font face="Tahoma, Arial, Helvetica, sans serif">' + rounder(cp2[i]*100,2)+'<\/td>')
   newin.document.writeln(' <td><font face="Tahoma, Arial, Helvetica, sans serif">' + rounder(cp3[i]*100,2)+'<\/td>')
   newin.document.writeln(' <td><font face="Tahoma, Arial, Helvetica, sans serif">' + rounder(cp4[i]*100,2)+'<\/td></tr>')
  }
...
function printprobs() {
  ...
  newin.document.write  (document.doit.sediment0.value + ' ' +js_alt_sedunits)
  newin.document.writeln(' in the first year following the fire.<br>')
  newin.document.write  ('   There is a ')
  newin.document.write  (document.doit.probability1.value)
  newin.document.write  ('% chance that sediment yield will exceed ')
  newin.document.write  (document.doit.sediment1.value + ' '+js_alt_sedunits)
  newin.document.writeln(' in the second year following the fire.<br>')
  newin.document.write  ('   There is a ')
  newin.document.write  (document.doit.probability2.value)
  newin.document.write  ('% chance that sediment yield will exceed ')
  newin.document.write  (document.doit.sediment2.value + ' '+js_alt_sedunits)
  newin.document.writeln(' in the third year following the fire.<br>')
  newin.document.write  ('   There is a ')
  newin.document.write  (document.doit.probability3.value)
  newin.document.write  ('% chance that sediment yield will exceed ')
  newin.document.write  (document.doit.sediment3.value + ' '+js_alt_sedunits)
  newin.document.writeln(' in the fourth year following the fire.<br>')
  newin.document.write  ('   There is a ' + document.doit.probability4.value)
  newin.document.writeln('% chance that sediment yield will exceed ' + document.doit.sediment4.value + ' '+js_alt_sedunits + ' in the fifth year following the fire.<br>')
...
set label '$climate_name' at screen 1,1 right font 'sans serif,16'
set key bottom
