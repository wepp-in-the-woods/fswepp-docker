...
#  $debug=1;
  ...
  $weppversion = 2010;	# 2014.02.07 DEH 2000 or 2010; WEPP 2010 needs frost.txt file in ERMiT directory to give 'correct' results
...
<!-- 2012.06.27 value="10" to value="20" -->
      ...
      <th colspan=5 bgcolor="lightgoldenrodyellow">
       <a href="javascript:showpt()">
          <img src="/fswepp/images/printer.png" border="0" alt="[table]" title="Display sediment yield--probability table"></a>
       &nbsp;&nbsp;&nbsp;
...
//    document.getElementById('probability0x').innerHTML = 5			//////////////////  2015   ////////////////
...
// sediment caught is capacity (Mg/ha or ton/ac) * efficiency, but not more than what is produced
     ...
     alert (rounder(sediment_0-caught_0,2))
