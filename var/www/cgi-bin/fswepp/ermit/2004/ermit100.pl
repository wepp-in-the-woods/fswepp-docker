...
#   $version = '2003.09.04';
#   $version = '2004.08.30';
    $version = 'ermit100 2004.09.16';

#  2004.09.16 DEH Add Fred Pierson, USDA_ARS to tagline; reduce fontsize of tagline; remove "Rock" link to dox.
...
#  2003.03.04 DEH Remove 'host' echo; add Pete at end; reinstate "Risk"
...
//      newin.document.writeln('    <td align="center" bgcolor="#333333"><font face="verdana,arial,helvetica" size="1"><img src="/fswepp/images/shift_anim_on.gif" width=6 height=6 border=0>&nbsp;&nbsp;<a href="javascript:self.close()">Close me</a></font></td>')
  ...
  function explain_rock_content () {
    ...
    if (newWin != null) {
      ...
      newin.document.writeln('    <br><br>')
      newin.document.writeln('    Any surface rocks need to be accounted for in the surface cover.')
      newin.document.writeln('    For example, if after a fire there is 50 percent surface cover remaining from vegetation,')
      newin.document.writeln('    and 20 percent of the bare soil is covered with rock, the correct surface cover')
      newin.document.writeln('    including vegetation and rock is 60 percent')
      newin.document.writeln('    (50 percent vegetation + 20 percent rock * 50 percent bare).')
      newin.document.writeln('    In this context, as surface cover due to rock increases, the cover should be increased;')
      newin.document.writeln('    both runoff and erosion will be reduced.')
      newin.document.writeln('    <br><br>')
      newin.document.writeln('    Our interface currently does not automatically add rock content to surface cover,')
      newin.document.writeln('    as there are cases where that may be inappropriate.')
...
//      newin.document.writeln('    <td align="center" bgcolor="#333333"><font face="verdana,arial,helvetica" size="1"><img src="/fswepp/images/shift_anim_on.gif" width=6 height=6 border=0>&nbsp;&nbsp;<a href="javascript:self.close()">Close me</a></font></td>')
  ...
  function explain_hill_gradient () {
    ...
    if (newWin != null) {
      newin.document.writeln('<HTML>')
      newin.document.writeln(' <HEAD>')
      newin.document.writeln('  <title>ERMiT hillslope gradient</title>')
      newin.document.writeln('  <style>')
      newin.document.writeln('   BODY')
      newin.document.writeln('   {scrollbar-base-color:666666;scrollbar-face-color:#333333;scrollbar-highlight-color:#333333;scrollbar-shadow-color:666666;scrollbar-dark-shadow-color:ffffcc;scrollbar-arrow-color:ff6600}')
      newin.document.writeln('   .question {color:ffffcc}')
      ...
      newin.document.writeln(' <body bgcolor="ivory" onLoad="top.window.focus()" link="white" vlink="white">')
      newin.document.writeln('  <font face="tahoma, sans serif">')
      newin.document.writeln('   <h3>ERMiT hillslope gradient</h3>')
      newin.document.writeln('    The topographic input for ERMiT includes a gradient for the top of the slope,')
      newin.document.writeln('     a gradient for the toe of the slope,')
      newin.document.writeln('     and an average gradient of the main part of the slope.')
      newin.document.writeln('     <br>')
      newin.document.writeln('     The <b>top</b> gradient is zero if the top of the slope starts at the top of the hill.')
      newin.document.writeln('     <br>')
      newin.document.writeln('     The <b>middle</b> gradient is the steepness at the center or the average gradient of the hillslope.')
      newin.document.writeln('     <br>')
      newin.document.writeln('     These values may be obtained from a field survey, forest map, or a GIS database.')
      newin.document.writeln('     <br><br>')
      newin.document.writeln('     <img src="/fswepp/images/ermit/hillslope.gif"><br>')
      newin.document.writeln('     <br><br>')
      newin.document.writeln('     <font size=2>')
      newin.document.writeln('      ERMiT v. ' + version + ' <i>explain_hill_gradient</i>')
      newin.document.writeln('     </font>')
      newin.document.writeln('<!--tool bar begins--><p>')
      newin.document.writeln('  <table bgcolor="#666666" width="40%" border="0" cellspacing="1" cellpadding="5" align="center">')
      newin.document.writeln('   <tr>')
  ...
  function explain_hill_length () {
    ...
    if (newWin != null) {
      newin.document.writeln('<HTML>')
      newin.document.writeln(' <HEAD>')
      newin.document.writeln('  <title>ERMiT hillslope length</title>')
      newin.document.writeln('  <style>')
      newin.document.writeln('   BODY')
      newin.document.writeln('   {scrollbar-base-color:666666;scrollbar-face-color:#333333;scrollbar-highlight-color:#333333;scrollbar-shadow-color:666666;scrollbar-dark-shadow-color:ffffcc;scrollbar-arrow-color:ff6600}')
      newin.document.writeln('   .question {color:ffffcc}')
      ...
      newin.document.writeln(' <body bgcolor="ivory" onLoad="top.window.focus()" link="white" vlink="white">')
      newin.document.writeln('  <font face="tahoma, sans serif">')
      newin.document.writeln('   <h3>ERMiT hillslope horizontal length</h3>')
      newin.document.writeln('     These values may be obtained from a field survey, forest map, or a GIS database.')
      newin.document.writeln('     <br><br>')
      newin.document.writeln('     <img src="/fswepp/images/ermit/hillslope.gif"><br>')
      newin.document.writeln('     <br><br>')
      newin.document.writeln('     <font size=2>')
      newin.document.writeln('      ERMiT v. ' + version + ' <i>explain_hill_length</i>')
      newin.document.writeln('     </font>')
      newin.document.writeln('<!--tool bar begins--><p>')
      newin.document.writeln('  <table bgcolor="#666666" width="40%" border="0" cellspacing="1" cellpadding="5" align="center">')
      newin.document.writeln('   <tr>')
  ...
  function explain_fire_severity () {
    ...
    if (newWin != null) {
      newin.document.writeln('<HTML>')
      newin.document.writeln(' <HEAD>')
      newin.document.writeln('  <title>ERMiT fire severity</title>')
      newin.document.writeln('  <style>')
      newin.document.writeln('   BODY')
      newin.document.writeln('   {scrollbar-base-color:666666;scrollbar-face-color:#333333;scrollbar-highlight-color:#333333;scrollbar-shadow-color:666666;scrollbar-dark-shadow-color:ffffcc;scrollbar-arrow-color:ff6600}')
      newin.document.writeln('   .question {color:ffffcc}')
      ...
      newin.document.writeln('  <script language="JavaScript">')

      newin.document.writeln('     function HighChecked() {')
      newin.document.writeln('     document.man.hhh.checked=true')
      newin.document.writeln('     document.man.hhl.checked=true')
      newin.document.writeln('     document.man.hlh.checked=true')
      newin.document.writeln('     document.man.lhh.checked=true')
      newin.document.writeln('     document.man.llh.checked=false')
      newin.document.writeln('     document.man.lhl.checked=false')
      newin.document.writeln('     document.man.hll.checked=false')
      newin.document.writeln('     document.man.lll.checked=false')
      newin.document.writeln('     document.man.hhh.disabled=true')
      newin.document.writeln('     document.man.hhl.disabled=true')
      newin.document.writeln('     document.man.hlh.disabled=true')
      newin.document.writeln('     document.man.lhh.disabled=true')
      newin.document.writeln('     document.man.llh.disabled=true')
      newin.document.writeln('     document.man.lhl.disabled=true')
      newin.document.writeln('     document.man.hll.disabled=true')
      newin.document.writeln('     document.man.lll.disabled=true')
      newin.document.writeln('     document.animated.src="/fswepp/images/ermit/high.gif"')
      newin.document.writeln('    }')

      newin.document.writeln('    function ModerateChecked() {')
      newin.document.writeln('     document.man.hhh.checked=false')
      newin.document.writeln('     document.man.hhl.checked=false')
      newin.document.writeln('     document.man.hlh.checked=true')
      newin.document.writeln('     document.man.lhh.checked=true')
      newin.document.writeln('     document.man.llh.checked=true')
      newin.document.writeln('     document.man.lhl.checked=true')
      newin.document.writeln('     document.man.hll.checked=false')
      newin.document.writeln('     document.man.lll.checked=false')
      newin.document.writeln('     document.man.hhh.disabled=true')
      newin.document.writeln('     document.man.hhl.disabled=true')
      ...
      newin.document.writeln('     document.man.hll.disabled=true')
      newin.document.writeln('     document.man.lll.disabled=true')
      newin.document.writeln('     document.animated.src="/fswepp/images/ermit/med.gif"')
      newin.document.writeln('    }')

      newin.document.writeln('    function LowChecked() {')
      newin.document.writeln('     document.man.hhh.checked=false')
      newin.document.writeln('     document.man.hhl.checked=false')
      newin.document.writeln('     document.man.hlh.checked=false')
      newin.document.writeln('     document.man.lhh.checked=false')
      newin.document.writeln('     document.man.llh.checked=true')
      newin.document.writeln('     document.man.lhl.checked=true')
      newin.document.writeln('     document.man.hll.checked=true')
      newin.document.writeln('     document.man.lll.checked=true')
      newin.document.writeln('     document.man.hhh.disabled=true')
      newin.document.writeln('     document.man.hhl.disabled=true')
      newin.document.writeln('     document.man.hlh.disabled=true')
      newin.document.writeln('     document.man.lhh.disabled=true')
      ...
      newin.document.writeln('     document.man.hll.disabled=true')
      newin.document.writeln('     document.man.lll.disabled=true')
      newin.document.writeln('     document.animated.src="/fswepp/images/ermit/low.gif"')
      newin.document.writeln('    }')

      newin.document.writeln('  <' + '/script>')

      newin.document.writeln(' </HEAD>')
      newin.document.writeln(' <body bgcolor="ivory" onLoad="top.window.focus()" link="white" vlink="white">')
      newin.document.writeln('  <font face="tahoma, sans serif">')
      newin.document.writeln('   <h3>ERMiT fire severity class</h3>')

      newin.document.writeln('Fire effects on erosion are not homogenous (Robichaud and Miller 2000).')
      newin.document.writeln('   Fire severity is a description of the impact of a fire on the soil and its litter layer.')
      newin.document.writeln('   The severity of a fire varies widely in space, depending on fuel load, moisture conditions and weather at the time of fire, and the topography.')
      newin.document.writeln('   Variability in fire often creates variability in severity, leading to mosaic landscapes.')
      newin.document.writeln('   Areas that are drier, such as those near ridge tops, and areas with greater amounts of fuel, may experience higher severity fires.')
      newin.document.writeln('   Areas that are wetter, such as riparian areas, will likely have less severe fires.')
      newin.document.writeln('<br><br>')
      newin.document.writeln('The user may select "high," "moderate," or "low" fire severity for the hillside.')
      newin.document.writeln('WEPP will model the hillslope as a set of three overland flow elements (OFEs) up the hill')
      newin.document.writeln('using a variety of burn severities based on the user selection (see live figure below).')
      newin.document.writeln('')
      newin.document.writeln('  <blockquote>')
      newin.document.writeln('   <table bgcolor="lightgrey">')
      newin.document.writeln('    <tr>')
      newin.document.writeln('     <th>')
      newin.document.writeln('      <hr width=40%>')

      newin.document.writeln('      <h3 align=center>Select a fire severity class</h3>')
      newin.document.writeln('      <form name="man">')
      newin.document.writeln('       <input type=radio name="management" onClick="HighChecked()">High severity<br>')
      newin.document.writeln('       <input type=radio name="management" onClick="ModerateChecked()">Moderate severity<br>')
      newin.document.writeln('       <input type=radio name="management" onClick="LowChecked()" checked>Low severity<br>')
      newin.document.writeln('       <br><br>')
      newin.document.writeln('       <table border=1 align="center">')
      newin.document.writeln('        <tr>')
      newin.document.writeln('         <th bgcolor=gold>OFE</th>')
      newin.document.writeln('	       <th><input type=checkbox name="hhh" disabled=true></th>')
      newin.document.writeln('	       <th><input type=checkbox name="hhl" disabled=true></th>')
      newin.document.writeln('         <th><input type=checkbox name="hlh" disabled=true></th>')
      newin.document.writeln('         <th><input type=checkbox name="lhh" disabled=true></th>')
      newin.document.writeln('	       <th><input type=checkbox name="llh" disabled=true checked></th>')
      newin.document.writeln('	       <th><input type=checkbox name="lhl" disabled=true checked></th>')
      newin.document.writeln('	       <th><input type=checkbox name="hll" disabled=true checked></th>')
      newin.document.writeln('	       <th><input type=checkbox name="lll" disabled=true checked></th>')
      newin.document.writeln('        </tr>')
      newin.document.writeln('        <tr>')
      newin.document.writeln('         <th bgcolor=gold>Upper<br>Middle<br>Lower</th>')
      newin.document.writeln('         <th>h<br>h<br>h</th>')
      newin.document.writeln('         <th>h<br>h<br>l</th>')
      newin.document.writeln('         <th>h<br>l<br>h</th>')
      newin.document.writeln('         <th>l<br>h<br>h</th>')
      newin.document.writeln('         <th>l<br>l<br>h</th>')
      newin.document.writeln('         <th>l<br>h<br>l</th>')
      newin.document.writeln('         <th>h<br>l<br>l')
      newin.document.writeln('         <th>l<br>l<br>l')
      newin.document.writeln('        </tr>')
      newin.document.writeln('       </table>')
      newin.document.writeln('      </form>')
      newin.document.writeln('     <br><br>')
      newin.document.writeln('     <hr width=40%>')

      newin.document.writeln('     <img name="animated" src="/fswepp/images/ermit/low.gif" border=2 width=300 height=196>')
      newin.document.writeln('     <br><br>')
      newin.document.writeln('     Red indicates a high severity burn, and brown indicates a low severity burn.')
      newin.document.writeln('      </center>')
      newin.document.writeln('     </th>')
      newin.document.writeln('    </tr>')
      newin.document.writeln('   </table>')
      newin.document.writeln('  </blockquote>')
      newin.document.writeln('  <blockquote>')
      newin.document.writeln('   <img src="/fswepp/images/ermit/figure_1.gif"><br><br>')
      newin.document.writeln('  </blockquote>')
      newin.document.writeln('  <br><br>')
      newin.document.writeln('  <font size=2>')
      newin.document.writeln('   ERMiT v. ' + version + ' <i>explain_fire_severity</i>')
      newin.document.writeln('  </font>')
      newin.document.writeln('<!--tool bar begins--><p>')
      newin.document.writeln('  <table bgcolor="#666666" width="40%" border="0" cellspacing="1" cellpadding="5" align="center">')
      newin.document.writeln('   <tr>')
  ...
  function explain_community () {
    ...
    if (newWin != null) {
      newin.document.writeln('<HTML>')
      newin.document.writeln(' <HEAD>')
      newin.document.writeln('  <title>ERMiT prefire community</title>')
      newin.document.writeln('  <style>')
      newin.document.writeln('   BODY')
      newin.document.writeln('   {scrollbar-base-color:666666;scrollbar-face-color:#333333;scrollbar-highlight-color:#333333;scrollbar-shadow-color:666666;scrollbar-dark-shadow-color:ffffcc;scrollbar-arrow-color:ff6600}')
      newin.document.writeln('   .question {color:ffffcc}')
      ...
      newin.document.writeln(' <body bgcolor="ivory" onLoad="top.window.focus()" link="white" vlink="white">')
      newin.document.writeln('  <font face="tahoma, sans serif">')
      newin.document.writeln('   <h3>ERMiT prefire community</h3>')

      newin.document.writeln('If "Range" or "Chaparral" is selected for <i>Vegetation type,</i>')
      newin.document.writeln('then <i>Range/chaparral prefire community description</i> is active.')
...
//      newin = window.open('','dry_ravel','width=600,scrollbars=yes,resizable=yes')                                         
      ...
      newin.document.writeln('  <tr><th align="right">Rock fragment:</th><td align=right>' + rfg +'%</td></tr>')
      ...
      newin.document.writeln('  <tr><th align="right">Fire severity:</th><td align=right>' + severity + '</td></tr>')
      newin.document.writeln('  </table>')
      newin.document.writeln(' <p>')
...
function showTexture()
{
  ...
  if (which == 0)             //clay loam
  ...
  else if (which == 2)       // sandy loam
    {
     ...
     document.ravelgraphic.src='/fswepp/images/ermit/gotravel.gif'                // 2004.09.16
    }
  else                       // loam
    {
     text = 'Loam';
...
theEnd
print ' <BODY background="/fswepp/ermit/under_dev.gif"
  ...
  <center>
  <FORM name="ermit" method="post" ACTION="http://',$wepphost,'/cgi-bin/fswepp/ermit/erm100.pl">
      ...
      <td align="center" bgcolor="85d2d2">
       ...
       <b>Climate</b></a>
        <a href="javascript:explain_climate_symbols()"
           ...
           onMouseOut="window.status='Forest Service ERMiT'; return true">
           <img src="/fswepp/images/questg.gif" width=14 height=12 border=0></a>
      </td>
...
print <<'theEnd1';
       ...
       <TD align="center">
        ...
        <input type="text" name="rfg" size="5" value="20"
           onChange="checkRange(rfg,'rock fragment',0,100,20,'%')"
           onFocus="showRange(this.form,'Rock fragment: ',0,100,'%')"
           onBlur="blankStatus()"> %</b>&nbsp;
         <a href="javascript:explain_rock_content()"
   ...
   <p>
    <table border=2 bgcolor="ivory">
     <tr>
      <th bgcolor=85d2d2>
        Vegetation type
        <a href="javascript:explain_veg_type()"
      ...
      <th bgcolor=85d2d2>
       Hillslope gradient
       <a href="javascript:explain_hill_gradient()"
      ...
      <th bgcolor=85d2d2>
       ...
       <a href="javascript:explain_hill_length()"
      ...
      <th bgcolor=85d2d2>
         Fire severity class
         <a href="javascript:explain_fire_severity()"
          onMouseOver="window.status='Explain fire severity class (new window)'; return true"
          onMouseOut="window.status='Forest Service ERMiT'; return true">
          <img src="/fswepp/images/questg.gif" width=14 height=12 border=0></a>
      </th>
     </tr>
...
print <<'theEnd';
      <td>
       <input type="radio" name="severity" value="h" checked="checked"> <b>High</b><br>
       <input type="radio" name="severity" value="m"> <b>Moderate</b><br>
       <input type="radio" name="severity" value="l"> <b>Low</b><br>
      </td>
     </tr>
     <tr>
      <td colspan="4" align="center" bgcolor="85d2d2">
        <b>Range/chaparral prefire community description</b>
         <a href="javascript:explain_community()"
            onMouseOver="window.status='Explain prefire community (new window)'; return true"
            onMouseOut="window.status='Forest Service ERMiT';return true">
          <img src="/fswepp/images/questg.gif" width=14 height=12 border=0></a>
       </td>
      </tr>
      <tr>
       <td bgcolor="yellow">
          <input name="pct_shrub" size="8" type="text" style="BACKGROUND-COLOR: lightyellow" onblur="javascvript:shrub()"><b> % shrub &nbsp;&nbsp;</b>   <!-- onchange calc others -->
       </td>
       <td bgcolor="lightgreen">
          <input name="pct_grass" size="8" type="text" style="BACKGROUND-COLOR: lightgreen" onblur="javascvript:grass()"><b> % grass &nbsp;&nbsp;</b>   <!-- onchange calc others -->
       </td>
       <td bgcolor="#eeddcc">
          <input name="pct_bare" size="8" type="text" style="BACKGROUND-COLOR: #eeddcc" onblur="javascvript:bare()">  % bare <!-- no change -->
       </td>
     </tr>
  </TABLE>
...
print '><img src="http://',$wepphost,'/fswepp/images/epaemail.gif" align="right" border=0></a>
   ...
   <b>Pete Robichaud</b> and <b>Bill Elliot,</b>
...
print "personality '<b>$me</b>'<br><b>$runs</b> ERMiT runs in 2004<br>\n";
