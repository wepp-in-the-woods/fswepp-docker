...
# note: check how leap years are handled #

# 22 Apr 2004 DEH pump 100-year climate files to 'working' if 'g'
#                 add storm duration estimation calculation
...
print TEMP "<p>
       <table border=1 cellpadding=8 bgcolor='ivory'>
        <tr><th bgcolor='#ffddff'>Ranking of event<br>(return interval)
         ...
         <th bgcolor='#ffddff'>Time to peak tp<br>(fraction)
         <th bgcolor='#ffddff'>Normalized peak int ip<br>
         <th bgcolor='#ffddff'>10-min peak int<br>mm/h
         <th bgcolor='#ffddff'>30-min peak int<br>mm/h
         <th bgcolor='#ffddff'>Storm date<br>Simulation Year
        </tr>
        <tr>
...
### duration DEH 040422 Earth Day 2004
    ...
    $dur = $durr;
    &peak_intensity;
#    if ($error_text ne '') {print "Error: $error_text\n\n";}
##   print $#i_peak,"\n";
#    $, = ' min ';
#    print @max_time_list,"\n";
#    foreach $peak (@i_peak) {
