...
print ' <BODY background="/fswepp/ermit/under_dev__.gif"
  ...
  <center>
  <!-- FORM name="ermit" method="post" ACTION="http://',$wepphost,'/cgi-bin/fswepp/ermit/erm100cfl.pl" -->
  <FORM name="ermit" method="post" ACTION="http://',$wepphost,'/cgi-bin/fswepp/ermit/zerm.pl">
...
print <<'theEnd';
      <td>
       <input type="radio" name="severity" value="h" onClick='document.burnsevpic.src="/fswepp/ermit/images/highburn.gif"'> <b>High</b><br>
       <input type="radio" name="severity" value="m" onClick='document.burnsevpic.src="/fswepp/ermit/images/modburn.gif"'> <b>Moderate</b><br>
       <input type="radio" name="severity" value="l" onClick='document.burnsevpic.src="/fswepp/ermit/images/lowburn.gif"' checked="checked"> <b>Low</b><br>
      </td>
     </tr>
     <tr>
      <td colspan="3" align="center" bgcolor="#85d2d2">
       ...
       <td align=center bgcolor=gray>
        <img name="burnsevpic" src="/fswepp/ermit/images/lowburn.gif" border=0>
       </td>
      </tr>
      <tr>
       <td bgcolor="yellow">
...
#   <b>Frederick B. Pierson</b> and <b>Corey A. Moffet,</b>
...
<b>Citation:</b>
 <p align="left" class="Reference">
        ...
        -->
        <b>',$runs,'</b> ERMiT runs in 2006. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        Personality "<b>',$me,'</b>"<br>
';
  if ($debug) {print "
