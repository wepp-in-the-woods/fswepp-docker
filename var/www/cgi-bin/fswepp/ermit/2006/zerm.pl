...
print TEMP "<p>
       <table border=1 cellpadding=8 bgcolor='ivory'>
        <tr>
         <th bgcolor='#ccffff'><font size=-2>Storm Rank<br>(return interval)</font></th>
...
print '
  ...
  <font size=-2>
   ...
   <p align="left" class="Reference">
        Robichaud, Peter R.; Elliot, William J.; Pierson, Frederick B.; Hall, David E.; Moffet, Corey A.
        2006.
        <b>Erosion Risk Management Tool (ERMiT) Ver. <a href="javascript:popuphistory()">2006.01.18</a>.</b>
        ...
        Frederick B. Pierson and Corey A. Moffet,
...
sub soil_parameters {
 ...
 # @ksat_h[0..4]        # high severity effective hydraulic conductivity of surface soil (avke) (mm/h)
  ...
  if ($vegtype eq 'forest') {
  ...
  else {   # $vegtype ne 'forest'...  # soil parameter values from Moffett and Robichaud 20 APR 06
    if ($SoilType eq 'sand') {
      $solthk = 400;      # depth of soil surface to bottom of soil layer (mm)
      $sand = 55;         # percentage of sand in the layer (%)
      $clay = 10;         # percentage of clay in the layer (%)
    ...
    if ($SoilType eq 'clay') {
      ...
      @ki_shrub_h[4] = 1.721E+5; @ki_grass_h[4] = 8.516E+4; @ki_bare_h[4] = 1.721E+5; @kr_h[4] = 2.702E-3;
    ...
    if ($SoilType eq 'loam') {
      ...
      @ki_shrub_h[3] = 9.286E+4; @ki_grass_h[3] = 2.994E+5; @ki_bare_h[3] = 2.944E+5; @kr_h[3] = 1.570E-3;
