...
# 2004.09.15 DEH Don't throw out first event (screws up list if it is largest of year)
#		 Create gnuplot postscript file then convert eps to png
# 2004.09.14 DEH Finish fix for less than 50 years with runoff events
# 2004.09.13 DEH Allow for short event list
# 		 $tp, $ip = '--' if peak events are 'N/A'
...
# select [5th, 10th, 20th, 50th, 75th] largest runoff event lines
  ...
  @selected_ranks = (5,10,20,50,75);			# 2004.09.16
  @selected_ranks = (5,10,20,50) if ($years1<75);	# 2004.09.16
...
#  $sterrFilePath = $workingpath . 'sterr';
  ...
  if ($debug) {print TEMP "<br>
   ...
   @probClimate = (0.075, 0.075, 0.20, 0.275, 0.375);	# rank 5, 10, 20, 50, 75  DEH 2004.09.16
...
#   for $sn (1..1) {   #ZZ#
#   for $sn (0..7) {
   for $sn (0..3) {		# loop through severities
     $s = $severe[$sn];
...
#   print TEMP @args;
   ...
   @args=  ("convert $gnuplotgrapheps $gnuplotgraphpng");
#  print TEMP @args;
   system @args;
  ...
  <form name="doit">
   ...
   <table border="1" bgcolor="ffff99">
    <tr>
     <td align="center">
      <script>
       sed_del_min = rounder(sed_del[100]*js_sedconv,2)   // 2004.09.16
...
#welog welog welog
  ...
  if ($debug) {}
    ...
    unlink $slopefile;
    unlink $evo_file;
#    unlink $shortCLIfile;	# DEH 2005.09.30 TEMP
    unlink $responseFile;
    unlink $ev_by_evFile;
    unlink $crspfile;
    unlink $stoutfile;
...
sed_del = new MakeArray; sed_del.length = 100  // 2004.09.16
// no mitigation
cp0 = new MakeArray; cp0.length = 100
cp1 = new MakeArray; cp1.length = 100
cp2 = new MakeArray; cp2.length = 100
cp3 = new MakeArray; cp3.length = 100
cp4 = new MakeArray; cp4.length = 100
// seeding
cp_s0 = new MakeArray; cp_s0.length = 100
cp_s1 = new MakeArray; cp_s1.length = 100
cp_s2 = new MakeArray; cp_s2.length = 100
cp_s3 = new MakeArray; cp_s3.length = 100
cp_s4 = new MakeArray; cp_s4.length = 100
// mulch 0.5
cp_mh0 = new MakeArray; cp_mh0.length = 100
cp_mh1 = new MakeArray; cp_mh1.length = 100
cp_mh2 = new MakeArray; cp_mh2.length = 100
cp_mh3 = new MakeArray; cp_mh3.length = 100
cp_mh4 = new MakeArray; cp_mh4.length = 100
// mulch 1.0
cp_mo0 = new MakeArray; cp_mo0.length = 100
cp_mo1 = new MakeArray; cp_mo1.length = 100
cp_mo2 = new MakeArray; cp_mo2.length = 100
cp_mo3 = new MakeArray; cp_mo3.length = 100
cp_mo4 = new MakeArray; cp_mo4.length = 100
// mulch 1.5
cp_moh0 = new MakeArray; cp_moh0.length = 100
cp_moh1 = new MakeArray; cp_moh1.length = 100
cp_moh2 = new MakeArray; cp_moh2.length = 100
cp_moh3 = new MakeArray; cp_moh3.length = 100
cp_moh4 = new MakeArray; cp_moh4.length = 100
// mulch 2
cp_mt0 = new MakeArray; cp_mt0.length = 100
cp_mt1 = new MakeArray; cp_mt1.length = 100
cp_mt2 = new MakeArray; cp_mt2.length = 100
cp_mt3 = new MakeArray; cp_mt3.length = 100
cp_mt4 = new MakeArray; cp_mt4.length = 100
';
...
function sedchange () {
  ...
  var sed_del_min = rounder(sed_del[100]*js_sedconv,2)      // 2004.09.16
