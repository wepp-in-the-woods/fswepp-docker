...
# select [5th, 10th, 20th, 50th] largest runoff event lines
  ...
  $years1=$years+1;				# 2004.09.14
  @selected_ranks = (5,10,20,50);		# 2004.09.14
  @selected_ranks = (5,10,20) if ($years1<50);	# 2004.09.14
  @selected_ranks = (5,10)    if ($years1<20);	# 2004.09.14
  @selected_ranks = (5)       if ($years1<10);	# 2004.09.14
  @selected_ranks = ()        if ($years1<5);	# 2004.09.14
...
print TEMP "<p>
       <table border=1 cellpadding=8 bgcolor='ivory'>
        <tr><th bgcolor='#ffddff'>Ranking of event<br>(return interval)
         <th bgcolor='#ffddff'>Storm<br>Runoff<br>($precipunits)
         ...
         <th bgcolor='#ffddff'>10-min peak intensity<br>($intunits)
         <th bgcolor='#ffddff'>30-min peak intensity<br>($intunits)
...
#  $sterrFilePath = $workingpath . 'sterr';
  ...
  if ($debug) {print TEMP "<br>
   ...
   @probClimate = (0.075, 0.075, 0.20, 0.65);	# rank 5, ..  DEH 2004.09.16
#  @probClimate = (0.075, 0.075, 0.20, 0.65);	# rank 5, ..  DEH 2004.03.18
#  @probClimate = (0.05, 0.05, 0.1, 0.3);	# rank 5, rank 10, rank 20, rank 50
#  @probClimate = (0.05, 0.1, 0.3, 0.5);	# rank 5, rank 10, rank 20, rank 50 removed again 2004.09.16
# no mitigation
...
<br>
   <form name="doit">
    ...
    <script language="JavaScript">
     ...
     mulchrate = '0.5'	////<!-- mulch half -->
     if (js_units == 'ft') mulchrate = '0.2'
     mulch1  = 'Mulch rate '+mulchrate+' '+js_sedunits
     mulch1a = 'Mulch rate '+mulchrate+' '+js_alt_sedunits

     mulchrate = '1.0'	////<!-- mulch one -->
     if (js_units == 'ft') mulchrate = '0.4'
     mulch2  = 'Mulch rate '+mulchrate+' '+js_sedunits
     mulch2a = 'Mulch rate '+mulchrate+' '+js_alt_sedunits

     mulchrate = '1.5'	////<!-- mulch one and a half -->
     if (js_units == 'ft') mulchrate = '0.7'
     mulch3  = 'Mulch rate '+mulchrate+' '+js_sedunits
     mulch3a = 'Mulch rate '+mulchrate+' '+js_alt_sedunits

     mulchrate = '2.0'	////<!-- mulch two -->
     if (js_units == 'ft') mulchrate = '0.9'
     mulch4  = 'Mulch rate '+mulchrate+' '+js_sedunits
     mulch4a = 'Mulch rate '+mulchrate+' '+js_alt_sedunits
     sediment0 = rounder(whatseds (0.1, cp0)*js_sedconv,2)
     sediment1 = rounder(whatseds (0.1, cp1)*js_sedconv,2)
     sediment2 = rounder(whatseds (0.1, cp2)*js_sedconv,2)
     sediment3 = rounder(whatseds (0.1, cp3)*js_sedconv,2)
     sediment4 = rounder(whatseds (0.1, cp4)*js_sedconv,2)
     sediment_s0 = rounder(whatseds (0.1, cp_s0)*js_sedconv,2)
     sediment_s1 = rounder(whatseds (0.1, cp_s1)*js_sedconv,2)
     sediment_s2 = rounder(whatseds (0.1, cp_s2)*js_sedconv,2)
     sediment_s3 = rounder(whatseds (0.1, cp_s3)*js_sedconv,2)
     sediment_s4 = rounder(whatseds (0.1, cp_s4)*js_sedconv,2)
     sediment_mh0 = rounder(whatseds (0.1, cp_mh0)*js_sedconv,2)
     sediment_mh1 = rounder(whatseds (0.1, cp_mh1)*js_sedconv,2)
     sediment_mh2 = rounder(whatseds (0.1, cp_mh2)*js_sedconv,2)
     sediment_mh3 = rounder(whatseds (0.1, cp_mh3)*js_sedconv,2)
     sediment_mh4 = rounder(whatseds (0.1, cp_mh4)*js_sedconv,2)
     sediment_mo0 = rounder(whatseds (0.1, cp_mo0)*js_sedconv,2)
     sediment_mo1 = rounder(whatseds (0.1, cp_mo1)*js_sedconv,2)
     sediment_mo2 = rounder(whatseds (0.1, cp_mo2)*js_sedconv,2)
     sediment_mo3 = rounder(whatseds (0.1, cp_mo3)*js_sedconv,2)
     sediment_mo4 = rounder(whatseds (0.1, cp_mo4)*js_sedconv,2)
     sediment_moh0 = rounder(whatseds (0.1, cp_moh0)*js_sedconv,2)
     sediment_moh1 = rounder(whatseds (0.1, cp_moh1)*js_sedconv,2)
     sediment_moh2 = rounder(whatseds (0.1, cp_moh2)*js_sedconv,2)
     sediment_moh3 = rounder(whatseds (0.1, cp_moh3)*js_sedconv,2)
     sediment_moh4 = rounder(whatseds (0.1, cp_moh4)*js_sedconv,2)
     sediment_mt0 = rounder(whatseds (0.1, cp_mt0)*js_sedconv,2)
     sediment_mt1 = rounder(whatseds (0.1, cp_mt1)*js_sedconv,2)
     sediment_mt2 = rounder(whatseds (0.1, cp_mt2)*js_sedconv,2)
     sediment_mt3 = rounder(whatseds (0.1, cp_mt3)*js_sedconv,2)
     sediment_mt4 = rounder(whatseds (0.1, cp_mt4)*js_sedconv,2)
    </script>
...
<!-- untreated -->
     <tr>
      ...
      <th bgcolor="lightgoldenrodyellow" align="right">
       Untreated <a href="javascript:showtable('cp','no_mit','No mitigation')"><img src="/fswepp/images/printer.png" border=0></a>&nbsp;
      </th>
...
<!-- seeding -->
     <tr>
      <th bgcolor="lightgoldenrodyellow" align="right">
       Seeding <a href="javascript:showtable('cp_s','seed','Seeding after fire')"><img src="/fswepp/images/printer.png" border=0></a>&nbsp;
      </th>
      <th><span id="sediment_s0"><script>document.write(sediment_s0)</script></span></th>

      <th><span id="sediment_s1"><script>document.write(sediment_s1)</script></span></th>
      <th><span id="sediment_s2"><script>document.write(sediment_s2)</script></span></th>
      <th><span id="sediment_s3"><script>document.write(sediment_s3)</script></span></th>
      <th><span id="sediment_s4"><script>document.write(sediment_s4)</script></span></th>
     </tr>
<!-- mulch half -->
     <tr>
      ...
      <th bgcolor="lightgoldenrodyellow" align="right">
       ...
       <a href="javascript:showtable('cp_mh','mulch_h',mulch1a)"><img src="/fswepp/images/printer.png" border=0></a>&nbsp;
      </th>
      <th><span id="sediment_mh0"><script>document.write(sediment_mh0)</script></span></th>
      <th><span id="sediment_mh1"><script>document.write(sediment_mh1)</script></span></th>
      <th><span id="sediment_mh2"><script>document.write(sediment_mh2)</script></span></th>

      <th><span id="sediment_mh3"><script>document.write(sediment_mh3)</script></span></th>
      <th><span id="sediment_mh4"><script>document.write(sediment_mh4)</script></span></th>
     </tr>
<!-- mulch one -->
     <tr>
      <th bgcolor="lightgoldenrodyellow" align="right">
       <script>document.writeln(mulch2)</script>
       <a href="javascript:showtable('cp_mo','mulch_o',mulch2a)"><img src="/fswepp/images/printer.png" border=0></a>&nbsp;

      </th>
      <th><span id="sediment_mo0"><script>document.write(sediment_mo0)</script></span></th>
      <th><span id="sediment_mo1"><script>document.write(sediment_mo1)</script></span></th>
      <th><span id="sediment_mo2"><script>document.write(sediment_mo2)</script></span></th>
      <th><span id="sediment_mo3"><script>document.write(sediment_mo3)</script></span></th>
      <th><span id="sediment_mo4"><script>document.write(sediment_mo4)</script></span></th>
...
<!-- mulch one and a half -->
     <tr>
      <th bgcolor="lightgoldenrodyellow" align="right">
       ...
       <a href="javascript:showtable('cp_moh','mulch_oh',mulch3a)"><img src="/fswepp/images/printer.png" border=0></a>&nbsp;
      </th>
      <th><span id="sediment_moh0"><script>document.write(sediment_moh0)</script></span></th>

      <th><span id="sediment_moh1"><script>document.write(sediment_moh1)</script></span></th>
      <th><span id="sediment_moh2"><script>document.write(sediment_moh2)</script></span></th>
      <th><span id="sediment_moh3"><script>document.write(sediment_moh3)</script></span></th>
      <th><span id="sediment_moh4"><script>document.write(sediment_moh4)</script></span></th>
     </tr>
<!-- mulch two -->
     <tr>
      ...
      <th bgcolor="lightgoldenrodyellow" align="right">
       ...
       <a href="javascript:showtable('cp_mt','mulch_t',mulch4a)"><img src="/fswepp/images/printer.png" border=0></a>&nbsp;
      </th>
      <th><span id="sediment_mt0"><script>document.write(sediment_mt0)</script></span></th>
      <th><span id="sediment_mt1"><script>document.write(sediment_mt1)</script></span></th>
      <th><span id="sediment_mt2"><script>document.write(sediment_mt2)</script></span></th>

      <th><span id="sediment_mt3"><script>document.write(sediment_mt3)</script></span></th>
      <th><span id="sediment_mt4"><script>document.write(sediment_mt4)</script></span></th>
     </tr>
<!-- contour-felled logs -->
     <tr>
      <th bgcolor="lightgoldenrodyellow">
       ...
       <div align="right">
        <font size=-1>
         ...
         Spacing <input type="text" name="spacing" value="0" size="5" onChange="javascript:logchange()"> <script>document.write(js_units)</script><br>
         IP<sub>10</sub> <input type="text" name="ip10" value="10" size="5" onChange="javascript:logchange()"> <script>document.write(js_intensity_units)</script><br>
         Storage <input type="text" name="capacity" value="0" size="5" disabled> <script>document.write(js_storage_units)</script>
        </font>
       </div>
      </th>
      <th valign="top">
      ...
      <th valign="top">
       ...
       <font size=-1>
        ...
        <span id="eff2"></span> % eff.<br>
        <span id="caught2"></span>&nbsp;caught
       </font>
      </th>
      <th valign="top">
       <span id="sediment_cl3"><script>document.write(sediment3)</script></span><br>
       <font size=-1>
        <span id="eff3"></span> % eff.<br>
...
// ip10 (10-min peak intensity (mm h-1) and js_avg_slope are temporarily inputtable
// ip10 will be calculated and js_avg_slope will revert to global value
   var ip10=document.doit.ip10.value		// DEH 2005.09
// do a bit of error-checking on form values
   if (!isNumber (diameter)) {diameter = 0; document.doit.diameter.value=0}
   if (!isNumber (spacing))  {spacing = 0; document.doit.spacing.value=0}

// temporary -- should be OK
   if (!isNumber (ip10)) {ip10 = 10; document.doit.ip10.value=10}
...
//   alert (js_soil_texture)
     sediment_bulk_density = 1.4	// will vary by soil texture chosen; use generic 1.4 for now
     ...
     capacity = capacity_m
     if (js_units == 'ft') {capacity=0.4461*capacity_m}
     document.doit.capacity.value=capacity			// DEH 2005.09

     var eff_0 = 113.97-0.8425*ip10; if (eff_0<0) {eff_0=0}; if (eff_0>100) {eff_0=100}
     var eff_1 = 116-1.4*ip10;       if (eff_1<0) {eff_1=0}; if (eff_1>100) {eff_1=100}
...
function probchange () {
  ...
  document.getElementById("sediment_mh0").innerHTML = rounder(whatseds (myprob,eval('cp_mh0')) * js_sedconv,2)
  document.getElementById("sediment_mh1").innerHTML = rounder(whatseds (myprob,eval('cp_mh1')) * js_sedconv,2)
  document.getElementById("sediment_mh2").innerHTML = rounder(whatseds (myprob,eval('cp_mh2')) * js_sedconv,2)
  document.getElementById("sediment_mh3").innerHTML = rounder(whatseds (myprob,eval('cp_mh3')) * js_sedconv,2)
  document.getElementById("sediment_mh4").innerHTML = rounder(whatseds (myprob,eval('cp_mh4')) * js_sedconv,2)

  document.getElementById("sediment_mo0").innerHTML = rounder(whatseds (myprob,eval('cp_mo0')) * js_sedconv,2)
  document.getElementById("sediment_mo1").innerHTML = rounder(whatseds (myprob,eval('cp_mo1')) * js_sedconv,2)
  document.getElementById("sediment_mo2").innerHTML = rounder(whatseds (myprob,eval('cp_mo2')) * js_sedconv,2)
  document.getElementById("sediment_mo3").innerHTML = rounder(whatseds (myprob,eval('cp_mo3')) * js_sedconv,2)
  document.getElementById("sediment_mo4").innerHTML = rounder(whatseds (myprob,eval('cp_mo4')) * js_sedconv,2)

  document.getElementById("sediment_moh0").innerHTML = rounder(whatseds (myprob,eval('cp_moh0')) * js_sedconv,2)
  document.getElementById("sediment_moh1").innerHTML = rounder(whatseds (myprob,eval('cp_moh1')) * js_sedconv,2)
  document.getElementById("sediment_moh2").innerHTML = rounder(whatseds (myprob,eval('cp_moh2')) * js_sedconv,2)
  document.getElementById("sediment_moh3").innerHTML = rounder(whatseds (myprob,eval('cp_moh3')) * js_sedconv,2)
  document.getElementById("sediment_moh4").innerHTML = rounder(whatseds (myprob,eval('cp_moh4')) * js_sedconv,2)

  document.getElementById("sediment_mt0").innerHTML = rounder(whatseds (myprob,eval('cp_mt0')) * js_sedconv,2)
  document.getElementById("sediment_mt1").innerHTML = rounder(whatseds (myprob,eval('cp_mt1')) * js_sedconv,2)
  document.getElementById("sediment_mt2").innerHTML = rounder(whatseds (myprob,eval('cp_mt2')) * js_sedconv,2)
  document.getElementById("sediment_mt3").innerHTML = rounder(whatseds (myprob,eval('cp_mt3')) * js_sedconv,2)
  document.getElementById("sediment_mt4").innerHTML = rounder(whatseds (myprob,eval('cp_mt4')) * js_sedconv,2)
...
# skip:
  ...
  @h[0] = @ki_l[0] . "\t" . @kr_h[0] . "\t" . $tauc_h . "\t" . @ksat_h[0];
  @h[1] = @ki_l[1] . "\t" . @kr_h[1] . "\t" . $tauc_h . "\t" . @ksat_h[1];
  @h[2] = @ki_l[2] . "\t" . @kr_h[2] . "\t" . $tauc_h . "\t" . @ksat_h[2];
  @h[3] = @ki_l[3] . "\t" . @kr_h[3] . "\t" . $tauc_h . "\t" . @ksat_h[3];
  @h[4] = @ki_l[4] . "\t" . @kr_h[4] . "\t" . $tauc_h . "\t" . @ksat_h[4];
...
sub soil_parameters {
 ...
 # @ksat_h[0..4]
  ...
  if ($vegtype eq 'forest') {
   ...
   if ($new_range) {	# New range/chaparral soil figures from Corey Moffett 23 May 2005
    if ($SoilType eq 'sand') {
      $solthk = 400;      # depth of soil surface to bottom of soil layer (mm)
      $sand = 55;         # percentage of sand in the layer (%)
      $clay = 10;         # percentage of clay in the layer (%)
      ...
      $tauc_l=15.35;
      $tauc_h=8.14;
      @ki_shrub_l[0] = 8.663E+4; @ki_grass_l[0] = 8.351E+4; @ki_bare_l[0] = 2.134E+5;
      @ki_shrub_l[1] = 1.784E+5; @ki_grass_l[1] = 1.519E+5; @ki_bare_l[1] = 3.592E+5;
      @ki_shrub_l[2] = 2.480E+5; @ki_grass_l[2] = 2.372E+5; @ki_bare_l[2] = 5.520E+5;
      @ki_shrub_l[3] = 3.637E+5; @ki_grass_l[3] = 3.258E+5; @ki_bare_l[3] = 1.168E+6;
      @ki_shrub_l[4] = 6.183E+5; @ki_grass_l[4] = 5.545E+5; @ki_bare_l[4] = 3.489E+6;
      @ki_shrub_h[0] = 2.411E+5; @ki_grass_h[0] = 2.134E+5; @ki_bare_h[0] = 2.134E+5;
      @ki_shrub_h[1] = 3.144E+5; @ki_grass_h[1] = 3.592E+5; @ki_bare_h[1] = 3.592E+5;
      @ki_shrub_h[2] = 4.630E+5; @ki_grass_h[2] = 5.520E+5; @ki_bare_h[2] = 5.520E+5;
      @ki_shrub_h[3] = 6.164E+5; @ki_grass_h[3] = 1.168E+6; @ki_bare_h[3] = 1.168E+6;
      @ki_shrub_h[4] = 8.207E+5; @ki_grass_h[4] = 3.489E+6; @ki_bare_h[4] = 3.489E+6;
      @kr_l[0] = 2.416E-6;
      @kr_l[1] = 5.088E-6;
      @kr_l[2] = 9.015E-6;
      @kr_l[3] = 1.291E-5;
      ...
      @kr_h[3] = 2.563E-3;
      @kr_h[4] = 2.889E-3;
      @ks_shrub_l[0] = 34; @ks_grass_l[0] = 29; @ks_bare_l[0] = 24;
      @ks_shrub_l[1] = 29; @ks_grass_l[1] = 28; @ks_bare_l[1] = 23;
      @ks_shrub_l[2] = 25; @ks_grass_l[2] = 22; @ks_bare_l[2] = 18;
      @ks_shrub_l[3] = 23; @ks_grass_l[3] = 21; @ks_bare_l[3] = 18;
      @ks_shrub_l[4] = 17; @ks_grass_l[4] = 18; @ks_bare_l[4] = 15;
      @ks_shrub_h[0] = 26; @ks_grass_h[0] = 24; @ks_bare_h[0] = 24;
      @ks_shrub_h[1] = 22; @ks_grass_h[1] = 23; @ks_bare_h[1] = 23;
      @ks_shrub_h[2] = 20; @ks_grass_h[2] = 18; @ks_bare_h[2] = 18;
      @ks_shrub_h[3] = 17; @ks_grass_h[3] = 18; @ks_bare_h[3] = 18;
      @ks_shrub_h[4] = 13; @ks_grass_h[4] = 15; @ks_bare_h[4] = 15;
    }
    if ($SoilType eq 'silt') {
      $solthk = 400;
      $sand = 25;
      ...
      $tauc_l=36.58;
      $tauc_h=19.39;
      @ki_shrub_l[0] = 2.308E+4; @ki_grass_l[0] = 1.513E+4; @ki_bare_l[0] = 3.864E+4;
      @ki_shrub_l[1] = 4.320E+4; @ki_grass_l[1] = 2.758E+4; @ki_bare_l[1] = 6.520E+4;
      @ki_shrub_l[2] = 8.975E+4; @ki_grass_l[2] = 5.556E+4; @ki_bare_l[2] = 1.293E+5;
      @ki_shrub_l[3] = 1.374E+5; @ki_grass_l[3] = 8.356E+4; @ki_bare_l[3] = 2.994E+5;
      @ki_shrub_l[4] = 2.097E+5; @ki_grass_l[4] = 1.253E+5; @ki_bare_l[4] = 7.880E+5;
      @ki_shrub_h[0] = 6.422E+4; @ki_grass_h[0] = 3.864E+4; @ki_bare_h[0] = 3.864E+4;
      @ki_shrub_h[1] = 7.613E+4; @ki_grass_h[1] = 6.520E+4; @ki_bare_h[1] = 6.520E+4;
      @ki_shrub_h[2] = 1.676E+5; @ki_grass_h[2] = 1.293E+5; @ki_bare_h[2] = 1.293E+5;
      @ki_shrub_h[3] = 2.329E+5; @ki_grass_h[3] = 2.994E+5; @ki_bare_h[3] = 2.994E+5;
      @ki_shrub_h[4] = 2.783E+5; @ki_grass_h[4] = 7.880E+5; @ki_bare_h[4] = 7.880E+5;
      @kr_l[0] = 1.360E-5;
      @kr_l[1] = 2.181E-5;
      @kr_l[2] = 3.241E-5;
      @kr_l[3] = 5.029E-5;
      ...
      @ks_shrub_l[4] = 16; @ks_grass_l[4] = 19; @ks_bare_l[4] = 15;
    ...
    if ($SoilType eq 'clay') {
      ...
      $tauc_l = 75.56;
      $tauc_h = 40.04;
      @ki_shrub_l[0] = 7.376E+4; @ki_grass_l[0] = 2.382E+3; @ki_bare_l[0] = 6.085E+3;
      @ki_shrub_l[1] = 1.485E+5; @ki_grass_l[1] = 3.869E+3; @ki_bare_l[1] = 9.148E+3;
      @ki_shrub_l[2] = 3.357E+5; @ki_grass_l[2] = 6.814E+3; @ki_bare_l[2] = 1.586E+4;
      @ki_shrub_l[3] = 5.399E+5; @ki_grass_l[3] = 9.476E+3; @ki_bare_l[3] = 3.395E+4;
      @ki_shrub_l[4] = 8.651E+5; @ki_grass_l[4] = 1.314E+4; @ki_bare_l[4] = 8.268E+4;
      @ki_shrub_h[0] = 2.053E+5; @ki_grass_h[0] = 6.085E+3; @ki_bare_h[0] = 6.085E+3;
      @ki_shrub_h[1] = 2.617E+5; @ki_grass_h[1] = 9.148E+3; @ki_bare_h[1] = 9.148E+3;
      @ki_shrub_h[2] = 6.267E+5; @ki_grass_h[2] = 1.586E+4; @ki_bare_h[2] = 1.586E+4;
      @ki_shrub_h[3] = 9.150E+5; @ki_grass_h[3] = 3.395E+4; @ki_bare_h[3] = 3.395E+4;
      @ki_shrub_h[4] = 1.148E+6; @ki_grass_h[4] = 8.268E+4; @ki_bare_h[4] = 8.268E+4;
      @kr_l[0] = 1.008E-5;
      @kr_l[1] = 1.426E-5;
      @kr_l[2] = 1.843E-5;
      @kr_l[3] = 3.977E-5;
      ...
      @kr_h[3] = 4.653E-3;
      @kr_h[4] = 2.957E-3;
      @ks_shrub_l[0] = 22; @ks_grass_l[0] = 20; @ks_bare_l[0] = 17;
      @ks_shrub_l[1] = 19; @ks_grass_l[1] = 17; @ks_bare_l[1] = 14;
      @ks_shrub_l[2] = 16; @ks_grass_l[2] = 15; @ks_bare_l[2] = 12;
      @ks_shrub_l[3] = 13; @ks_grass_l[3] = 12; @ks_bare_l[3] = 10;
      @ks_shrub_l[4] = 11; @ks_grass_l[4] = 10; @ks_bare_l[4] =  8;
      @ks_shrub_h[0] = 17; @ks_grass_h[0] = 17; @ks_bare_h[0] = 17;
      @ks_shrub_h[1] = 15; @ks_grass_h[1] = 14; @ks_bare_h[1] = 14;
      @ks_shrub_h[2] = 12; @ks_grass_h[2] = 12; @ks_bare_h[2] = 12;
      @ks_shrub_h[3] = 10; @ks_grass_h[3] = 10; @ks_bare_h[3] = 10;
      @ks_shrub_h[4] =  8; @ks_grass_h[4] =  8; @ks_bare_h[4] =  8;
    }
    if ($SoilType eq 'loam') {
      $solthk = 400;
      $sand = 45;
      ...
      $tauc_l = 14.38;
      $tauc_h = 7.62;
      @ki_shrub_l[0] = 4.674E+3; @ki_grass_l[0] = 3.276E+3; @ki_bare_l[0] = 8.369E+3;
      @ki_shrub_l[1] = 8.753E+3; @ki_grass_l[1] = 5.976E+3; @ki_bare_l[1] = 1.413E+4;
      @ki_shrub_l[2] = 4.047E+4; @ki_grass_l[2] = 2.590E+4; @ki_bare_l[2] = 6.028E+4;
      @ki_shrub_l[3] = 7.613E+4; @ki_grass_l[3] = 4.746E+4; @ki_bare_l[3] = 1.701E+5;
      @ki_shrub_l[4] = 9.708E+4; @ki_grass_l[4] = 5.990E+4; @ki_bare_l[4] = 3.769E+5;
      @ki_shrub_h[0] = 1.301E+4; @ki_grass_h[0] = 8.369E+3; @ki_bare_h[0] = 8.369E+3;
      @ki_shrub_h[1] = 1.543E+4; @ki_grass_h[1] = 1.413E+4; @ki_bare_h[1] = 1.413E+4;
      @ki_shrub_h[2] = 7.556E+4; @ki_grass_h[2] = 6.028E+4; @ki_bare_h[2] = 6.028E+4;
      @ki_shrub_h[3] = 1.290E+5; @ki_grass_h[3] = 1.701E+5; @ki_bare_h[3] = 1.701E+5;
      @ki_shrub_h[4] = 1.289E+5; @ki_grass_h[4] = 3.769E+5; @ki_bare_h[4] = 3.769E+5;
      @kr_l[0] = 2.240E-5;
      @kr_l[1] = 3.309E-5;
      @kr_l[2] = 5.001E-5;
      @kr_l[3] = 6.420E-5;
      ...
      @kr_h[3] = 5.998E-3;
      @kr_h[4] = 3.830E-3;
      @ks_shrub_l[0] = 33; @ks_grass_l[0] = 24; @ks_bare_l[0] = 20;
      @ks_shrub_l[1] = 28; @ks_grass_l[1] = 18; @ks_bare_l[1] = 15;
      @ks_shrub_l[2] = 21; @ks_grass_l[2] = 10; @ks_bare_l[2] =  9;
      @ks_shrub_l[3] = 20; @ks_grass_l[3] = 10; @ks_bare_l[3] =  8;
      @ks_shrub_l[4] = 16; @ks_grass_l[4] =  8; @ks_bare_l[4] =  7;
      @ks_shrub_h[0] = 25; @ks_grass_h[0] = 20; @ks_bare_h[0] = 20;
      @ks_shrub_h[1] = 22; @ks_grass_h[1] = 15; @ks_bare_h[1] = 15;
      @ks_shrub_h[2] = 17; @ks_grass_h[2] =  9; @ks_bare_h[2] =  9;
      @ks_shrub_h[3] = 16; @ks_grass_h[3] =  8; @ks_bare_h[3] =  8;
      @ks_shrub_h[4] = 13; @ks_grass_h[4] =  7; @ks_bare_h[4] =  7;
    }  # #SoilType
   }	# if ($new_range)
   else {
    if ($SoilType eq 'sand') {
