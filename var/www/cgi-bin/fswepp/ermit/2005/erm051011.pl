...
## WEPP ERMiT version history
  ...
  $version='2005.10.11';	# Fixed clay-loam Ki high severity values and Ki high vs low for all soil textures
...
#=========================================================================
   ...
   $new_range=1 if ($parameters{'new_range'} =~ 'on');	# 2005.05.25 DEH
...
';
print 'New soil parameters for range<br>' if ($new_range);
print '
  </font>
 </body>
</html>
...
# skip:
  ...
  @h[0] = @ki_h[0] . "\t" . @kr_h[0] . "\t" . $tauc_h . "\t" . @ksat_h[0];	# 2005.10.11 DEH was @ki_l[]
  @h[1] = @ki_h[1] . "\t" . @kr_h[1] . "\t" . $tauc_h . "\t" . @ksat_h[1];	# 2005.10.11 DEH "
  @h[2] = @ki_h[2] . "\t" . @kr_h[2] . "\t" . $tauc_h . "\t" . @ksat_h[2];      # 2005.10.11 DEH "
  @h[3] = @ki_h[3] . "\t" . @kr_h[3] . "\t" . $tauc_h . "\t" . @ksat_h[3];      # 2005.10.11 DEH "
  @h[4] = @ki_h[4] . "\t" . @kr_h[4] . "\t" . $tauc_h . "\t" . @ksat_h[4];      # 2005.10.11 DEH "
 ...
 # @ksat_h[0..4]
  ...
  if ($vegtype eq 'forest') {
    ...
    if ($SoilType eq 'clay') {          
      ...
      @ki_h[0] =  400000; @kr_h[0] = 0.00020; @ksat_h[0] = 13;  	# fixed bad subscript 2005.10.11 DEH
