...
-->
   ...
   <input type="hidden" name="diameter" value =" 1" size="6"> <!-- duplicate diameter -->
   <input type="hidden" name="spacing" value="10" size="6">   <!-- duplicate spacing -->
...
//<!-- contour-felled logs -->		// 2004.10.05 DEH

  document.writeln(' <tr>')
  document.writeln('  <th bgcolor="lightgoldenrodyellow">')
  document.writeln('    Logs &amp; Wattles <img src="'+gostone+'"><br>')
  document.writeln('    Dia. <input type="text" name="diameter" value =" 1" size="5" disabled onChange="javascript:logchange()">')
  document.writeln('    Sp. <input type="text" name="spacing" value="10" size="5" disabled onChange="javascript:logchange()">')
  document.writeln(' <\/th>')

  seds = document.doit.sediment0.value
  if (seds < twocap) {seds = seds / 2}  else {seds = seds - capacity}
  seds='XXX'
  document.writeln('  <th><input type="text" name="sediment_cl0" size="8" disabled onFocus="self.blur()" value='+seds+'>')
//  seds = document.doit.sediment1.value
//  if (seds < twocap) {seds = seds / 2}  else {seds = seds - capacity}
  document.writeln('  <th><input type="text" name="sediment_cl1" size="8" disabled onFocus="self.blur()" value='+seds+'>')
//  seds = document.doit.sediment2.value
//  if (seds < twocap) {seds = seds / 2}  else {seds = seds - capacity}
  document.writeln('  <th><input type="text" name="sediment_cl2" size="8" disabled onFocus="self.blur()" value='+seds+'>')
//  seds = document.doit.sediment3.value
//  if (seds < twocap) {seds = seds / 2}  else {seds = seds - capacity}
  document.writeln('  <th><input type="text" name="sediment_cl3" size="8" disabled onFocus="self.blur()" value='+seds+'>')
//  seds = document.doit.sediment4.value
//  if (seds < twocap) {seds = seds / 2}  else {seds = seds - capacity}
  document.writeln('  <th><input type="text" name="sediment_cl4" size="8" disabled onFocus="self.blur()" value='+seds+'><\/tr>')
  document.writeln(' <\/table>')
 </script>
   </form>
<br>
...
sub soil_parameters {
 ...
 # @ksat_h[0..4]
  ...
  if ($vegtype eq 'forest') {
   ...
   if ($new_range && !$new_cligen) {	# New range/chaparral soil figures from Corey Moffett 23 May 2005
    if ($SoilType eq 'sand') {
      $solthk = 400;      # depth of soil surface to bottom of soil layer (mm)
      $sand = 55;         # percentage of sand in the layer (%)
      $clay = 10;         # percentage of clay in the layer (%)
   ...
   elsif ($new_range && $new_cligen) { # New range soil figures for CLIGEN 5.22 from Corey Moffett 9 Sep 2005
    if ($SoilType eq 'sand') {
      $solthk = 400;      # depth of soil surface to bottom of soil layer (mm)
      $sand = 55;         # percentage of sand in the layer (%)
      $clay = 10;         # percentage of clay in the layer (%)
      ...
      $tauc_l=15.35;
      $tauc_h=7.53;
      @ki_shrub_l[0] = 7.548E+4; @ki_grass_l[0] = 5.016E+4; @ki_bare_l[0] = 1.714E+5; @kr_l[0] = 1.984E-6;
      ...
      @ks_shrub_l[0] = 49; @ks_grass_l[0] = 30; @ks_bare_l[0] = 24;
      @ks_shrub_l[1] = 29; @ks_grass_l[1] = 28; @ks_bare_l[1] = 23;
      @ks_shrub_l[2] = 25; @ks_grass_l[2] = 22; @ks_bare_l[2] = 18;
      @ks_shrub_l[3] = 21; @ks_grass_l[3] = 20; @ks_bare_l[3] = 16;
      @ks_shrub_l[4] = 15; @ks_grass_l[4] = 14; @ks_bare_l[4] = 12;
      @ks_shrub_h[0] = 35; @ks_grass_h[0] = 24; @ks_bare_h[0] = 24;
      @ks_shrub_h[1] = 20; @ks_grass_h[1] = 23; @ks_bare_h[1] = 23;
      @ks_shrub_h[2] = 18; @ks_grass_h[2] = 18; @ks_bare_h[2] = 18;
      @ks_shrub_h[3] = 15; @ks_grass_h[3] = 16; @ks_bare_h[3] = 16;
      @ks_shrub_h[4] = 11; @ks_grass_h[4] = 12; @ks_bare_h[4] = 12;
    }
    if ($SoilType eq 'silt') {
      $solthk = 400;
      $sand = 25;
      ...
      @ki_shrub_h[3] = 2.874E+5; @ki_grass_h[3] = 5.326E+5; @ki_bare_h[3] = 5.326E+5; @kr_h[3] = 4.349E-3;
      @ki_shrub_h[4] = 2.675E+5; @ki_grass_h[4] = 8.425E+5; @ki_bare_h[4] = 8.425E+5; @kr_h[4] = 6.483E-3;
      @ks_shrub_l[0] = 38; @ks_grass_l[0] = 44; @ks_bare_l[0] = 35;
      @ks_shrub_l[1] = 30; @ks_grass_l[1] = 34; @ks_bare_l[1] = 27;
      @ks_shrub_l[2] = 22; @ks_grass_l[2] = 25; @ks_bare_l[2] = 20;
      @ks_shrub_l[3] = 19; @ks_grass_l[3] = 21; @ks_bare_l[3] = 17;
      @ks_shrub_l[4] = 14; @ks_grass_l[4] = 16; @ks_bare_l[4] = 13;
      @ks_shrub_h[0] = 27; @ks_grass_h[0] = 35; @ks_bare_h[0] = 35;
      @ks_shrub_h[1] = 21; @ks_grass_h[1] = 27; @ks_bare_h[1] = 27;
      @ks_shrub_h[2] = 16; @ks_grass_h[2] = 20; @ks_bare_h[2] = 20;
      @ks_shrub_h[3] = 13; @ks_grass_h[3] = 17; @ks_bare_h[3] = 17;
      @ks_shrub_h[4] = 10; @ks_grass_h[4] = 13; @ks_bare_h[4] = 13;
    }
    if ($SoilType eq 'clay') {
      $solthk = 400;
      $sand = 25;
      ...
      $tauc_l = 75.56;
      $tauc_h = 37.04;
      @ki_shrub_l[0] = 5.358E+4; @ki_grass_l[0] = 1.908E+3; @ki_bare_l[0] = 6.636E+3; @kr_l[0] = E-6;
      @ki_shrub_l[1] = 1.063E+5; @ki_grass_l[1] = 3.069E+3; @ki_bare_l[1] = 6.581E+3; @kr_l[1] = E-5;
      @ki_shrub_l[2] = 3.357E+5; @ki_grass_l[2] = 6.814E+3; @ki_bare_l[2] = 1.586E+4; @kr_l[2] = E-5;
      @ki_shrub_l[3] = 6.306E+5; @ki_grass_l[3] = 1.055E+4; @ki_bare_l[3] = 5.886E+4; @kr_l[3] = E-5;
      @ki_shrub_l[4] = 1.085E+6; @ki_grass_l[4] = 1.537E+4; @ki_bare_l[4] = 8.516E+4; @kr_l[4] = E-5;
      @ki_shrub_h[0] = 1.657E+5; @ki_grass_h[0] = 6.636E+3; @ki_bare_h[0] = 6.636E+3; @kr_h[0] = E-3;
      @ki_shrub_h[1] = 2.263E+5; @ki_grass_h[1] = 6.581E+3; @ki_bare_h[1] = 6.581E+3; @kr_h[1] = E-3;
      @ki_shrub_h[2] = 6.267E+5; @ki_grass_h[2] = 1.586E+4; @ki_bare_h[2] = 1.586E+4; @kr_h[2] = E-3;
      @ki_shrub_h[3] = 1.058E+6; @ki_grass_h[3] = 5.886E+4; @ki_bare_h[3] = 5.886E+4; @kr_h[3] = E-3;
      @ki_shrub_h[4] = 1.038E+6; @ki_grass_h[4] = 8.516E+4; @ki_bare_h[4] = 8.516E+4; @kr_h[4] = E-3;
      @ks_shrub_l[0] = 25; @ks_grass_l[0] = 21; @ks_bare_l[0] = 17;
      @ks_shrub_l[1] = 23; @ks_grass_l[1] = 19; @ks_bare_l[1] = 15;
      @ks_shrub_l[2] = 17; @ks_grass_l[2] = 15; @ks_bare_l[2] = 12;
      @ks_shrub_l[3] = 13; @ks_grass_l[3] = 11; @ks_bare_l[3] =  9;
      @ks_shrub_l[4] = 11; @ks_grass_l[4] =  9; @ks_bare_l[4] =  7;
      @ks_shrub_h[0] = 18; @ks_grass_h[0] = 17; @ks_bare_h[0] = 17;
      @ks_shrub_h[1] = 16; @ks_grass_h[1] = 15; @ks_bare_h[1] = 15;
      @ks_shrub_h[2] = 12; @ks_grass_h[2] = 12; @ks_bare_h[2] = 12;
      @ks_shrub_h[3] =  9; @ks_grass_h[3] =  9; @ks_bare_h[3] =  9;
      @ks_shrub_h[4] =  8; @ks_grass_h[4] =  7; @ks_bare_h[4] =  7;
    }
    if ($SoilType eq 'loam') {
      $solthk = 400;
      $sand = 45;
      ...
      @ki_shrub_h[0] = 1.201E+4; @ki_grass_h[0] = 9.047E+3; @ki_bare_h[0] = 9.047E+3; @kr_h[0] = 1.944E-3;
      ...
      @ki_shrub_h[3] = 1.569E+5; @ki_grass_h[3] = 2.994E+5; @ki_bare_h[3] = 2.944E+5; @kr_h[3] = 5.004E-3;
      @ki_shrub_h[4] = 1.060E+5; @ki_grass_h[4] = 3.491E+5; @ki_bare_h[4] = 3.491E+5; @kr_h[4] = 5.680E-3;
      @ks_shrub_l[0] = 38; @ks_grass_l[0] = 25; @ks_bare_l[0] = 20;
      @ks_shrub_l[1] = 30; @ks_grass_l[1] = 21; @ks_bare_l[1] = 17;
      @ks_shrub_l[2] = 21; @ks_grass_l[2] = 10; @ks_bare_l[2] =  8;
      @ks_shrub_l[3] = 19; @ks_grass_l[3] =  9; @ks_bare_l[3] =  8;
      @ks_shrub_l[4] = 14; @ks_grass_l[4] =  8; @ks_bare_l[4] =  6;
      @ks_shrub_h[0] = 27; @ks_grass_h[0] = 20; @ks_bare_h[0] = 20;
      @ks_shrub_h[1] = 21; @ks_grass_h[1] = 17; @ks_bare_h[1] = 17;
      @ks_shrub_h[2] = 15; @ks_grass_h[2] =  8; @ks_bare_h[2] =  8;
      @ks_shrub_h[3] = 13; @ks_grass_h[3] =  8; @ks_bare_h[3] =  8;
      @ks_shrub_h[4] = 10; @ks_grass_h[4] =  6; @ks_bare_h[4] =  6;
    }  # #SoilType
   }	# elsif ($new_range && $new_cligen)
   else {
    if ($SoilType eq 'sand') {
      $solthk = 400;      # depth of soil surface to bottom of soil layer (mm) 
      $sand = 55;         # percentage of sand in the layer (%)             
