...
//      newin.document.writeln('    <td align="center" bgcolor="#333333"><font face="verdana,arial,helvetica" size="1"><img src="/fswepp/images/shift_anim_on.gif" width=6 height=6 border=0>&nbsp;&nbsp;<a href="javascript:self.close()">Close me</a></font></td>')
  ...
  function explain_burn_severity () {
    ...
    if (newWin != null) {
      ...
      newin.document.writeln('       <img src="/fswepp/images/ermit/ermit_severity.gif" width=489 height=332><br>')
      ...
      newin.document.writeln('       These various combinations have an equal probability of occuring')
...
print ' <BODY background="/fswepp/ermit/under_dev__.gif"
  ...
  <center>
  <FORM name="ermit" method="post" ACTION="http://',$wepphost,'/cgi-bin/fswepp/ermit/ermnewz.pl">
...
print <<'theEnd';
     ...
     <tr>
      ...
      <tr>
       ...
       <td>
        <font size=-2><input name="new_cligen" type="checkbox">Cligen 5.22564</font>   <!-- ZZZZ -->
