...
## BEGIN HISTORY ###################################
## WEPP ERMiT Input screen version history

  $version='2005.09.30';	# Make new CLIGEN version the default.
...
print '<html>
 <head>
  ...
  <META NAME="Inputs" CONTENT="Climate station; soil texture; rock content; vegetation type (forest, range, chaparral); hillslope gradient and horizontal length; soil burn severity class; range/chaparral prefire community description (% shrub, % grass)">
...
//      newin.document.writeln('    <td align="center" bgcolor="#333333"><font face="verdana,arial,helvetica" size="1"><img src="/fswepp/images/shift_anim_on.gif" width=6 height=6 border=0>&nbsp;&nbsp;<a href="javascript:self.close()">Close me</a></font></td>')
  ...
  function explain_burn_severity () {
    ...
    if (newWin != null) {
      ...
      newin.document.writeln('   Fire effects on erosion are not homogeneous (Robichaud, P.R., Miller, S.M., 1999. <i>Spatial interpolation and simulation of post-burn duff thickness after prescribed fire.</i> <b>International Journal of Wildland Fire</b> 9(2):137-143).')
      ...
      newin.document.writeln('      <h3 align=center>Select a soil burn severity class</h3>')
      newin.document.writeln('      <form name="man">')
      newin.document.writeln('       <input type=radio name="management" onClick="HighChecked()">High | ')
      newin.document.writeln('       <input type=radio name="management" onClick="ModerateChecked()">Moderate | ')
      newin.document.writeln('       <input type=radio name="management" onClick="LowChecked()" checked>Low<br>')
      newin.document.writeln('       <br><br>')
      newin.document.writeln('       <table border=1 align="center">')
      newin.document.writeln('        <tr>')
      newin.document.writeln('         <th><th bgcolor=gold colspan=8>Soil Condition</th>')
      newin.document.writeln('        </tr>')
      newin.document.writeln('        <tr>')
      newin.document.writeln('         <th bgcolor=gold>OFE</th>')
      newin.document.writeln('	       <th bgcolor=gold><input type=checkbox name="hhh" disabled=true></th>')
      newin.document.writeln('         <th bgcolor=gold><input type=checkbox name="lhh" disabled=true></th>')
      newin.document.writeln('         <th bgcolor=gold><input type=checkbox name="hlh" disabled=true></th>')
      newin.document.writeln('	       <th bgcolor=gold><input type=checkbox name="hhl" disabled=true></th>')
      newin.document.writeln('	       <th bgcolor=gold><input type=checkbox name="llh" disabled=true checked></th>')
      newin.document.writeln('	       <th bgcolor=gold><input type=checkbox name="lhl" disabled=true checked></th>')
      newin.document.writeln('	       <th bgcolor=gold><input type=checkbox name="hll" disabled=true checked></th>')
      newin.document.writeln('	       <th bgcolor=gold><input type=checkbox name="lll" disabled=true checked></th>')
      newin.document.writeln('        </tr>')
      newin.document.writeln('        <tr>')
      newin.document.writeln('         <th bgcolor=gold>Upper<br>Middle<br>Lower</th>')
      newin.document.writeln('         <th bgcolor=lightblue>h<br>h<br>h</th>')
      newin.document.writeln('         <th bgcolor=lightblue>l<br>h<br>h</th>')
      newin.document.writeln('         <th bgcolor=lightblue>h<br>l<br>h</th>')
      newin.document.writeln('         <th bgcolor=lightblue>h<br>h<br>l</th>')
      newin.document.writeln('         <th bgcolor=lightblue>l<br>l<br>h</th>')
      newin.document.writeln('         <th bgcolor=lightblue>l<br>h<br>l</th>')
      newin.document.writeln('         <th bgcolor=lightblue>h<br>l<br>l')
      newin.document.writeln('         <th bgcolor=lightblue>l<br>l<br>l')
      newin.document.writeln('        </tr>')
      newin.document.writeln('       </table>')
      ...
      newin.document.writeln('     Red indicates a high soil condition, brown (yellow) a low soil condition.')
      newin.document.writeln('   </font>')
      newin.document.writeln('      </center>')
      newin.document.writeln('     </th>')
      newin.document.writeln('    </tr>')
      ...
      newin.document.writeln('   <table border=1>')
      newin.document.writeln('    <tr>')
      newin.document.writeln('     <td width=600>')
      newin.document.writeln('      <font face="tahoma, sans serif" size=-1>')
      newin.document.writeln('       <center><b>Soil Burn Severity</b></center><br>')
      newin.document.writeln('       <img src="/fswepp/images/ermit/ermit_severity.gif" width=490 height=338><br>')
      newin.document.writeln('       Spatial distributions of low (L) and high (H) soil conditions describing')
      newin.document.writeln('       low, moderate, and high soil burn severity.')
      newin.document.writeln('       Note the various combinations that occur for any selected soil burn severity.')
      newin.document.writeln('       These various combinations have an equal probability of occurring')
      newin.document.writeln('       during a run and are used to select soil conditions for the model.')
      newin.document.writeln('      </font>')
...
print ' <BODY background="/fswepp/ermit/under_dev__.gif"
  ...
  <center>
  <FORM name="ermit" method="post" ACTION="http://',$wepphost,'/cgi-bin/fswepp/ermit/ermnewcflx.pl">
     ...
     <tr align="top">
      <td align="center" bgcolor="#85d2d2">
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="javascript:explain_climate_symbols()"
           ...
           onMouseOut="window.status='Forest Service ERMiT'; return true">
           <!-- img src="/fswepp/images/quest.gif" width=14 height=12 border=0 alt="[?]" --> <!-- ZZZZ --> </a>
      ...
      <td align="center" bgcolor="#85d2d2">
       ...
       <a href="javascript:explain_soil_texture()"
        ...
        onMouseOut="window.status='Forest Service ERMiT'; return true">
        <img src="/fswepp/images/quest.gif" width=14 height=12 border=0 alt="[?]"></a>
      </td>
     </tr>
     <tr align=top>
   ...
   <p>
    <table border=2 bgcolor="ivory">
     <tr>
      ...
      <th bgcolor=#85d2d2>
       Hillslope gradient
       <a href="javascript:explain_topography()"
      ...
      <th bgcolor=#85d2d2>
         ...
         <a href="javascript:explain_burn_severity()"
...
theEnd1
if ($units eq 'm') { print '      <td align="center"><b>
...
print <<'theEnd';
     ...
     <tr>
      ...
      <tr>
       ...
       <td>
        <font size=-2><input name="new_cligen" type="checkbox" checked>Cligen 5.22564</font>   <!-- ZZZZ -->
        <font size=-2><input name="new_range" type="checkbox">New range soils</font>   <!-- ZZZZ -->
       </td>
     </tr>
  </TABLE>
     ...
     <tr>
      <td valign="top" bgcolor="white">
       <font face="tahoma, arial, helvetica, sans serif" size=1>
        ERMiT interface v. <a href="javascript:popuphistory()">',$version,'</a> (for review only)<br>
        <b>Pete Robichaud, Bill Elliot,</b> and <b>David Hall,</b>
        USDA Forest Service, Rocky Mountain Research Station, Moscow, ID<br>
        <b>Fred Pierson</b> and <b>Corey Moffet,</b>
        USDA Agricultural Research Service, Northwest Watershed Research Center, Boise, ID<br>
        Personality "<b>',$me,'</b>"<br><b>',$runs,'</b> ERMiT runs in 2005 (<b>1,550</b> runs in 2004)<br>
';
  if ($debug) {print "
