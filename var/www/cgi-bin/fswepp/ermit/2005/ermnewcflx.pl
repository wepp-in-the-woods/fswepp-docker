...
## WEPP ERMiT version history
  ...
  $version='2005.09.30';	# New mulch tables for 47, 72, 89, 94% ground cover
...
# mulch 047% GC	# 2005.09.30 DEH
        @probabilities_m470[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m470[$k];	# 2005.09.30 DEH
        @probabilities_m471[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m471[$k];	# 2005.09.30 DEH
        @probabilities_m472[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m472[$k];	# 2005.09.30 DEH
        @probabilities_m473[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m473[$k];	# 2005.09.30 DEH
        @probabilities_m474[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m474[$k];	# 2005.09.30 DEH
# mulch 72% GC	# 2005.09.30 DEH
        @probabilities_m720[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m720[$k];	# 2005.09.30 DEH
        @probabilities_m721[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m721[$k];	# 2005.09.30 DEH
        @probabilities_m722[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m722[$k];	# 2005.09.30 DEH
        @probabilities_m723[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m723[$k];	# 2005.09.30 DEH
        @probabilities_m724[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m724[$k];	# 2005.09.30 DEH
# mulch 89% GC	# 2005.09.30 DEH
        @probabilities_m890[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m890[$k];	# 2005.09.30 DEH
        @probabilities_m891[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m891[$k];	# 2005.09.30 DEH
        @probabilities_m892[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m892[$k];	# 2005.09.30 DEH
        @probabilities_m893[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m893[$k];	# 2005.09.30 DEH
        @probabilities_m894[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m894[$k];	# 2005.09.30 DEH
# mulch 94% GC	# 2005.09.30 DEH
        @probabilities_m940[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m940[$k];	# 2005.09.30 DEH
        @probabilities_m941[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m941[$k];	# 2005.09.30 DEH
        @probabilities_m942[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m942[$k];	# 2005.09.30 DEH
        @probabilities_m943[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m943[$k];	# 2005.09.30 DEH
        @probabilities_m944[$sp] = @probClimate[$c] * @probspatial[$sn] * @probSoil_m944[$k];	# 2005.09.30 DEH
...
# mulch 47% GC	# 2005.09.30 DEH
  $cum_prob_m470 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m471 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m472 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m473 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m474 = 0.05;	# 2005.09.30 DEH
# mulch 72% GC	# 2005.09.30 DEH
  $cum_prob_m720 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m721 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m722 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m723 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m724 = 0.05;	# 2005.09.30 DEH
# mulch 89% GC	# 2005.09.30 DEH
  $cum_prob_m890 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m891 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m892 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m893 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m894 = 0.05;	# 2005.09.30 DEH
# mulch 94% GC	# 2005.09.30 DEH
  $cum_prob_m940 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m941 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m942 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m943 = 0.05;	# 2005.09.30 DEH
  $cum_prob_m944 = 0.05;	# 2005.09.30 DEH
  for $sp (0..$#sed_yields) {
# no mitigation
...
<!-- mulch 47% -->
     <tr>
      <th bgcolor="lightgoldenrodyellow" align="right">
       ...
       <a href="javascript:showtable('cp_m47','mulch_47',mulch1a)"><img src="/fswepp/images/printer.png" border=0></a>&nbsp;
      </th>
      <th><span id="sediment_m470"><script>document.write(sediment_m470)</script></span></th>
      <th><span id="sediment_m471"><script>document.write(sediment_m471)</script></span></th>
      <th><span id="sediment_m472"><script>document.write(sediment_m472)</script></span></th>
      <th><span id="sediment_m473"><script>document.write(sediment_m473)</script></span></th>
      <th><span id="sediment_m474"><script>document.write(sediment_m474)</script></span></th>
     </tr>
<!-- mulch 72% -->
     <tr>
      <th bgcolor="lightgoldenrodyellow" align="right">
       <script>document.writeln(mulch2)</script>
       <a href="javascript:showtable('cp_m72','mulch_72',mulch2a)"><img src="/fswepp/images/printer.png" border=0></a>&nbsp;
      </th>
      <th><span id="sediment_m720"><script>document.write(sediment_m720)</script></span></th>
      <th><span id="sediment_m721"><script>document.write(sediment_m721)</script></span></th>
      <th><span id="sediment_m722"><script>document.write(sediment_m722)</script></span></th>
      <th><span id="sediment_m723"><script>document.write(sediment_m723)</script></span></th>
      <th><span id="sediment_m724"><script>document.write(sediment_m724)</script></span></th>
     </tr>
<!-- mulch 89% -->
     <tr>
      <th bgcolor="lightgoldenrodyellow" align="right">
       <script>document.writeln(mulch3)</script>
       <a href="javascript:showtable('cp_m89','mulch_89',mulch3a)"><img src="/fswepp/images/printer.png" border=0></a>&nbsp;
      </th>
      <th><span id="sediment_m890"><script>document.write(sediment_m890)</script></span></th>
      <th><span id="sediment_m891"><script>document.write(sediment_m891)</script></span></th>
      <th><span id="sediment_m892"><script>document.write(sediment_m892)</script></span></th>
      <th><span id="sediment_m893"><script>document.write(sediment_m893)</script></span></th>
      <th><span id="sediment_m894"><script>document.write(sediment_m894)</script></span></th>
     </tr>
<!-- mulch 94% -->
     <tr>
      <th bgcolor="lightgoldenrodyellow" align="right">
       <script>document.writeln(mulch4)</script>
       <a href="javascript:showtable('cp_m94','mulch_94',mulch4a)"><img src="/fswepp/images/printer.png" border=0></a>&nbsp;
      </th>
      <th><span id="sediment_m940"><script>document.write(sediment_m940)</script></span></th>
      <th><span id="sediment_m941"><script>document.write(sediment_m941)</script></span></th>
      <th><span id="sediment_m942"><script>document.write(sediment_m942)</script></span></th>
      <th><span id="sediment_m943"><script>document.write(sediment_m943)</script></span></th>
      <th><span id="sediment_m944"><script>document.write(sediment_m944)</script></span></th>
     </tr>
<!-- contour-felled logs -->
     <tr>
...
// mulch 47%
cp_m470 = new MakeArray; cp_m470.length = 80
cp_m471 = new MakeArray; cp_m471.length = 80
cp_m472 = new MakeArray; cp_m472.length = 80
cp_m473 = new MakeArray; cp_m473.length = 80
cp_m474 = new MakeArray; cp_m474.length = 80
// mulch 72%
cp_m720 = new MakeArray; cp_m720.length = 80
cp_m721 = new MakeArray; cp_m721.length = 80
cp_m722 = new MakeArray; cp_m722.length = 80
cp_m723 = new MakeArray; cp_m723.length = 80
cp_m724 = new MakeArray; cp_m724.length = 80
// mulch 89%
cp_m890 = new MakeArray; cp_m890.length = 80
cp_m891 = new MakeArray; cp_m891.length = 80
cp_m892 = new MakeArray; cp_m892.length = 80
cp_m893 = new MakeArray; cp_m893.length = 80
cp_m894 = new MakeArray; cp_m894.length = 80
// mulch 94%
cp_m940 = new MakeArray; cp_m940.length = 80
cp_m941 = new MakeArray; cp_m941.length = 80
cp_m942 = new MakeArray; cp_m942.length = 80
cp_m943 = new MakeArray; cp_m943.length = 80
cp_m944 = new MakeArray; cp_m944.length = 80
';
...
# ###
  ...
  $cum_prob_m470=0; $cum_prob_m471=0; $cum_prob_m472=0; $cum_prob_m473= 0; $cum_prob_m474= 0;
  $cum_prob_m720=0; $cum_prob_m721=0; $cum_prob_m722=0; $cum_prob_m723= 0; $cum_prob_m724= 0;
  $cum_prob_m890=0; $cum_prob_m891=0; $cum_prob_m892=0; $cum_prob_m893= 0; $cum_prob_m894= 0;
  $cum_prob_m940=0; $cum_prob_m941=0; $cum_prob_m942=0; $cum_prob_m943= 0; $cum_prob_m944= 0;
