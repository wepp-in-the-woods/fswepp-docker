...
sub createsoilfile {
    ...
    $ksflag =
      0;    # hold internal hydraulic conductivity constant (0 => do not ad$
...
sub soil_parameters {
    ...
    if ( $vegtype eq 'forest' ) {
        ...
        if ( $SoilType eq 'sand' ) {
            ...
            @ki_bare_h[1]  = 7710000;
            @ki_shrub_h[2] = 795000;
            @ki_grass_h[2] = 1280000;
            @ki_bare_h[2]  = 1280000;
            @ki_shrub_h[3] = 1180000;
            @ki_grass_h[3] = 1440000;
            @ki_bare_h[3]  = 1440000;
            @ki_shrub_h[4] = 1820000;
            @ki_grass_h[4] = 2240000;
            @ki_bare_h[4]  = 2240000;
            @kr_l[0]       = 6.79e-06;
            @kr_l[1]       = 1.23e-05;
            @kr_l[2]       = 1.97e-05;
        ...
        if ( $SoilType eq 'silt' ) {
            ...
            @ki_grass_l[3] = 824000;
            @ki_bare_l[3]  = 3120000;
            @ki_shrub_l[4] = 1210000;
            @ki_grass_l[4] = 1280000;
            @ki_bare_l[4]  = 5080000;
            @ki_shrub_h[0] = 693000;
            @ki_grass_h[0] = 971000;
            @ki_bare_h[0]  = 9710000;
            @ki_shrub_h[1] = 1110000;
            @ki_grass_h[1] = 1570000;
            @ki_bare_h[1]  = 1570000;
            @ki_shrub_h[2] = 1640000;
            @ki_grass_h[2] = 2340000;
            @ki_bare_h[2]  = 2340000;
            @ki_shrub_h[3] = 2170000;
            @ki_grass_h[3] = 3120000;
            @ki_bare_h[3]  = 3120000;
            @ki_shrub_h[4] = 3480000;
            @ki_grass_h[4] = 5080000;
            @ki_bare_h[4]  = 5080000;
            @kr_l[0]       = 9.24e-05;
            @kr_l[1]       = 1.29e-04;
            @kr_l[2]       = 1.97e-04;
        ...
        if ( $SoilType eq 'clay' ) {
            ...
            @ki_grass_l[1] = 679000;
            @ki_bare_l[1]  = 2520000;
            @ki_shrub_l[2] = 1200000;
            @ki_grass_l[2] = 989000;
            @ki_bare_l[2]  = 3810000;
            @ki_shrub_l[3] = 1580000;
            @ki_grass_l[3] = 1300000;
            @ki_bare_l[3]  = 5120000;
            @ki_shrub_l[4] = 2510000;
            @ki_grass_l[4] = 2050000;
            @ki_bare_l[4]  = 8470000;
            @ki_shrub_h[0] = 1400000;
            @ki_grass_h[0] = 1530000;
            @ki_bare_h[0]  = 1530000;
            @ki_shrub_h[1] = 2300000;
            @ki_grass_h[1] = 2520000;
            @ki_bare_h[1]  = 2520000;
            @ki_shrub_h[2] = 3460000;
            @ki_grass_h[2] = 3810000;
            @ki_bare_h[2]  = 3810000;
            @ki_shrub_h[3] = 4650000;
            @ki_grass_h[3] = 5120000;
            @ki_bare_h[3]  = 5120000;
            @ki_shrub_h[4] = 7660000;
            @ki_grass_h[4] = 8470000;
            @ki_bare_h[4]  = 8470000;
            @kr_l[0]       = 1.60e-04;
            @kr_l[1]       = 1.80e-04;
            @kr_l[2]       = 2.00e-04;
        ...
        if ( $SoilType eq 'loam' ) {
            ...
            @ki_bare_h[0]  = 9490000;
            @ki_shrub_h[1] = 759000;
            @ki_grass_h[1] = 1070000;
            @ki_bare_h[1]  = 1070000;
            @ki_shrub_h[2] = 977000;
            @ki_grass_h[2] = 1380000;
            @ki_bare_h[2]  = 1380000;
            @ki_shrub_h[3] = 1320000;
            @ki_grass_h[3] = 1880000;
            @ki_bare_h[3]  = 1880000;
            @ki_shrub_h[4] = 2160000;
            @ki_grass_h[4] = 3110000;
            @ki_bare_h[4]  = 3110000;
            @kr_l[0]       = 6.50e-05;
            @kr_l[1]       = 9.50e-05;
            @kr_l[2]       = 2.10e-04;
        ...
        for ( $i = 0 ; $i < 5 ; $i++ ) {
            ...
            @ki_h[$i] =
              ...
              $pbare * @ki_bare_h[$i];
            @kr_l[$i] =
              $pshrub * @kr_l[$i] + $pgrass * @kr_l[$i] + $pbare * @kr_l[$i];
            @kr_h[$i] =
              $pshrub * @kr_h[$i] + $pgrass * @kr_h[$i] + $pbare * @kr_h[$i];
            @ksat_l[$i] =
              $pshrub * @ks_shrub_l[$i] +
              $pgrass * @ks_grass_l[$i] +
              $pbare * @ks_bare_l[$i];
