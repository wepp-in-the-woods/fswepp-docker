...
print ' <BODY link="#555555" vlink="#555555" onLoad="StartUp()">
  ...
  <FORM name="ermit" method="post" ACTION="http://',$wepphost,'/cgi-bin/fswepp/ermit/urm2014.pl">
...
#
# to do: claculate value of year below and for report at end (or YTD) or ultimately have fancier report
#
  $wc  = `wc ../working/_2014/we.log`;
  @words = split " ", $wc;
  $runs = @words[0];
...
<!--  1,550 runs in 2004 -->
        ...
        <b>',$runs,'</b> ERMiT runs since Jan 01, 2014<br>
