...
#  calls:
#    /cgi-bin/fswepp/wasp/ww.pl
#    /cgi-bin/fswepp/wasp/logstuff.pl   ??
#  popup links:
...
<title>Forest Service Water And Sediment Predictor</title>
  ...
  <META NAME="Name" CONTENT="WASP Water And Sediment Predictor">
  <META NAME="Brief Description" CONTENT="WASP, a component of FS WEPP, predicts erosion from rangeland, forestland, and forest skid trails. Forest Service Water And Sediment Predictor allows users to easily describe numerous disturbed forest and rangeland erosion conditions. The interface presents the probability of a given level of erosion occurring the year following a disturbance.">
  <META NAME="Status" CONTENT="Under development 2010">
...
//      this.form.achtung.value="Run WEPP"
    if (checkYears(document.forms.wasp.climyears)) {
      RunningMsg(document.forms.wasp.actionw,"Running WEPP...");
      document.forms.wasp.achtung.value="Run WEPP"
    }
  }

  function submitme(which) {
    document.forms.wasp.achtung.value=which
//    document.forms.wasp.submit.value="Describe"
    document.forms.wasp.submit()
    return true
  }
...
//    window.document.wasp.Climate.selectedIndex = 0;
//    window.document.wasp.climyears.value = max_year[0];
...
//   window.document.wasp.ofe1.selectedIndex = 0;
//   window.document.wasp.ofe2.selectedIndex = 7;
    if (window.document.wasp.Climate.selectedIndex == "") {
        window.document.wasp.Climate.selectedIndex = 0;
    }
    climYear();
  }
  ...
  function pcover1() {        // change ofe1 pcover to default for selected
    var which = window.document.wasp.UpSlopeType.selectedIndex;
    window.document.wasp.ofe1_pcover.value=default_pcover[which];
    return false;
  }

  function pcover2() {        // change ofe2 pcover to default for selected
    var which = window.document.wasp.LowSlopeType.selectedIndex;
    window.document.waspofe2_pcover.value=default_pcover[which];
    return false;
  }

  function climYear() {        // change climate years to max for selected
    var which = window.document.wasp.Climate.selectedIndex;
//    window.document.waspclimyears.value=max_year[which];
    window.document.wasp.climate_name.value=climate_name[which];
//    var vegyear=Math.min (max_year[which],10);
//    var simyear=Math.min (max_year[which],100);
//    window.document.wasp.actionv.value=vegyear + "vegetation calibration";
//    window.document.wasp.actionw.value=simyear + "WEPP run";
//    window.document.wasp.actionv.value="vegetation calibration";
//    window.document.wasp.actionw.value="WEPP run";
    window.document.wasp.achtung.value="Calibrate vegetation";
    window.document.wasp.achtung.value="WEPP run";
    return false;
  }
function RunningMsg (obj, text) {
  ...
  function checkRange(obj,min,max,def,unit,thistext) {
     if (isNumber(obj.value)) {                   // obj == document.wasp.BS
...
{
  var which = window.document.wasp.SlopeType.selectedIndex;
...
function showTexture() {
  var which = window.document.wasp.SoilType.selectedIndex;
...
function showGeology() {
  ...
  var which = window.document.wasp.RockName.selectedIndex;
  if (lunit == ' m') {
  ...
  window.status = text
  document.forms.wasp.conduct.value=shc
  return true
}

function checkRestriction() {
   var Restricted = window.document.wasp.restriction.checked;
//   alert ("restriction: " + Restricted);
   if (Restricted) {
     window.document.wasp.RockName.disabled=0
     window.document.wasp.aniso.disabled=0
     window.document.wasp.conduct.disabled=0
     window.document.wasp.climyears.disabled=1
     showGeology()
     ...
     window.document.wasp.RockName.disabled=1
     window.document.wasp.aniso.disabled=1
     window.document.wasp.conduct.disabled=1
     window.document.wasp.climyears.disabled=0
     e=document.getElementById("rest");
...
print ' <BODY bgcolor="white" link="#555555" vlink="#555555" onLoad="StartUp()">
  <font face="Arial, Geneva, Helvetica">
   ...
   <table width=100% border=0>
    <tr>
     <td align=center bgcolor="f0f014">  <!-- "#5cb3ff" -->
      <font size=3><b>WASP &ndash; Water And Sediment Predictor</b><br>
       <font color=crimson>* under construction *</font></font>
     </td>
    </tr>
   </table>
  <center>
...
theEnd
         print "       onChange=\"checkConduct(this.form.conduct)\"> ($cunit)
";
print <<'theEnd';
              </td>
             </div>
...
print <<'theEnd';
          ...
          <tr>
           ...
           <td rowspan=2 bgcolor="tan">
theEnd
      print "      <input type=\"text\" size=5 name=\"ofe1_length\" value=\"$ldef\"
";
print <<'theEnd';
           ...
           <td rowspan=2 bgcolor="tan">
theEnd
    print "            <input type=\"text\" size=5 name=\"ofe1_depth\" value=\"$ddef1\"
";
print <<'theEnd';
          ...
          <tr>
           ...
           <tr>
            ...
            <td rowspan=2 bgcolor="tan">
theEnd
       print "       <input type=\"text\" size=5 name=\"ofe2_length\" value=\"$ldef\"
";
print <<'theEnd';
            ...
            <td rowspan=2 bgcolor="tan">
theEnd
    print "             <input type=\"text\" size=5 name=\"ofe2_depth\" value=\"$ddef2\"
";
print <<'theEnd';
...
<font size=1>
  <input type=radio name="weppversion" value="2008">WEPP 2008 |
