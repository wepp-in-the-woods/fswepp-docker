...
#    @ofeLengths=(10,10,5,5);
#    @width=(100,100,100,100);
#    @precips=(80545.9,80545.9,80545.9,80545.9);
#    @runoffs=(1049.60,2494,13955,46058);
## Runoff Volume (m^3)\n", $ofeLengths[$i]*$width[$i]*$runoffs[$i]/1000;
#    @ess=(21025.91,21389,6488,6554);
#    @eps=(12089.06,12113,30562,30362);
#    @ers=(8047.04,8882,8027,80170);
#    @dps=(13567.08,14225,11500,13735);
#    @lats=(23826,46168,106904,96191);
#    @initialH2Os=(143.26,143.26,215,215);
#    @finalH2Os=(155.61,156.38,247,247);
#    @initialFrozes=(0,0,0,0);
#    @finalFrozes=(0,0,0,0);
#    @initialSnow=(0,0,0,0);
#    @finalSnow=(133.67,132.52,131.85,133);
#    @ups=(0,1050,4989,13955);
#    @upsub=(0,23826,92333,106904);
#    @irr=(0,0,0,0);
#    @drainq=(0,0,0,0);
...
#    $i = $_;
    ...
    print "    <tr><th align=right>Runoff (mm)</th><td align=right>-</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$runoffs[$i]};print "</tr>\n";
    print "    <tr><th align=right>Soil Evap (mm)</th><td align=right>-</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$ess[$i]};print "</tr>\n";
    print "    <tr><th align=right>Plant Evap (mm)</th><td align=right>-</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$eps[$i]};print "</tr>\n";
    print "    <tr><th align=right>Residue Evap (mm)</th><td align=right>-</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$ers[$i]};print "</tr>\n";
    print "    <tr><th align=right>Deep seep (mm)</th><td align=right>-</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$dps[$i]};print "</tr>\n";
    print "    <tr><th align=right>Lat Flow (mm)</th><td align=right>-</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$lats[$i]};print "</tr>\n";
    print "    <tr><th align=right>Initial Soil Water (mm)</th><td align=right>+</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$initialH2Os[$i]};print "</tr>\n";
    print "    <tr><th align=right>Final Soil Water (mm)</th><td align=right>-</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$finalH2Os[$i]};print "</tr>\n";
    print "    <tr><th align=right>Initial Frozen Soil Water (mm)</th><td align=right>+</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$initialFrozes[$i]};print "</tr>\n";
    print "    <tr><th align=right>Final Frozen Soil Water (mm)</th><td align=right>-</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$finalFrozes[$i]};print "</tr>\n";
    print "    <tr><th align=right>Initial Snow Water (mm)</th><td align=right>+</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$initialSnow[$i]};print "</tr>\n";
    print "    <tr><th align=right>Final Snow Water (mm)</th><td align=right>-</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$finalSnow[$i]};print "</tr>\n";
    print "    <tr><th align=right>Upstream surface runon (mm)</th><td align=right>+</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$ups[$i]};print "</tr>\n";
    print "    <tr><th align=right>Upstream subsurface runon (mm)</th><td align=right>+</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$upsub[$i]};print "</tr>\n";
    print "    <tr><th align=right>Irrigation Water (mm)</th><td align=right>+</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$irr[$i]};print "</tr>\n";
    print "    <tr><th align=right>Tile Drainage (mm)</th><td align=right>-</td>";for (0..$ofes-1) {$i=$_;printf "<td align=right>%12.0f</td>",$drainq[$i]};print "</tr>\n";
