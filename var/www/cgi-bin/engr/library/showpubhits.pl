...
#  2009-08-18 DEH add option to specify httpd code to display (&code=200)
...
#    put 'dig' results in hash; check that first, then call 'dig' if not found
