...
sub return_html {
   ...
   print "<html>
 <head>
  <title>SSG Search Results</title>
 </head>
 <body link=green vlink=darkgreen alink=crimson>
  <font face='Tahoma, Arial, sans serif'>
   <h3 align='center'>Results of Search in $title</h3>
   Below are the results of your search sorted by filename:
   <br>
   <hr size=7 width=75%>
   <br>
   <ul>
