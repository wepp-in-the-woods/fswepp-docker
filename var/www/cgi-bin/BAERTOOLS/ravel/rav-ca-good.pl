...
$lat1         =$cgi->param('bndlat1');
$lat2         =$cgi->param('bndlat2');
$lon1         =$cgi->param('bndlon1');
$lon2         =$cgi->param('bndlon2');
...
print "  <h4>$description</h4>
  <table border=1>
   ...
   <tr>
    ...
    <td colspan=2><font face='trebuchet, tahoma, arial' size=2>$vegetationSize $lengthunit</font></td>
   </tr>
   <tr>
   ...
   <tr>
    ...
    <td colspan=2><font face='trebuchet, tahoma, arial' size=2>$fireImpactDepth $lengthunit</font></td>
   </tr>
   <tr>
...
#      print "     <td valign='bottom'><img src='black.gif' width='2' height='@histo[$his]' alt='$his: $histo[$his]' border=0></td>\n";
       print "     <td valign='top'><img src='/black.gif' width='2' height='@histo[$his]' onClick=\"document.elevation.elev.value='@histo[$his]'\"></td>\n";
     }
...
#    @timing = `time ./ravel $paramFile $demfilename >$stdout0 2>$stderr0`;
     print "./ravel $paramFile $demfilename >$stdout0 2>$stderr0<br>\n";
...
#    Maximum Z: $max_z
   ...
   <br>
   <form name='deposition'><input type='text' name='depos' readonly></form>
   <br>
   <table cellpadding=0 cellspacing=0>
    <tr>
...
#    Maximum Z: $max_z
   ...
   Range: $range grams ($min_r to $max_r)
   <br>
   <form name='production'><input type='text' name='prod' readonly></form>
   <br>
   <table cellpadding=0 cellspacing=0>
    <tr>
     <td colspan=100 align=left>$min_r</td>
