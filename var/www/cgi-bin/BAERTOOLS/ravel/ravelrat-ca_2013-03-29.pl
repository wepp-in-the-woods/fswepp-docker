...
# FS RavelRAT-CA Results history
   $version='2013.03.28';	# Modify color math for deposition and production graphics
...
//   document.deposition.depos_hist.value="[',$real,' &mdash; ',$realh,' $depunit]: ',@histo[$his],'"
   }
...
#       if ($encode) {print "     <td width=6 height=5 bgcolor='$color' onClick=\"document.elevation.elev.value='[$rows, $col]: $val m'\"></td>\n";}
        if ($encode) {
          print "     <td width=6 height=5 bgcolor='$color' onClick='ElevClick($rows,$col,$val,\"m\")'></td>\n";}
        else {
...
#      print "     <td height='5' bgcolor='$color' onClick=\"document.elevation.elev_hist.value='[$real &mdash; $realh m]: @histo[$his]'\"></td>\n";
       print "     <td height='5' bgcolor='$color' onClick='ElevHistClick($real,$realh,@histo[$his],\"m\")'></td>\n";
     }
       print '    </tr>
    <tr>
';
...
#                            onMouseover=\"document.getElementById('deprcv').innerHTML='<b>$val</b> $depunit deposition at row <b>$row</b> column <b>$col</b>'\"></td>\n";
          print "     <td width=6 height=5 bgcolor='$color' onClick='DepoClick($row,$col,$val,\"$depunit\",\"$unique\")' onMouseover='DepHover($row,$col,$val,\"$depunit\")'></td>\n";
        }
        else {
          print "     <td width=6 height=5 bgcolor='$color'></td>\n";}
      }			# for ($col=0...)
if ($row == $max_dep_row) {						# DEH 110609
      print "     <td width=4 bgcolor=crimson id=\"r$row\"></td>\n";	# DEH 110525
} else {
      print "     <td width=4 bgcolor=tan id=\"r$row\"></td>\n";	# DEH 110525
}
...
if ($col == $max_dep_col) {                                             # DEH 110609
        print "     <td width=5 height=4 bgcolor=crimson id=\"c$col\"></td>\n";
}
else {
        print "     <td width=5 height=4 bgcolor=tan id=\"c$col\"></td>\n";
}
      }
      print '    </tr>
   </table>
...
#      print "     <td height='5' bgcolor='$color' onClick=\"document.deposition.depos_hist.value='[$real &mdash; $realh $depunit]: @histo[$his]'\">
       print "     <td height='5' bgcolor='$color' onClick='DepoHistClick($real,$realh,@histo[$his],\"$depunit\")'></td>\n";
   }		# for ($his=0...)
...
';
     ...
     print "     <td valign='top'><img src='black.gif' width='2' height='2' onMouseover='DepHistCount(@histo[0])'></td>\n";
     for ($his=1;$his<256;$his++) {
...
#      print "     <td valign='top'><img src='black.gif' width='2' height='$height' onClick=\"window.status='@histo[$his]'\"></td>\n";
       print "     <td valign='top'><img src='black.gif' width='2' height='$height' onMouseover='DepHistCount(@histo[$his])'></td>\n";
     }		# for ($his=0...)
#######################
    print "
   </tr>
...
@cell[$col]=0-@cell[$col];						# DEH 20110608
          if (@cell[$col] < $min_r && @cell[$col]>0) {			# DEH 20110608
            $min_r = @cell[$col];
            $min_prod_row = $row;
            $min_prod_col = $row;
          }
...
#         if((@cell[$col] > $max_r) && @cell[$col]<0) {
          if((@cell[$col] > $max_r) && @cell[$col]>0) {			# DEH 20110608
            $max_r = @cell[$col];
            $max_prod_row = $row;
            $max_prod_col = $col;
          }
...
#         print "     <td width=6 height=5 bgcolor='$color' onClick='ProdClick($row,$col,$val,\"$depunit\",\"$unique\")' onMouseover=\"document.getElementById('prodrcv').innerHTML='<b>$val</b> $depunit production at row <b>$row</b> column <b>$col</b>'\"></td>\n";
          print "     <td width=6 height=5 bgcolor='$color' onClick='ProdClick($row,$col,$val,\"$depunit\",\"$unique\")' onMouseover='ProdHover($row,$col,$val,\"$produnit\")'></td>\n";
        }
        else {
          print "     <td width=6 height=5 bgcolor='$color'></td>\n";
        }
...
if ($row == $max_prod_row) {
      print "     <td width=4 bgcolor=#347235 id=\"pr$row\"></td>\n";	# DEH 110525
} else {
      print "     <td width=4 bgcolor=tan id=\"pr$row\"></td>\n";	# DEH 110525
}
...
';
      for ($col=0;$col<$num_cols;$col++) {
if ($col == $max_prod_col) {
        print "     <td width=5 height=4 bgcolor=#347235 id=\"pc$col\"></td>\n";
} else {
        print "     <td width=5 height=4 bgcolor=tan id=\"pc$col\"></td>\n";
}
      }
      print '    </tr>
   </table>
...
#      print "     <td height='5' bgcolor='$color' onClick=\"document.production.prod_hist.value='[$real &mdash; $realh $produnit]: @histo[$his]'\"></td>\n";
       print "     <td height='5' bgcolor='$color' onClick='ProdHistClick($real,$realh,@histo[$his],\"$produnit\")'></td>\n";
##77##
     }		# for ($his=0...)
#########################
print '
...
#    print "     <td valign='top'><img src='black.gif' width='2' height='0' onClick=\"window.status='@histo[0]'\"></td>\n";
     print "     <td valign='top'><img src='black.gif' width='2' height='2' onMouseover='ProdHistCount(@histo[0])'></td>\n";
     for ($his=1;$his<255;$his++) {
       $height=$heightScale*@histo[$his];
#      print "     <td valign='top'><img src='black.gif' width='2' height='$height' onClick=\"window.status='@histo[$his]'\"></td>\n";
       print "     <td valign='top'><img src='black.gif' width='2' height='$height' onMouseover='ProdHistCount(@histo[$his])'></td>\n";
     }		# for ($his=0...)
#########################
    print "
   </tr>
