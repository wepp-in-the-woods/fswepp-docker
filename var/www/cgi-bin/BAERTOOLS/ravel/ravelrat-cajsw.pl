...
#         print "     <td width=6 height=5 bgcolor='$color' onClick=\"document.deposition.depos.value='[$row, $col]: $val $depunit'\"></td>\n";}
          print "     <td width=6 height=5 bgcolor='$color' onClick='javascript:DepoClick($row,$col,$val,\"$depunit\",\"$unique\")'></td>\n";}
        else {
...
<span id='cell_dep'>[click on deposition plot above]</span><br>
<span id='bin_count'>[click on histogram axis below]</span>
...
#######################
  ...
  <td align=top>
   <img src='/BAERTOOLS/ravel/DEMdepGraph.php?file=$unique&x=$max_dep_row' name='ELEVdepGraphWE'><br>
   <img src='/BAERTOOLS/ravel/DEMdepGraph.php?file=$unique&y=$max_dep_col' name='ELEVdepGraphNS'><br>
  </td>
 </tr>
</table>
</table>
