...
### urm1.pl from Elena 2005.01.24 ###

## BEGIN HISTORY ###################################
## Understory Response Model (Plant Characteristics) version history

  $version='2005.09.15';	# DEH added automatic version history reporting
# $version='2005.09.14';	# DEH fixed path to plantsearch2.pl again, change comment references from urm.pl to urm1.pl
# $version='2005.09.13';	# EV: ??
# $version='2005.02.03';	# DEH changed to Tahoma font was (not complete within tables), improve HTML formatiing, change version no. to "minutes/days old"
# $version='2005.02.03';	# EV updated function checkfirecanopy1()
### 2005.01.25 DEH fixed path to plantsearch.pl ###
# $version='2004.04.29';	# Beta release for Boise workshop
...
# $version = '[urm1.pl ' . $long_ago . $time . ' old]';
...
if(weedval==0){alert("If you need information on your weed try the search engine under species. You will need to input all the information manually");
...
document.plantsimulator.bud_loc.options[4]=new Option("Bulb/corn","bulb",false,false);
...
mymenu += '<option selected value=\"-2\">Select one</option>\\n';
mymenu += '<option value=\"0\">The weed is not in the list</option>\\n';
