...
//  mywin.document.writeln('   <form method="post" name="elena" action="http://localhost/Scripts/fuels/urm/plantsearch2.pl">')
...
{for(var i=0; i<treatmts.length;i++)
 ...
 <body link="#99ff00" vlink="#99ff00" alink="#99ff00">
  <font face="tahoma, arial, helvetica, sans serif">
   ...
   <!-- form method="post" name="plantsimulator" action="http://localhost/Scripts/fuels/urm/test/urm1.pl" onsubmit="return checkform()"-->
