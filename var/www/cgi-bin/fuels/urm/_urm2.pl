...
<td><IMG src="https:/fuels/urm/images/knapweedt.jpg" alt="The Understory Response Model" align="right">
		...
		<center><font size=6>User Inputs</font></center><br>
		<table align="center" border="2" cellpadding="5" cellspacing="5" ID="Table3">
			<caption>
				<b><font size="4">Initial Stands Conditions</font></b>
			</caption>
			<tr>
				<th BGCOLOR="#006009">
					<Font color="#99ff00">Size of Treated Area (acres):</Font></th>
				<th BGCOLOR="#006009">
					<Font color="#99ff00">Starting<br>
					Canopy Cover (%):</Font></th>
				<th BGCOLOR="#006009">
					<Font color="#99ff00">Average Duff Depth (inches)</Font></th>
			</tr>
			<tr>
				<td>$parea</td>
				<td>$startcanopy</td>
...
##  FEIS writeup set up                #
########################################
$indexpath="C:\\Inetpub\\Scripts\\fuels\\urm\\test\\FEIS_index.txt";
...
#</i></a>]</p>";
print "  <p>
    [<a href='/fuels/urm/FEIS_writeup/all_plants/$foldertest.html' target='_popup'><b>FEIS Summaries for <i>$species</i></b></a>]
   </p>
";	# DEH
	print "</center>";
	$pnotaflag=0;
...
close(INDEXFILE);
  if($pnotaflag) {
    $pnota= "There is not a summary for '<i>" . $species . "</i>' in FEIS";
