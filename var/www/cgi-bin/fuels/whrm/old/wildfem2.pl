...
if($lengthenames>=2)
{
	...
	if($evalues[$i]==-3){$pevalues[$i]="Greater than 700% Decrease";}
...
# $spepath = "c:\\Inetpub\\Scripts\\wildlifem\\species\\".$taxgroup."\\";
...
<html>
	...
	<table align="center" width="100%" border="0">
		<tr>
		<td><img src="/fuels/wirm/images/borealtoad3_Pilliod.jpg" alt="Boreal Toad" align="left"></td>
		<td align="center"><hr>
...
$psentence[2]="The management activity will have <br>minimal affect on habitat suitability";
