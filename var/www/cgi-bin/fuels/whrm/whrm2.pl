...
function explain_average() {
    ...
    if (newWin != null) {
      ...
      newin.document.writeln('    <tr><td bgcolor="#99ff00" align="center">')
      newin.document.writeln('     <font face="tahoma, arial, helvetica, sans serif">')
      newin.document.writeln('      <h3>Wildlife Habitat Response Model<br><br>Average Effects on Habitat Suitability</h3><br>')
      newin.document.writeln('     </font>')
      newin.document.writeln('    </td></tr>')
      newin.document.writeln('   </table>')
      newin.document.writeln('  <i>Average Effects on Habitat Suitability</i> is a weighted average of Predicted Effects on Habitat Suitability based on the amount of literature supporting the habitat association. See the text and table4 of the User&#39s Guide for information on calculations and definitions of qualitative statements .')
      newin.document.writeln('<!--tool bar begins--><p>')
      newin.document.writeln('  <table bgcolor="#666666" width="20%" border="0" cellspacing="1" cellpadding="5"  align="center">')
      newin.document.writeln('   <tr>')
      newin.document.writeln('    <td align="center" bgcolor="#333333"')
						...
						<th  bgcolor="#006009">
      					...
      					<br>
        					<a href="javascript:explain_predict()"
           					onMouseOver="window.status=' Explain Predicted Effects on Habitat Suitability(new window)';return true"
						...
						<th  bgcolor="#006009">
      					...
      					<br>
        					<a href="javascript:explain_average()"
           					onMouseOver="window.status='Explain Average Effect on Habitat Suitability (new window)';return true"
           					onMouseOut="window.status='Wildlife Habitat Response Model'; return true">
         					<img src="/fuels/whrm/images/quest2.gif" width="18" height="16" border="0"></a>
						</th>
					</tr>
 ...
 <body>
  <font face="tahoma, arial, helvetica, sans serif">
   <center>
    <table align="center" border="2">
     <caption>
      <font size="5"><b>Wildlife Habitat Response Model Background Information<br> $comname (<i>$sciname</i>)</b></font>
     </caption>
fin1
for($i=0; $i<=12;$i++)
{print"
