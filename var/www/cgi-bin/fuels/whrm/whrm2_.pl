    ...
    <tr>
     <td valign="top" bgcolor="lightgoldenrodyellow">
      <font face="tahoma, arial, helvetica, sans serif" size=1>
        ...
        (for review only)<br>
        Developed by David Pilliod, USDA Forest Service, Rocky Mountain Research Station, Missoula, MT<br>
        Coded by Elena Velasquez &amp; David Hall<br>
        Team leader Elaine Kennedy Sutherland, USDA Forest Service, Rocky Mountain Research Station, Missoula, MT
      </font>
     </td>
     <td valign="top">
