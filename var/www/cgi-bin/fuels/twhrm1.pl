...
if(!document.twhrm1.treatment[0].checked && !document.twhrm1.treatment[1].checked && !document.twhrm1.treatment[2].checked && !document.twhrm1.treatment[3].checked)
	...
	//retun false;
	alert("You must choose at least two treatment");
	return false;
	}
return true;
}
  ...
  // end hide -->
	...
	<body link=\"#99ff00\" vlink=\"#99ff00\" alink=\"#99ff00\">
		<table align=\"center\" width=\"100%\" border=\"0\">
			<tr>
				<td><img src="/fuels/whrm/images/borealtoad4_Pilliod.jpg"  alt="Wildlife Habitat Response Model" align="left">
				</td>
				<td align=\"center\"><hr>
					<h2>Wildlife Habitat Response Model</h2>
					<hr>
				</td>
				<td><img src="/fuels/whrm/images/grayjay3_Pilliod.jpg"  alt="Wildlife Habitat Response Model" align="right" width=156 height=117>
				</td>
			</tr>
		</table>
		<center>
			...
			<form method=\"post\" name=\"twhrm1\" action=\"http:/cgi-bin/fuels/whrm/twhrm2.pl\" onsubmit=\"return checkform()\">
				<p><b>Treatments to Be Compared: </b>(You must select at least one)
					...
					<table align=\"center\" border=\"2\">
						...
						<tr>
							<th BGCOLOR=\"#006009\">
								<Font color=\"#99ff00\">Thinning and Broadcast Burning</Font></th>
							<td><input type=\"checkbox\" name=\"treatment\" value=\"1\"></td>
						</tr>
						<tr>
							<th BGCOLOR=\"#006009\">
								<Font color=\"#99ff00\">Thinning and Pile Burning</Font></th>
							<td><input type=\"checkbox\" name=\"treatment\" value=\"2\"></td>
						</tr>
						<tr>
							<th BGCOLOR=\"#006009\">
								<Font color=\"#99ff00\">Prescribed Fire</Font></th>
							<td><input type=\"checkbox\" name=\"treatment\" value=\"3\"></td>
						</tr>
						<tr>
							<th BGCOLOR=\"#006009\">
								<Font color=\"#99ff00\">Wildfire</Font></th>
