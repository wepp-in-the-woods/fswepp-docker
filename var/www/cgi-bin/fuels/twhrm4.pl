...
if ( $lengthenames >= 2 ) {
    for ( $i = 0 ; $i <= ( @enames - 2 ) ; $i++ ) {
        ...
        if ( $evalues[$i] == -3 ) {
            $pevalues[$i] = "Greater than 70% Decrease";
        }
...
for ( $j = 0 ; $j < $tsize ; $j++ ) {
    if ( $treatments[$j] == 1 ) {
        $nametreatment[$j] = "Thinning <br>and<br> Broadcast Burning";
    }
    elsif ( $treatments[$j] == 2 ) {
        $nametreatment[$j] = "Thinning <br>and<br>Pile Burning";
    }
...
for ( $j = 0 ; $j < $tsize ; $j++ ) {
    if ( $treatments[$j] == 1 ) {
        $lnametreatment[$j] = "Thinning and Broadcast Burning";
    }
    elsif ( $treatments[$j] == 2 ) {
        $lnametreatment[$j] = "Thinning and Pile Burning";
    }
...
$tempstring3 =
"].submit()\" onMouseOver=\"window.status='Results for the individual treatment  (new window)';return true\" onMouseOut=\"window.status='Wildlife Habitat Response Model'; return true\" >";
$ftempstring = "";
...
####delete$spepath = 'species/'.$taxgroup.'/';      # 2005.02.01 DEH
    ...
    for ( $i = 0 ; $i <= $nestrow - 1 ; $i++ ) {
        if ( $treatments[$k] == 1 ) {
            if ( $nestfeacode[$i] == -99 ) {
                ...
                $evaltimesdir[$i]     = $tbfevalues[$i] * $nestdir[$i];
...
"<p>nestcode is $nestfeacode[$i] and nestdir is $nestdir[$i] and product is $evaltimesdir[$i] ";
                print
                  "<p>sum[0]is $sum[0] and pevaluesindex1 is $pevaluesindex1";
            }
        }
        if ( $treatments[$k] == 2 ) {
            if ( $nestfeacode[$i] == -99 ) {
                $tpbsum[0]              = 0;
                $tpbpevaluesindex1      = 0;
                $tpbevaltimesdirnest[0] = 0;
            }
            else {
                $tpbevaltimesdir[$i]     = $tpbevalues[$i] * $nestdir[$i];
            ...
            if ($debug) {
                print
"<p>nestcode is $nestfeacode[$i] and nestdir is $nestdir[$i] and product is $tpfevaltimesdir[$i] ";
                print
                  "<p>sum[0]is $sum[0] and pevaluesindex1 is $pevaluesindex1";
            }
        }
        if ( $treatments[$k] == 3 ) {
            if ( $nestfeacode[$i] == -99 ) {
                $pfsum[0]              = 0;
                $pfpevaluesindex1      = 0;
                $pfevaltimesdirnest[0] = 0;
            }
            else {
                $pfevaltimesdir[$i]     = $pfevalues[$i] * $nestdir[$i];
            ...
            if ($debug) {
                print
"<p>nestcode is $nestfeacode[$i] and nestdir is $nestdir[$i] and product is $pfevaltimesdir[$i] ";
                print
                  "<p>sum[0]is $sum[0] and pevaluesindex1 is $pevaluesindex1";
            }
        }
        if ( $treatments[$k] == 4 ) {
            if ( $nestfeacode[$i] == -99 ) {
                $wfsum[0]              = 0;
                $wfpevaluesindex1      = 0;
                $wfevaltimesdirnest[0] = 0;
            }
            else {
                $wfevaltimesdir[$i]     = $wfevalues[$i] * $nestdir[$i];
            ...
            if ($debug) {
                print
"<p>nestcode is $nestfeacode[$i] and nestdir is $nestdir[$i] and product is $wfevaltimesdir[$i] ";
                print
                  "<p>sum[0]is $sum[0] and pevaluesindex1 is $pevaluesindex1";
            }
        }
        ...
        if ( $treatments[$k] == 1 ) {
            if ( $fhabifeacode[$i] == -99 ) {
                ...
                $evaltimesdir[ $pevaluesindex1 + $i ] =
                  $tbfevalues[ $pevaluesindex1 + $i ] * $fhabidir[$i];
                $evaltimesdirfhabi[$i] = $evaltimesdir[ $pevaluesindex1 + $i ];
                $sum[1] =
                  $sum[1] +
                  $tbfevalues[ $pevaluesindex1 + $i ] *
                  $fhabidir[$i] *
            ...
            if ($debug) {
                print
"<p>fhabicode is $fhabifeacode[$i] and fhabidir is $fhabidir[$i]";
                print
                  "<p>sum[1]is $sum[1] and pevaluesindex2 is $pevaluesindex2";
            }
        }
        if ( $treatments[$k] == 2 ) {
            if ( $fhabifeacode[$i] == -99 ) {
                $tpbsum[1]               = 0;
                $tpbpevaluesindex2       = $tpbpevaluesindex1;
                $tpbevaltimesdirfhabi[0] = 0;
            }
            else {
                $tpbevaltimesdir[ $tpbpevaluesindex1 + $i ] =
                  $tpbevalues[ $tpbpevaluesindex1 + $i ] * $fhabidir[$i];
                $tpbevaltimesdirfhabi[$i] =
                  $tpbevaltimesdir[ $tpbpevaluesindex1 + $i ];
                $tpbsum[1] =
                  $tpbsum[1] +
                  $tpbevalues[ $tpbpevaluesindex1 + $i ] *
                  $fhabidir[$i] *
                  ( $fhabirank1[$i] / $rankm[2] );
...
"<p>fhabicode is $fhabifeacode[$i] and fhabidir is $fhabidir[$i]";
                print
"<p>tpbsum[1]is $tpbsum[1] and pevaluesindex2 is $tpbpevaluesindex2";
            }
        }
        if ( $treatments[$k] == 3 ) {
            if ( $fhabifeacode[$i] == -99 ) {
                $pfsum[1]               = 0;
                $pfpevaluesindex2       = $pfpevaluesindex1;
                $pfevaltimesdirfhabi[0] = 0;
            }
            else {
                $pfevaltimesdir[ $pfpevaluesindex1 + $i ] =
                  $pfevalues[ $pfpevaluesindex1 + $i ] * $fhabidir[$i];
                $pfevaltimesdirfhabi[$i] =
                  $pfevaltimesdir[ $pfpevaluesindex1 + $i ];
                $pfsum[1] =
                  $pfsum[1] +
                  $evalues[ $pfpevaluesindex1 + $i ] *
                  $fhabidir[$i] *
                  ( $fhabirank1[$i] / $rankm[2] );
...
"<p>fhabicode is $fhabifeacode[$i] and fhabidir is $fhabidir[$i]";
                print
"<p>pfsum[1]is $sum[1] and pfpevaluesindex2 is $pfpevaluesindex2";
            }
        }
        if ( $treatments[$k] == 4 ) {
            if ( $fhabifeacode[$i] == -99 ) {
                $wfsum[1]               = 0;
                $wfpevaluesindex2       = $wfpevaluesindex1;
                $wfevaltimesdirfhabi[0] = 0;
            }
            else {
                $wfevaltimesdir[ $wfpevaluesindex1 + $i ] =
                  $wfevalues[ $wfpevaluesindex1 + $i ] * $fhabidir[$i];
                $wfevaltimesdirfhabi[$i] =
                  $wfevaltimesdir[ $wfpevaluesindex1 + $i ];
                $wfsum[1] =
                  $wfsum[1] +
                  $evalues[ $wfpevaluesindex1 + $i ] *
                  $fhabidir[$i] *
                  ( $fhabirank1[$i] / $rankm[2] );
...
"<p>fhabicode is $fhabifeacode[$i] and fhabidir is $fhabidir[$i]";
                print
"<p>wfsum[1]is $wfsum[1] and wfpevaluesindex2 is $wfpevaluesindex2";
            }
        }
        ...
        if ( $treatments[$k] == 1 ) {
            if ( $preavafeacode[$i] == -99 ) {
                ...
                $evaltimesdir[ $pevaluesindex2 + $i ] =
                  $tbfevalues[ $pevaluesindex2 + $i ] * $preavadir[$i];
                $evaltimesdirpreava[$i] = $evaltimesdir[ $pevaluesindex2 + $i ];
                $sum[2] =
                  $sum[2] +
                  $tbfevalues[ $pevaluesindex2 + $i ] *
                  $preavadir[$i] *
...
"<p>preavacode is $preavafeacode[$i] and preavadir is $preavadir[$i] ";
                ...
                print
                  "<p>sum[2]is $sum[2] and pevaluesindex3 is $pevaluesindex3";
            }
        }
        ...
        if ( $treatments[$k] == 2 ) {
            if ( $preavafeacode[$i] == -99 ) {
                $tpbsum[2]                = 0;
                $tpbpevaluesindex3        = $tpbpevaluesindex2;
                $tpbevaltimesdirpreava[0] = 0;
            }
            else {
                $tpbevaltimesdir[ $tpbpevaluesindex2 + $i ] =
                  $tpbevalues[ $tpbpevaluesindex2 + $i ] * $preavadir[$i];
                $tpbevaltimesdirpreava[$i] =
                  $tpbevaltimesdir[ $tpbpevaluesindex2 + $i ];
                $tpbsum[2] =
                  $tpbsum[2] +
                  $tpbevalues[ $tpbpevaluesindex2 + $i ] *
                  $preavadir[$i] *
                  ( $preavarank1[$i] / $rankm[3] );
...
"<p>preavacode is $preavafeacode[$i] and preavadir is $preavadir[$i] ";
                ...
                print
"<p>tpbsum[2]is $tpbsum[2] and tpbpevaluesindex3 is $tpbpevaluesindex3";
            }
        }
        if ( $treatments[$k] == 3 ) {
            if ( $preavafeacode[$i] == -99 ) {
                $pfsum[2]                = 0;
                $pfpevaluesindex3        = $pfpevaluesindex2;
                $pfevaltimesdirpreava[0] = 0;
            }
            else {
                $pfevaltimesdir[ $pfpevaluesindex2 + $i ] =
                  $pfevalues[ $pfpevaluesindex2 + $i ] * $preavadir[$i];
                $pfevaltimesdirpreava[$i] =
                  $pfevaltimesdir[ $pfpevaluesindex2 + $i ];
                $pfsum[2] =
                  $pfsum[2] +
                  $pfevalues[ $pfpevaluesindex2 + $i ] *
                  $preavadir[$i] *
                  ( $preavarank1[$i] / $rankm[3] );
...
"<p>preavacode is $preavafeacode[$i] and preavadir is $preavadir[$i] ";
                ...
                print
"<p>pfsum[2]is $pfsum[2] and pfpevaluesindex3 is $pfpevaluesindex3";
            }
        }
        if ( $treatments[$k] == 4 ) {
            if ( $preavafeacode[$i] == -99 ) {
                $wfsum[2]                = 0;
                $wfpevaluesindex3        = $pevaluesindex2;
                $wfevaltimesdirpreava[0] = 0;
            }
            else {
                $wfevaltimesdir[ $wfpevaluesindex2 + $i ] =
                  $wfevalues[ $wfpevaluesindex2 + $i ] * $preavadir[$i];
                $wfevaltimesdirpreava[$i] =
                  $wfevaltimesdir[ $wfpevaluesindex2 + $i ];
                $wfsum[2] =
                  $sum[2] +
                  $wfevalues[ $wfpevaluesindex2 + $i ] *
                  $preavadir[$i] *
                  ( $preavarank1[$i] / $rankm[3] );
...
"<p>preavacode is $preavafeacode[$i] and preavadir is $preavadir[$i] ";
                ...
                print
"<p>wfsum[2]is $wfsum[2] and wfpevaluesindex3 is $wfpevaluesindex3";
            }
        }
        ...
        if ( $treatments[$k] == 1 ) {
            if ( $coverfeacode[$i] == -99 ) {
                ...
                $evaltimesdir[ $pevaluesindex3 + $i ] =
                  $tbfevalues[ $pevaluesindex3 + $i ] * $coverdir[$i];
                $evaltimesdircover[$i] = $evaltimesdir[ $pevaluesindex3 + $i ];
                $sum[3] =
                  $sum[3] +
                  $tbfevalues[ $pevaluesindex3 + $i ] *
                  $coverdir[$i] *
...
"<p>covercode is $coverfeacode[$i] and coverdir is $coverdir[$i] ";
                print
"<p>sum[3]is $sum[3] and pevaluesindex3 is $pevaluesindex3+$i";
            }
        }
        if ( $treatments[$k] == 2 ) {
            if ( $coverfeacode[$i] == -99 ) {
                $tpbsum[3]               = 0;
                $tpbpevaluesindex4       = $tpbpevaluesindex3;
                $tpbevaltimesdircover[0] = 0;
            }
            else {
                $tpbevaltimesdir[ $tpbpevaluesindex3 + $i ] =
                  $tpbevalues[ $tpbpevaluesindex3 + $i ] * $coverdir[$i];
                $tpbevaltimesdircover[$i] =
                  $tpbevaltimesdir[ $tpbpevaluesindex3 + $i ];
                $tpbsum[3] =
                  $tpbsum[3] +
                  $tpbevalues[ $tpbpevaluesindex3 + $i ] *
                  $coverdir[$i] *
                  ( $coverrank1[$i] / $rankm[4] );
...
"<p>covercode is $coverfeacode[$i] and coverdir is $coverdir[$i] ";
                print
"<p>tpbsum[3]is $tpbsum[3] and tpbpevaluesindex3 is $tpbpevaluesindex3+$i";
            }
        }
        if ( $treatments[$k] == 3 ) {
            if ( $coverfeacode[$i] == -99 ) {
                $pfsum[3]               = 0;
                $pfpevaluesindex4       = $pfpevaluesindex3;
                $pfevaltimesdircover[0] = 0;
            }
            else {
                $pfevaltimesdir[ $pfpevaluesindex3 + $i ] =
                  $pfevalues[ $pfpevaluesindex3 + $i ] * $coverdir[$i];
                $pfevaltimesdircover[$i] =
                  $pfevaltimesdir[ $pfpevaluesindex3 + $i ];
                $pfsum[3] =
                  $pfsum[3] +
                  $pfevalues[ $pfpevaluesindex3 + $i ] *
                  $coverdir[$i] *
                  ( $coverrank1[$i] / $rankm[4] );
...
"<p>covercode is $coverfeacode[$i] and coverdir is $coverdir[$i] ";
                print
"<p>pfsum[3]is $pfsum[3] and pfpevaluesindex3 is $pfpevaluesindex3+$i";
            }
        }
        if ( $treatments[$k] == 4 ) {
            if ( $coverfeacode[$i] == -99 ) {
                $wfsum[3]               = 0;
                $wfpevaluesindex4       = $wfpevaluesindex3;
                $wfevaltimesdircover[0] = 0;
            }
            else {
                $wfevaltimesdir[ $wfpevaluesindex3 + $i ] =
                  $wfevalues[ $wfpevaluesindex3 + $i ] * $coverdir[$i];
                $wfevaltimesdircover[$i] =
                  $wfevaltimesdir[ $wfpevaluesindex3 + $i ];
                $wfsum[3] =
                  $wfsum[3] +
                  $wfevalues[ $wfpevaluesindex3 + $i ] *
                  $coverdir[$i] *
                  ( $coverrank1[$i] / $rankm[4] );
...
"<p>covercode is $coverfeacode[$i] and coverdir is $coverdir[$i] ";
                print
"<p>wfsum[3]is $wfsum[3] and wfpevaluesindex3 is $wfpevaluesindex3+$i";
            }
        }
    }
...
for ( $k = 0 ; $k <= ( $tsize - 1 ) ; $k++ ) {
    if ( $treatments[$k] == 1 ) {
        for ( $i = 0 ; $i <= ( @evaltimesdir - 1 ) ; $i++ ) {
            if ( $evaltimesdir[$i] == -3 ) {
                $pevaltimesdir[$i] = "Highly Negative";
            }
            if ( $evaltimesdir[$i] == -2 ) {
                $pevaltimesdir[$i] = "Moderately Negative";
            }
            if ( $evaltimesdir[$i] == -1 ) {
                $pevaltimesdir[$i] = "Slightly Negative";
            }
            if ( $evaltimesdir[$i] == 0 ) { $pevaltimesdir[$i] = "Neutral"; }
            if ( $evaltimesdir[$i] == 1 ) {
                $pevaltimesdir[$i] = "Slightly Positive";
            }
            if ( $evaltimesdir[$i] == 2 ) {
                $pevaltimesdir[$i] = "Moderately Positive";
            }
            if ( $evaltimesdir[$i] == 3 ) {
                $pevaltimesdir[$i] = "Highly Positive";
            }
    ...
    if ( $treatments[$k] == 2 ) {
        for ( $i = 0 ; $i <= ( @tpbevaltimesdir - 1 ) ; $i++ ) {
            if ( $tpbevaltimesdir[$i] == -3 ) {
                $tpbpevaltimesdir[$i] = "Highly Negative";
            }
            if ( $tpbevaltimesdir[$i] == -2 ) {
                $tpbpevaltimesdir[$i] = "Moderately Negative";
            }
            if ( $tpbevaltimesdir[$i] == -1 ) {
                $tpbpevaltimesdir[$i] = "Slightly Negative";
            }
            if ( $tpbevaltimesdir[$i] == 0 ) {
                $tpbpevaltimesdir[$i] = "Neutral";
            }
            if ( $tpbevaltimesdir[$i] == 1 ) {
                $tpbpevaltimesdir[$i] = "Slightly Positive";
            }
            if ( $tpbevaltimesdir[$i] == 2 ) {
                $tpbpevaltimesdir[$i] = "Moderately Positive";
            }
            if ( $tpbevaltimesdir[$i] == 3 ) {
                $tpbpevaltimesdir[$i] = "Highly Positive";
            }
        }
        if ( $tpbfeaflag[0] ) { $tpbanimalresp[0] = -99; $tpbtotalrow = 1; }
        else {
            $tpbanimalresp[0] = $tpbsum[0] / $rr1;
            $tpbtotalrow      = $tpbtotalrow + $rr1;
            $tpbdivisorstand  = $tpbdivisorstand + 1;
        }

        ##$rr2=$fhabirow;
        if ( $tpbfeaflag[1] ) { $tpbanimalresp[1] = -99; }
        else {
            $tpbanimalresp[1] = $tpbsum[1] / $rr2;
            $tpbtotalrow      = $tpbtotalrow + $rr2;
            $tpbdivisorstand  = $tpbdivisorstand + 1;
        }
        ...
        if ( $tpbfeaflag[2] ) { $tpbanimalresp[2] = -99; }
            ...
            $tpbanimalresp[2] = $tpbsum[2] / $rr3;
            $tpbtotalrow      = $tpbtotalrow + $rr3;
            $tpbdivisorstand  = $tpbdivisorstand + 1;
        }
        ...
        if ( $tpbfeaflag[3] ) { $tpbanimalresp[3] = -99 }
            ...
            $tpbanimalresp[3] = $tpbsum[3] / $rr4;
            $tpbtotalrow      = $tpbtotalrow + $rr4;
            $tpbdivisorstand  = $tpbdivisorstand + 1;
        }
    }
    if ( $treatments[$k] == 3 ) {
        for ( $i = 0 ; $i <= ( @pfevaltimesdir - 1 ) ; $i++ ) {
            if ( $pfevaltimesdir[$i] == -3 ) {
                $pfpevaltimesdir[$i] = "Highly Negative";
            }
            if ( $pfevaltimesdir[$i] == -2 ) {
                $pfpevaltimesdir[$i] = "Moderately Negative";
            }
            if ( $pfevaltimesdir[$i] == -1 ) {
                $pfpevaltimesdir[$i] = "Slightly Negative";
            }
            if ( $pfevaltimesdir[$i] == 0 ) {
                $pfpevaltimesdir[$i] = "Neutral";
            }
            if ( $pfevaltimesdir[$i] == 1 ) {
                $pfpevaltimesdir[$i] = "Slightly Positive";
            }
            if ( $pfevaltimesdir[$i] == 2 ) {
                $pfpevaltimesdir[$i] = "Moderately Positive";
            }
            if ( $pfevaltimesdir[$i] == 3 ) {
                $pfpevaltimesdir[$i] = "Highly Positive";
            }
        }
        if ( $pffeaflag[0] ) { $pfanimalresp[0] = -99; $pftotalrow = 1; }
        else {
            $pfanimalresp[0] = $pfsum[0] / $rr1;
            $pftotalrow      = $pftotalrow + $rr1;
            $pfdivisorstand  = $pfdivisorstand + 1;
        }

        ##$rr2=$fhabirow;
        if ( $pffeaflag[1] ) { $pfanimalresp[1] = -99; }
        else {
            $pfanimalresp[1] = $pfsum[1] / $rr2;
            $pftotalrow      = $pftotalrow + $rr2;
            $pfdivisorstand  = $pfdivisorstand + 1;
        }
        ...
        if ( $pffeaflag[2] ) { $pfanimalresp[2] = -99; }
            ...
            $pfanimalresp[2] = $pfsum[2] / $rr3;
            $pftotalrow      = $pftotalrow + $rr3;
            $pfdivisorstand  = $pfdivisorstand + 1;
        }
        ...
        if ( $pffeaflag[3] ) { $pfanimalresp[3] = -99 }
            ...
            $pfanimalresp[3] = $pfsum[3] / $rr4;
            $pftotalrow      = $pftotalrow + $rr4;
            $pfdivisorstand  = $pfdivisorstand + 1;
        }
    }
    if ( $treatments[$k] == 4 ) {
        for ( $i = 0 ; $i <= ( @wfevaltimesdir - 1 ) ; $i++ ) {
            if ( $wfevaltimesdir[$i] == -3 ) {
                $wfpevaltimesdir[$i] = "Highly Negative";
            }
            if ( $wfevaltimesdir[$i] == -2 ) {
                $wfpevaltimesdir[$i] = "Moderately Negative";
            }
            if ( $wfevaltimesdir[$i] == -1 ) {
                $wfpevaltimesdir[$i] = "Slightly Negative";
            }
            if ( $wfevaltimesdir[$i] == 0 ) {
                $wfpevaltimesdir[$i] = "Neutral";
            }
            if ( $wfevaltimesdir[$i] == 1 ) {
                $wfpevaltimesdir[$i] = "Slightly Positive";
            }
            if ( $wfevaltimesdir[$i] == 2 ) {
                $wfpevaltimesdir[$i] = "Moderately Positive";
            }
            if ( $wfevaltimesdir[$i] == 3 ) {
                $wfpevaltimesdir[$i] = "Highly Positive";
            }
        }
        if ( $wffeaflag[0] ) { $wfanimalresp[0] = -99; $wftotalrow = 1; }
        else {
            $wfanimalresp[0] = $wfsum[0] / $rr1;
            $wftotalrow      = $wftotalrow + $rr1;
            $wfdivisorstand  = $wfdivisorstand + 1;
        }

        ##$rr2=$fhabirow;
        if ( $wffeaflag[1] ) { $wfanimalresp[1] = -99; }
        else {
            $wfanimalresp[1] = $wfsum[1] / $rr2;
            $wftotalrow      = $wftotalrow + $rr2;
            $wfdivisorstand  = $wfdivisorstand + 1;
        }
        ...
        if ( $wffeaflag[2] ) { $wfanimalresp[2] = -99; }
            ...
            $wfanimalresp[2] = $wfsum[2] / $rr3;
            $wftotalrow      = $wftotalrow + $rr3;
            $wfdivisorstand  = $wfdivisorstand + 1;
        }
        ...
        if ( $wffeaflag[3] ) { $wfanimalresp[3] = -99 }
            ...
            $wfanimalresp[3] = $wfsum[3] / $rr4;
            $wftotalrow      = $wftotalrow + $rr4;
            $wfdivisorstand  = $wfdivisorstand + 1;
        }
    }
}    ##end of k loop
...
for ( $j = 0 ; $j < $tsize ; $j++ ) {
    if ( $treatments[$j] == 1 ) {
        ...
        elsif ( $suncerpreava[0] != $suncerpreava[ $rr3 - 1 ] ) {
            $unflag[2] = 1;
        }
...
"<p>suncercover is :@suncercover and $suncercover[0] and $suncercover[$rr4-1] and $unflag[3]<br>";
    ...
    if ( $treatments[$j] == 2 ) {
        ...
        for ( $k = 0 ; $k <= ( $rr3 - 1 ) ; $k++ ) {
            ...
            elsif ( $tpbevaltimesdirpreava[$k] == 0 ) {
                $tpbuncerpreava[$k] = 0;
            }
        ...
        if ( ( $tpbsuncernest[0] == 0 ) || ( $tpbsuncernest[ $rr1 - 1 ] == 0 ) )
        {
            $tpbunflag[0] = 0;
        }
        elsif ( $tpbsuncernest[0] != $tpbsuncernest[ $rr1 - 1 ] ) {
            $tpbunflag[0] = 1;
        }
        @tpbsuncerfhabi = sort @tpbuncerfhabi;
        if (   ( $tpbsuncerfhabi[0] == 0 )
            || ( $tpbsuncerfhabi[ $rr2 - 1 ] == 0 ) )
        {
            $tpbunflag[1] = 0;
        }
        elsif ( $tpbsuncerfhabi[0] != $tpbsuncerfhabi[ $rr2 - 1 ] ) {
            $tpbunflag[1] = 1;
        }
        @tpbsuncerpreava = sort @tpbuncerpreava;
        if (   ( $tpbsuncerpreava[0] == 0 )
            || ( $tpbsuncerpreava[ $rr3 - 1 ] == 0 ) )
        {
            $tpbunflag[2] = 0;
        }
        elsif ( $tpbsuncerpreava[0] != $tpbsuncerpreava[ $rr3 - 1 ] ) {
            $tpbunflag[2] = 1;
        }
        @tpbsuncercover = sort @tpbuncercover;
        if (   ( $tpbsuncercover[0] == 0 )
            || ( $tpbsuncercover[ $rr4 - 1 ] == 0 ) )
        {
            $tpbunflag[3] = 0;
        }
        elsif ( $tpbsuncercover[0] != $tpbsuncercover[ $rr4 - 1 ] ) {
            $tpbunflag[3] = 1;
        }

        if ($debug) {
            print
"<p>tpbsuncernest is :@tpbsuncernest and $tpbsuncernest[0] and $tpbsuncernest[$rr1-1] and $tpbunflag[0]<br>";
            print
"<p>tpbsuncerfhabi is :@tpbsuncerfhabi and $tpbsuncerfhabi[0] and $tpbsuncerfhabi[$rr2-1] and $tpbunflag[1]<br>";
            print
"<p>tpbsuncerpreava is :@tpbsuncerpreava and $tpbsuncerpreava[0] and $tpbsuncerpreava[$rr3-1] and $tpbunflag[2]<br>";
            print
"<p>tpbsuncercover is :@tpbsuncercover and $tpbsuncercover[0] and $tpbsuncercover[$rr4-1] and $tpbunflag[3]<br>";
        }
    ...
    if ( $treatments[$j] == 3 ) {
        ...
        if ( ( $pfsuncernest[0] == 0 ) || ( $pfsuncernest[ $rr1 - 1 ] == 0 ) ) {
            $pfunflag[0] = 0;
        }
        elsif ( $pfsuncernest[0] != $pfsuncernest[ $rr1 - 1 ] ) {
            $pfunflag[0] = 1;
        }
        @pfsuncerfhabi = sort @pfuncerfhabi;
        if ( ( $pfsuncerfhabi[0] == 0 ) || ( $pfsuncerfhabi[ $rr2 - 1 ] == 0 ) )
        {
            $pfunflag[1] = 0;
        }
        elsif ( $pfsuncerfhabi[0] != $pfsuncerfhabi[ $rr2 - 1 ] ) {
            $pfunflag[1] = 1;
        }
        @pfsuncerpreava = sort @pfuncerpreava;
        if (   ( $pfsuncerpreava[0] == 0 )
            || ( $pfsuncerpreava[ $rr3 - 1 ] == 0 ) )
        {
            $pfunflag[2] = 0;
        }
        elsif ( $pfsuncerpreava[0] != $pfsuncerpreava[ $rr3 - 1 ] ) {
            $pfunflag[2] = 1;
        }
        @pfsuncercover = sort @pfuncercover;
        if ( ( $pfsuncercover[0] == 0 ) || ( $pfsuncercover[ $rr4 - 1 ] == 0 ) )
        {
            $pfunflag[3] = 0;
        }
        elsif ( $pfsuncercover[0] != $pfsuncercover[ $rr4 - 1 ] ) {
            $pfunflag[3] = 1;
        }

        if ($debug) {
            print
"<p>pfsuncernest is :@pfsuncernest and $pfsuncernest[0] and $pfsuncernest[$rr1-1] and $pfunflag[0]<br>";
            print
"<p>pfsuncerfhabi is :@pfsuncerfhabi and $pfsuncerfhabi[0] and $pfsuncerfhabi[$rr2-1] and $pfunflag[1]<br>";
            print
"<p>pfsuncerpreava is :@pfsuncerpreava and $pfsuncerpreava[0] and $pfsuncerpreava[$rr3-1] and $pfunflag[2]<br>";
            print
"<p>pfsuncercover is :@pfsuncercover and $pfsuncercover[0] and $pfsuncercover[$rr4-1] and $pfunflag[3]<br>";
        }
    ...
    if ( $treatments[$j] == 4 ) {
        ...
        if ( ( $wfsuncernest[0] == 0 ) || ( $wfsuncernest[ $rr1 - 1 ] == 0 ) ) {
            $wfunflag[0] = 0;
        }
        elsif ( $wfsuncernest[0] != $wfsuncernest[ $rr1 - 1 ] ) {
            $wfunflag[0] = 1;
        }
        @wfsuncerfhabi = sort @wfuncerfhabi;
        if ( ( $wfsuncerfhabi[0] == 0 ) || ( $wfsuncerfhabi[ $rr2 - 1 ] == 0 ) )
        {
            $wfunflag[1] = 0;
        }
        elsif ( $wfsuncerfhabi[0] != $wfsuncerfhabi[ $rr2 - 1 ] ) {
            $wfunflag[1] = 1;
        }
        @wfsuncerpreava = sort @wfuncerpreava;
        if (   ( $wfsuncerpreava[0] == 0 )
            || ( $wfsuncerpreava[ $rr3 - 1 ] == 0 ) )
        {
            $wfunflag[2] = 0;
        }
        elsif ( $wfsuncerpreava[0] != $wfsuncerpreava[ $rr3 - 1 ] ) {
            $wfunflag[2] = 1;
        }
        @wfsuncercover = sort @wfuncercover;
        if ( ( $wfsuncercover[0] == 0 ) || ( $wfsuncercover[ $rr4 - 1 ] == 0 ) )
        {
            $wfunflag[3] = 0;
        }
        elsif ( $wfsuncercover[0] != $wfsuncercover[ $rr4 - 1 ] ) {
            $wfunflag[3] = 1;
        }

        if ($debug) {
            print
"<p>wfsuncernest is :@wfsuncernest and $wfsuncernest[0] and $wfsuncernest[$rr1-1] and $wfunflag[0]<br>";
            print
"<p>wfsuncerfhabi is :@wfsuncerfhabi and $wfsuncerfhabi[0] and $wfsuncerfhabi[$rr2-1] and $wfunflag[1]<br>";
            print
"<p>wfsuncerpreava is :@wfsuncerpreava and $wfsuncerpreava[0] and $wfsuncerpreava[$rr3-1] and $wfunflag[2]<br>";
            print
"<p>wfsuncercover is :@wfsuncercover and $wfsuncercover[0] and $wfsuncercover[$rr4-1] and $wfunflag[3]<br>";
        }
    ...
    if ( $treatments[$j] == 2 ) {
        for ( $i = 0 ; $i <= 3 ; $i++ ) {
            if ( ( $tpbanimalresp[$i] >= -3 ) && ( $tpbanimalresp[$i] < -2 ) ) {
                if ( $tpbunflag[$i] ) {
                    $tpbpanimalresp[$i] = $tpbupsentence[0];
                    $tpbffpsentence[$i] = $tpbfpsentence[0];
                }
                else {
                    $tpbpanimalresp[$i] = $tpbpsentence[0];
                    $tpbffpsentence[$i] = $tpbfpsentence[0];
                }
            }
            elsif (( $tpbanimalresp[$i] >= -2 )
                && ( $tpbanimalresp[$i] < -1 ) )
            {
                if ( $tpbunflag[$i] ) {
                    $tpbpanimalresp[$i] = $tpbupsentence[1];
                    $tpbffpsentence[$i] = $tpbfpsentence[1];
                }
                else {
                    $tpbpanimalresp[$i] = $tpbpsentence[1];
                    $tpbffpsentence[$i] = $tpbfpsentence[1];
                }
            }
            elsif (( $tpbanimalresp[$i] >= -1 )
                && ( $tpbanimalresp[$i] < -0.25 ) )
            {
                if ( $tpbunflag[$i] ) {
                    $tpbpanimalresp[$i] = $tpbupsentence[2];
                    $tpbffpsentence[$i] = $tpbfpsentence[2];
                }
                else {
                    $tpbpanimalresp[$i] = $tpbpsentence[2];
                    $tpbffpsentence[$i] = $tpbfpsentence[2];
                }
            }
            elsif (( $tpbanimalresp[$i] >= -0.25 )
                && ( $tpbanimalresp[$i] <= 0.25 ) )
            {
                if ( $tpbunflag[$i] ) {
                    $tpbpanimalresp[$i] = $tpbupsentence[3];
                    $tpbffpsentence[$i] = $tpbfpsentence[3];
                }
                else {
                    $tpbpanimalresp[$i] = $tpbpsentence[3];
                    $tpbffpsentence[$i] = $tpbfpsentence[3];
                }
            }
            elsif (( $tpbanimalresp[$i] > 0.25 )
            ...
            {
                if ( $tpbunflag[$i] ) {
                    $tpbpanimalresp[$i] = $tpbupsentence[4];
                    $tpbffpsentence[$i] = $tpbfpsentence[4];
                }
                else {
                    $tpbpanimalresp[$i] = $tpbpsentence[4];
                    $tpbffpsentence[$i] = $tpbfpsentence[4];
                }
            }
            ...
            {
                if ( $tpbunflag[$i] ) {
                    $tpbpanimalresp[$i] = $tpbupsentence[5];
                    $tpbffpsentence[$i] = $tpbfpsentence[5];
                }
                else {
                    $tpbpanimalresp[$i] = $tpbpsentence[5];
                    $tpbffpsentence[$i] = $tpbfpsentence[5];
                }
            }
            ...
            {
                if ( $tpbunflag[$i] ) {
                    $tpbpanimalresp[$i] = $tpbupsentence[6];
                    $tpbffpsentence[$i] = $tpbfpsentence[6];
                }
                else {
                    $tpbpanimalresp[$i] = $tpbpsentence[6];
                    $tpbffpsentence[$i] = $tpbfpsentence[6];
                }
            }
            else {
                $tpbpanimalresp[$i] = "Not Available";
                $tpbffpsentence[$i] = "Not Available";
            }
        }    #end i loop
    }    #end treatment
    if ( $treatments[$j] == 3 ) {
        for ( $i = 0 ; $i <= 3 ; $i++ ) {
            if ( ( $pfanimalresp[$i] >= -3 ) && ( $pfanimalresp[$i] < -2 ) ) {
                if ( $pfunflag[$i] ) {
                    $pfpanimalresp[$i] = $pfupsentence[0];
                    $pfffpsentence[$i] = $pffpsentence[0];
                }
                else {
                    $pfpanimalresp[$i] = $pfpsentence[0];
                    $pfffpsentence[$i] = $pffpsentence[0];
                }
            }
            ...
            {
                if ( $pfunflag[$i] ) {
                    $pfpanimalresp[$i] = $pfupsentence[1];
                    $pfffpsentence[$i] = $pffpsentence[1];
                }
                else {
                    $pfpanimalresp[$i] = $pfpsentence[1];
                    $pfffpsentence[$i] = $pffpsentence[1];
                }
            }
            elsif (( $pfanimalresp[$i] >= -1 )
                && ( $pfanimalresp[$i] < -0.25 ) )
            {
                if ( $pfunflag[$i] ) {
                    $pfpanimalresp[$i] = $pfupsentence[2];
                    $pfffpsentence[$i] = $pffpsentence[2];
                }
                else {
                    $pfpanimalresp[$i] = $pfpsentence[2];
                    $pfffpsentence[$i] = $pffpsentence[2];
                }
            }
            elsif (( $pfanimalresp[$i] >= -0.25 )
                && ( $pfanimalresp[$i] <= 0.25 ) )
            {
                if ( $pfunflag[$i] ) {
                    $pfpanimalresp[$i] = $pfupsentence[3];
                    $pfffpsentence[$i] = $pffpsentence[3];
                }
                else {
                    $pfpanimalresp[$i] = $pfpsentence[3];
                    $pfffpsentence[$i] = $pffpsentence[3];
                }
            }
            ...
            {
                if ( $pfunflag[$i] ) {
                    $pfpanimalresp[$i] = $pfupsentence[4];
                    $pfffpsentence[$i] = $pffpsentence[4];
                }
                else {
                    $pfpanimalresp[$i] = $pfpsentence[4];
                    $pfffpsentence[$i] = $pffpsentence[4];
                }
            }
            elsif ( ( $pfanimalresp[$i] > 1 ) && ( $pfanimalresp[$i] <= 2 ) ) {
                if ( $pfunflag[$i] ) {
                    $pfpanimalresp[$i] = $pfupsentence[5];
                    $pfffpsentence[$i] = $pffpsentence[5];
                }
                else {
                    $pfpanimalresp[$i] = $pfpsentence[5];
                    $pfffpsentence[$i] = $pffpsentence[5];
                }
            }
            elsif ( ( $pfanimalresp[$i] > 2 ) && ( $pfanimalresp[$i] <= 3 ) ) {
                if ( $pfunflag[$i] ) {
                    $pfpanimalresp[$i] = $pfupsentence[6];
                    $pfffpsentence[$i] = $pffpsentence[6];
                }
                else {
                    $pfpanimalresp[$i] = $pfpsentence[6];
                    $pfffpsentence[$i] = $pffpsentence[6];
                }
            }
            else {
                $pfpanimalresp[$i] = "Not Available";
                $pfffpsentence[$i] = "Not Available";
            }
        }    #end i loop
    }    #end treatment
    ...
    if ( $treatments[$j] == 4 ) {
        for ( $i = 0 ; $i <= 3 ; $i++ ) {
            if ( ( $wfanimalresp[$i] >= -3 ) && ( $wfanimalresp[$i] < -2 ) ) {
                if ( $wfunflag[$i] ) {
                    $wfpanimalresp[$i] = $wfupsentence[0];
                    $wfffpsentence[$i] = $wffpsentence[0];
                }
                else {
                    $wfpanimalresp[$i] = $wfpsentence[0];
                    $wfffpsentence[$i] = $wffpsentence[0];
                }
            }
            ...
            {
                if ( $wfunflag[$i] ) {
                    $wfpanimalresp[$i] = $wfupsentence[1];
                    $wfffpsentence[$i] = $wffpsentence[1];
                }
                else {
                    $wfpanimalresp[$i] = $wfpsentence[1];
                    $wfffpsentence[$i] = $wffpsentence[1];
                }
            }
            elsif (( $wfanimalresp[$i] >= -1 )
                && ( $wfanimalresp[$i] < -0.25 ) )
            {
                if ( $wfunflag[$i] ) {
                    $wfpanimalresp[$i] = $wfupsentence[2];
                    $wfffpsentence[$i] = $wffpsentence[2];
                }
                else {
                    $wfpanimalresp[$i] = $wfpsentence[2];
                    $wfffpsentence[$i] = $wffpsentence[2];
                }
            }
            elsif (( $wfanimalresp[$i] >= -0.25 )
                && ( $wfanimalresp[$i] <= 0.25 ) )
            {
                if ( $wfunflag[$i] ) {
                    $wfpanimalresp[$i] = $wfupsentence[3];
                    $wfffpsentence[$i] = $wffpsentence[3];
                }
                else {
                    $wfpanimalresp[$i] = $wfpsentence[3];
                    $wfffpsentence[$i] = $wffpsentence[3];
                }
            }
            ...
            {
                if ( $wfunflag[$i] ) {
                    $wfpanimalresp[$i] = $wfupsentence[4];
                    $wfffpsentence[$i] = $wffpsentence[4];
                }
                else {
                    $wfpanimalresp[$i] = $wfpsentence[4];
                    $wfffpsentence[$i] = $wffpsentence[4];
                }
            }
            elsif ( ( $wfanimalresp[$i] > 1 ) && ( $wfanimalresp[$i] <= 2 ) ) {
                if ( $wfunflag[$i] ) {
                    $wfpanimalresp[$i] = $wfupsentence[5];
                    $wfffpsentence[$i] = $wffpsentence[5];
                }
                else {
                    $wfpanimalresp[$i] = $wfpsentence[5];
                    $wfffpsentence[$i] = $wffpsentence[5];
                }
            }
            elsif ( ( $wfanimalresp[$i] > 2 ) && ( $wfanimalresp[$i] <= 3 ) ) {
                if ( $wfunflag[$i] ) {
                    $wfpanimalresp[$i] = $wfupsentence[6];
                    $wfffpsentence[$i] = $wffpsentence[6];
                }
                else {
                    $wfpanimalresp[$i] = $wfpsentence[6];
                    $wfffpsentence[$i] = $wffpsentence[6];
                }
            }
            else {
                $wfpanimalresp[$i] = "Not Available";
                $wfffpsentence[$i] = "Not Available";
            }
        }    #end i loop
    }    #end treatment
}    #end j loop
...
for ( $i = 0 ; $i <= $nestrow - 1 ; $i++ ) {
    if ( $i == 0 ) {
        if ( $nestfeacode[$i] == -99 ) {
            print
              "<td colspan=$tsize2 align=center>No Information Is Available</td>
            </tr>";
        }
        else {
            ...
            for ( $j = 0 ; $j < $tsize ; $j++ ) {
                if ( $treatments[$j] == 1 ) {
                    print "<td align=center rowspan=$rr1>$panimalresp[0]</td>";
                }
                elsif ( $treatments[$j] == 2 ) {
                    print
                      "<td align=center rowspan=$rr1>$tpbpanimalresp[0]</td>";
                }
                elsif ( $treatments[$j] == 3 ) {
                    print
                      "<td align=center rowspan=$rr1>$pfpanimalresp[0]</td>";
                }
                else {
                    print
                      "<td align=center rowspan=$rr1>$wfpanimalresp[0]</td>";
                }
            }
            print "</tr>";
        }
...
for ( $i = 0 ; $i <= $fhabirow - 1 ; $i++ ) {
    if ( $i == 0 ) {
        if ( $fhabifeacode[$i] == -99 ) {
            ...
            for ( $j = 0 ; $j < $tsize ; $j++ ) {
                if ( $treatments[$j] == 1 ) {
                    print "<td align=center rowspan=$rr2>$panimalresp[1]</td>";
                }
                elsif ( $treatments[$j] == 2 ) {
                    print
                      "<td align=center rowspan=$rr2>$tpbpanimalresp[1]</td>";
                }
                elsif ( $treatments[$j] == 3 ) {
                    print
                      "<td align=center rowspan=$rr2>$pfpanimalresp[1]</td>";
                }
                else {
                    print
                      "<td align=center rowspan=$rr2>$wfpanimalresp[1]</td>";
                }
            }
            print "</tr>";
        }
...
for ( $i = 0 ; $i <= $preavarow - 1 ; $i++ ) {
    if ( $i == 0 ) {
        if ( $preavafeacode[$i] == -99 ) {
            ...
            for ( $j = 0 ; $j < $tsize ; $j++ ) {
                if ( $treatments[$j] == 1 ) {
                    print "<td align=center rowspan=$rr3>$panimalresp[2]</td>";
                }
                elsif ( $treatments[$j] == 2 ) {
                    print
                      "<td align=center rowspan=$rr3>$tpbpanimalresp[2]</td>";
                }
                elsif ( $treatments[$j] == 3 ) {
                    print
                      "<td align=center rowspan=$rr3>$pfpanimalresp[2]</td>";
                }
                else {
                    print
                      "<td align=center rowspan=$rr3>$wfpanimalresp[2]</td>";
                }
            }
            print "</tr>";
        }
...
for ( $i = 0 ; $i <= $coverrow - 1 ; $i++ ) {
    if ( $i == 0 ) {
        if ( $coverfeacode[$i] == -99 ) {
            ...
            for ( $j = 0 ; $j < $tsize ; $j++ ) {
                if ( $treatments[$j] == 1 ) {
                    print "<td align=center rowspan=$rr4>$panimalresp[3]</td>";
                }
                elsif ( $treatments[$j] == 2 ) {
                    print
                      "<td align=center rowspan=$rr4>$tpbpanimalresp[3]</td>";
                }
                elsif ( $treatments[$j] == 3 ) {
                    print
                      "<td align=center rowspan=$rr4>$pfpanimalresp[3]</td>";
                }
                else {
                    print
                      "<td align=center rowspan=$rr4>$wfpanimalresp[3]</td>";
                }
            }
            print "</tr>";
        }
...
for ( $i = 0 ; $i <= $nestrow - 1 ; $i++ ) {
    if ( $i == 0 ) {
        if ( $nestfeacode[$i] == -99 ) { $nestelem[$i] = "no"; }
...
for ( $i = 0 ; $i <= $fhabirow - 1 ; $i++ ) {
    if ( $i == 0 ) {
        if ( $fhabifeacode[$i] == -99 ) { $forgelem[$i] = "no"; }
...
for ( $i = 0 ; $i <= $preavarow - 1 ; $i++ ) {
    if ( $i == 0 ) {
        if ( $preavafeacode[$i] == -99 ) { $preyelem[$i] = "no"; }
...
for ( $i = 0 ; $i <= $coverrow - 1 ; $i++ ) {
    if ( $i == 0 ) {
        if ( $coverfeacode[$i] == -99 ) { $coveelem[$i] = "no"; }
...
for ( $k = 0 ; $k <= $tsize - 1 ; $k++ ) {
    for ( $i = 0 ; $i <= $nestrow - 1 ; $i++ ) {
        if ( $treatments[$k] == 1 ) {
            if ( $evaltimesdirnest[$i] < 0 ) {
                $nestneg[ $size1[$k] ] = $nestelem[$i];
                $size1[$k] = $size1[$k] + 1;
            }
        }
        if ( $treatments[$k] == 2 ) {
            if ( $tpbevaltimesdirnest[$i] < 0 ) {
                $tpbnestneg[ $size1[$k] ] = $nestelem[$i];
                $size1[$k] = $size1[$k] + 1;
            }
        }
        if ( $treatments[$k] == 3 ) {
            if ( $pfevaltimesdirnest[$i] < 0 ) {
                $pfnestneg[ $size1[$k] ] = $nestelem[$i];
                $size1[$k] = $size1[$k] + 1;
            }
        }
        if ( $treatments[$k] == 4 ) {
            if ( $wfevaltimesdirnest[$i] < 0 ) {
                $wfnestneg[ $size1[$k] ] = $nestelem[$i];
                $size1[$k] = $size1[$k] + 1;
            }
        }
    }
###########################
    for ( $i = 0 ; $i <= $fhabirow - 1 ; $i++ ) {
        if ( $treatments[$k] == 1 ) {
            if ( $evaltimesdirfhabi[$i] < 0 ) {
                $forgneg[ $size2[$k] ] = $forgelem[$i];
                $size2[$k] = $size2[$k] + 1;
            }
        }
        if ( $treatments[$k] == 2 ) {
            if ( $tpbevaltimesdirfhabi[$i] < 0 ) {
                $tpbforgneg[ $size2[$k] ] = $forgelem[$i];
                $size2[$k] = $size2[$k] + 1;
            }
        }
        if ( $treatments[$k] == 3 ) {
            if ( $pfevaltimesdirfhabi[$i] < 0 ) {
                $pfforgneg[ $size2[$k] ] = $forgelem[$i];
                $size2[$k] = $size2[$k] + 1;
            }
        }
        if ( $treatments[$k] == 4 ) {
            if ( $wfevaltimesdirfhabi[$i] < 0 ) {
                $wfforgneg[ $size2[$k] ] = $forgelem[$i];
                $size2[$k] = $size2[$k] + 1;
            }
        }
    }
###########################
    for ( $i = 0 ; $i <= $preavarow - 1 ; $i++ ) {
        if ( $treatments[$k] == 1 ) {
            if ( $evaltimesdirpreava[$i] < 0 ) {
                $preyneg[ $size3[$k] ] = $preyelem[$i];
                $size3[$k] = $size3[$k] + 1;
            }
        }
        if ( $treatments[$k] == 2 ) {
            if ( $tpbevaltimesdirpreava[$i] < 0 ) {
                $tpbpreyneg[ $size3[$k] ] = $preyelem[$i];
                $size3[$k] = $size3[$k] + 1;
            }
        }
        if ( $treatments[$k] == 3 ) {
            if ( $pfevaltimesdirpreava[$i] < 0 ) {
                $pfpreyneg[ $size3[$k] ] = $preyelem[$i];
                $size3[$k] = $size3[$k] + 1;
            }
        }
        if ( $treatments[$k] == 4 ) {
            if ( $wfevaltimesdirpreava[$i] < 0 ) {
                $wfpreyneg[ $size3[$k] ] = $preyelem[$i];
                $size3[$k] = $size3[$k] + 1;
            }
        }
    }
###########################
    for ( $i = 0 ; $i <= $coverrow - 1 ; $i++ ) {
        if ( $treatments[$k] == 1 ) {
            if ( $evaltimesdircover[$i] < 0 ) {
                $coveneg[ $size4[$k] ] = $coveelem[$i];
                $size4[$k] = $size4[$k] + 1;
            }
        }
        if ( $treatments[$k] == 2 ) {
            if ( $tpbevaltimesdircover[$i] < 0 ) {
                $tpbcoveneg[ $size4[$k] ] = $coveelem[$i];
                $size4[$k] = $size4[$k] + 1;
            }
        }
        if ( $treatments[$k] == 3 ) {
            if ( $pfevaltimesdircover[$i] < 0 ) {
                $pfcoveneg[ $size4[$k] ] = $coveelem[$i];
                $size4[$k] = $size4[$k] + 1;
            }
        }
        if ( $treatments[$k] == 4 ) {
            if ( $wfevaltimesdircover[$i] < 0 ) {
                $wfcoveneg[ $size4[$k] ] = $coveelem[$i];
                $size4[$k] = $size4[$k] + 1;
            }
        }
    }
...
for ( $k = 0 ; $k < $tsize ; $k++ ) {
    if ( $treatments[$k] == 1 ) {
        $nestc[$k] = $animalresp[0];
        $forgc[$k] = $animalresp[1];
        $preyc[$k] = $animalresp[2];
        $covec[$k] = $animalresp[3];
    }
    if ( $treatments[$k] == 2 ) {
        $nestc[$k] = $tpbanimalresp[0];
        $forgc[$k] = $tpbanimalresp[1];
        $preyc[$k] = $tpbanimalresp[2];
        $covec[$k] = $tpbanimalresp[3];
    }
    if ( $treatments[$k] == 3 ) {
        $nestc[$k] = $pfanimalresp[0];
        $forgc[$k] = $pfanimalresp[1];
        $preyc[$k] = $pfanimalresp[2];
        $covec[$k] = $pfanimalresp[3];
    }
    if ( $treatments[$k] == 4 ) {
        $nestc[$k] = $wfanimalresp[0];
        $forgc[$k] = $wfanimalresp[1];
        $preyc[$k] = $wfanimalresp[2];
...
if ( ( $canopycover !~ /^no/ ) && ( $canopycover !~ /^No/ ) ) {
    print <<"endcca";
...
if ( $snestc[0] == -99 ) {
    print
"<p>There is insufficient published information to evaluate effects of the selected fuel treatments on reproduction habitats. 
Please consult with a local wildlife biologist.</p>";
}
else {
    if ( $snestc[0] > 0 ) {
        if ( $snestc[0] == $snestc[$#snestc] ) {
            print <<"nesp1";
...
nesp1
            ...
            print
"<p>All the selected treatments resulted in a positive effect on reproduction habitat.</p>";
        }
    }
    elsif ( $snestc[0] == 0 ) {
        if ( $snestc[0] == $snestc[$#snestc] ) {
...
nesp2
            ...
            print
"<p>All the selected treatments resulted in a positeve effect on reproduction habitat</p>";
        }
    }
    else {
        print
"<p>The following treatment(s) resulted in <u><b>negative</b></u> effects on reproduction habitat for the $species:";
        print "<ul>";
        for ( $j = 0 ; $j < $tsize ; $j++ ) {
            if ( $nestc[$j] < 0 ) {
                if ( $treatments[$j] == 1 ) {
                    print "<li><b>$lnametreatment[$j]</b> where ";
                    if ( $size1[$j] == 1 ) {
                        print
"change in $nestneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size1[$j] == 2 ) {
                        print
"changes in $nestneg[0] and $nestneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig = "changes in $nestneg[0], $nestneg[1], ";
                        for ( $k = 2 ; $k < $size1[$j] ; $k++ ) {
                            $stopstrig = $size1[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig = $tempstrig . "and " . $nestneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $nestneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 2 ) {
                    ...
                    if ( $size1[$j] == 1 ) {
                        print
"change in $tpbnestneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size1[$j] == 2 ) {
                        print
"changes in $tpbnestneg[0] and $tpbnestneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $tpbnestneg[0], $tpbnestneg[1], ";
                        for ( $k = 2 ; $k < $size1[$j] ; $k++ ) {
                            $stopstrig = $size1[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $tpbnestneg[$k];
                            }
                            else {
                                $tempstrig =
                                  $tempstrig . $tpbnestneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 3 ) {
                    ...
                    if ( $size1[$j] == 1 ) {
                        print
"change in $pfnestneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size1[$j] == 2 ) {
                        print
"changes in $pfnestneg[0] and $pfnestneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $pfnestneg[0], $pfnestneg[1], ";
                        for ( $k = 2 ; $k < $size1[$j] ; $k++ ) {
                            $stopstrig = $size1[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $pfnestneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $pfnestneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 4 ) {
                    print "<li><b>$nametreatment[$j]</b> where ";
                    if ( $size1[$j] == 1 ) {
                        print
"change in $wfnestneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size1[$j] == 2 ) {
                        print
"changes in $wfnestneg[0] and $wfnestneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $wfnestneg[0], $wfnestneg[1], ";
                        for ( $k = 2 ; $k < $size1[$j] ; $k++ ) {
                            $stopstrig = $size1[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $wfnestneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $wfnestneg[$k] . ", ";
                            }
...
if ( $sforgc[0] == -99 ) {
    print
"<p>There is insufficient published information to evaluate effects of the selected fuel treatments on foraging habitats. 
Please consult with a local wildlife biologist.</p>";
}
else {
    if ( $sforgc[0] > 0 ) {
        if ( $sforgc[0] == $sforgc[$#sforgc] ) {
            print <<"forgp1";
<p>Of the selected fuel treatments, <b>WHRM</b>
...
forgp1
            ...
            print
"<p>All the selected treatments resulted in a positive effect on foraging habitat.</p>";
        }
    }
    elsif ( $sforgc[0] == 0 ) {
        if ( $sforgc[0] == $sforgc[$#sforgc] ) {
...
"<p>All the selected treatments resulted in a positive effect on foraging habitat</p>";
        ...
        print
"<p>The following treatment(s) resulted in <u><b>negative</b></u> effects on foraging habitat for the $species:";
        print "<ul>";
        for ( $j = 0 ; $j < $tsize ; $j++ ) {
            if ( $forgc[$j] < 0 ) {
                if ( $treatments[$j] == 1 ) {
                    ...
                    if ( $size2[$j] == 1 ) {
                        print
"change in $forgneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size2[$j] == 2 ) {
                        print
"changes in $forgneg[0] and $forgneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig = "changes in $forgneg[0], $forgneg[1], ";
                        for ( $k = 2 ; $k < $size2[$j] ; $k++ ) {
                            $stopstrig = $size2[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig = $tempstrig . "and " . $forgneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $forgneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 2 ) {
                    ...
                    if ( $size2[$j] == 1 ) {
                        print
"change in $tpbforgneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size2[$j] == 2 ) {
                        print
"changes in $tpbforgneg[0] and $tpbforgneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $tpbforgneg[0], $tpbforgneg[1], ";
                        for ( $k = 2 ; $k < $size2[$j] ; $k++ ) {
                            $stopstrig = $size2[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $tpbforgneg[$k];
                            }
                            else {
                                $tempstrig =
                                  $tempstrig . $tpbforgneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 3 ) {
                    ...
                    if ( $size2[$j] == 1 ) {
                        print
"change in $pfforgneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size2[$j] == 2 ) {
                        print
"changes in $pfforgneg[0] and $pfforgneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $pfforgneg[0], $pfforgneg[1], ";
                        for ( $k = 2 ; $k < $size2[$j] ; $k++ ) {
                            $stopstrig = $size2[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $pfforgneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $pfforgneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 4 ) {
                    ...
                    if ( $size2[$j] == 1 ) {
                        print
"change in $wfforgneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size2[$j] == 2 ) {
                        print
"changes in $wfforgneg[0] and $wfforgneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $wfforgneg[0], $wfforgneg[1], ";
                        for ( $k = 2 ; $k < $size2[$j] ; $k++ ) {
                            $stopstrig = $size2[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $wfforgneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $wfnestneg[$k] . ", ";
                            }
...
if ( $spreyc[0] == -99 ) {
    print
"<p>There is insufficient published information to evaluate effects of the selected fuel treatments on forage or prey habitat. 
Please consult with a local wildlife biologist.</p>";
}
else {
    if ( $spreyc[0] > 0 ) {
        if ( $spreyc[0] == $spreyc[$#spreyc] ) {
            print <<"preyp1";
<p>Of the selected fuel treatments, <b>WHRM</b>
...
preyp1
            ...
            print
"<p>All the selected treatments resulted in a positive effect on forage or prey habitat.</p>";
        }
    }
    elsif ( $spreyc[0] == 0 ) {
        if ( $spreyc[0] == $spreyc[$#spreyc] ) {
...
"<p>All the selected treatments resulted in a positive effect on forage or prey habitat.</p>";
        ...
        print
"<p>The following treatment(s) resulted in <u><b>negative</b></u> effects on forage or prey habitat  
	for the $species:";
        print "<ul>";
        for ( $j = 0 ; $j < $tsize ; $j++ ) {
            if ( $preyc[$j] < 0 ) {
                if ( $treatments[$j] == 1 ) {
                    ...
                    if ( $size3[$j] == 1 ) {
                        print
"change in $preyneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size3[$j] == 2 ) {
                        print
"changes in $preyneg[0] and $preyneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig = "changes in $preyneg[0], $preyneg[1], ";
                        for ( $k = 2 ; $k < $size3[$j] ; $k++ ) {
                            $stopstrig = $size3[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig = $tempstrig . "and " . $preyneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $preyneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 2 ) {
                    ...
                    if ( $size3[$j] == 1 ) {
                        print
"change in $tpbpreyneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size3[$j] == 2 ) {
                        print
"changes in $tpbpreyneg[0] and $tpbpreyneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $tpbpreyneg[0], $tpbpreyneg[1], ";
                        for ( $k = 2 ; $k < $size3[$j] ; $k++ ) {
                            $stopstrig = $size3[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $tpbpreyneg[$k];
                            }
                            else {
                                $tempstrig =
                                  $tempstrig . $tpbpreyneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 3 ) {
                    ...
                    if ( $size3[$j] == 1 ) {
                        print
"change in $pfpreyneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size3[$j] == 2 ) {
                        print
"changes in $pfpreyneg[0] and $pfpreyneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $pfpreyneg[0], $pfpreyneg[1], ";
                        for ( $k = 2 ; $k < $size3[$j] ; $k++ ) {
                            $stopstrig = $size3[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $pfpreyneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $pfpreyneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 4 ) {
                    ...
                    if ( $size3[$j] == 1 ) {
                        print
"change in $wfpreyneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size3[$j] == 2 ) {
                        print
"changes in $wfpreyneg[0] and $wfpreyneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $wfpreyneg[0], $wfpreyneg[1], ";
                        for ( $k = 2 ; $k < $size3[$j] ; $k++ ) {
                            $stopstrig = $size3[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $wfpreyneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $wfnestneg[$k] . ", ";
                            }
...
if ( $scovec[0] == -99 ) {
    print
"<p>There is insufficient published information to evaluate effects of the selected fuel treatments on cover habitats. 
Please consult with a local wildlife biologist.</p>";
}
else {
    if ( $scovec[0] > 0 ) {
        if ( $scovec[0] == $scovec[$#scovec] ) {
            print <<"covep1";
<p>Of the selected fuel treatments, <b>WHRM</b>
...
covep1
            ...
            print
"<p>All the selected treatments resulted in a positive effect on cover habitat.</p>";
        }
    }
    elsif ( $scovec[0] == 0 ) {
        if ( $scovec[0] == $scovec[$#scovec] ) {
...
"<p>All the selected treatments resulted in a positive effect on cover habitat.</p>";
        ...
        print
"<p>The following treatment(s) resulted in <u><b>negative</b></u> effects on cover habitat for the $species:";
        print "<ul>";
        for ( $j = 0 ; $j < $tsize ; $j++ ) {
            if ( $covec[$j] < 0 ) {
                if ( $treatments[$j] == 1 ) {
                    ...
                    if ( $size4[$j] == 1 ) {
                        print
"change in $coveneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size4[$j] == 2 ) {
                        print
"changes in $coveneg[0] and $coveneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig = "changes in $coveneg[0], $coveneg[1], ";
                        for ( $k = 2 ; $k < $size4[$j] ; $k++ ) {
                            $stopstrig = $size4[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig = $tempstrig . "and " . $coveneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $coveneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 2 ) {
                    ...
                    if ( $size4[$j] == 1 ) {
                        print
"change in $tpbcoveneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size4[$j] == 2 ) {
                        print
"changes in $tpbcoveneg[0] and $tpbcoveneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $tpbcoveneg[0], $tpbcoveneg[1], ";
                        for ( $k = 2 ; $k < $size4[$j] ; $k++ ) {
                            $stopstrig = $size4[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $tpbcoveneg[$k];
                            }
                            else {
                                $tempstrig =
                                  $tempstrig . $tpbcoveneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 3 ) {
                    ...
                    if ( $size4[$j] == 1 ) {
                        print
"change in $pfcoveneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size4[$j] == 2 ) {
                        print
"changes in $pfcoveneg[0] and $pfcoveneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $pfcoveneg[0], $pfcoveneg[1], ";
                        for ( $k = 2 ; $k < $size4[$j] ; $k++ ) {
                            $stopstrig = $size4[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $pfcoveneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $pfcoveneg[$k] . ", ";
                            }
                ...
                if ( $treatments[$j] == 4 ) {
                    print "<li>$nametreatment[$j] where ";
                    if ( $size4[$j] == 1 ) {
                        print
"change in $wfcoveneg[0] contributed to these negative effects.";
                    }
                    elsif ( $size4[$j] == 2 ) {
                        print
"changes in $wfcoveneg[0] and $wfcoveneg[1] contributed to these negative effects.";
                    }
                    else {
                        $tempstrig =
                          "changes in $wfcoveneg[0], $wfcoveneg[1], ";
                        for ( $k = 2 ; $k < $size4[$j] ; $k++ ) {
                            $stopstrig = $size4[$j] - 1;
                            if ( $k == $stopstrig ) {
                                $tempstrig =
                                  $tempstrig . "and " . $wfcoveneg[$k];
                            }
                            else {
                                $tempstrig = $tempstrig . $wfcoveneg[$k] . ", ";
                            }
...
for ( $j = 0 ; $j < $tsize ; $j++ ) {
    if ( $treatments[$j] == 1 ) {
        print
" <!--deleteform method=post name=wildlifem2 action=https://localhost/Scripts/fuels/whrm/twhrm5.pl--> ";
        print
" <form method=post name=wildlifem2 action=/cgi-bin/fuels/whrm/twhrm5.pl> ";
        ...
        print
" <input type=\"hidden\" value=\"Thinning and Broadcast Burning\" name=\"treatname\"> ";

        for ( $i = 0 ; $i < $temprow ; $i++ ) {
            print
qq(<INPUT type="hidden" name="evalues$i" value="$tbfevalues[$i]">);
        }
        print " </form> ";
    }
    if ( $treatments[$j] == 2 ) {
...
" <form method=post name=wildlifem2 action=/cgi-bin/fuels/whrm/twhrm5.pl> ";
        ...
        print " <input type=\"hidden\" value=\"$temprow\" name=\"temprow\"> ";
        print
" <input type=\"hidden\" value=\"Thinning and Pile Burning\" name=\"treatname\"> ";

        for ( $i = 0 ; $i < $temprow ; $i++ ) {
            print
qq(<INPUT type="hidden" name="evalues$i" value="$tpbevalues[$i]">);
        }
        print " </form> ";
    }
    if ( $treatments[$j] == 3 ) {
...
" <form method=post name=wildlifem2 action=/cgi-bin/fuels/whrm/twhrm5.pl> ";
        ...
        print " <input type=\"hidden\" value=\"$temprow\" name=\"temprow\"> ";
        print
" <input type=\"hidden\" value=\"Prescribed Fire\" name=\"treatname\"> ";

        for ( $i = 0 ; $i < $temprow ; $i++ ) {
            print
              qq(<INPUT type="hidden" name="evalues$i" value="$pfevalues[$i]">);
        }
        print " </form> ";
    }
    if ( $treatments[$j] == 4 ) {
...
" <form method=post name=wildlifem2 action=/cgi-bin/fuels/whrm/twhrm5.pl> ";
        ...
        for ( $i = 0 ; $i < $temprow ; $i++ ) {
            print
              qq(<INPUT type="hidden" name="evalues$i" value="$wfevalues[$i]">);
        }
        print " </form> ";
    }
...
for ( $i = 0 ; $i <= 12 ; $i++ ) {
    print "
     <tr>
      <th colspan=2>
       <font size=3>$litreview[(2*$i)]</font>
      </th>
...
for ( $i = 27 ; $i <= ( @litreview - 1 ) ; $i++ ) {
    ...
    chop $temp;
    chomp $temp;
    if ( $temp =~ /Study Location:/ ) {
        $temp = "<blockquote>\n     <b>Study Location:</b>"
          . substr( $temp, 15 ) . '<br>';
    }
    if ( $temp =~ /Location of Study:/ ) {
        $temp = "\n     <blockquote><b>Location of Study:</b>"
          . substr( $temp, 18 ) . '<br>';
    }
    if ( $temp =~ /Habitat Description:/ ) {
        $temp = ' <b>Habitat Description:</b>' . substr( $temp, 20 ) . '<br>';
    }
    if ( $temp =~ /Summary:/ ) {
        $temp = ' <b>Summary:</b>' . substr( $temp, 8 ) . "\n    </blockquote>";
    }
    print "    $temp\n";
