...
// 2013.09.10 -- modified from 2011.12.08 index.php
//    added banner about rescheduled 50th anniversary celebration, and 
//    deleted last-modified code (footer display) as it always showed date of display, not php file date
...
<div id="section01">
	<div class="contentbox01">
		<ul class="fslinks">
			<li><a href="https://www.fs.fed.us/rmrs/" title="Rocky Mountain Research Station"><img src="<?php echo ("".$home_URL."/".$shared_directory.""); ?>/logo_rmrs_tan_bkgd.gif" width="160" height="118" alt="Rocky Mountain Research Station" /></a></li>
			<li><a href="https://www.usda.gov" title="United States Department of Agriculture"><img src="<?php echo ("".$home_URL."/".$shared_directory.""); ?>/logo_usda.gif" width="69" height="47" alt="United States Department of Agriculture" /></a><a href="https://www.fs.fed.us/"><img src="<?php echo ("".$home_URL."/".$shared_directory.""); ?>/logo_fs_tan_bkgd.gif" width="45" height="46" alt="United States Forest Service" /></a></li>
			<li><a href="https://www.usa.gov"><img src="<?php echo ("".$home_URL."/".$shared_directory.""); ?>/logo_usagov_tan_bkgd.gif" width="121" height="36" alt="USA.gov" /></a></li>
		</ul>
       ...
       <div id="pagewrapper01" class="home">
           ...
           <div class="contentbox01">
            <h1>Moscow Forestry Sciences Laboratory</h1>
             <div class="simple-main-content-nav">
              <h2><a href="<?php echo ("".$home_URL."");?>/climate/">Climate Data &amp; Estimates, Climate Change and Plant Climate Relationships</a></h2>
              <h2><a href="<?php echo ("".$home_URL."");?>/lidar/">LiDAR &ndash; Multiscale Curvature Classification</a></h2>
		...
		<li><a href="<?php echo ("".$home_URL."");?>/smp/">Long-Term Soil Productivity (LTSP)</a></li>
	        <li><a href="<?php echo ("".$home_URL."");?>/smp/solo/"><acronym title="Soil quality monitoring and Long term ecosystem sustainability">SoLo</acronym>: Soil Monitoring and Productivity Library</a></li>
              ...
              <h2>Soil and Water Engineering</h2>
               <table border=0>
                <tr>
                 <td width=60%>
                  <ul>
                   <li><a href="/library/">Publications</a></li>
                   <li><a class="main-nav-current" href="/engr/software.html">Soil erosion and slope stability modeling software</a> (FS&nbsp;WEPP, LISA, XSTABL)</li>
                   <!-- a class="main-nav-current" href="/fswepp/" FS WEPP modeling software -->
                   <li><a class="main-nav-current" href="/BAERTOOLS/">BAERTOOLS</a></li>
                   <li><a class="main-nav-current" href="wbiomass">Western Biomass software</a></li>
                  </ul>
                 </td>
                 <td valign=top>
                  <ul>
                  <li><a class="main-nav-current" href="/engr/DuffMoistureMeter/">Duff Moisture Meter</a></li>
                  <li><a class="main-nav-current" href="/engr/siltfence/">Silt fences</a></li>
                  <li><a class="main-nav-current" href="/engr/watershed/watersheddata.html">Watershed data</a></li>
                 </ul>
                </td>
               </tr>
              </table>

              <h2><a href="fuels">Applied Wildland Fire Research in Support of Project Level Hazardous Fuels Planning</a></h2>

         <h2><a href="people">Moscow Lab Personnel</a></h2>
					</div>
					<h2>Rocky Mountain Research Station Programs located at the Moscow Laboratory</h2>
					<ul>
						<li><a href="https://www.fs.fed.us/rmrs/research/programs/air-water-aquatics/">Air, Water and Aquatics</a></li>
						<li><a href="https://www.fs.fed.us/rmrs/research/programs/forest-woodlands-ecosystem/">Forests and Woodlands Ecosystems</a></li>
						<li><a href="https://www.fs.fed.us/rmrs/research/programs/grassland-shrubland-desert/">Grassland, Shrubland and Desert Ecosystems</a></li>
					</ul>
